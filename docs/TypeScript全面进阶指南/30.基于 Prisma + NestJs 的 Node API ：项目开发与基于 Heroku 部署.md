...
![img](./images/e3472b1da0ad4e83b172de9459ce8f89~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

在登录时，如果提示需要 Multi-Factor Auth，可以选择先跳过。完成登录后，它会将你重定向到应用管理页面：

![img](./images/1d110619004e4206970b09f5ccc58352~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

点击右上角的新建，选择创建一个新应用，应用名需要是独一无二的：

![img](./images/4bf682717ec8459d80cdd4d6b30dc8ad~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

创建成功后，我们会来到应用界面，以我们已经创建完毕的页面为例：

![img](./images/71d6ff9e4d094f039b8b02ffbfd6e19a~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

点击 Deploy，我们需要把应用和 github 仓库关联起来，这样就能在每次提交时自动重新部署了：

![img](./images/7a417cbbef4d42d79a8ba9ed7bed5db5~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

首先选择 Connect to GitHub，授权完毕后选择你对应的仓库，配置完毕后你会看到这样的界面：

![img](./images/bafba9bd4745406f81ad9816ad252b32~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

点击 Enable Automatic Deploys 后，我们的应用就会随着每次 Git 提交而重新部署。

另外，我们此前的环境配置其实就是安装了 Heroku 的 CLI ，现在我们需要通过 CLI 在终端也登录上：

![img](./images/09019473d3624134ac5b364846e27855~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![img](./images/dfed83b21e3343fe8b018d00d118102f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

点击创建一个新的 token，复制它，回到终端运行 `heroku login -i`，账号名输入你的邮箱，密码输入 token，确认登录：

![img](./images/5c40b8f03ce8412fb6afbeed2238ef09~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![img](./images/218f581028b44df8b3708a5093c64ec1~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
[![image380be9c6e463109c.png](./images/532677aa75a59eeb778b322bf6536d0b.png)](https://link.juejin.cn/?target=https%3A%2F%2Fwww.imagehub.cc%2Fimage%2FGfiN6y)

点击安装，将安装到我们的应用中：

![img](./images/0b87bc3e13a0450d9c9c0785a97e83dc~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

![img](./images/be4728eb4e8d4501aa0d753c675e715d~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

数据库的链接会被以环境变量 `process.env.DATABASE_URL `注入进来，来到应用配置页面，点击显示环境变量：

![imagee38ce6a381dc9b3b.png](./images/b32f3cf2e9154e68a3aa71a3f16f6e7f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![imagedb88d65589f9bb99.png](./images/d2d399ff45334686980f119b2e9c6f3b~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![imagee102f1b42e36a82b.png](./images/da58905298d5482984b597c991bf3dda~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![imagef0c3c4a1ded5150f.png](./images/6025bda33b8a4709a9b4dba1b129d064~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

![imagea22f61b473e93e2c.png](./images/c756e5dd4e134fca9cfd32935f70cd1a~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![image752c0cd8664a87c4.png](./images/0f3ea4d8ac65437a9c80090698003514~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![img](./images/7314b443ae7b47c3872633790b054945~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

`GET /article`：

![img](./images/37eb9b4838754c41b4b197a87ceec6eb~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

`GET /article?id=20`：

![img](./images/c5a7fc13bdce46f49738b00c7f7f2c8d~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

`POST /article/update`：

![img](./images/31fc1d35f6cd4dd9a524dbf2d90f16ed~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
