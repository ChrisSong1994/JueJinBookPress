...
![img](./images/35a35cdc4e764431aa795f61c8a8d8e9~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)

如果你选择了使用 TypeScript，它会自动为你安装 `@typescript-eslint/` 一系列工具。比如上面我们最终安装了这些依赖：

![img](./images/383031f761d94c568f24921e5b138809~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
...
![img](./images/6c44b7cd1263402884dbd71148f8b93e~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.png)
