...
![1.jpeg](./images/82dd65a49b45c09ecca8a8e734982499.webp )
...
那么 KeepaliveItem 组件也会被卸载的，这个是在所难免的，如果 Content 是 KeepaliveItem 的子元素节点，那么 KeepaliveItem 的卸载，所有的子元素也会被卸载，这样的话保持 Content 的存活也就不可能实现了。
 ...
 ![2.jpeg](./images/09ab7110ebf70685ed9a4b83433aad4e.webp )
...
这个时候关键的一步来了，**children 不要在 KeepaliveItem 中直接渲染，而是把 children（ Content 对应的 element 对象 ），交给 KeepaliveScope。**
  ...
  ![3.jpeg](./images/0f2c85622c74349425d90d344426a9bb.webp )

KeepaliveScope 得到了 Content 的 element 对象，这个时候直接渲染 element 对象就可以了，此时 Content 组件对应的 DOM 元素就会存在了。
    
![5.jpeg](./images/845d54825f3f21cfd680f33db1258070.webp )
    
![6.jpeg](./images/93c30682ea741942ddff8ced6994fa62.webp )
...
![7.png](./images/a0ed24094013c5fb483bf8f0cb3c4efe.webp )
...
![8.png](./images/f32cb77f1e1f5302a287acae4b930b33.webp )
...
![12.jpeg](./images/b2186bee25057dc42cd1f03357fa7b4e.webp )
...
![1.jpeg](./images/f7496a7834d84d5475c54820acc49498.webp )
...
![2.jpeg](./images/7e6c14a3e617de044e8da5cd016a3f0e.webp )
...
![3.jpeg](./images/6b101dde127f972a9d742680fbb82996.webp )
