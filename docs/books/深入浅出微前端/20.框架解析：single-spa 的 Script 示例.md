...
![image.png](./images/50924f6288194abba6762b71b296feb6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![yuque_diagram.jpg](./images/0addb891d06948a696d8b381f7d60498~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

## 动态 Script 示例 - 主应用设计

首先来看下动态 Script 的实现示例，实现效果如下所示，点击左侧的导航切换路由，使用 single-spa 监听路由的变化来切换微应用：

![录屏2024-01-30 09.25.15.gif](./images/ce0532bf23944bcd9bc41cfe0c6aec10~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/1bb643035623420bab0520322e9989f8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
