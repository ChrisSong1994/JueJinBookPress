...
![屏幕录制2023-11-02 09.10.37.gif](./images/2811d71da368468ab0ca449c04dfa97e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们可以使用 [Rectangle](https://rectangleapp.com/) 软件达到同样的效果， 它是一款用于窗口管理的免费软件，并且可以通过快捷键快速帮助 Mac 上的 APP 进行窗口大小和位置调整，如下所示：

![屏幕录制2023-11-02 08.58.44.gif](./images/9a27c9394c9547b7a3f50c14a1523d09~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

Rectangle 中的快捷键如下所示：
![image.png](./images/0567b3a44da1471c89f6c6dca665b867~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2023-11-02 19.26.50.png](./images/5495a9adff1a44f490d587fbeab296c5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

Arc 为了解决这个问题，主要引入了几个产品功能。首先是[定时清除已经打开的标签页](https://resources.arc.net/en/articles/6701333-auto-archive-clean-as-you-go)：

![image.png](./images/4ac7c29410b347cc8ae6bd31043f305e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/2cf9f9e1880c42e0b239df14f579253c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-02 20.54.54.gif](./images/39dffa2ee815451b87f24af481f729bc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

> 温馨提示：Arc 的搜索框可以实现 Raycast 中的 Quicklinks 功能，这个功能我们会在 Raycast 中进行讲解。

最后在 Arc 唤醒的搜索框中还可以搜索已经打开的标签页，从而可以防止新开重复的标签页：

![屏幕录制2023-11-02 21.08.29.gif](./images/db68f6b8c5e3449388541a28bd531ae6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-02 21.19.52.gif](./images/8ab2326bdb0443a3a230469bf010f9f1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/34f07d395e074a2b9d7f0dee33f8d98d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-04 10.58.46.gif](./images/1cf27e1726304f7c87ab163dbfcee467~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-04 12.02.09.gif](./images/3c974911b3c54f09998cb4f85cb9e66a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2023-11-04 12.34.08.png](./images/f094ca15ef7d4af991765cd5980d3e3f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2023-11-04 12.49.07.png](./images/0ce983d13a624d1880e74920cde36d9f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们可以通过双指手势进行左右滑动切换 Spaces，也可以使用快捷键按顺序使用 **⌃1** ~ **⌃N** 进行切换，如下所示：

![屏幕录制2023-11-04 12.58.21.gif](./images/6f4e63517c9a417d993ea6df86fea4cd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/c75673d59bff4db793d733aaea826cc6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

你可以通过 XMind 快速学习想要掌握的知识点，并在这个过程中锻炼学习思维和总结能力：

![image.png](./images/147b067dc25440c683f6d7c2eafbcf4d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-07 20.06.27.gif](./images/115c382a97c64c8887e4336fd7942c58~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们可以简单搜索需要执行的系统命令或者应用程序，从而可以快速执行这些命令，例如锁屏：
![image.png](./images/6a27cc875f1d49a5ba8a9fd5dcddd240~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

搜索 Chrome 应用程序进行启动：
![image.png](./images/dca4aed34f2c4afe86e5ce80a213925f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

也可以快速执行计算：
![image.png](./images/2811f4f00ac34ccda2bf2b522aa5cab2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/9774fb3bfc95444aa2063378dcd8bab5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/26cf8670fec44969981b02b8b437ccd3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-07 20.58.58.gif](./images/d34edb627aad462cb245a44fd475d746~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

如果想要提高搜索的效率，那么可以给 Quicklink 设置搜索别名，从而提高搜索的命中效率：

![image.png](./images/3fdcee5826414e2fa41be2b1f5e56c83~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/9fd90e0d18af49ecbec883b6f37d3d22~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/bf9528812a4f4421ac906b4d4b096a30~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/fa79a4fcc5614244901408ba1758fdfc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
搜索 VS Code 并下载扩展：
![image.png](./images/23abc5777d2b42be9d861b962c737daa~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
安装完成后可以查看扩展具备哪些能力：
![image.png](./images/2af3bd69532042b9828d0312c7698b7b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以为常用的命令设置搜索关键词，然后可以通过 Raycast 快速打开最近的 VS Code 应用：

![屏幕录制2023-11-07 21.26.17.gif](./images/ec88da05fa444db18609b454e735b480~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/b771fcbae3604dc4bafcf992fe5e7aea~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
选择 Node.js 设计脚本命令：
![image.png](./images/e5339a0907e9466ca1f394554d275514~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-08 19.52.22.gif](./images/9190a44e49a24ce79694a9586eaf755d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/168b98115e8b494980efa759224decbb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/2c39ff664d81417882643d4fdefb4027~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/bbc4545a523a4e6dac396413715d5150~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

默认会打开 https://ke-complex-modifications.pqrs.org 地址，搜索 Hyper Key 并可以选择空格右侧 **⌥** 作为 Hyper Key：

![image.png](./images/45856ff2e36e43e3946812d16d77a016~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/a9a574b779704608b2077f44fb45378a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/6f68114ce26a4683aebea1676114189b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

此时我们按下 **⌥P** 可以快速打开 VS Code 的最近项目搜索框：

![屏幕录制2023-11-08 20.55.35.gif](./images/a977454bd3dc40f09f6ff60b1bce6266~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![屏幕录制2023-11-08 21.04.53.gif](./images/163b10a49ba24f9daa79456fb7e5a81e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当然，还记得之前我们设置的 Quicklinks 功能吗，我们可以给 Google 搜索设置一个选中搜索内容 + 快捷键使用快速搜索，进行如下设置：

![image.png](./images/9cfc5ffebe3c4724bd748fe80b2b896c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

此时我在学习课程内容的时候发现 Module Federation 是一个很陌生的单词，我想对它进行搜索，那么只需要选中关键词，然后执行快捷键 **⌥G**：

![屏幕录制2023-11-08 21.26.14.gif](./images/dafe4dc255d64020bbd22bf840ce4d03~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
