...
![image.png](./images/b4d00a3279f344d4be4bdc3989fd6f97~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

上图中的**微应用 Fetch 加载逻辑**会使用 `import-html-entry` 替换实现，如下所示：

![yuque_diagram (53).jpg](./images/62ae7165d82e4b199b8a912b0eadb469~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![录屏2024-06-01 10.49.55.gif](./images/956caca29e434584bff383602d42e20d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/bcfcadc996c54125bf125bb587d9d4f1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/a4e149a05b7f432191e713f5215228ea~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![yuque_diagram (55).jpg](./images/c36fc4ab92a14f04b06e4e8acfbc8911~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/70afffa068ca4ac0b62fcab59716d503~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![yuque_diagram (59).jpg](./images/efaf866cba1941a598c4bdc1eecacae6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

> 温馨提示：上图中的绿色区域实现提取外联 `styles`。

其中通过正则匹配 `<script>` 标签（包含内联和外联脚本）的执行流程如下所示：

![yuque_diagram (60).jpg](./images/31be396410e14164b358a5741bfa58ed~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![yuque_diagram (61).jpg](./images/62af6974f2fb4c6fa9b8f150ef025609~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
