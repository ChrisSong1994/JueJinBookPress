...
![image.png](./images/2a47206d97d0490093336c6546940c08~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/5322dbbdd5e747e488e953b3ad1c735d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/5109ca8369ed458a94b771657c7cd85c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/9f9d013c24ea4e2db5da66419c0fe881~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

首次访问微应用 2 时 `vendors.js` 命中 304 缓存：

![image.png](./images/1a15fe0119ca4fbdae7e6b0e1dc5bbc8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/6bf780d797f643868d7bdd9b0726eb8e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/a66fcaedc74d4f6a8bf6f9ded0e05520~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们可以总结一下上述这些示例的首屏加载情况，如下所示：

![image.png](./images/bf4441beefc34494ae87814cecadcae2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/f86fc28d852243858269c090eccdf5ba~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/66d54a0cede34d96b2859490405bfb02~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/2e352177acd341b08380fa33ff08e642~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![录屏2024-03-05 19.37.52.gif](./images/7da3f18ee5f44d119848ef9ef7503bde~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/8b469825b25841df9d60773ed6d43240~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

`promise.then` 中打印的生命周期函数如下所示：

![](./images/a2eab4c786884ee898a2a89aa9787b6d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![Webpack 运行时分析-流程图 (1).jpg](./images/50df1b60e9fe4786b925c974f6570427~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![录屏2024-03-11 09.10.35.gif](./images/e79c2bd7dba54d7da4bde6ad77f5d608~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
