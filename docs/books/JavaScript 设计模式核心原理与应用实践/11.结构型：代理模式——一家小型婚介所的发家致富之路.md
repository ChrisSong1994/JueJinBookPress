...
![](./images/169e1b7893b5b5c7~tplv-t2oaga2asx-image.image.png)    

这是为啥呢？这就要从网络请求的整个流程说起了。一般情况下，当我们访问一个 url 的时候，会发生下图的过程：        

![](./images/169ecd30b1247ec6~tplv-t2oaga2asx-image.image.png)
...
![](./images/169ecdacec73af47~tplv-t2oaga2asx-image.image.png)
