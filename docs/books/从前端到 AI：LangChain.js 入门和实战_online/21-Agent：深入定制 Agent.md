...
![CleanShot 2024-04-14 at 23.07.16@2x.png](./images/d7523052450c42c89a45907fcb154f43~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
后面就是，serpAPI 返回正常结果：
![CleanShot 2024-04-14 at 23.13.27@2x.png](./images/4944d354408745d2bb440248e893dd0e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后再次调用 llm 节点：

![CleanShot 2024-04-14 at 23.14.18@2x.png](./images/2b58e5b55b7d43be8a623cf2a2f0ea9d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-04-14 at 23.18.01@2x.png](./images/209c9950d3ad44c2ac4f3299610a78b3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

是请求 serp 搜索微软当前的股价，serp 正常返回，然后第二次 llm 节点的调用是：

![CleanShot 2024-04-14 at 23.18.55@2x.png](./images/5399839066cf4ec69509c23cab8c5f78~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-04-15 at 13.56.13@2x.png](./images/5e2664436cef4256b94bb5a3c6c54462~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```js
  ...
  console.log(res);
```
![CleanShot 2024-04-15 at 17.39.25@2x.png](./images/ceb141a845634bf986cc07efb50f4a8f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
