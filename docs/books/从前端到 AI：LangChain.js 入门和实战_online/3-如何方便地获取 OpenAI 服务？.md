...
![CleanShot 2024-04-23 at 22.11.05@2x.png](./images/f881f0a7227c4847abfbfc4a84bb1c5a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后我们创建一个 Azure OpenAI 的服务：

![CleanShot 2024-04-23 at 22.12.10@2x.png](./images/5fa50e691e044992b4878db2e0ab3930~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

目前 OpenAI 的业务需要申请才能使用，第一次打开这个界面会提醒填写表单进行申请：

![CleanShot 2024-04-23 at 22.13.36@2x.png](./images/d8124116b1994f2da2788163a03ddef4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-04-23 at 22.24.17@2x.png](./images/c69977c1d21042b6aaf65661cfe1031e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)



Azure OpenAI 与 OpenAI API 有些不同，在 Azure 中，你需要先创建一个模型的部署，然后才能在 API 中使用部署名称去调用对应的部署，我们先创建一个 gpt4 的模型：

![CleanShot 2024-04-23 at 22.27.06@2x.png](./images/52dfe76c5a1a4b838b9bfe91c9a50654~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


![CleanShot 2024-04-23 at 22.27.50@2x.png](./images/86d904ca39304e6a835c823dabfcbd5c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


这里模型的版本根据你服务部署所在的区域有关，并且不同模型的 API 定价不同，你可以根据需要去创建特定的模型版本。

![CleanShot 2024-04-23 at 22.28.00@2x.png](./images/db196cac00da4047938701637190f364~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


创建之后，你就可以在聊天界面去测试这个部署：

![CleanShot 2024-04-23 at 22.30.10@2x.png](./images/9ed8a6e8a0b547b5a716249ca2c01c1b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-04-24 at 16.53.36@2x.png](./images/0b28b531e36f4f04a7b4b53ff13a3436~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
