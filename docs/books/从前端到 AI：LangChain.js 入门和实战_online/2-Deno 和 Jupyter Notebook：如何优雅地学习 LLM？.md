...
![CleanShot 2024-03-18 at 21.46.36@2x.png](./images/91e59b5d479c49c29770861e8088114e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-03-18 at 21.57.45@2x.png](./images/090c646b45dc4562b11b24002b7cf219~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-03-18 at 22.17.58@2x.png](./images/15ff9a5118dd48b796deaaafba52b8fb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

如果我们对切割的结果不满意，可以调整切割的方式，

![CleanShot 2024-03-18 at 22.18.36@2x.png](./images/d99ef1b62c1c47f6864a3200c0349c4c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
可以看到，再次运行第三个单元格两次后，左侧的数字就变成了 4。

**注意**，如果上游数据发生了改变，下游并不会自动的更新或者重新运行，例如我们这里手动修改 text 的值改成一个字符串。

![CleanShot 2024-03-18 at 22.21.05@2x.png](./images/5bad03f3eae54f5e92a88771468696b9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，后面依赖于 text 的代码格并没有自动更新，需要自己手动重新运行：

![CleanShot 2024-03-18 at 22.20.26@2x.png](./images/546c3bfb6acc4c418b761fbbe555a5a7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
之所以叫 Notebook 是因为天然支持 markdown，我们新建一个块，然后设置为 markdown 块：

![CleanShot 2024-03-19 at 11.37.55@2x.png](./images/e83f072f11cb4eeab2bfb16d2589da60~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![CleanShot 2024-03-19 at 11.39.34@2x.png](./images/bc1e5c15f06c4d6691effb1237a00dce~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在运行之后，就会渲染出来：

![转存失败，建议直接上传图片文件](./images/96bcc389c60b4e09ab11d6865dc90b36~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-03-19 at 11.27.05@2x.png](./images/dce9d4a5aadb4ebab65bee32fe37dcef~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-03-19 at 11.43.55@2x.png](./images/a3baab1c70c640859a1f5a59d4db0b15~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

<https://marketplace.visualstudio.com/items?itemName=ms-toolsai.jupyter>

![CleanShot 2024-03-19 at 11.45.39@2x.png](./images/3ef268044b274a44a80292f8408afe74~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
a
```
![CleanShot 2024-03-19 at 21.58.38@2x.png](./images/986a47dc02934611990cbcb4f3e350b5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![CleanShot 2024-03-19 at 22.05.50@2x.png](./images/8dc5ad42d5a34358a260d297499c0107~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
