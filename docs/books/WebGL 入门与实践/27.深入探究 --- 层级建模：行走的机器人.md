...
![](./images/16716697500485d2~tplv-t2oaga2asx-image.image.png)
...
![](./images/16711dfcf8990c2d~tplv-t2oaga2asx-image.image.png)
...
![](./images/16711e19ce7ea9fc~tplv-t2oaga2asx-image.image.png)

嗯，这次我们可以看到两个挨着的立方体了，靠右的是 forearm。

层级建模的一个优势是，我们只需要考虑局部的变换，不需要考虑世界坐标系变换，库会为我们自动计算。接下来我们演示一下，这次我们只让 arm 进行平移：

![](./images/16712ade469a330d~tplv-t2oaga2asx-image.image.png)
...
![](./images/16711e29ab3b8039~tplv-t2oaga2asx-image.image.png)
...
![](./images/16711e93eccba498~tplv-t2oaga2asx-image.image.png)
...
![](./images/16712d1a70f0f6e7~tplv-t2oaga2asx-image.image.png)
...
![](./images/167155e9f123c86a~tplv-t2oaga2asx-image.image.png)
...
![](./images/16715669ce1f8a79~tplv-t2oaga2asx-image.image.png)
...
![](./images/167156a1b273a716~tplv-t2oaga2asx-image.image.png)
...
![](./images/167167a6e64c57a0~tplv-t2oaga2asx-image.image.png)
