...
![](./images/098f02a9584a44caa14b9e8c89cd6d87~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
是这样的：
![](./images/a87a4da969324f2eabad176600aeb3a9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3ef593f753ee4bdba48e8dc67fae4d11~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 drop 的时候会触发 drop 回调函数，第一个参数是 item，就是 drag 的元素声明的那个。

只是这样还不行，还要在根组件加上 Context：

![](./images/29131c45d90e461e8576e7ae57d23d23~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f1b14269550b44628e861e83f76dd950~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

确实，现在元素能 drag 了，并且拖到目标元素也能触发 drop 事件，传入 item 数据。

那如果 type 不一样呢？

![](./images/7c0ea643b53a4cbaa0329a611b390970~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/b30d03ad74ed43cda507b39e958e7dd8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

那就触发不了 drop 了。

然后我们给 Box 组件添加一个 color 的 props，用来设置背景颜色：

![](./images/a08c4576d2ef48b8b00b512b7ee7872a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2c3154fcedda4fe48a585652f0512079~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/2c1c168b06be4fc596bf702183d762aa~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

没啥问题。

然后我们改下 Container 组件，增加一个 boxes 数组的 state，在 drop 的时候把 item 加到数组里，并触发渲染：

![](./images/3c8afb456b8b4697b47b8941bb440ee3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a351c740e1504a168f8923c79c7acda0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，拖拽到容器里的功能就实现了。

我们再加上一些拖拽过程中的效果：

![](./images/46affc9f2c9e49e2b30ab02e5ba5cad7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7178fdd175e54c2d8a9299de646cf076~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

确实，这样就给拖拽中的元素加上了对应的样式。

但如果我们想把这个预览的样式也给改了呢？

![](./images/974dd0fff0bd4f8b83650e643e95be82~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/aaaf5124a76a42329d84b5da516e433a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

现在的效果是这样的：

![](./images/bba8326668154b74b383c7e7131a3259~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

确实加上了自定义的预览样式，但是原来的还保留着。

这个也可以去掉：

![](./images/dd86c006693c49b6b1cbadbd97b6423c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2029e572643b474eb03ad3aa2ea400a0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/50c59509e968444dab885ebd880c4732~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

把它渲染出来是这样的：

![](./images/73446c2a9aa14bd9976438a38245143e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/fbe16875a8c547cea6dd7cb7dfe6453a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

接下来做的很显然就是交换位置了。

我们实现一个交换位置的方法，传入 Card 组件，并且把当前的 index 也传入：

![](./images/82a527f14c5849cea18f6cba3c1f5021~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
...
![](./images/c57f8781bd884f1ca45e3599b5c8e83f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/253f022acf244b4889b0d1277e9227b4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d1622644466743c792981ffd6a37855b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/19367f9bfb4043a7b79b687e386046ec~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9547b313d0894a11bce646d073be124e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

但现在你会发现它一直在换：

![](./images/68bf0af647e844c4ba91b8b55a7b3ead~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

那是因为交换位置后，没有修改 item.index 为新的位置，导致交换逻辑一致触发：

![](./images/eeef4d02d06c40cda15df821b627ea49~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/d8b2ca6cf48141d3942c9f7d3b372e11~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 hover 时就改变顺序，体验好多了。

然后我们再处理下拖拽时的样式。

![](./images/85da4e1ec7384ef78d894c41c972f8f0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/976ad015d5ca43089a3c2fab40c1d4d7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
