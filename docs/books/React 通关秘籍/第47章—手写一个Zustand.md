...
![](./images/cff2e7881119434190c0d26c7ad32073~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

zustand：

![](./images/ccb38193ae9c41e4b68fd08f01bf8bfe~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

看 npm 包的周下载量，redux 有 880w，而 zustand 也有 260w 了：

redux：

![](./images/1c8b363b562a4995932c74a62bfb728e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

zustand：

![](./images/4d962af6d26c4b3ab6c87f35c6d18561~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/049dc3b9398b4c71adddf67dbfd0bf39~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a92fbafeb491470e94913811f96be6fd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/976ff3a9b79f41a4beb72f7e02d38f07~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后在组件里调用 create 返回的函数，取出属性或者方法在组件里用：

![](./images/fecf937f65af47be8685eb15262b115d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/66f53d0566a84b50bc076ca481fa97d5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

此外，你还可以调用 subscribe 来添加一个监听器：

![](./images/5f96a9674d244e14a3de5e45427f6a19~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7427987af0a0487db8cc8d141a998c5b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这就是 zustand 的全部用法了，就这么简单。

![](./images/6ab61fe8aa604e3bb7ddc20e79f61764~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a789b7bbb5214082aac31e915909574b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/5707cf2971a744b9b2d2a1d3f3ac30f0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样不就给 zustand 的 set 方法加上了额外的功能么？

![](./images/371915a1fcd44ff5bf7c9245106e76d5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1b712c446ff44096a56de29a341a5576~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

效果如下：

![](./images/4d5312dfe9c34bd7af988bb9eb7cbd0a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而且，中间件是可以层层嵌套的：

我们把自己写的 log 和内置的 persist 结合起来：

![](./images/35a2546e1697420c8d9b81f2c3332380~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

效果如下：

![](./images/314e9cb8372b456a92b6274b199e4c2d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/179b386d20414054920cdbe29e476fa7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/52c507fec2a7487e90961e1f235c613c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/cde3193d934d4e769325a2ccc9f7fa56~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3e2328ed38394499b0e7a40b0b4a3de4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，功能依然正常：

![](./images/35c48201496242a9945776fa9515fc46~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/7b766f587cd14122a83401d85685f3bd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ec7c78b9bf784e038339d3f4f5d5dfef~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

有了这个 useSyncExternalStore 的 hook，我们就不用自己监听 store 变化触发 rerender 了：

![](./images/ce27c72c270141a88b27a14afff0281e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a377db82e9fc4c2a8b13c46cac935467~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

改下调试的端口，点击调试启动：

![](./images/d237292abc904dc9b653854c51f3a7bc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

把 zustand 换成之前的，然后打个断点：

![](./images/1424329f18cf43b3b42e47c32480fb62~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

通过调试，可以看到 create 的实现如下：

![](./images/4eefcd90ecf2412f85639fe5a6ecbef2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而 useStore 的实现如下：

![](./images/b1f3550b38c14b59b08edc4c44f8d142~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a314f83d13804c3482ac4e69f0658b9d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

源码里确实做了处理：

![](./images/2e67d323555b457f91c940d5699414c3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

至于为什么要这样，[官方解释](https://github.com/pmndrs/zustand/blob/main/docs/guides/typescript.md)说是为了好做中间件的 ts 类型处理：

![](./images/e4769fde57ef47d68eae82269332cfb4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
