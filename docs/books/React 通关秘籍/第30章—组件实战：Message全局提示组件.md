...
![](./images/917fbcbcff2747db87f8849178813682~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

和一般组件写在 JSX 里不同：

![](./images/8c4b7d614e3b4b65a7c8bcf6f8df5acb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

它是通过 api 的方式用的：

![](./images/ef20b8076c164272a2636fcfa8bd635c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e076c8b91f70404a83047e65e7f9fbc8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bf9c5b8a60f345f2947cb01ae3806626~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f5c3dbff79bb44f884197d6d3163ae34~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/81e18e47be0c4241b62b385e319a74e3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1ffb6aeb8fd444b1a13d40b93b277b5f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d561a87446f14636942fa7c881910998~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/dcbadf179bcd419da9c2a7b88f568ee9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

add 核心就是 setMessageList 添加一个元素。

用 getId 方法生成一个新的 id：

![](./images/d79bdc91afa544f48c5b168347ccbc30~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

如果传入了 id 就直接用传入的，否则返回递增的 id。

然后先根据 id 查找有没有已有的 message，如果有就不添加，直接返回之前的：

![](./images/c2f124356c6f4666ba7bfada4e64c08a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

否则，top 的在前面插入一个元素，bottom 的在后面插入一个元素：

![](./images/237bbf6dd200485a89e3ed7fdb35eed5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这个 getMessagePosition 方法就是遍历 top 和 bottom 数组，查找下有没有对应的 Message：

![](./images/7b6f2da3e62549239e357e44e58f5bf5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

update 就是找到对应的 message 修改信息：

![](./images/791c96142d5f432bbb2fd8c187750914~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

查找的方式就是先找到它在哪个数组里，然后返回对应数组中的下标：

![](./images/bb565ffb1ed4450d800f1e5bcb574c06~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

remove 是找到对应的数组，从中删除这个元素，clear 是重置数组：

![](./images/5a158cd1cc08427aa1eef0c8c7d36bc2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

实现了列表的增删改查之后，加上过渡动画就能实现这种效果：

![](./images/edea1f21a5854dcd9ad8eb8ed47a553c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们在 MessageProvider 里用 useStore 创建 message 列表，然后把它渲染出来：

![](./images/4739ee9e5700412d90c45186f954011a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6d3720bfcef84fa4b19a2b64640fa376~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们调用下：

![](./images/b633c587747a4b23bda4385dbcc46f9b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e501adc670ac41e79bacd3811e29b5f2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/af938dfefa9d436eaaed8ca2e4efa4cc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4282855b130d47c3a68cf3d0cf56a61a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/8100eb0efd9748c38060da79a983e997~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当然，现在的 message 比较丑，我们写一下样式：

![](./images/f3f6385f014c49b4841975b1cc9da0a4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/94bc1b7239304bd5a4165ed29d42a34b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

好看多了。

只是现在的 message 都是在 root 下渲染的：

![](./images/c754e433d405422b89e201c777b55ede~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们通过 createPortal 把它渲染到 body 下。

![](./images/6d967deb73024d34bf134d176ea5655b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4c6d54cf334745a2abcd96e5576b99a2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

此外，我们还要处理下 hover 的事件，当 hover 的时候，这个提示会一直存在不会消失，直到鼠标移开才消失。

否则，到了 duration 的时间就会消失。

![](./images/25849f3f68fd4bbeb9d725d6e4bdb4da~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/88971b7877cd46b890734f121c93e1a6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/db291bd39f574819bbe0e42f96900b57~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/689009e84de5438ab6d77fb96e4a2282~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/d2f99b75a10249ecbf3ad344649aaeff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c3819df99ed748c7a191224506be7ec0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/31ae42135ec243e2bbc45e40f898aa68~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/c04ae50b06d842bfb835d208e230ebc2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

你会发现先执行的 useMessage 取了 messageRef.current 的值，然后我们才设置了 messageRef.current。

![](./images/064dd566a7674bc88f242642aded84a3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f3d40943a55e4d6584f54afbb0746acc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a3785f4534d64d22a029e8138fb4df61~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
