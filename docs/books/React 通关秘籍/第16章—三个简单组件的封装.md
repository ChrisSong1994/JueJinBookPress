...
![](./images/3e07bd1b6dfd472d8929594fc09b321e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9118f8dc31e64aaa9ac57efe095e4f5e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

但我们也可以把它封装成 Portal 组件来用。

接收 attach、children 参数，attach 就是挂载到的 dom 节点，默认是 document.body

![](./images/d04d78a8f66c4306a9e49897eae7a14b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后提供一个 getAttach 方法，如果传入的是 string，就作为选择器来找到对应的 dom，如果是 HTMLElement，则直接作为挂载节点，否则，返回 document.body：

![](./images/14a292753c634fb8b19cdf32009436b5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后在 attach 的元素下添加一个 dom 节点作为容器：

![](./images/7ce11f58dfd24f4d90dd9f4861caa25a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2aaba0615f5143df913f66ecb1227ca9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0a13a3b01d7a47c9987ecb3b07d17da7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/d07beef597db4eb0a7ab0db2d12f3286~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/fa8efaefb7e74ae78887a276814e0543~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0a3e581f70244117a3dbcb5718c6d973~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，2s 后 dom 发生改变，MutationObserver 监听到了它子节点的变化，属性的变化。

![](./images/d14a39fc1e364a86913e99499f6cb5f6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/00da9a19fe9947539ea3845b66a83641~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这个 api 用起来也不麻烦，但可以封装成自定义 hooks 或者组件。

ahooks 里就有这个 hook：

![](./images/ff4404b11ce7488fa84dccb2e69a8841~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而 antd 里更是把它封装成了组件：

![](./images/71a6112c1dc24d84a7968ff91e501eb5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样用：

![](./images/01463185d37f4d90bcb3ab5f7d9a9eb3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1ecadc5dbd684b47bad6c3d36fdde844~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/5536eb0792444f55a83e9a5e62620fbf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4d97f5c2f8e0492b87f0f94418fae4b6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/764996a9351b49f196e2cbc77d8d23ee~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7ca78605bc454a5b9599dbc0015f729d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/3e468d15d288436eac38a623af87f35e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b8c6c1ecf71d42fa8a281ea4f288c20a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/03ac5e86a52540818b9961f95b2011d1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后用 cloneElement 给元素加上 onClick 事件，执行复制，并且还会调用元素原来的 onClick 事件：

![](./images/0b00981af99448899985db14ab27cd19~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

换成我们自己的组件：

![](./images/be9357bb7f704122b75c5d2fd63f1461~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

效果一样：

![](./images/b765b37f10934344abd83f8d92309535~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
