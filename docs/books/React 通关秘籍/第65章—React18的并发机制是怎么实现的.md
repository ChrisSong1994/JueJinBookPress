...
![](./images/855a154a837148baa23081088756151b~tplv-k3u1fbpfcp-watermark.image.png)

vdom 是指 React Element 的对象树：

![](./images/38736547cc364112ae0bf3f57f4d89e3~tplv-k3u1fbpfcp-watermark.image.png)

之后这个 vdom 会转换为 fiber 结构：

![](./images/5229ddf0916944909be3f214a97258e1~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/c54edf29da2a45f48b8aa5eb3647074e~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/ff1a03c562b54904899dc9a8f5bfa0ed~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/479cc2b24bdf46daac214f36d2ef87a3~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/3c3cd7ab2eea4a0aaa2786b9b9e79efb~tplv-k3u1fbpfcp-watermark.image.png)

然后把剩下的节点 schdule 就好了。当再次 schedule 到这个任务，就会继续渲染。

![](./images/53a00058a09e4cf38011849cf8a880c5~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/aa3f280365d34fa59db5e518efffbab2~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/173203d93b37453687bfbd3dd1501b9b~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/52aaa6b45216469f8d9ecaece41786a5~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/50f98a9d8e75477cbe2ce2fa9fee0ab0~tplv-k3u1fbpfcp-watermark.image.png)

这样设计的好处，自然是可以用二进制运算快速得到是哪种优先级了：

比如按位与、按位或等：

![](./images/2e9d1876d65841bf96fbe2a8ec75378e~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/5de14084a57f42878527304af920508d~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/d9ea7750892c4d5f9ea5c98cf37dd90d~tplv-k3u1fbpfcp-watermark.image.png)

是不是就很像赛道：

![](./images/44824c2544314587af70c7f4ad32c122~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/621f03ae0002482eb9e38fdd92a9aa7d~tplv-k3u1fbpfcp-watermark.image.png)

怎么实现的 Lane 优先级转 Event 优先级，那就是有几个分界点了：

![](./images/0198956afad44c4ca5085c2079c8c43b~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/09e6d7be54a44fbe9a2d0dba8d590558~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/0e8481731912482dbbf550a69c4b013c~tplv-k3u1fbpfcp-watermark.image.png)

并发执行：

![](./images/e23e8cf738534822b207dc1b26f3bfa6~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/c3fa46a8b1614243a0776a22c6dee16c~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/87c53e1253644ebebfc161b0363e3ff0~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/b057d5bd19ea4b529080cb0951f2d3af~tplv-k3u1fbpfcp-watermark.image.png)

源码里是在调用回调函数之前设置了更新的优先级为 ContinuousEvent 的优先级，也就是连续事件优先级，比 DiscreteEvent 离散事件优先级更低，所以会比另一个 setState 触发的渲染的优先级低，在调度的时候排在后面。

这里设置的其实就是 Lane 的优先级：

![](./images/2c0b607b3dee4c38b595a2244bbd83f4~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/b9ff71ed92e74b00a5199a629d5b6e47~tplv-k3u1fbpfcp-watermark.image.png)
