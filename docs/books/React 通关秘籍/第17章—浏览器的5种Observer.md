...
![](./images/b0a7e768453e4bb99365e614a98d8b3f~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/5f7c3f41e1924c62942a741bd7d4baa5~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/647a660a3f0f40ea90cff9b2a6ea8398~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/a7e836594b754b2e8d262c3fee602ec9~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/f8119b259a5640218a61f530573c956a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3712761d69f142e6bbe580db5a712977~tplv-k3u1fbpfcp-watermark.image.png)

大小变化被监听到了，看下打印的信息：

![](./images/c64db90b225e4350b777f8ec57032043~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/c5d336a321b147f2ab655e1c6857d55d~tplv-k3u1fbpfcp-watermark.image.png)
...
mark：
![](./images/4aacfb0969534307b2718f27e3b52472~tplv-k3u1fbpfcp-watermark.image.png)

图片加载：

![](./images/11a00ac93d614c50a272728b4afd319d~tplv-k3u1fbpfcp-watermark.image.png)

measure：

![](./images/0795f5a92e2947caa1d2c8939912dab3~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/d7d6bcc99daa4c588ccf9005fbfbb453~tplv-k3u1fbpfcp-watermark.image.png)

浏览器还会在一些情况下对网页行为做一些干预（intervention），比如会把占用 cpu 太多的广告的 iframe 删掉：

![](./images/f7bb6903a6f846908cde63064336ceab~tplv-k3u1fbpfcp-watermark.image.png)

会在网络比较慢的时候把图片替换为占位图片，点击才会加载：

![](./images/9fa5be3e31ff4846ad8b90b1a61e6ee7~tplv-k3u1fbpfcp-watermark.image.png)

这些干预都是浏览器做的，会在控制台打印一个报告：

![](./images/7d5f7d6e298a49e8af99792f696ae803~tplv-k3u1fbpfcp-watermark.image.png)
