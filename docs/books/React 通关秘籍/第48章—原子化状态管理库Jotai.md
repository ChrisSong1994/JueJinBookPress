...
![](./images/c323f28070da446c9f70a5c72dc17050~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/0f7a52d698f94597b1aa7dfa7af97fb8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f412d82d51714f4b9a63947cae9a1c1c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
export default App;
```
![](./images/d6efa34a0ed14a77a01b881d78ba08b3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7f68f86991da467b93d7b96cdf790d40~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/3242566136b647f0a94815a85f491823~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

store 里定义全部的 state，然后在组件里选出一部分来用。

这个叫做 selector：

![](./images/752ecda80ed1456fbba97f9cde86b20f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

状态变了之后，zustand 会对比 selector 出的状态的新旧值，变了才会触发组件重新渲染。

此外，这个 selector 还可以起到派生状态的作用，对原始状态做一些修改：

![](./images/b7e37f0575b643cfac4bd77af5e51ef6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/678f0e5bf8a4460dadb1581ce6a106e3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

状态可以组合，产生派生状态：

![](./images/74d4ca3baa9e434884c8981631f57e83~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/e5cd85a5b14b4f09b19556fdf31c504c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而在 zustand 里是通过 selector 来做：

![](./images/be730aa9d1a84ea9b4247e1e54b17f77~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/2436ce94699c4cf7837d10dc37fa6a8f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4e83b8050cad42c5baeb10d1ec090e90~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/caf5ec47b3ed4137b9daa448df3f8c07~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

atom 除了可以直接传值外，也可以分别传入 get、set 函数。

之前的派生状态就是只传入了 get 函数：

![](./images/1b3fe0dcf85348d2b0b24ad8f8cbb727~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，状态是只读的。

这里我们只传入了 set 函数：

![](./images/f1531622a98741349cecc120d47d4c9d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

所以状态是只能写。

用的时候要取第二个参数：

![](./images/d7b602d1aa8f4d6780fde996758a7ccd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当然，这么写有点费劲，所以 atom 对于只读只写的状态多了两个 hook：

![](./images/7a77794666864adc957d640065381c7a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

useAtomValue 是读取值，useSetAtom 是拿到写入函数。

而常用的 useAtom 就是拿到这两者返回值的数组。

![](./images/fbd0d8f8795f4825a2dbc7c52a60c430~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f477c75d991c4e1b9f25ebf152aaa6eb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3c5748f67bf54c40a0209a8b8d750b25~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/581131660345448882d43f025e662a8e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

换成 useSetAtom，也就是不需要读取状态值。

这样状态变了就不如触发这个组件的重新渲染了：

![](./images/194a522cd47e457cbbd9657999c8defc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/79e3f3f0cbc44fa0a4d242823ee92c44~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/97cb5cd555f54fd79b667b011db96303~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

jotai 里是用 utils 包的 atomWithStorage：

![](./images/b6f128895d78499a8e787748659744d8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/5f25d4e7aaab4a2f934c9b15e8c6faf4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

它是怎么实现的呢？和 zustand 的中间件有啥区别么？

看下源码：

![](./images/192ce04ddba1469381f209fad3cf7eab~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
