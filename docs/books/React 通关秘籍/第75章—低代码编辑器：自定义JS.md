...
![](./images/182bbd2b1acf423d967860b1ca1f3b3a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

它就支持通过代码来自定义动作。

而且自定义 JS 可以拿到 doAction 方法来执行其他动作：

![](./images/fed4c8a02110400fb1fc0062aea168c0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0280b285dcb54c34b41ca474adb8df4b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9decd4f5800f4674a9b56a23b693dea1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e368b7bc13f1410fb43f6592e99e3235~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

动作添加成功。

在 json 里可以看到这个配置：

![](./images/e7c0387939734ea58eeacc134844ee9b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

接下来只要 Preview 的时候实现这种 action 的执行就好了。

![](./images/7c43f5f25d9e45ceb197ce551634804f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/427223250db64412b9de9cfca3b7890c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样就实现了自定义 JS 的执行。

然后给执行的函数加上一些参数：

![](./images/ea58f10f3a304412899832645eb7b99b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a2049e14eb6a49c69d99e5b6a07a88d5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/4e2e36c367dd4ec7943435c1e4ecd6a8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，自定义 JS 的功能就完成了。

但现在有个问题：

![](./images/7e036025d5014df7a0d3b1942552af30~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/648d3bc183f34ee0ab37c8b5fde112be~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

改下 ComponentEvent 组件：

![](./images/a86714f9954c4fbca15e36a32178e991~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/038f739808a7462e864658c734b4985c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/7a75c2fec88a4e10934c69b3d6307c9d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c013881401484ceb8b9ea1c9c4e1dac6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/b486c5d6781d4bc7a94423d2c17a057e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4ff6acb1bf4a4258a8da9a17b8e6e648~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，回显就完成了。

然后保存的时候也要处理下：

![](./images/a63ba8e8606247cfabb6230d398cd03d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/fba0a427af3748558f61e12fb117eb53~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3610111d7f9d49c2a1deb37a02552e55~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

action 的新增和修改正常。

这时候我发现虽然最终保存的是对的，回显的不对：

![](./images/0a7149317ef447d6a207a5a8fe2103a0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

如上图，我修改下面的 action 的时候，回显的依然是之前的值，但保存是对的。

这是为什么呢？我们不是传了参数了么：

![](./images/fe1159000ec044f2a4ca36c6f31a3ef0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

因为我们是用非受控模式写的，传的参数作为表单的默认值：

![](./images/8fc1a513de394a6499d517ce0a943f33~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a6c0af4f4648414da77751ea24403e27~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/d63058657fb84c71954ffefccbbadf80~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/349437ec9a9e4b07b2257d3ca3fdad28~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当传入 value 参数的时候，同步设置内部的 value

![](./images/812755def33e4f7db5dc62444303c065~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

测试下：

![](./images/9042409f0305442d971b3436d276cb0f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
