...
![](./images/2eb43795740b4e039c69de13cb8e9a6b~tplv-k3u1fbpfcp-watermark.image.png)

测试 react 组件和 hooks 可以使用 @testing-library/react 这个包，然后测试用例使用 jest 来组织。

这两个包 cra 都给引入了，我们直接跑下 npm run test 就可以看到单测结果。

![](./images/da47091071444e8e890abef11314e2ad~tplv-k3u1fbpfcp-watermark.image.png)

App 组件是这样的：

![](./images/fb6813410e654ceab54465d3716cbd6e~tplv-k3u1fbpfcp-watermark.image.png)

它的单测是这么写的：

![](./images/952331492b0448af837e40c9c6db42b3~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/b5a57e0d716340038ef04e6d886b433a~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/aa18b88eae844ead8c722ffa9965bc59~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/178928819cbc46a0aa56dff13daf2da2~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/01e5a9ebf26a4fcf92ce6e3297556a18~tplv-k3u1fbpfcp-watermark.image.png)

fireEvent 可以触发任何元素的任何事件：

![](./images/c2837b73349e4ee985222ed9fdf7d8a4~tplv-k3u1fbpfcp-watermark.image.png)

那如何触发 change 事件呢？

这样写：

![](./images/66cd08d1de4d4db2b8858fa87c51b703~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/40468d2629d54908a4decca116046022~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/5c24c0df407f401cbe9a04bf81229fc0~tplv-k3u1fbpfcp-watermark.image.png)

这种用 waitFor 包裹下，设置 timeout 的时间就好了：

![](./images/bd26fabdd0944863b6bc32e8f970b197~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e0ac8438b9a64fd8a92705ffd5cc44d7~tplv-k3u1fbpfcp-watermark.image.png)

除了这些之外，还有一个 api 比较常用，就是 act

它是 react-dom 包里的，@testing-library/react 对它做了一层包装。

![](./images/33379aba49774f5e98705ac2a651f004~tplv-k3u1fbpfcp-watermark.image.png)

就是可以把所有浏览器里跑的代码都包一层 act，这样行为会和在浏览器里一样。

文档里的例子是这样的：

![](./images/80961a1881e24e928615d16741c5bf61~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/802c7db6ab9c457b94585a000c3de809~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/1d6cef42756b4e499a9cf38df5cb5328~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a49fa806a98d4b218ab6e8c23fe8c3cd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
