...
![](./images/f98f30bd2d2e4f1693006506f2ae8acb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

顺便把源码也做一下：

![](./images/489fa7a114934ad2b150c9c1c4d9560d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

预览则是展示编辑好的页面：

![](./images/6af86a14244e431aaa338a0c97607299~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7e8906faf86247baaa74b7e089a6ac65~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

试一下：

![](./images/4513b6f67098476d940398a33a10c220~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c82882a8f3564b76b2a64fdba5fbe4d8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e21753a2b15645c2a47d6d4f4f4f8233~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/42a5a775ce6446d4a7752d7fa703212a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

高度有点小，在 MaterialWrapper 设置下 height：

![](./images/aa6035aa95984113906eb456e470d536~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/773d1f5e187b4008828c6b68087c88e1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

编辑的时候不响应点击事件，预览的时候才有反应。

这是因为编辑的组件做了处理：

![](./images/01cec5af5fbd45ebb08186f30f82d07a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

每个组件都要区分编辑和预览两种状态，甚至渲染的内容都不同。

所以，我们最好是编辑和预览状态的组件分开写：

![](./images/a25c65e68a7646468977f3d8d274106c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

改下 ComponentConfig，添加 dev、prod 属性。

然后我们给 Page、Button、Container 组件都添加两种状态的：

![](./images/db5d50b03d924dfcbb4df23a1851bde0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f0ab7d36573449729c6e110d0e5d1f92~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/d6abfbc82190476692113936f7720ace~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b1d172c96a15465f9bda7d2923b41477~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

先看下效果：

![](./images/e3f6995c62c442368b4c4dfc247ff571~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2aeed37b5955495c8263320fbec74198~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
mode: 'edit' | 'preview';
```
```javascript
...
![](./images/9400f1db58f64945a43db987cc8fab24~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4db719c535134b7fbe60a9316cf8086c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
