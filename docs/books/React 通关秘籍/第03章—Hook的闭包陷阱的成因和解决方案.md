...
![](./images/5e77e63f083b4b23a024795e09bcc259~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b65be16ef0a344dd80888d72c14c92c0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

为什么呢？

大家可能觉得，每次渲染都引用最新的 count，然后加 1，所以觉得没问题：

![](./images/8b009eefb31b43cd9ac592f512e77022~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b55b6ba62e8e4f0a8bc9db726aae8a0d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ae5bd877c1064ae794e0cb7acb6444f8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这次并没有形成闭包，每次的 count 都是参数传入的上一次的 state。

![](./images/bf98db9314104a3480fbb98bdd520bd0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2dd11775cf3f4f00b168baf4e9f848b1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a631dbd862864eb2bdb467149e395b45~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/80ebcb21f71541c194da144776c2ceec~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6353fa155208496c9faef53c21cbff53~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a18f23a7e4bb4ebc9d925108a45a8587~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/628d1b97372142758ee1be4d14574f0c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3c36cc9bae7e40f7aa98cf998499b533~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e43ff228443446778dd6d516282a1bdc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


上面的 useInterval 没有返回 clean 函数，调用者不能停止定时器，所以我们再加一个 ref 来保存 clean 函数，然后返回：

![](./images/ea9bbe0c88bc4d14a2ede83b7544de84~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
