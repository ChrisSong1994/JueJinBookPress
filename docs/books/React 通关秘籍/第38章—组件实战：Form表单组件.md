...
![](./images/730c4b51a23f44a8bca2935d52f7e0d6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/52bc2023ca1e4971a0fa1dfeb7432d69~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/8a3409dfb7c54ca2b922e76860b9b697~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/232f6ae69f394500b0d75d67ca134bbf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/40a976982a454676894fd24f10ce4dbc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

安装依赖，改下 main.tsx

![](./images/c83821058ca44df8a8bfe957a867e424~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2abf56d424f3459ea2e3f7f1c0adbe88~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4a6210b87a304e1990446416f72765ec~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3a49abccd6164befa6e1faa94a8d27cd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后把这些方法保存到 context 中，并且给原生 form 元素添加 onSubmit 的处理：

![](./images/1133e18f4ad14c46b15af62ab60fe103~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7099e8d516f34e1b8f3451f3878c91ee~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

首先是参数，可以传入 label、name、valuePropName、rules 等：

![](./images/e63e13c60f5b4827bedaccf7152d1cea~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

valuePropName 默认是 value，当 checkbox 等表单项就要取 checked 属性了：

![](./images/84a123556caf4a3f9dab074fb7fbd164~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这里 children 类型为 ReactElement 而不是 ReactNode。

因为 ReactNode 除了包含 ReactElement 外，还有 string、number 等：

![](./images/6d200f6a32714d5fbf94a7303eb0658f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0b95df0dd393466d9906a21546511a3a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

比如这种就不需要包装：

![](./images/20a783f76c834697865ce0135cf80c77~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

创建两个 state，分别存储表单值 value 和 error。

从 context 中读取对应 name 的 values 的值，同步设置 value：

![](./images/df9929bc9d984117a923c587062d9182~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后 React.cloneElement 复制 chilren，额外传入 value、onChange 等参数：

![](./images/c0d07f737e8440d389ea3d23111e7cdf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

onChange 回调里设置 value，并且修改 context 里的 values 的值：

![](./images/a3bed81034b44ccda5961ecc54d65ed2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这里的 getValueFromEvent 是根据表单项类型来获取 value：

![](./images/cd025ffa1b274368af1d2783ffe06a0a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后是校验 rules，这个是用 async-validator 这个包：

![](./images/f9a4103d80624967a128312a89e037c3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 context 注册 name 对应的 validator 函数：

![](./images/9ea8ba58f65c4785a1828081248ab533~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后 Item 组件渲染 label、children、error

![](./images/509239c752284fb4a0d6a5b52e6bd696~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bbee212ef23548d29da2af1f850aeb55~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1c7515edc73f4afea05f1f81b36c5aac~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

它的 store 属性保存表单值，然后暴露 getFieldValue、setFieldValue 等方法来读写 store。

然后它提供了一个 useForm 的 hook 来创建 store：

![](./images/34ddd235fbff451f93a1847db5f3ded1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

用的时候这样用：

![](./images/ef18824b162a44da9e7bedc6780aea31~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，Form 组件里就可以通过传进来的 store 的 api 来读写 store 了：

![](./images/e4315a54ae6f478abd6d17480f9f1897~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当然，它会通过 context 把 store 传递下去：
![](./images/0bd73127c2d14c3f831a48932ec87c26~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 Field 也就是 Item 组件里就通过 context 取出 store 的 api 来读写 store：

![](./images/cecd901f359148d3950f49616c597a20~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/28f8fb3152eb4675b6dd89102028dfba~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/04cd71f31b344529973da571fe69b263~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
export default Basic;
```
![](./images/519a39254f6a43f5807e5cd0367a331a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/da423bd611504c76a18189d782bdb699~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
