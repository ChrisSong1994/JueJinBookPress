...
![](./images/82be24bbbe2541bd8f9b63ec3e782a96~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

react-use：
![](./images/4e53dc4f67db48ee8c9e846cb1173502~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0c387a3147b241788b854e17aa0c29fb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e29d5acfa24947e4b1f0eabe55274290~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/8bc126b147bc436bb331bd9edfa47f09~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ef776583122843e8bd00777ab2dbec6e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

**一般自定义 hook 里返回的函数都要用 useCallback 包裹下，这样调用者就不用自己处理了。**

![](./images/d1fc772004df4db6b8cf60e73fd013d7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f80d9146f6124d7686df4dab2550425a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/cb68346f4c584baebf704cf5bf360c57~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

用 cloneElement 复制 ReactElement，给它添加 onMouseEnter、onMouseLeave 事件。

并用 useState 保存 hover 状态：

![](./images/32d19722588b4fd5b3e1491dceaa7f5d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这里注意如果传入的 React Element 本身有 onMouseEnter、onMouseLeave 的事件处理函数，要先调用下：

![](./images/732ffb1bc4494068a0501287eff7858d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
换成我们实现的试一下：

![](./images/175c7c8bd15c42e4b3e292e3aa43b5f0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/219439fd3a7b4d51be6d0c61dbbbda07~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/050544eb13b24c7f821dcb59f47c3734~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ac33b31615a54f1d95b25f721f7ce114~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6da1e8558876498ca0b6df2ccbb76b0b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/a6da587c63dd471e956aaf56d0376a51~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

其实还有一种方式更常用，就是返回 hook 返回 onXxx 函数，调用者自己绑定。

比如 @floating-ui/react 包的 useInteractions，就是返回 props 对象，比如 {onClick: xxx} 让调用者自己绑定：

![](./images/3f2b59e6d32142a8940e6b0d9d26c74d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/a3929ca67a9142179ca908ba428af10c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

或者只返回事件处理函数：

![](./images/6c6f2f908b394116aa41007c851a43d0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
