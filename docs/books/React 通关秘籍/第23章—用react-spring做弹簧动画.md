...
![](./images/87e8c27b94ee4e89b2d3c2da9943eb74~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/5dcbf21883af468d8ebbb1920cf90eaa~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b1a18049e5a248ef994efd90eb611a81~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

此外，你还可以不定义 duration，而是定义摩擦力等参数：

![](./images/e70d41fef0b34dfc9f80461298f3f5fb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4a9188e81d8f4302868be2e979a17dd2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/26d96c0b1571403081bcae522066c709~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/469638f7c5ed42a6826226d669529790~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

tension: 100

![](./images/f77106856c264fecac4ea62fa37c8f2e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，确实 tension（弹簧张力）越大，弹簧越紧，回弹速度越快。

mass: 2

![](./images/fb25e9e4c06f498a977451a7cd788a41~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

mass: 20

![](./images/9c633ef451a04e388c0d37f15b8f8ec8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，mass（质量越大），惯性越大，回弹距离和次数越大。

friction: 10

![](./images/4b4e872788df4c66bc38c72afefb24d7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

friction: 80

![](./images/56290d22c1b94eac97fb54cfd2c9eb42~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0929b0a07ae64c64aa5913657ae4ac6c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当然，也可以不用 duration 的方式：

![](./images/c74b46e96bf54beebf272e07ba1530dc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而是用弹簧动画的效果：

![](./images/2393d33f8ae449069b13738ae48b9eaa~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/32204b56603240998d474202ea1de387~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6860f4f3b36c454b8770c3fd706c1eb0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/30c4b1d52fd34b4192b6afc880fa4550~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/939415608d594f268455aa87e4742496~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b63d848636194521a9a18e0728c58c8e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当你注释掉横线或者竖线，会更明显一点：

![](./images/b3f7b84de0d94645b64d901f5155f341~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/b857e9fc3ca246d0a1ef122598df23ed~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/e49a1d2384a14c0a983343a2f98ce3d6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后再做笑脸的动画，这个就是用 rect 在不同画几个方块，做一个 scale 从 0 到 1 的动画：

![](./images/6bbe18af023c4f2da12484596879edc7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/1c80a65e910246899bf3f578839e648d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

动画用弹簧动画的方式，指定 mass（质量） 和 tension（张力），并且每个 box 都有不同的 delay：

![](./images/85f1091b7a52431a8f7a94f4d86d9e23~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f527e8c9437446f19c3bc7bb28fd0d0f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
