...
![](./images/daaedfa65b0545078cf167d91a5cdf20~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/28b601ebc68a4ec59cef8d14e7dcd426~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f9b08a5a40ff418b9907e0dcdc5d27ff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/fa942ff7ef2845088d9cbfe6b46e48e9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/58dc1660b73d4303a1516ef9df416122~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/20fb3a265662442cae8b08f78a112cda~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/76e2d15379a54d5ea8fe3b67486b956a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而 css 文件，则是要通过 js 代码把它添加到 head 里的 style 标签里：

![](./images/8116458582524a15bb71f604afc322dd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/de374d008ab74b86afa2af9879b22686~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/5701e53a44524d44ba52878ca09cb9cf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/20e4d7ac186a47f98be2b2cbfb2f99e3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6539c999d5a149bdb3ce9c4ec487e4dc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

其实还有一个问题要处理：

![](./images/35578766c50040d9ac29dd1d38ea35d9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

比如 App.tsx 的 jsx 内容编译后变成了 React.createElement，但是我们并没有引入 React，这样运行会报错。

处理下：

![](./images/fa33ef92adac41f59b11afd001c33bac~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/304e34892f9f488e92109786d37a0b73~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/04b8dddc0b1543638237b34158cd6043~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9c2d7901daea4822914ef0444f005c07~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
