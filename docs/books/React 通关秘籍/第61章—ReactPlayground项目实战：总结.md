...
![](./images/7f6d276902e2434e9f715d4380f7f54e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
npm run dev
```
![](./images/71d44af4619f4e8faba7b26367b411b8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

浏览器访问下：

我们可以在左侧编辑器写组件和样式，然后在右边实时预览：

![](./images/55e1b2011f4b436881e2d641fcd4621a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

css 和 ts 代码都有提示：

![](./images/b7f038ad53c745deadfa18ac2f19100c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/d72ea10b45604a19bfd3428279b457a6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

并且我们后面引入的 npm 包也会有类型提示：

![](./images/93d9b8102fe5436e916a6ad5a9c189cc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

但额外引入的 npm 包不能直接用：

![](./images/da19a5272a5b4d4780debf418225c12b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

需要在 import-map.json 里配置下才行：

![](./images/d3ac6b4a440d4e3bb39e055ac3637ce1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

文件可以新增、删除、修改：

![](./images/d239832d560a4a9e92c589ce3178d296~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

比如我们新增一个 Aaa.tsx 组件

![](./images/72babc98d417498ba89e42ccd4a97b40~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

还有它的样式 Aaa.css

![](./images/c272d4fb92214a6ea35bd1bde7dff3d8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 App.tsx 里引入后就可以使用：

![](./images/ca1b162f854e4b608b3c9c5c4461a6f8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/cef550b88cd64d52b373a7876a86e4b3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

此外，还可以下载代码到本地：

![](./images/a81a1ce7b90a4cf4ac638c240f22eb9c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

还有切换亮色、暗色主题：

![](./images/d67d379551a04728b3cf7de3c8e10107~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/96d008524701479fbf6eb1bdd213af2b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/51233e2e566e452984d5bc618307bf51~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

通过 babel 插件实现了对 import 语句的修改：

![](./images/ad6d09400c264a4da97634d177a3cae9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e2e0cb9853964d4e9c9844c273f8fb43~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

替换 html 模版里 import maps 和 src 部分的 script 标签后，同样用 blob url 设置为 iframe 的 src 就可以了。

这样就可以预览了：

![](./images/c0db0b3acda04ebba949c3c30cc62e22~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
iframe 的代码如下：

![](./images/a1f2fe71111c4632a935a8b6b45186e5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
