...
![](./images/49bfabaa05a646c7982c14c301fcb6f8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
npx tsc --init
```
![](./images/cdfafd1e98304b5f8a500e9ab6d201c1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/5ab9dd0663054c8cb4f7f26b5a8aef31~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

React.createElement 第一个参数是类型，第二个参数是 props，第三个参数是 children。

具体的 render function 的名字也可以指定：

![](./images/88f4545decd941a88e6885ae12dc97bc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

再次执行编译，生成的就是这样的：

![](./images/c09d1fd09bfa490db4be8023cdf213a2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这就是从 jsx 到 render function 这一步，由 babel、tsc 等编译器来做：

![](./images/486556f03b3d4fb9ba8966a1bd1f55b6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/eaa17d2d5207448aaf1b0119c0c457d7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/41f42b03844748a6a8f875dd852463cc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/fb72721f4e3e4e43beec8e6777349956~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

浏览器访问下：

![](./images/0e03c9168e124141b7bc8c9275afb4c6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1a3d85633a28455da775592bcda5e8ce~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1dce452b134742239587cd03d72c93d9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

为什么有两个 root 呢？

因为初始渲染会生成一个 fiber 链表，然后后面 setState 更新会再生成一个新的 fiber 链表，两个 fiber 链表要做一些对比里决定对 dom 节点的增删改，所以都要保存。

![](./images/fbc13410c2c94e26828bdb05d9f0cea9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而 performUnitOfWork 处理每个 fiber 节点之后，会按照 child、sibling、return 的顺序返回下一个要处理的 fiber 节点：

![](./images/81356ad309834a31b72f2ec71f40e9a5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

就是通过这种顺序来把 fiber 树变为链表的：

![](./images/98ff118b03b14d5f9e56e1dcbeff674d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/c5332b73820446e082956a8b1696880e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7553ed2ef3e14354ad479f296d584e24~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

首先，拿到 alternate 的 child，依次取 sibling，逐一和新的 fiber 节点对比。

![](./images/050491e04c9d422ea370a382dee14eaf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后根据对比结果来创建新的 fiber 节点，也是先 child 后 sibling 的方式：

![](./images/82e090ba2eff4c77979e34b201dfa851~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样遍历之前的 fiber 链表和生成新的 fiber 链表的原因，看图很容易搞懂：

![](./images/5ca1fea415194681a6a8e2a76715720c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/a522e55cf96149f5b791f16af53316d8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后 diff 两个 fiber 链表，就是判断节点 type 是不是一样。

如果一样，就是修改，不一样，那就是删除或者新增，搭上对应的标记：

![](./images/0e491a6dc8ce4ec386c59e8b5aebac1d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c502e1241be547bc9bbfbd60d648da61~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0d1d4fef4b43466386fcf60b28cb6ae1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3139c166e69d4dabbbca882c6358b809~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/45476733e1c048799a899c3a7bbb50cb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

那 state 就是 0，然后 queue 里存了三个修改 state 的函数。

每次调用 useState 时会在 stateHooks 添加一个元素来保存 state：

![](./images/88fc3bb179454d7b9979cb1914d5f5e2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

state 的初始值是前面一次渲染的 state 值，也就是取 alternate 的同一位置的 state：

![](./images/e0d7849b6b7e4736884fead00f31ebd1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样对初始 state 执行多个 action（也就是 setState） 之后，就拿到了最终的 state 值。

![](./images/a485bf53823042bfabedd56e27419cc1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

修改完 state 之后清空 queue。

比如这里初始 state 是 0，调用三次 action 之后，state 变为 3：

![](./images/657fd00dc90741d08fbb6e44806604c3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后 setState 就是在 action 数组里添加新的 action，并且让 nextUnitOfWork 指向新的 wipRoot，从而开始新的一轮渲染：

![](./images/4475bce5697040d48ba34d1a96184ff7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d2f93a4f8d024b74bb7968cb63b74feb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e7edbdc4ae4e4713bfdf46ae6addf6dc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

它同样要遍历 fiber 链表：

![](./images/694bd9d6f9484cc6bf9eeffc13723f52~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/cbfb1f353bd64176a7b0918f6dc73357~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当没有传入 deps 数组，或者 deps 数组和上次不一致时，就执行 cleanup 函数。

![](./images/3fd2e7fe39c247d3a83d90e049ad7653~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ba683dfd7bb947d98b81aee94a0b4043~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当没有 alternate 的时候，就是首次渲染，直接执行所有的 effect。

否则，如果没传入 deps 或者 deps 数组变化的时候再执行 effect 函数：

![](./images/8eb1d25c778a4d3c87d4573a4f6c0907~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9b27d0c9fa3d407b8757c8432d3f0845~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后外面包一层函数，避免污染全局变量：

![](./images/302686b9306b4bdf82ed9f54254faa37~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/be0fcf0b58704e4793b6f60594ab02ae~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bf1eaf434f07480e9e8f7d0b2c64aa03~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bbf5f2972f994218874cde1dcd6b4cd9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
