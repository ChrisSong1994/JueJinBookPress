...
![](./images/8f025d7d5ad94483932f9b03d773a78f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4d518270e1074b90b3407d6880bc0033~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c681f6093b4b4eefae2ba3ccb5f8d735~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，最开始展示 placeholder 的内容。

当图片划入可视区域后，会替换成图片：

![](./images/b5b85e46a00449e28f58ece8b2218fef~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在网络里也可以看到，当图片进入可视区域才会下载：

![](./images/43d9869a63e0447f9145f27331e7fbfe~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9b9dc3bd3d4b416e93da2dd6e275dbff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0effc2a659c44292b8a388e85fb612e4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
这样：
![](./images/7df5c3cafb2c48bbbcd13bdc656ed821~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/7f4f54c8768c4762bc0e3c154cf8eb67~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

react-lazyload 是进入可视区域才会把内容替换为 LazyGuang，而这时候才会去下载组件对应的代码。

效果就是这样的：

![](./images/93a53f7d319842e7b339e0fb0d2d2a73~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，Guang.tsx 的组件代码，img2.png 的图片，都是进入可视区域才加载的。

你还可以设置 offset，也就是不用到可视区域，如果 offset 设置 200，那就是距离 200px 到可视区域就触发加载：

![](./images/fee950cee345488ebf420159b5218420~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/c088c9294fd74e62836883131ff4ecd5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f29b77a741b548dd82f68a53b9200ba1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
...
![](./images/84622fd51f2e4343b14d0f9f75da1d63~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/c46b7297e2694bc0a53bded33fe264ed~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，首先是图片加载，然后是组件加载，这说明 offset 生效了：

![](./images/4178060633ae4fb2933034cdbf1dce33~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/b8c86931190745699945980fe4f71a3e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


![](./images/bbdb5216532842fba4c86e7dc324740d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
