...
![image.png](./images/7bc00cefaf344c84b0092cd40d349792~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/0be68997957e49239d89c837a6ddc0f0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/c5eaa6df937646219f719a6e7f16a272~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

对应的代码就是这样：


![image.png](./images/2a10a33ec17347979337be75ea669f7b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/df7b6f4a05854adb9fff079cf96ef7d9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/701d54954b0e486286a235b3bec3b1f2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后暴露了一个 createAudioNode 的方法来创建两种节点（destination 节点只有一个）：

![image.png](./images/e8fb1e3f67c34a2fb0a3d05f7eb7ca9c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

创建完加到 Map 里。

然后提供两个 Audio 节点的连接和断开连接的方法：

![image.png](./images/7f369b90d7c54c91af5f98919eaf4724~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这就是我们用流程图节点 id 来作为 Map 的 key 的好处，可以直接把流程图节点的操作对应到 Audio 节点。

然后暴露一个删除 Audio 节点的方法：

![image.png](./images/59239cfb79674050bb977d8173bbaca7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

首先 disconnect 所有的连接，然后 stop 这个 Audio 节点，之后从 map 中删除它。

然后是更新参数的方法：

![image.png](./images/92d9389bf03147feb13f7c4a56387852~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

两种流程图节点中的参数修改，就通过这个方法更新到 Audio 节点


![image.png](./images/eef8e2bbe3c244f7a6922e55c3e2e901~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

最后暴露一个暂停、修复声音播放的方法：

![image.png](./images/5953d21e69a94e94bf96cee7a87b707b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/9647783dbf7f44bcb0a27f63e3c67a1d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

没有边。

流程图节点 connect 的时候，顺便也把对应的 Audio 节点 connect：

![image.png](./images/abf2aaa1ae924209997185c72dc8aaa5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![2024-08-29 21.13.32.gif](./images/38157591c33b48a0b0d1ab9362675cb9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/ee177c767abc4d94abe24932946e581e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样点击喇叭就有声音了：

![2024-08-29 21.51.05.gif](./images/7ae74df9663a4460b3063e6c67ec4ac0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/bc3899e77b004769a307b396594a685b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
...
![2024-08-30 08.06.37.gif](./images/73ca7d821cab42cf830292a66e0967e6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/7466fdcef5b74049a684cd2eaf243ffb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

不加的话拖动进度条就变成了拖动节点：

![2024-08-30 07.56.40.gif](./images/955c60960ce6416da6d6b8dd3569bb64~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这个是 react flow 提供的用于禁止拖动的 className：

![image.png](./images/8df35b89a2ec4ab4aa169dfeb90bfd50~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

同样的方式处理下 OscillatorNode

![image.png](./images/05940da5fc0a4b8a8bf2d216d94f432f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![2024-08-30 08.11.10.gif](./images/58635c54c05342e68901421b5d78e475~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/d95e5d15c4f2469f814041aaa0327bee~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/5de88b20225345f79fd39a921fdc48f5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/bc071d4693b84e4baf1dea233e278414~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

看下效果：

![image.png](./images/2810f47840b54bc3a3d257581c9b33ff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
