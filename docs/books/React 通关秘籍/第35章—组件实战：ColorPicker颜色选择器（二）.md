...
![](./images/20ac81477a5748e4bc2b7b043e4b5625~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以分成这两部分：

![](./images/5fd47b8fa9a4434892056ef89abf8520~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/eb837001ffa746deb8fe6658f262ee05~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/b5f2c218d40348b096d6bf9eddb3f10a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e885cb0aeeb64f24a0d33a9f8b12410d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c0a44da912e84bd88c80d14a8c1d838b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7d476b91b6294754925562e01276b396~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/327ea5a869474239bbcfbffcd59b9e3e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
...
![](./images/49a69a43bea74667bb9d4bafefb3f778~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

调色板出来了。

还要实现上面的滑块，这个封装个组件，因为 Slider 也会用到：

![](./images/aecac5993af040a3af4b9b077e98e93c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4a97291e195545f6973d543c6008f972~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

加一下两种滑块的样式：

![](./images/fe2de7116f0e4b2189822660e616c0c9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4f3e4bdc7dee4d9f8a4c7bdd26b96100~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/651f7b70364e49439b1e2f9db1207251~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

只是现在看不到。

加一下 zindex 就好了：

![](./images/fc2ded19864b4306a6cf577696954510~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/b6fd17c37b944b2fab498980178c77f2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d128620480a04a59b1d7bd6a71f146df~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/207c659842504884a8bd4e84bbe09ee8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

如果不单独分 Transform 这个组件呢？

那就是把这段样式写在 Hanlder 组件里，然后加上俩参数：

![](./images/900c131c4e5a43369e005e1e5902cc9b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9b185601d35b4e47ac4e4a84e592edfd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

而在 jsx 里绑定事件，这时候 event 是 React.MouseEvent 类型：

![](./images/c7c9e4c7649a4e0584360220ab55877d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们都要支持：

![](./images/6649fd6c826545c58eb173d74c4e8e0b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这两个一个是保存 offset 的，一个是保存是否在拖动中的标记的：

![](./images/25376dbb38fd4c9597754effb0fd27d3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后先把之前的事件监听器去掉：

![](./images/59c094d66bf54bb788b92f000f1ff28a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 mousedown 的时候绑定 mousemove 和 mouseup 事件：

![](./images/7818321c925640b88d19c0f3de6006ec~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ee21bfe6bee94473ba37a1971619e030~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们来试下效果：

![](./images/c849274db39a47048c0816ee27ea9016~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/eba2365e16c54899a00d6d3bb024e33d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/8549ab71e45a443e9789871db2b31301~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 ColorPickerPanel 组件里处理下 onChange：

![](./images/ce94e29a1e4b49cd9913c20f65f4c62a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0487916e286743349a3573c19ecda683~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

没啥问题。

只是现在初始的颜色不对：

![](./images/6096f0fa4f274e78a21b88e7fcd7fac2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

最开始也要计算一次滑块位置：

![](./images/cce6bde8c2b84e809b7dcaf68d881b8a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1e46391865c247a98170d8350a7c4230~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/617f6daf1c1b44438fb9422e7c3376ab~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我在 App.tsx 里设置个不同的颜色：

![](./images/8cecf19296ac48c8beadc1f0c262dd85~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
初始位置也是对的：
![](./images/7c2220c3793f4e2a832a4c7767b3809e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们在下面加一个颜色块：

![](./images/a3feeda541d542409b14da94ecdbcdbf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

```html
<div style={{width: 20, height: 20, background: colorValue.toRgbString()}}></div>
```
![](./images/5d0a0460f34549d2a3c09096c749811a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，随着滑块的移动，返回的颜色是对的。

但有时候会变为选择，而不是拖拽，我们优化下体验：

![image.png](./images/fe659d07df1f41b78150d01f536b1fbc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![2024-08-31 17.55.28.gif](./images/3f8b4f7f2e80478c8dc8651865bb91a7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

好多了。

还有一点，我们前面的 value 参数其实是 defaultValue：

![image.png](./images/4365b521c4044c4fa9129ba6ea87c833~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/1132e8ffaa4f427db8ec9304544bec46~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/9d41780b96b6443194971d26e5ddede0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d3592e184efc42c2bf2355d8912328a8~tplv-k3u1fbpfcp-watermark.image.png)

而 v 的取值范围是 0 到 100%

试一下：

![2024-08-31 18.35.50.gif](./images/ff46a400d71b471ea9749c54f8e62712~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
