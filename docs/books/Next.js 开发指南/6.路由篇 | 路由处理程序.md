...
![image.png](./images/babbee6771464a4f86b56a6ec8acc6f9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/a067b254ed254d738e7384fcd1a13bb0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/75d5b058673841c3b4f4b9ab75507c2a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/bfbe33a5acae40978e0633c66953be55~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

如果请求地址是 `http://localhost:3000/api/posts/1`，效果如下：

![image.png](./images/c5eebccd5d7b41f5a8614c18364702b8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![get-cache.gif](./images/d95418beb1214522a86c15aebde94538~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

现在我们部署生产版本，运行 `npm run build && npm run start`：


![get-cache-1.gif](./images/114035e161cb479b9aa4e12cc036ba94~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2024-02-29 12.02.47.png](./images/403817cc707a4a95ad6c994d03353ccc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2024-02-29 12.37.21.png](./images/55aceee3f8c340359a8517ee57903212~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

运行效果如下：

![get-cache-2.gif](./images/0bfa4f4e118343c795d4f377826f525e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![get-cache-3.gif](./images/d24ddaaf8cf74ecd89f7209696210260~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![get-cache-4.gif](./images/61b01c30135e4776919b1eaab0e0f375~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
