...
![image.png](./images/081f4269b85447a0ae044465ea9fa2f4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

点击左边的 `New` 按钮，可以增加一个 Note，增加后，左侧笔记列表也会同时更新：

![React Notes 增加.gif](./images/3411f724c4eb4d1997311f245723df14~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在编辑的时候，也可以删除一个 Note，删除后左侧笔记列表也会同时更新：

![React Notes 删除.gif](./images/dad06db2883947c288dc871c769db98b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以对现有的 Note 进行修改：

![React Notes 修改.gif](./images/769756f0159a465097938e39a0eac2de~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

还可以在左侧用搜索框查找一个 Note：

![React Notes 查找.gif](./images/f2111a45e641438daab0ae9d3394dc90~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2023-12-14 下午4.08.38.png](./images/c0ce14cd1fd74018ac9e956d1da4864f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/fb2ac654862f445fb9146ce39caba318~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

运行 `npm run dev`，打开 `localhost: 3000`开启项目：

![image.png](./images/60cd55caf07d46ab9832700283dd1f3d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/6752f40eba614c99a75c1e0e67cff120~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/fd716fcce111422697241f8463989a52~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/8aae8a72646348fdb715e742f1e3cf1e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/c9907e43c6f14b308a31d1ebddd11b66~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们已经成功的获取了 Redis 数据库中的数据，然后服务端渲染到了页面上。

现在在 Medis 中应该已经可以查看到写入的数据：

![image.png](./images/1bd5a4a1c4d14aeea990ca4c239c6226~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/387c82dde3384009a47671aa2918ff38~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2023-12-14 下午10.56.02.png](./images/7b8254999ba64c4bad1ff63ef2c0c621~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

你会发现 node\_modules 并没有 day.js，但如果你现在在 SidebarNoteList 组件的顶部添加 `'use client'`，声明为客户端组件，你会发现立刻就多了 day.js：

![截屏2023-12-14 下午10.59.07.png](./images/037b4091549a45bd9457361eced21579~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

### 3. 最佳实践：多用服务端组件

这就是使用 React Server Compoent 的好处之一，服务端组件的代码不会打包到客户端的 bundle 中：

![image.png](./images/588f2f2a57b545f3a247ffcd27a6aa81~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
