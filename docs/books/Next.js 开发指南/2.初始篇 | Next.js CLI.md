...
![image.png](./images/ec2fc0641cf1438cafdf1197b2f58771~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

完成选择之后，`create-next-app` 会自动创建项目文件并安装依赖，创建安装完的项目目录和文件如下：

![image.png](./images/76e218812d164d8a98212ac18342c56c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/02fe813e102e4adf98f1c3e30b3d7e82~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

命令行会提示运行在 `3000` 端口，我们在浏览器打开页面 [http://localhost:3000/](http://localhost:3000/)，看到如下内容即表示项目成功运行：

![image.png](./images/9e8626c484a0463ab08325e411647e56~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/f15914cd6c544635ab145cc001d06345~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/5cf4b85fa2194c9ea26bb20e9d29008c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/c4f2e351301d45699599287c0c86f779~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![截屏2023-12-04 下午3.38.18.png](./images/7b4152d5a7a84af3be6d5d248fd2528f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/25804df079cd4dd6ab34370bebdecfd5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

通常执行 `npm run build` 和 `npm run start`后，你再打开控制台，会发现在生产环境中不支持性能测量：

![image.png](./images/8ed96ece5ba946e0a1f80894f29c10be~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

但如果你执行 `npx next build --profile` 再执行 `npm run start`，尽管 React 插件会显示当前在生产环境，但 Profiler 是可以使用的：

![image.png](./images/c55d230e2aa147da831e019724815d93~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/a6de7b36eb2c4a85bd22eae7deb10aff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/44e90f70c6654a3b9a8d0016a9fd1ea0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
