...
![](./images/dcf9fd82f7ef4ee1ac2f8b7dca473043~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/ee2958b5a2da4345af66e5465c71c37a~tplv-k3u1fbpfcp-watermark.image.png)

别人开发 Vue 组件，用到了 event 的某个值，需要 console.log 打印下看看，然后再写代码。

你呢？靠调试。边调试边写代码。

![](./images/cb4874f7d17c4f1886eb5648223867c6~tplv-k3u1fbpfcp-watermark.image.png)

别人用到了 node 的某个库，不知道有啥 api，要去查文档，或者靠库的类型定义。

你呢？靠调试。

![](./images/4d74f9b3d775427fa13668e16ecc9341~tplv-k3u1fbpfcp-watermark.image.png)
