...
![](./images/02950a71e15748f2928b37229c2c9130~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/441120abf3d54cb286072222f39e325c~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/753ffbec176d4c5597b7ece7c6ce3df1~tplv-k3u1fbpfcp-watermark.image.png)

在 More Tools 里打开：

![](./images/18af111c8afa498184ea799f97457ed2~tplv-k3u1fbpfcp-watermark.image.png)

然后你就可以看到当前页面所有的 CDP 数据交互：

![](./images/0c1a2da442854919babed66b20fce290~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/92d23d0a533c4a438466efebf5e29b6d~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/4047e6eceb4248d7a95a3fb12169d5b2~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/6ceccbc7a7ba4d78aa69b7d33361b224~tplv-k3u1fbpfcp-watermark.image.png)

它下面有几个 html：

![](./images/1ce13f9453ca48ca835ca4af9be10363~tplv-k3u1fbpfcp-watermark.image.png)

我们在 node_modules/chrome-devtools-frontend 下执行 "npx http-server ." 起个静态服务看一下：

devtools_app.html 就是网页的那个调试页面：

![](./images/58bf2ecb228643e6bca2b3aabcaa0b6b~tplv-k3u1fbpfcp-watermark.image.png)

node_app.html 就是 node 的那个调试页面：

![](./images/f11ef607497d4cdeb435ba9fbc75b0fd~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/2a9e43ba7cd341a4abfd78521e57ff51~tplv-k3u1fbpfcp-watermark.image.png)

启动 ws 服务，你就会发现控制台打印了一系列收到的消息：

![](./images/72fe70764a1549de8d5d148892b48064~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/ede36e24c8614a1e8d82f4d34ad997ee~tplv-k3u1fbpfcp-watermark.image.png)

现在 Protocol Monitor 里看看 NetWork 部分都是怎么通过 CDP 交互的：

![](./images/d4c0069659a04e2bb0e94f59f65d68c1~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/5fa2d0d0ff3543fe8d1426312209cd19~tplv-k3u1fbpfcp-watermark.image.png)

然后在 frontend 的页面看一下：

![](./images/b011341015ef41239b24b6cba4bf7f06~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/ff8bf1b09cb14241ac99d524229ca01e~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/ec15632d8d804b6fbd67fc0a670dc3d1~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/ac11fc79d9e540e2b138bd96d35835da~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/1d7816aee40d435699499d7347ebe8ea~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/fd881de59b6044d7bd88569842774dc4~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/19ce7f280d1c43b3bc16207796396d1b~tplv-k3u1fbpfcp-watermark.image.png)

而 electron 环境下是这样的：

![](./images/bee3ff370a2941dabd9a0e50e6b643f1~tplv-k3u1fbpfcp-watermark.image.png)

嵌入到一个环境的时候是这样的：

![](./images/f3f11db99c564cca8259965096e7f043~tplv-k3u1fbpfcp-watermark.image.png)

而且，像上面那种在一个窗口里渲染，在另一个窗口里调试的这种需求，electron 直接提供了 api 来支持。

![](./images/da6a9e4ef65f4a0cbfed641b050afd7b~tplv-k3u1fbpfcp-watermark.image.png)
