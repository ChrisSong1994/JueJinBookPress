...
![](./images/e8bc4ae454b04eeca80ca051e7682698~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/6c17e3b2656f4333bd16eb94d456c506~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/75e91f65d75c483280a90afb0e4818dd~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/5fc60ec9ea7747ee84a4ef37c906ce0a~tplv-k3u1fbpfcp-watermark.image.png)

如果是扩展 DevTools 的 Chrome 插件，那还有一部分 DevTools Page，是在 DevTools 里显示的页面：

![](./images/5c0ac4a1ae914a9f8487d94d124f3b66~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/450ec35eeea941e2ad3e23b84f516a24~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/1cb7cba556a64d2fa73d6c07e46a65e0~tplv-k3u1fbpfcp-watermark.image.png)

DevTools Page 部分渲染出的界面是这样的：

![](./images/232770d91b264eada85e06b1270f4a12~tplv-k3u1fbpfcp-watermark.image.png)

React DevTools 也是类似的，都是通过 backend 拿到组件信息，然后传递给 DevTools Page 做渲染和交互。

![](./images/f8f84c161dfa4c259cc17eaade7af176~tplv-k3u1fbpfcp-watermark.image.png)

不过 React DevTools 还有独立的 Electron 应用，可以用于 React Native 的调试。

![](./images/18268166b9f94e6d91a196dc40058740~tplv-k3u1fbpfcp-watermark.image.png)
