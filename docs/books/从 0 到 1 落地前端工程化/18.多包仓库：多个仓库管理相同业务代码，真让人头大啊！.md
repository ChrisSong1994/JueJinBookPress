...
![项目依赖](./images/8a0d67eb612c4c73bd5091cd5b340620~tplv-k3u1fbpfcp-watermark.png)
...
![Multirepo](./images/d4fa5ce356a845b791731e39372aa8a1~tplv-k3u1fbpfcp-watermark.png)

在使用`lerna`后，`Multirepo仓库`就会变成`Menorepo仓库`，其组织形式就会变成这样。

![Monorepo](./images/49783cc91fd841758f6560ffe377b28d~tplv-k3u1fbpfcp-watermark.png)
