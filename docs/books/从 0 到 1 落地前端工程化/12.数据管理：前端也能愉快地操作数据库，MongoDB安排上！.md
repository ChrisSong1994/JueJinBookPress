...
![下载配置-MongoDB](./images/ea42fceb12bc4320abcad9440fa1aa6c~tplv-k3u1fbpfcp-watermark.png)
...
![下载配置-Compass](./images/b9cba8fcc64a4c5aa8ffb47b11d8bded~tplv-k3u1fbpfcp-watermark.png)

打开`Compass`，发现需填写一条`MongoDB标准URL`才能连接数据库。

![Compass-连接](./images/f19aa51b644b4ea58c6dc0b62b6b31db~tplv-k3u1fbpfcp-watermark.png)
...
![Compass-连接成功](./images/bf8302ead2e449edbf3152237d0aa0ad~tplv-k3u1fbpfcp-watermark.png)
...
![小型接口系统](./images/859f8038d65040d295dbf546af1cee20~tplv-k3u1fbpfcp-watermark.png)
...
![SchemaType](./images/892935049549431c893738ecda13db2d~tplv-k3u1fbpfcp-watermark.png)
...
![Postman创建请求](./images/bad61c773b8e49bcaa679bf8c20e6ff2~tplv-k3u1fbpfcp-watermark.png)
...
![Postman配置参数](./images/beefb72afbc340dea2a865df4b32e286~tplv-k3u1fbpfcp-watermark.png)

输入完毕点击`Send`，输出以下信息表示请求成功。

![Postman请求响应](./images/c20772e062e04959ac9c025b8d3c75cb~tplv-k3u1fbpfcp-watermark.png)
...
![刷新数据库](./images/656ed1f36fc943d187cfa1ae8a6d05ae~tplv-k3u1fbpfcp-watermark.png)

![新增集合](./images/aa41f148352a47fb977235a00533645a~tplv-k3u1fbpfcp-watermark.png)
...
![Postman接口集合](./images/b0439d1d6bc34bc5839097e3f09b0699~tplv-k3u1fbpfcp-watermark.png)
...
![Postman全局环境](./images/f267f551cc96473aa741315ffd9e1ff7~tplv-k3u1fbpfcp-watermark.png)

输入`全局环境`的名称，设置当前环境中的变量内容。分别创建`开发环境`与`生产环境`的变量。

![Postman全局环境Dev](./images/ae2651a53a76421daceb90b4809c205e~tplv-k3u1fbpfcp-watermark.png)

![Postman全局环境Prod](./images/e9ce76b196ef477dbf3a726c8e19fe64~tplv-k3u1fbpfcp-watermark.png)
