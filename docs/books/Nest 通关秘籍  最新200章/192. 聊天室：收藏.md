...
![](./images/2fa3173ff55a42ba9c43b4aaa0e0b8c3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/2b87aebcca4849318b7ea634c5d61e37~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

sql 没啥问题：

![](./images/ec2625640bc94b8e903a9334a1aa94af~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/161860e5b1bf464fac2db9e124c983c7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/db8107a269314ff484d42db1786eb725~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/07ba965c1bda4894a78fc45c7eb2e6b6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

查看下：

![](./images/679ab4552f7e4198a1038d0f5b33b356~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

删除一条：

![](./images/dc7e9f830dec4496b958380f023e1195~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

查看下：

![](./images/5a223b33b5e145999adc4a0735b6aec5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/46de95547b124d61b5db7c6775f49f8b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们实现下收藏功能。

简化下交互，双击聊天记录触发收藏：

![](./images/a1c2b314338941e4a0d291da8156e9eb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
onDoubleClick={() => {
...
![](./images/bb6348427ee444c6b7853b317223b2a8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c5993ff30e8d44e5af7cce7c52197470~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bc2b5c177b48402493a35ee71ce43a5a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
