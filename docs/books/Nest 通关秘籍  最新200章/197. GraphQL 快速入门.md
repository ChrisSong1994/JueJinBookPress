...
![](./images/69766c3214044ea9bb39bccec27ea53f~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/29f59758180547c0b5e36f6f8bb85ad4~tplv-k3u1fbpfcp-watermark.image.png)
...
npm init -y
```
![](./images/fddedf2692a44a91af0ef6c0f02271bb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/92e02989bef0441da2b47d057ffcda1c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9a76c82f15d347deb8b0dc7bc9e1258f~tplv-k3u1fbpfcp-watermark.image.png)

有同学可能问了，node 可以直接解析 esm 模块么？

可以的。只需要在 package.json 中声明 type 为 module：

![](./images/764dd70c276645b1a20049d0b2605955~tplv-k3u1fbpfcp-watermark.image.png)

那所有的 .js 就都会作为 esm 模块解析：

![](./images/88a61d897c2f4578ad9196303fd98126~tplv-k3u1fbpfcp-watermark.image.png)

跑起来之后，浏览器访问一下：

就可以看到这样的 sandbox，这里可以执行 graphql 的查询：

![](./images/b3d94c3284c84d7ab5e5be77ff428e86~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/b278c7267b504004ab7ae454b5050424~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/81b8b08007a34bc996425019a8650349~tplv-k3u1fbpfcp-watermark.image.png)

这里 “光光” 那个学生是异步取的数据，resolver 会执行对应的异步函数，拿到最终数据：

![](./images/f11da7e9bb294f35a96b8ab225353ef8~tplv-k3u1fbpfcp-watermark.image.png)

取老师的信息就可以这样：

![](./images/ecd1871863014c3dafe5d3760efe03c9~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/1bc53b8890a94cb183fe664fe801049e~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/a8b2178e3ad842fba02af787140d7f70~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/46045692e6374bcfacaa01b5f3c11308~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/fc9883cfac5c4990a19e3804ea397d8f~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/7ec04705f8a04fe78a88d61fb74d1033~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/0d60bf2fdfd24d019ba09a3ec5a3c41b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```grqphql
type Res {
    success: Boolean
    id: String
...
![](./images/14e66d3982aa44789cc022c3fb47c38e~tplv-k3u1fbpfcp-watermark.image.png)
