...
![](./images/5624c518ca6a4ab2abbe6aa2caa349f7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bc291426918c4c8c9fc36fa457e2a349~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

没啥问题。

然后添加另一个接口的：

![](./images/df8f0a9c36eb492c99a5457c1b0e53ca~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ee2de6a6bd654fd8a2b7f355d1f433aa~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后再加个 @ApiTags 把这俩接口文档分成一组：

![](./images/14cbe2e9d58a4f99a56279dffe060f3f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/1ea48596bdec438d83099408c4647e8d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，swagger 文档就完成了。

然后来写前端代码：

![](./images/7b4da8015f294391b3954d09bce2ee10~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c43ed1fdde14491784d46ba90330a6eb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d21c7978d25046baa7923415b0b10a84~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/f55153338166427cad63c4a81f518484~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/283d9d2235a94a5e925053b53dc1a572~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ca37c9b8cc0b4030bccb8cea6c8f53f7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当数据变化的时候，渲染图表：

![](./images/4c393f117d93430aadb585638d2877c7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7b118a65729a4d8485ad331c93015f21~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后我们再加上饼图的部分：

![](./images/aa5d56c3366d44c6ade673537d80cf02~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/29d3c56e45464a88a11d5ef6149fda49~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，统计的图表就完成了：

![](./images/a162af31ba9846b98043d89106ef1d9a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

我们在下面再加一个会议室使用情况的图表。

![](./images/a907dbf321584b8485ab8e88c876b9f5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/acbd23471ffa4adfa20c94b39f594d18~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/10566b4ab89b4053ad344fc4e7c53c9e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e58b11e720e04887b90311a4df5a4912~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
