...
![image.png](./images/e8a8c969780647d88312b4af89ce96e0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/2207726d5d3143a7870bace598023154~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1dfdb2067179481fb8ef946ce9285386~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/f61205924827451e92d1de7fdfb154ef~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

每条聊天记录关联了发送用户、聊天室的信息。

这样用户进入聊天室的时候，就可以关联查出历史聊天记录，并且显示是哪个用户发的。

![image.png](./images/34a754e26d8b4d0a9165e658434e39ff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

收藏表就是记录了哪条用户、收藏了哪条聊天历史。

![](./images/deb584dd7a994c5e9f35e2946fe3aa8f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后用户和用户的好友关系就是多对多关联：

![image.png](./images/6a34f0cf6fce407bab718ac1425f68a5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/5c0bf3f358c74274aaf0c0a747ce5e01~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

但是添加好友关系之间，会发好友申请，放在 friend_request 表里，通过后才会加入好友关系表。


![image.png](./images/e30ad5a7286b439c9bccd5723c5a0e0d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/7b89bf43f25d42e7a9d1a2bdc889f673~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/afca23dd20994eccb96e92f029993072~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/d3dccefddfc6425293068827a3e7944e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/3d0d757469484fce8ba3fc1f3dff2029~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/1bcf513377f44dfbb09f67edb6c4d140~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/f6264406c00546aa9169384191cff176~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后结合当前登录用户的 userId，就生成了一条收藏：

![image.png](./images/d9c13003647b4f4b957c683d7d7ae523~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
