...
![](./images/c5ecdcb680cd4014a13e85c2c9b60b00~tplv-k3u1fbpfcp-watermark.image.png)

那就用现在的数据库，如何保证面对大量并发请求的时候，服务不崩呢？

答案就是消息队列，比如常用的 RabbitMQ：

![](./images/bbbb2b6a4a8343faaefe616d7106596f~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e28327a1056a465ca536e4936352fad2~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/704ce4c856b14477b876c748f6ac05f5~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/f243a0274dab460e93fca9449bd6eae8~tplv-k3u1fbpfcp-watermark.image.png)

这个版本是有 web 管理界面的。

点击 run：

![](./images/c676b36fe21145a3bd903519638ee17c~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/7c9bcc0b2bb64207bd019c51880f6669~tplv-k3u1fbpfcp-watermark.image.png)

就可以在浏览器访问 http://localhost:15672 了：

![](./images/5ad9966bc5d54e158ec64a1072108c63~tplv-k3u1fbpfcp-watermark.image.png)

这就是它的 web 管理界面。

输入 guest、guest 进入管理页面：

![](./images/473961bfb209489e843f6b3ae9c6db0c~tplv-k3u1fbpfcp-watermark.image.png)
...
npm init -y
```
![](./images/1429cd094f614fd7a553457ba79896da~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/fdfa52e57d014dd6b6513a74485c251d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/887379f89b7b463dbc5d422874e37dd0~tplv-k3u1fbpfcp-watermark.image.png)

之后就可以在管理界面看到这个队列了：

![](./images/a80df3dbbbe2437790c034618ac7a0c3~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/6ddba08a7bd54fb9bf321201b3b8886d~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/cc4fb3fe4c97488491dfc4dc8e7b7518~tplv-k3u1fbpfcp-watermark.image.png)
...
node ./src/producer.js
```
![](./images/5cb548997f7b4d96ad512958498d1ba9~tplv-k3u1fbpfcp-watermark.image.png)

消息消费端：
```
node ./src/consumer.js
```
![](./images/34b9eaae95154945bec2c4facf9e2878~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/a89ebbdbe9054f698d926b10a1476e0b~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/bda9d30c18004d9db0f96e146725f2f6~tplv-k3u1fbpfcp-watermark.image.png)

这就是通过 direct 交换机发送消息的过程。

在管理页面上也可以看到这个交换机的信息：

![](./images/3258c8cf6c824ffcbe2e7a67f1436fce~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/69749640c4944b69a3a35c8ab507dee6~tplv-k3u1fbpfcp-watermark.image.png)

可以看到，两个消费者分别收到了不同 routing key 对应的消息。

当然，在管理界面这里也是可以发消息的：

![](./images/dc3ba57519b544e2b634fb9587147d72~tplv-k3u1fbpfcp-watermark.image.png)

消费者端同样可以收到：

![](./images/3e84f01e1f3d4f0592b698411b203845~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/5dbb1165aa5f441eaf7056f6dc39b762~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/73fd42e8ba24443198296501984c1d76~tplv-k3u1fbpfcp-watermark.image.png)
