...
![](./images/8b211ab9d9194da4b27229d748887f37~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

分享出去很不方便。

这时候就可以通过短链服务把它缩短：

![](./images/4c8ee9fe6b45486abfc51ec56cc316f0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

点击短链会跳转到原链接：

![](./images/7a54d225d10244a7ba595587615c332c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这种在短信里很常见：

![](./images/6ebede01abb6454c9d8dd8e86d0a3f4c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0f4c1a9fe2264f188cd15a7e2446a284~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/5cc20b10406b4b8d80dea639ae26f41a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

还可以做一些分析：

![](./images/b130d898281c433ea842c998ac33d6d4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ad074557e15149ad83efe154589dd3fe~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/65197cdf1fe24f0f9874888b1ae37743~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e8d55e7164974d728ad423980824c54d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0e97d5a2f11e4f85b77423947f902612~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

随机生成 0-61 的数字，然后转成字符。

62 的 6 次方，范围有 580 亿，足够用了：

![](./images/b7d111efa99543fd8ee622b60b7d9fc7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4841cfd7b0f445f2a84a91168b981736~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7318eaabf8d24b2fac6e3ab73604e9b7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

先进入项目，把它跑起来：

    npm run start:dev

![](./images/0596b21b198d409391310a3556b316bf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

浏览器看到 hello world，代表 nest 服务跑成功了：

![](./images/f7516bcdad3b4c92aa4a869023d406ff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7cfd92779aee4f71b99725a18b93a535~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

指定名字、字符集为 utf8mb4，然后点击右下角的 apply。

创建成功之后在左侧就可以看到这个 database 了：

![](./images/9a200f9e98604ddc9658937629ac1e11~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ee1a89260b3442a3a68ed58c8130d1ac~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/0183c2033b7c4d4397f3307b78bb3c08~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

保存之后，TypeORM会自动建表:

![](./images/9817210634084bfb80e846ea41f918df~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/e5eaef96c96e46eb9be7923d33d0acc7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/35ab3bc3701e4e5b97a94e0d50e734d0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/cb3e81ed1fe54146850a53fa5e18ef6e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9cfc7780489a435aae708fe76b93e641~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后在 service 方法上声明，每 5s 执行一次：

![](./images/71e1bb13a4fc455a90d30b09a39d1cb1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/da207a4a676a4005af78881ff76c3732~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

数据库中也可以看到插入的未使用的压缩码：

![](./images/1b6a242a31f940c1bde4533b045a59c0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

当然，一个个这么插入可太费劲了。

我们一般是在凌晨 4 点左右批量插入一堆，比如一次性插入 10000 个。

![](./images/875589c996c64ab48385ee5d68bb1806~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/4a920928075b4de5aded211e597d48a0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

同样会自动建表：

![](./images/4198170d0a3e42f199f728d57eb5da43~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/671860b8ec504dccbb4493ddb596623a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/9ae4fab0939440dfafeb794a91a32ced~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/88737ff560954cfe8c4801404b0b160f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1a795016948b4ce5ac2fdaec9b0bed09~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，打印了 4 条 sql：

![](./images/a2907562f1b34d5eac682666c9fc961d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7ccf2ff4102a46de9c8c85206bba2d4d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/3e6bb96e45d64327852089d80aef6e7e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ae97470f965e429b9f63b3edec11add5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/151d37cb5113428b8263395cd58505bd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/b4b745c87af14532b2e22f4104ad60b5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![2023-12-01 14.32.03.gif](./images/4c7ea3fb7f214727bc86cd095e57252e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，我们的短链服务就完成了。

其他的非核心功能，比如记录每次访问记录，做一些分析：

![](./images/39233680e07d4b9faf8e782a6cb2dc41~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/67fbebff65a94dd89612e8b89bafeb7a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
