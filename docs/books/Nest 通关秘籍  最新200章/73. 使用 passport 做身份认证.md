...
![](./images/a61d415919c94c6287c2a2f92a215859~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f5bb06800a4f4d3f8b082dcc6e88e230~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/98742b56090242089178eda25ab90cf4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![2.3.png](./images/895567963a604e14a2e77ab6810e8539~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
进入项目，安装 passport：
...
![](./images/1dff2212906444ef8453cff548f080c7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
添加用户名密码认证的策略：
...
![](./images/09d8b29792d84e329598aeec6149b2af~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/95ae3305ca0b4d03b7201d9a3c87513b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后在 AuthModule 里引入下：

![](./images/7f4e72bd571545be84096b2e5a961fdc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
npm run start:dev
```
![](./images/758a0a51f4b84e218e6693203cbdbb25~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

postman 里测试下：

![](./images/c94aec9bdd6147169b1b25c25248ae98~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/b859cdc48f9f4481a9abec213df2b561~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/80858ddf870c44488d35e5997c13b540~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/22e2c21fd8854c4abe2a592aff039ee9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/66040af35eed436db182e2b720312a0f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c62988bb8eef4f37a7a76f8c2f47f715~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3c6f592bd6cd41dfb9e64a7738d659f8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1d5a9d8c7b2b4078adc2153ecbbb9382~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后通过 Authorization 的 header 带上 Bearer xxx 的 token 访问下：

![](./images/582a3a55c09c42dc95e1ea7ab11daa90~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/db21c92d5d29476e810d21e2892b81e9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/85ed3cabe56c48edb0672ab350cfd32c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/010386453de4464ea7ffe2d332201881~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6614fe16949347d6a06f26408f61f7f4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/f9852fff2ee944128485716bc6faa5c7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/98e582bbbe2546bda930701ebed27719~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
