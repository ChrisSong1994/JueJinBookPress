...
![](./images/6da9b16984df497f885b585c1a0ae229~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/72fad8b1901b45c5bb0b76b2dac096eb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/935142a52e374c62859b0127dc3c8b37~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

生成的代码很容易看懂：

![](./images/ee0f45755ff4410998795c9f1da2d632~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/74be7181e8674a7a9003afdd10100178~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e54288524c5c458e8f1623883f190333~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

浏览器访问下 http://localhost:3000

![](./images/1888dd8944bd4cd08a59579a9320e825~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7a362ed2d7e74839a5f384da5de5a078~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

分别指定 event 和 data。

这时候原来的代码就收不到 findAll 返回的消息了：

![](./images/66f6642d80544f7e8d4e93cfe4a5787c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

因为返回的消息是 guang，可以加一下这个事件的监听：

![](./images/296d293e676742c987b55aa8057d1905~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/46ac2ba29cbb43f0a221e5bd705bf35d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

那如果我不是马上发送消息，而是过几秒再发呢？

这就要返回 rxjs 的 Observer 了：

![](./images/b1468d5c160148178c339270825e02e3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3e6bb22a986b4fb39c2def618eff5561~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7cf4aba85c7045d78df8519a16986f39~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/593aa19c68f244019cab9c2455f0c933~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样也可以，但是和具体的平台耦合了，不建议这样写。

除了 @ConnectedSocket 装饰器注入实例，也可以用 @WebSocketServer 注入实例：

![](./images/a1d9098eaae24585b6c7701ad6a1453e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/417aaf0a8e7e44fc9ef65e903f8d15a8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

同样，也是不建议用的。

此外，服务端也有 connected、disconnected 等生命周期函数：

![](./images/831abbd32acd42c890ec043663ee9385~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
@WebSocketGateway()
