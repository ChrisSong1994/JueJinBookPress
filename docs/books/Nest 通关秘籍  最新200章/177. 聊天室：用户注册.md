...
```
![](./images/19e6fb2b45c744418a23b7fdc1f99df5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/92cd7c967458498ba039c9080c3b66ff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/39c6d6cf9799493daa920d5933bd56f1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/79c6744195774e0983d2939e43b334c0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/230839d862284a0d9bd52a9bc46b855b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 mysql workbench 里可以看到创建好的 user 表：

![](./images/d0e46c77c86a410fa062d50641797b77~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/6a9c3aef03334fbf83790ed66059ed10~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```
nest g service prisma --no-spec
```

![](./images/f013381ca40e4585989ff508c0005fb9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e66f8e8dafc04259b0f68068d64a59a1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/93a8bdb06dba43be8e0a9ee6f1747c05~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 UserService 里注入 PrismaService 来做 crud：

![](./images/0016ca216a514e1982ef2b355da3accd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1834efcc33ae466f81465725f602300b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6301c45c4c304b759b404b92ac28f988~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/93db2c95a64642f4b3934c03149f4c48~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
{
    "username": "guang",
    "nickName": "神说要有光",
...
![](./images/5cfef6be9eab4d568330bdf4474b2d37~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

数据库中没有 captcha 的字段。

我们要在调用 service 之前删掉它：

![](./images/f95402e58cf643f4bb81efe78e5fecdb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

再试一下：

![](./images/9b445de70f9949f88a108c1029487ad6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

服务端打印了 insert 的 sql 语句：

![](./images/f14b7fa3769a493592cd40196a3821d1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

数据库里也可以看到这条记录：

![](./images/ca160547d3e5478080f02f66b2f7f151~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/891bf47824664ca6a602718f0dde4a31~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/872494934b3f4ecb890aab20b2be45d3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bb80249d69514fa7a280f0cf4365173f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

因为还没实现发送邮箱验证码的逻辑，这里我们手动在 redis 添加一个 key：

![](./images/470ded5fb7b74eee8a12d33cf1870e0d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/bc40a67e2e964c9083b6d7315b90113a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/81f436f31602425a9f510697cb975e4a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
带上正确的验证码，注册成功：

![](./images/46328bce605f4d1093453865336b67dd~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
这时可以在数据库里看到这条记录：

![](./images/4d2d00e97ce643ebabf11e32e2523739~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
