...
```
![](./images/882bb2b261dc498e9c86eac064e9b71d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3c4eb5949e5c4db58be3a5e609a9cfec~tplv-k3u1fbpfcp-watermark.image.png)

然后来写前端代码。

之前我们用过这种方式：

![](./images/753d11400bb24de990c88aed2747e5b7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

就是让 nest 服务支持静态文件的访问。

现在我们换种方式，让 nest 服务支持跨域，再单独跑个 http-server 来提供静态服务：

![](./images/880bed6b418146429c3ffefcf9fd122d~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/79133c8d30e24ac697a70f77a89beade~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e926c1cac43e4e7582582f3df856bc4b~tplv-k3u1fbpfcp-watermark.image.png)

服务端就打印了 file 对象，并且文件也保存到了 uploads 目录：

![](./images/f7c34f46db274df6bc550055de2135ae~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/94658887fadf4555ad96831b807e7161~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/205af2332049409c99314f874019dcca~tplv-k3u1fbpfcp-watermark.image.png)

后端收到了上传的 aaa、bbb 的文件：

![](./images/a613787305044330a21da8819748e3a1~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/ecb670f0f7c74247ae5d28ed67ba3b22~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/6a9c49812e6347ea85448ef02c47ecf6~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/b18c4423b6f944588a6ed526493d98d0~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/70f7d2696cf74b92bc7717cb97e56b54~tplv-k3u1fbpfcp-watermark.image.png)

在 FileInterceptor 里也是一样：

![](./images/0ec1738c231b404f987188d0a889d8d7~tplv-k3u1fbpfcp-watermark.image.png)

在 multer 里我们是通过 array 方法来处理多个 file 的字段：

![](./images/d4c8d3a72bf5409b9063e63a4bab4b82~tplv-k3u1fbpfcp-watermark.image.png)

在 FilesInterceptor 里也一样：

![](./images/2cf97274ab374920ae7ad7cef44c3782~tplv-k3u1fbpfcp-watermark.image.png)

另外两个装饰器也是同理：

![](./images/f718fcfe8b1a40c983afcf6819374eb9~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/88bfd8c8b8f54580b58c424d663465eb~tplv-k3u1fbpfcp-watermark.image.png)

而 UploadedFile、UploadedFiles 这些装饰器，只是从 request 中取出处理完的 file、files 等属性作为参数传入 handler：

![](./images/99c9bc9118334a67b02ec3f988e6ea3d~tplv-k3u1fbpfcp-watermark.image.png)

了解了这些装饰器的原理之后，回头再来看这些文件上传用的装饰器，是不是就很清晰了呢：

![](./images/13e71610bb544aa3bfa3660c1e89f588~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/4192a44fd2bd4116ba72c6f5b84ca935~tplv-k3u1fbpfcp-watermark.image.png)

然后访问下：

![](./images/503b8d783e364a1d86f4e54dcae7a74a~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e3399d79b81e413d8afbeab48e1e9b58~tplv-k3u1fbpfcp-watermark.image.png)

可以看到，返回的也是 400 响应，并且 message 说明了具体的错误信息。

而且这个错误信息可以自己修改：

![](./images/eb21c5bd18524ad682bb1963447a1213~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/e3c9e71974a24148872514e620c68491~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/fe54b13c46c644648d512d1d7a695d51~tplv-k3u1fbpfcp-watermark.image.png)

在浏览器上传个文件：

![](./images/f92f91e62e20429f8385ecfa94f46cbe~tplv-k3u1fbpfcp-watermark.image.png)
