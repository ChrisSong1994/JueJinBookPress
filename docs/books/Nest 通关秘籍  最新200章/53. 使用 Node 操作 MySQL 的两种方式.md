...
![](./images/198e7a1ef31743f49799bbb42392d07c~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/39575fc93dfe4e468daa39de47aebc69~tplv-k3u1fbpfcp-watermark.image.png)

和我们在 mysql workbench 里执行效果一样。

![](./images/64a85415cb7f4e9cafdc2882c6ee8b0b~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/740183baff8a4df69d2fe245232a0fa8~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/d479b595b70c4d5ca013db16e8d4a5ba~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/81ca6a47da704829bdebe38a158f156d~tplv-k3u1fbpfcp-watermark.image.png)

点下刷新，可以看到确实修改了：

![](./images/398da9cf22184817ba22c8e743c0160a~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/5cfa8bd7e0c94e46839a112260091478~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/3f05d163e3e9433b9b67090975adf221~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/1958a1babf864c7abca8166dec40e97a~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/518eb14a89ca416e933318ca978260ac~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/9afd05d94fbd4154acb805fa9656d17c~tplv-k3u1fbpfcp-watermark.image.png)

回过头来再看看这些 option：

![](./images/f83ffc6c8dc646ac9f7180deb0895a7b~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e253cffe2fdb440d8a515e403510a9c4~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/3f0d16b99b824b03945d76d9616cd147~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/9338fc5a7f5643e28e63a4cc49bd5ab3~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/20311814f7a94017b919efc47163af3b~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/36e165fdaf9a4494b8a65cc0a5a5628f~tplv-k3u1fbpfcp-watermark.image.png)

打开看一下：

![](./images/1a3338303dfd49e69a58ddc7820979fe~tplv-k3u1fbpfcp-watermark.image.png)

它还有一条数据。

而且控制台也打印了查询出来的这条数据：

![](./images/436b9fb2421c4e7cac7c86bc7f1118ce~tplv-k3u1fbpfcp-watermark.image.png)

怎么做到的呢？

我们看下代码，有这样一个 entity，通过装饰器声明了主键列和其他的列：

![](./images/16240ef5954c4a389d9eba0f6510121d~tplv-k3u1fbpfcp-watermark.image.png)

在 index.ts 里创建了一个 User 的对象，调用 save 方法保存这个对象，通过 find 方法查询这个对象：

![](./images/aea70c6020d54037b1083209fdc1b647~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e8e7c12c0bf54c90b5f960e1b8979a2d~tplv-k3u1fbpfcp-watermark.image.png)

然后去数据库把那个 user 表删掉。

![](./images/40d1f18fa78c4cbebb0d0780f8355375~tplv-k3u1fbpfcp-watermark.image.png)

再重新 npm run start：

![](./images/c94579eec20a4efbb943f8f678d391c2~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/13fa6a00c32f4fdf8e1c521da38a8d24~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/d975d42524a74d629e64b9f354c88b36~tplv-k3u1fbpfcp-watermark.image.png)
