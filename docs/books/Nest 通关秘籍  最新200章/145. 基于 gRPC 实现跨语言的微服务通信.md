...
![](./images/8744e0820c3b4e55bb58cbf2d4224dec~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

其中，RPC 是 Remote Procedure Call，远程过程调用。

比如 java 微服务有个方法 aaa，node 微服务想调用它，就可以通过 gRPC 来实现。

![](./images/960c5ba9f121468489a373ba8df71872~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/465121afc9454f7987fdba406856e69c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/93202f1629dc4df093718fbe7e14b23b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，就有了两个 nest 的 application：

![](./images/7a0baac2ec35411eb79810b56e45a47b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

改下 grpc-server 的启动端口号为 3001:

![](./images/2b4e9eb098344ce4b9f9232baa9cdb76~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/bd8725a610614134afcced48055da1d1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/889173b7f3cc4bec81783fba5d343191~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

浏览器访问下：

![](./images/0e716b0a98d24a8fa3e62afc3ff4eb61~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/b3c63728610e4df2aa29e20643bf1e57~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/cbcc2da7c11a4e119577af90d2bf6b63~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a1bb01f9717a4d9d99cd4f3ba088714e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

安装之后就有语法高亮了：

![](./images/5685d36ce8794e9aa692c51d6d42262e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/8f4eb5d734494e2fbb8f8f925bf75afb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/86284c6f816c471eb4c0525c39b55109~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
npm run start:dev grpc-server
```
![](./images/6b87cbb5bb2f412297747c7af07bb251~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这时 dist 下就有 grpc-server 的代码了： 

![](./images/4f832c59003d4510aed6ba309f9323e6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后我们在 grpc-client 里连上它：

在 AppModule 里添加连接 grpc-server 的微服务的配置：

![](./images/12030bd8ae8a4c6c85d26214392c64fe~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f3dc9c2b83b6487fa8b37afc7d9ea527~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后在 AppController 里实现调用远程方法的逻辑：

![](./images/31a3a5b082d44a289f748f9e7a7c83e8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2be16550f9a54a1fa884bf1c32b0d716~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/119e9a214c244c2ab5c00636c21224e1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，远程方法调用成功了。

这就是基于 grpc 的远程方法调用，用 java、python、go、c++ 等实现的微服务也是这样来通信。

![](./images/82cd368ae0fb4321a55b01182ff5e08a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/95ac4d74e3984ac7bce3ed1e5bdfe21b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后也是定义这样的 proto 文件：

![](./images/f27f966938ae4fb798eef7b9a54acc60~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

之后定义对应的 servie：

![](./images/f34e2518db424f65af445e2dfda82e32~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
