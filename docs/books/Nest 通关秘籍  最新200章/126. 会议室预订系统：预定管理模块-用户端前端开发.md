...
![](./images/2c48a82b4211498baaddbbb3547fca63~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这个页面就是一个列表：

![](./images/f5243f2fa51946f192575f88c0baa822~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d271754a30e8442285335cc2236ed77a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

和后台管理的页面差不多，只不过这里没有 user 的搜索。

我们登录的时候把它放到了 localStorage 里，所以这里从 localStorage 取就行：

![](./images/fe82c514ecbe40bead2566a06ae1512b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/ad99206ec65d40b0af9e3e7032c6dd91~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e5104ce8a34b4c5b85a5e0f8d32591cc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
...
![](./images/ee4234bf1f574c4584c585860a20d0d8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/9eaf74fa453c466180a4ca918d48b294~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后加上下面的表格：

![](./images/c01c0cb2a8bf4b3e9c32b5fe0d6fd87d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/cc9445b2049b444fac0b17e86fd07f91~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/146dc4bf86ba458d845ae22118eb8b60~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/8af9043095494b9382971e73d3b01ff2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/d3e54efc16424180b22c7231d4ecf4e5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/581c84cabc1d48929aed4f248c2b6d2f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

没啥问题。

如果没有合适的数据，就手动去数据库里改一下：

![](./images/a8803f967b9c4f6e89ea40b202320bc4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

接下来，还有一个添加预定的功能：

![](./images/8ab95474f0be488cbde34e4a7975f5e1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e4b996e8ab9a48209d994b28b7637b9f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

添加 isCreateModalOpen 的 state 来标识弹窗是否打开，并且记录点击的是哪个会议室：

![](./images/6fdaa471d1374fb9b90428f14fc86f03~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3b46e523254347939475a12646a22f41~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/dc351559c9f646ae83d4828e49c7138d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/787ac7eaea2d44a4884ad4aa09022f1b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


然后在 interface.ts 添加用到的接口：

![](./images/bbc7c06400174b0a80ff8f076d4da6ac~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b24c0df2a973408cbacdc3ac389be261~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/14a7e98af7a04241a198881d232da89e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
