...
![image.png](./images/c27d9c5bae3b443eaa74bc8906fa381e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/c0802f9494be4862ac8a8306c4c74f77~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/fd3550faf431488d8fb6ea885bf540cf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


![image.png](./images/c8cb7cb926a543388e01349e517d6058~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![2024-08-27 19.32.36.gif](./images/3bf5e6a1dd5e403e9801f9013b085c74~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


![2024-08-27 19.33.22.gif](./images/2d87b8a53ec04c31b928b6450bc00395~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

然后再调用下 ranking 接口：

![image.png](./images/2a172befd240441aae28fd891b77ca73~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

现在只返回了 id，我们返回下详细信息。


![image.png](./images/aa8f11b640134551be475a1ac410379c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/48b8daacf92a42289e9d16d5c9ee234f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样就返回了排行榜的详细信息。

加下前缀：
![image.png](./images/13c969c70c0b4e739510f5fe07197fcb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![image.png](./images/05c36bb87a664e29a83daf3489ac3fdc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

加一下 AuthGuard 做下登录鉴权：

![image.png](./images/6508036c3ab94345afe3d38d05eb1d74~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
{
  provide: APP_GUARD,
  useClass: AuthGuard
...
![image.png](./images/c423bebf069c4488aa0bc7db8d813c98~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/d0e026611cb1425d8cf1858edbd965b2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


![image.png](./images/1ce22a2597b0453abbb395015c56f4eb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)


![image.png](./images/e072ce6121b94978932fd4c1a8760441~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/b80e52146bf74f339cefefc2ef2b50ba~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![2024-08-27 20.10.40.gif](./images/eccbe7245820486690ab2e0e7be88eb6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
