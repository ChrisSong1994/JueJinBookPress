...
```
![](./images/28318d058bf54cfd84f00fa57ac3129e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/5be602ad04944448bafdd1ae3d194e97~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

现在两个 socket 都在 chatroomId 为 1 的房间里，可以相互发消息。

而用户所在的聊天室会有不同的 chatroomId，不同登录用户会有不同的 userId

![](./images/3f4fb34cab6241f3ad2ab90bae7228ce~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

把 chatroomId 和 userId 换成真实的，不就能在不同房间聊天了么？

![](./images/bf6c8494ec484e3ba745236245ea02dc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/3f7c2afeab43408e9c5c40e6b3a22550~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/fa9126b3504140ae8e833b5292f046f9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/c4178976e9d54188b4f468ac97b1dbe9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/34af739fc228425498deb6417df91a58~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/2b7e42c983e54118a6fe2ba63d964286~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/6d7d40c1e7b1493fa00132e569f27399~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 ChatModule 引入下：

![](./images/6f853f7da2304ba5a473474eea7c310e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

发消息的时候就可以保存聊天记录了：

![](./images/a39f0e562c884006bdee968aabc6db50~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7a1d3d746c904c98b56b1e461d0f6d89~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这时候聊天内容就保存到了数据库里：

![](./images/4342cda5471f4569ba881b101e1cbfeb~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ee9a8fd172c74184929cd8ca98dae59d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/df3c929b693a4cd7b465c00806e845d1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样，点击切换不同聊天室的时候，就可以把聊天历史记录查出来展示了：

![](./images/02449f8cba804bbea45684fb15d88623~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
