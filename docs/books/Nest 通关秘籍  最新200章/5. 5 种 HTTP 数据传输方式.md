...
![](./images/b09a4411e26a40a0be7272dae3213eeb~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/af563395e1984ea5b90a19a04ce6730f~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/c429166d35264cea922ebe45d399d4ef~tplv-k3u1fbpfcp-watermark.image.png)
...
nest new xxx
```
![](./images/90a973017feb47e48e69c5054b2faa83~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

*   在根目录执行 nest g resource person 快速生成 person 模块的 crud 代码
```
nest g resource person
```
![](./images/11b0c13aa815440eac113ad6b73f42a7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3a5e59b898a14bfbbfa649299f91d2ec~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这样一个有 person 的 crud 接口的服务就跑起来了。

服务跑起来以后是这样的

![](./images/47547045ae0e48f0959e9f52b284cfe7~tplv-k3u1fbpfcp-watermark.image.png)

打印出了有哪些接口可以用，可以在浏览器测试下：

![](./images/b290de4da2f249358342ceb7aa3c3dcf~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/7a1c5ea5d5c44227b083db1bd516f950~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/03cc5b8bea74411eb1d2c13ff9951be2~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/9c07cbcf33e64205904f6dd0a813cda6~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/f4648b0e210f49f2885e0f2e10654cdc~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e33a33bdee4541eaab6af22108010161~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/e2579657d1464c618e7ef7f5b1032f2d~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/c1e8cb55184943d9be3df6ccf9644f74~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/8976bc8696d846a58e4812a7ab5f6d2f~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/2e22d13b586a4d358cb569acd4cf35dc~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/29fbb5ee24af48c1b1744c129c77fb7a~tplv-k3u1fbpfcp-watermark.image.png)

服务端接收到了 name 和 age：

![](./images/c56d6418815c4726a493d4f1ffef72b0~tplv-k3u1fbpfcp-watermark.image.png)

去服务器控制台看下：

![](./images/8924b69b7c044b65a475ad8576f6c549~tplv-k3u1fbpfcp-watermark.image.png)

![](./images/78efe5d63a0846799583ca66f3dc5c39~tplv-k3u1fbpfcp-watermark.image.png)
