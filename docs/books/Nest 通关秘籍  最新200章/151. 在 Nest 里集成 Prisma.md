...
![](./images/089216ef997c41be989759f60a74b76e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3209bcf5edca44bb8d55d080464cfb3d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/c549d1d792aa4eb8b177c67ae9a7faee~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/dee7c45a681f432596ed1a5e94d49477~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这时候数据库就就有这两个表了：

![](./images/c9dce99f9e864813855eecba63ed88a7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/0c81ec506a8b4421bb748af4c2077f83~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

外键约束也创建好了：

![](./images/ff8151898fa241e3acc44f4964299c6f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/e373e6c5051744d6b466a0cc0af56f12~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/76f386beb84444cdb5a33d6d2905e232~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

```
nest g service employee --flat --no-spec
```

![](./images/0ae95fadb1c540c192b28663542c0152~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/ed0d441e0e0648e49f8f22a26e29c1ea~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/64bbe39372e04d8884c7a31b839ae9c6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/97accd6e7c8844c4a2a108dfe1ed31b8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

生成了 2 条 insert 语句：

![](./images/82fe7c328ea74a11919c048fd0c18ebe~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

在 mysql workbench 里也可以看到插入的 2 条记录：

![](./images/5a32a07bb02346e4ab1746333f0c3f0a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/e75179a690674f8ca1cb536ec795c181~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
