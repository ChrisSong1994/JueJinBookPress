...
![](./images/78cbd671d30a44b493f1a22db475bd8a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d03109a9ec564ea2b9e5d272177fd954~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/7a38bb4f1a794b37a96bf10b8f6eef67~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
```
![](./images/b18987ef24a54aa5afd4c4aab283fe32~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

注意，选择生成 WebSockets 类型的代码。

这样，基于 websocket 的 crud 代码就生成了：

![](./images/dac03b2dffcc4a268b907255fe039d19~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/3e13557d0dc1493eaad999b4db1b120f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/dc04833e63b140d680fd6fe8d08cb6e4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

浏览器访问下：

![](./images/bfb531bba221417dbe04ee68446e476c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/aa24591ddcc24477a58710e6ea42c3f3~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/04b029daad2f4cc69293547155b04335~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这两种是等价写法：

![](./images/6164cd253d0144168db2937de8c714e6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/8b2fa67c8c6f470da1a228e4c516e99f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

再打开一个页面，进入 aaa 房间：

![](./images/0a36abc648794055abf56bb79f3555f2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这时候之前那个房间就有 2 条消息了：

![](./images/ad962768273b4329addecc1ac6ac7c20~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

再打开一个页面，进入 bbb 房间，这时候之前的 aaa 房间并没有收到消息：

![](./images/9ce2856443d94522b05ab45a17aec725~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e1dd912e7b1a409eb56ff2781656c6ef~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
```javascript
import { MessageBody,SubscribeMessage, WebSocketGateway, WebSocketServer } from '@nestjs/websockets';
import { Server, Socket } from 'socket.io';
...
![](./images/ce82af4dff494d04a83d7b240c88028b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

再打开一个页面：

![](./images/f013372d705049edaa8491c710beb7ee~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

可以看到，另一个页面也收到消息了，因为这俩在一个房间。

我们进入其他房间发消息试试：

![](./images/92661f053938417bb5e3e4e3af905a03~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这时候另外两个页面就没收到消息了：

![](./images/70802698f41d4d85a2784aa8f1f5ba4a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
