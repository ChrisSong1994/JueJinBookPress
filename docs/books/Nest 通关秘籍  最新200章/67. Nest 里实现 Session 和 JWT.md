...
![](./images/74f805d6f4954fba8bbf5a070e08c31e~tplv-k3u1fbpfcp-watermark.image.png)

然后用 postman 测试下：

![](./images/a533a453fe45496fb61084e9409345f9~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/0690af4482204510857f640ec11f1b9c~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/66c2384eacb14d4795d359f9f58f8f18~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/2a622591c25041c2bec8b2c73630aa97~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/f40b87a16e344006a58a29a95e3dee33~tplv-k3u1fbpfcp-watermark.image.png)

放到请求的 header 里：

![](./images/825a4a3bba2c445a80ae0df3bb2316a9~tplv-k3u1fbpfcp-watermark.image.png)

这时候响应为 2，并且返回一个新的 token：

![](./images/7a73e766c8b04e58a93d22fac74e7861~tplv-k3u1fbpfcp-watermark.image.png)

把它复制下来放到 header 里再次请求：

![](./images/65a1cd5c2144432bb077c39faf7ffe11~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/04d7d1d5150c445a92ce331dec24ebb1~tplv-k3u1fbpfcp-watermark.image.png)

这时候 jwtService.verify 方法就会抛异常，然后我们返回了 401 错误。

![](./images/bdf2a2485c3641e7ae0c8883f3825f34~tplv-k3u1fbpfcp-watermark.image.png)
