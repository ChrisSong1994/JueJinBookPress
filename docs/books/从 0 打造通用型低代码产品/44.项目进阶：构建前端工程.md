...
![](./images/e3db61013baf49a881de4b66e6aad9a8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/a83f3efe2a094aea82969b7cf168407d~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/d871e8d04b2b4603bf65d9259994e081~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/44d154a5d70b45549939ec101d22c901~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/234483d5bf9a4b4d8bf15bdfe7ea7331~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)如果你想后台常驻，可以全局安装使用pm2来完成启动，具体可以查阅**pm2**的相关文档，如下shell所示：
...
![](./images/5600199229be463f940067f0d9532db7~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/e675669436c64ff88fdac31cbb960b42~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1d9f022eb03b4e12998c3f300907f087~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

如下图所示：

此时私有化平台的 **@huos/core**已经更新成为1.0.1版本，此时表明我们的包已经发布完成，后续就可以通过**npm install**进行使用。

![](./images/b4eebed114774f7ca82916bbac25b603~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/b0c8237bc1134be783dfa1c509951af1~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/f8d7f4cc9715411badff8cc9ce8362db~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

![](./images/d5c23978532b4a65abfc68d8c7581190~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/1b56873d30804c5b96b81eda663454df~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

创建新项目会跳转到下图的界面，如果使用的是**github**登录的话，可以直接选择现有的仓库直接导入，在这里我直接选择了[ignition-web](https://vercel.com/lgnition/ignition-web)项目直接导入。

![](./images/5408d0e4c5394bda9ce53f016d2a74b8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![](./images/31cd2b814f564000a4aecebc08cc4a53~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

以上配置修改完成后，后续提交代码就会进行我们工程的构建，如下图所示：

构建完成后就会出现前端访问的地址，以及下面的**Deplpyment Details**的阶段都没有错误，此时就可以访问我们的前端工程路径了。

![](./images/3ebe592b88e14d2ba2dada0714dfe96f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
