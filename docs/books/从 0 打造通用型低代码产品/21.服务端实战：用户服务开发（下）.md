...
![image.png](./images/6f9fd03107a6497f86d7bee4f4774613~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/392b53d5f548466cbf2358af79678632~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

正常完成用户 **jwt** 注册之后可以看到如下所示，我们已经正常登录成功了。


![image.png](./images/f06eb5258103481ea3dac7bd51979cbf~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/a6f1be976bc94b4f9b3cc9d8cda5a351~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/558f0b0d0ba04e9e8e5fd3c7c8e6a35c~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

用户系统的主要代码如下图所示区域：

![image.png](./images/c4f080f9caa24b64af0274aca1126bdc~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/14e011e3efb141ff90a2715b40b65028~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

#### 资源管理

![image.png](./images/9334470977ba4cd8b18a9bff4e34e725~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

资源管理的服务端代码如下所示：

![image.png](./images/aa3d1d4d221342e89c142793192d1349~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/eae3b0975e4b449eb558631c2b853d2b~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

权限的服务端代码集中在下图所示：

![image.png](./images/f7435d7abef04fce9a807df7fa6a47f9~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/90ef7cb83e584c88897cc96c96100a16~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

这一块是最为复杂的一点，因为角色需要同时关联用户以及权限，所以整体的设计比较复杂，为了将系统的拓展性做的比较通用，我们采用的是 **role-privilege** 以及 **role-user** 关联表的设计。

角色管理的服务端代码如下：

![image.png](./images/8deee12e8d104365958fe0c888c0d6b5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/9da67d03e95446f7b79f0343fe16bfc6~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
@Entity()
...
![image.png](./images/1ee33bed1cbb49a6863079f2fecfb5e8~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

所以在用户授权权限的时候，其实是新增 **role-privilege** 表数据：

![image.png](./images/cdc3b3b220d443c7b051f3acfd12e704~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)

再完成角色授权之后可以进行用户的角色给予：

![image.png](./images/37ec3fba264144ea8c633cb409c54ec5~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
