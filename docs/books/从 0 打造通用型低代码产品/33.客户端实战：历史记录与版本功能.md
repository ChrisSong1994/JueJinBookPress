...
![image.png](./images/2803dcc563af4e2cad8ea30a939a0b59~tplv-k3u1fbpfcp-watermark.image.png)

## 历史记录实现

根据所述的实现思路，我在面板中设计了以下界面。在顶部，使用一个选项卡来切换本地存储和远程存储，以便查看不同纬度之间的页面内容。请参考下图：

![](./images/369473477428460aa68784199b5e7e36~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/dfc71d665d604e5182bbeefabbef2d7c~tplv-k3u1fbpfcp-zoom-1.image.png)
