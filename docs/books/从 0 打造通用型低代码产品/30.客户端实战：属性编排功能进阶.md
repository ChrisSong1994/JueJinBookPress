...
![](./images/a5f6de7d7bdc4c6985baa17c084cdfe8~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/66494ea56b13426b8643fa7560de40bf~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/4bdf1f0870fb40cca376a0ec55aa2f6d~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/b9d28fd188a24baa83b5f42f9299391a~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/38b5ded9a929407f8643a0ab74165d7e~tplv-k3u1fbpfcp-zoom-1.image.png)

### 状态绑定

当属性面板渲染结束后，这个时候切换表单内的属性是没有任何效果的，因为编辑器的状态与表单的状态还没有进行关联的流程，也就是下图红框中的步骤。

![](./images/8945bb4146ac45278861d220d21d9b4b~tplv-k3u1fbpfcp-zoom-1.image.png)
