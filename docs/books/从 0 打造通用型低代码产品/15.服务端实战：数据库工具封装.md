...
![image.png](./images/e46130660a0644d0874134e155ec0cb2~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image.png)
...
![image.png](./images/5a2ab7e0c5f1468f93b1fe3a445b51eb~tplv-k3u1fbpfcp-watermark.image.png)

点击测试能正常得到如下返回值的话，则代表数据插入成功，功能正常：

![image.png](./images/7f96c873a40a4c8da2c2a5570ae82945~tplv-k3u1fbpfcp-watermark.image.png)

查询数据库所得如下所示：
![image.png](./images/f84e4e76d5f54972a80440c0f61831a3~tplv-k3u1fbpfcp-watermark.image.png)
