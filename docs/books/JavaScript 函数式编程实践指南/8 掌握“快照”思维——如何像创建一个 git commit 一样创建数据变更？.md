...
![](./images/19477267dd3e4059b0175817cf2143dd~tplv-k3u1fbpfcp-zoom-1.image.png)

在变化发生后，A 和 A' 是共存的，变化前的那一次快照指向 A，变化后的这一次快照指向 A'。

而未被修改到的 B 文件，将会原封不动地呆在原地，被新版本的快照所复用，如下图所示：

![](./images/68bd7ddec61a48aa8ba293694f5707cc~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/ce171e12eb46413b8fec82de50b9d76d~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/0d15e3f86f0c4671af148d439518d641~tplv-k3u1fbpfcp-zoom-1.image.png)

当我们创建对象 B 的时候，我们可以只针对发生变化的 age 字段创建一条新的数据，并将对象 B 剩余的指针指回 A 去，，如下图：

![](./images/9e9cb9a8af624b1291b9f1f058c31c71~tplv-k3u1fbpfcp-zoom-1.image.png)
