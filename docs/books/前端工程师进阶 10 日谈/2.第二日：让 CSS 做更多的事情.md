...
![](./images/f1a0ba30ff414e76bee05d08210a9b03~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/1a4c989b265f48ecb737cf14bc89d61e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/87af2c94f7884351be11aeb80698a4db~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/153d3ec2c06f4e6f940f123296f5a4b8~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/75ea54e8dcdd4c3ca5efdf76da0e11d6~tplv-k3u1fbpfcp-zoom-1.image.png)

这时，你会发现block元素的四个边框缩成了4个小三角形。如果我们将上、右、下的边框都隐藏起来，那么不是我们需要的小三角形的效果吗？

![](./images/d341ad921ccc4addbb218d3590e7adeb~tplv-k3u1fbpfcp-zoom-1.image.png)

如果我们希望得到不同角度的三角形，我们还可以改变相邻的border的宽度，比如我们要得到正三角形，我们可以将上下边框（`border-top`）和左右边框（`border-left`）的比例维持在1比根号3。

![](./images/c6e43d1f72c140fea8c5c8ed22fffc6e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/de6891ae64a24204aeb8600dd028adc6~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/f57d56a4c2db4c4caa5058f0c9e2ae61~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/746762b99b824602a3bd88510b9f56ae~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/606da9a1c9d34d5aab17f0338ff368df~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/63e68b35f3994e7c8860516c7b1bd7dc~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/9dd2f2b762f14d5ebcde4b0f1eac9ca6~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/dd8bbb776e784d2cad89392b9bbf1827~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/23d9311aab174204afbf8e8280c99d3d~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/ac3706b3379e44ea851244b72b0b0df2~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/0d7a48877a964342aa457b74664281b7~tplv-k3u1fbpfcp-zoom-1.image.png)

好，我们把颜色换回来，这样就得到我们期望的结果：

![](./images/7a36f45e45cd484880f9b8066bd20d92~tplv-k3u1fbpfcp-zoom-1.image.png)

所以，只要给这个伪元素设置不同的旋转角度，就能得到相应的统计饼图，如下图所示（为了看起来更清晰，我们把蓝色部分的伪元素颜色替换为了半透明的）：

![](./images/79fca011cfa14b38a9eb9b788c9846b2~tplv-k3u1fbpfcp-zoom-1.image.png)

<!--
![](./images/t012f63e6642b6c365a.gif.png)
-->
...
![](./images/54d0005e3a6a44d0ab1a70279294b5a9~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/284af822b63f4d6aa4018956a4ebcabf~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/0503b53ec6a4442d9d5d6b497f2d1df4~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/f544064b39624cda8955e425cb784a9f~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/ca2466fdb90e4f67a1b96290dd478a55~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/10307ec74c8f4309a8affe9bde9290cb~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/2d453402cef149f5aeff046c658d63d4~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/c69c9ade76dd49e6bc506ca35ae0ccb7~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/54bcd43e46854c798a87c4837e7008e0~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/908b1d2aa15d472caaa68b48f0f2c2d3~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/0256258d004c4d26b0ee8b0eeb491826~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/0b712619635f4588bda70ee81dd1fdc7~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/3de10fe9d3c549b48ac9fbfa2b7636ea~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/257d048e48ee49498af538e98df14652~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/4107876fabe449c184eb0eb8189e4929~tplv-k3u1fbpfcp-zoom-1.image.png)
...
<!-- ![](./images/t01af943c9181395383.gif.png) -->
...
![](./images/895ccae0ff4a4f06993e609f0b6633db~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/40274a40d6d14168bed04512efb8900e~tplv-k3u1fbpfcp-zoom-1.image.png)

同样，这时我们发现当进度超过50%的时候，进度展示的效果就不正确了。为了清晰，我将`.pie`元素的左半圆设置为半透明：

![](./images/7ed6d6fc8b8c4550be5752d0a3215988~tplv-k3u1fbpfcp-zoom-1.image.png)
