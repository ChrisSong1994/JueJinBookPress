...
![image.png](./images/074804630b39471e809def7080e9614d~tplv-k3u1fbpfcp-watermark.image.png)

第一步执行时，会完成对 `a` 和 `b` 头部这 2 个节点进行 `patch`。当 `i = 2` 时，由于此时的 `c` 和 `e` 节点的 `key` 不一样，所以退出了头部比对流程，进入尾部比对：


![image.png](./images/8b9733b3694f4c81a22015672b56cdf0~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/41f9b957775b441580d331f3c4f3656b~tplv-k3u1fbpfcp-watermark.image.png)

第一步执行时，会完成对 `a` 和 `b` 头部这 2 个节点进行 `patch`。当 `i = 2` 时，由于此时的 `e` 和 `c` 节点的 `key` 不一样，所以退出了头部比对流程，进入尾部比对：


![image.png](./images/5d570fbb6d864c379a0eaf6011cc3521~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/29972b7a05414f8daf0ffcd348b650b3~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/b9846f1800394683a19b5a68950f7fe6~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/dba3693544114cf19ff3114c8becab61~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/1dcba8989ae348e6af85333a22280da2~tplv-k3u1fbpfcp-watermark.image.png)
