...
![image.png](./images/73dad47e4d3e45419a9ad3f7ff746fa0~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/1481f62edb484224aefd7498bb9b871a~tplv-k3u1fbpfcp-watermark.image.png)

示例中 `main/index` 入口\(`entry`\)同时依赖于 `c` 模块，默认情况下 Webpack 不会对此做任何优化处理，只是单纯地将 `c` 模块同时打包进 `main/index` 两个 Chunk：

![image.png](./images/ae729e4dd408433ea242733ae9913d89~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/88d54f6ffcfe44658fddb93c4bd57e95~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/1a1d537299ed44da947a7dbf03e22a18~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/e6ddb044d1d649a297ec76000bcad3d6~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/e8a66c3358fb42e59660a0640210f359~tplv-k3u1fbpfcp-watermark.image.png)
