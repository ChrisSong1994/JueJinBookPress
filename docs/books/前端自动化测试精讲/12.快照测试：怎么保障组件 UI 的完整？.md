...
![](./images/e2a7cf44d55142ea91db398bd597df8e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/7dd45f03b9ac495d828dea8128a08d15~tplv-k3u1fbpfcp-zoom-1.image.png)

除了用例执行成功的说明外，可以发现在 __test__ 目录下生成了一个 __snapshots__ ，这个目录用来存放我们的快照文件：

![](./images/87b48aef2d95400cadb913ac9b787798~tplv-k3u1fbpfcp-zoom-1.image.png)

我们来看看新生成的快照里面有什么：

![](./images/1870137521f54ae195cbe8b81eda4413~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/bf9d7feb3a13466eac1a67964f445bcd~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/14d4b78619354578865449c2951f4a76~tplv-k3u1fbpfcp-zoom-1.image.png)

## 快照测试的更新

大家可能会有一个疑问，如果我这次需求迭代完，这个组件的确 DOM 结构就是会变，那我们应该怎么更新之前的快照呢？对于用例中的快照更新有两种方式，第一种我们可以直接在控制台中输入 `u` 来更新快照：

![](./images/ee5810add4f04b168c29bc108a88c40e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/c532629a584f4225a1f3d9017b8c9860~tplv-k3u1fbpfcp-zoom-1.image.png)
