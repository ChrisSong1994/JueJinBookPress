...
![](./images/40b91c80b73a4ae9a1c54033cae7e309~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/926efd234ce14b89b4083d8626b4f12e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/373a2004e1be4baab3c978564e6669c3~tplv-k3u1fbpfcp-zoom-1.image.png)

不过因为 mock 是在 import 之前覆写的缘故，类型并没有得到修改，所以我们会有下面的类型报错：

![](./images/bf8e66fcd4f2440b8ababa40bc4edf41~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/e7c80fe1e20f44028c1e20037f021b71~tplv-k3u1fbpfcp-zoom-1.image.png)
