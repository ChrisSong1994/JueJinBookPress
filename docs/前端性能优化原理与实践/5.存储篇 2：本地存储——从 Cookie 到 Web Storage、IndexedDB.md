# 5.存储篇 2：本地存储——从 Cookie 到 Web Storage、IndexedDB
...
![](./images/166002bebabcf363~tplv-t2oaga2asx-image.image.png)  
...
![](./images/16600d07e6abdd81~tplv-t2oaga2asx-image.image.png) 
...
![](./images/16623d7a9457d1df~tplv-t2oaga2asx-image.image.png)
