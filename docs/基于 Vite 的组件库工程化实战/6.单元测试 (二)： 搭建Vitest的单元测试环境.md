...
![img](./images/01c325cd24e778c793fbf1e6add20891.webp )
...
![img](./images/51eaa52408d4345bdda44f1c9ec75dc2.webp )

解决的办法就是在 vite.config.ts 中增加一个类型定义声明

![img](./images/f9c435f57d14ab17f0c5724bb4e5ec74.webp )
...
![img](./images/02e613439a188ad497f7a46019117212.webp )
...
![img](./images/66cc478cd6adcc78c540e916c0d89f9e.webp )

上面的测试只是测试了按钮的默认状态。对于按钮组件来讲，它的主要逻辑是根据不同的 props 属性来定制不同的样式。下面我们针对这些逻辑继续编写测试。

![img](./images/c9db40e1454114148a618954c0bb8576.webp )
