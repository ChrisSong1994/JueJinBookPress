...
![image.png](./images/57ba0a5e54e691081edda3ea858756af.webp )
...
![image.png](./images/7b7c68cd265fa4e92e07ac39b008ef0d.webp )
...
![image.png](./images/174bbc49a74a68f13edaaa9cec224441.webp )


![image.png](./images/359b81c16b577ced3a816cd4e55629ed.webp )
...
![image.png](./images/60f57b2c6a970fe71461c9b4dd892da3.webp )

还会自动的生成徽章。这个徽章是会根据报告结果动态变化的，属于客观的第三方数据，具有公信力。


![image.png](./images/dca824b4b5ce5e6a65d7789d91d93663.webp )

首先需要登录 [Codecov 网站](https://codecov.io/)。


![image.png](./images/2ad049448b7bc7671c15ffe98ba84f2f.webp )

**一定要使用 Github 账号进行登录****，**这样它可以直接读取你的 Github 中的项目。


![image.png](./images/ec8eebe274c8bc883566689f9ce942ea.webp )


![image.png](./images/57851a1f110c9905d987e2bd4b657dc5.webp )

然后是添加访问授权，如果你的项目在你名下的组织下，也需要访问授权。


![image.png](./images/540a93f64801c9eebdd7a68c5ea43dc0.webp )

这时候你就可以在网站上找到所有 Github 中的项目。选择 【Not yet setup 】，选择需要展示覆盖率报告的网站后的【 setup repo】链接，就可以看到安装指南。


![image.png](./images/8c08ad8de627d7c1b26d01e3b7e3d298.webp )
...
![image.png](./images/42544c88bd1ef31b540c25c4fa279018.webp )

提交代码就可以自动生成覆盖率报告了。


![image.png](./images/8d2f1bacf793208760796b1b3b3be68d.webp )

Codecov Action 会自动识别语言与测试框架的覆盖率报告种类，然后上传相应的数据。这里面要特别说明，对于 Vitest ，是上传的 json 格式的报告，所以需要确定你确实生成了 json 报告。如何生成可以看上文介绍。


![image.png](./images/21ee0ea91af2222571d3e4cefd47c89d.webp )
...
![image.png](./images/044c49b5079e10d2c5c6087bfbd37be8.webp )


![image.png](./images/f79e185e11c9c8d5099638d1e88c3444.webp )
