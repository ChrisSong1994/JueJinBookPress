...
![img](./images/34f49c01f65a43a78f9b6bd37c0e396d~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![img](./images/6e9b2db05603449081d5444cbb960518~tplv-k3u1fbpfcp-zoom-1.image.png)

当然也可以后期添加和修改，下面就在组件库添加上开源协议。

![img](./images/dd4673b12ecc40d09c94dcb3a2e0eb11~tplv-k3u1fbpfcp-zoom-1.image.png)

其实开源许可证就是一个文本文件放在项目的根目录下，所以可以在根目录下点击 【Add file】选择 【Create new file】。

![img](./images/ae86429e77cb401694a3e41529fe24fc~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![img](./images/fe4c83a22d994cfda520a90866a9592d~tplv-k3u1fbpfcp-zoom-1.image.png)
