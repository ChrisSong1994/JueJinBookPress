...
![img](./images/9d10a470ff305ee245c1fc5926e80200.webp )
...
![img](./images/a73f9339b07cf1510c77c55c72b8d244.webp )

但是如果将 utils.ts 编译为 utils.js 文件。这个时候类型定义就会丢失。

![img](./images/8728e28048630d63c649215980138176.webp )

那调用的时候自然也不会有类型检查。

![img](./images/67892eaff956767948295c342c9805ef.webp )

可以看到调用 add 方法的时候，类型是 any。

如果想要保留类型定义，就需要生成类型定义文件，将类型保留到类型定义文件中 d.ts。这个时候编辑器就可以依据类型定义文件进行类型检查了。

![img](./images/f405191d3060348056649aee3945bc75.webp )
...
![img](./images/13e87d7b8b54eb1265ddce620672808d.webp )
...
![img](./images/5f7be68df8ca4962f143dabb59828c40.webp )
...
-   copyDtsFiles： 目的是可以自动复制源码中的类型定义，这个需要有。
    ...
    -   ```
        pnpm build
        ```
    -   ![img](./images/ddbe1fbe41519de30d6e667bcba06de0.webp )

### 定义类型定义入口

类型定义入口文件是靠编写编译脚本实现的。如何编写这个脚本在后面介绍。现在大家先弄清生成后的样子。对于一个软件包来讲，类型定义文件的位置通过 package.json 的 types 属性确定。

![img](./images/7ef5f0173e05c3f8c40861f553270683.webp )
...
![img](./images/8547bfb4a9e3f45ff1d1a8316bddaa02.webp )

具体写法为

![img](./images/f0e92abfc9c483dd3f55a6b0a66c82e7.webp )
...
![img](./images/d6cbed8706ed7aee42c304bbe060e78d.webp )
...
![img](./images/1285c63acc7ba7f8269440c50a322812.webp )
...
![img](./images/3ed298ce1369c192aadd788263c7fab5.webp )
