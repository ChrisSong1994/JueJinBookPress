...
![img](./images/5a9acd7684b3041a8a1ff6e196da8fdc.webp )
...
![img](./images/72dd5d7957d557a3de6d6b6b3acf24ed.webp )
...
![img](./images/731cbf797e344a55ea7fdda19eb95e60.webp )

大家可以看一下 Vite 的社区模板库，tailwind 几乎就是标配。

<https://github.com/vitejs/awesome-vite#templates>

![img](./images/727e4e3295ddeca4dbfc5acc8b9abad9.webp )
...
![img](./images/eec72407c6c9870dee5be040971ab77c.webp )
...
![img](./images/7cad5f07eee6409a289e3b6a10dbd8e9.webp )
...
![img](./images/c33974ca9093c5d9cff1dfe6fe5c185b.webp )
...
![img](./images/19447312b68cf405e56418c42dd05c6b.webp )

参考代码放在这 ：<https://github.com/smarty-team/smarty-admin/>

使用同样的方式，给按钮定制各种样式。这里面就不赘述。最后看一下效果。

![img](./images/a053b05aa24035179ade386cadb6de97.webp )

### 【 Icon 图标按钮】实现

![img](./images/1c3562a8e541446776ddfe7d483576c4.webp )
...
![img](./images/751c7b278d01559abfa6468e9db501e1.webp )

如果你想使用一个 【 🔍 】 搜索，首先可以在 [iconfy](https://icones.js.org/) 使用【search】搜索，然后选择一个心仪的图标。

![img](./images/04b2b55bbef14f58a6c843ee3ee32a58.webp )
...
![img](./images/de8367d2ac183f131e3ce39d443d4a0e.webp )


### Build 时单独导出 CSS
使用 unocss 后，如果运行 pnpm build 的时候会报错。

![image.png](./images/596702da0936f84b4934e2fb34b95ed2.webp )
...
![image.png](./images/fc921809305db2dff39e07fee66023dd.webp )



![image.png](./images/c42c700f4863b48f997b7bb8148bc1a9.webp )
...
![img](./images/098cf634790be46f42f6229d8d1fa231.webp )