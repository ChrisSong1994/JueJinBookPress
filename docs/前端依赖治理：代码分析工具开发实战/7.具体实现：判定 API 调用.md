...
![](./images/f6899d1d5be44de797adadcfb930d5fc~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/b51e8e96c3bc4952b03a0d26bde5b4a8~tplv-k3u1fbpfcp-zoom-1.image.png)

（2）代码第 13 行 `app` 节点的 Symbol 信息：

![](./images/608de7fd475c47a4aa3d22c5d633376f~tplv-k3u1fbpfcp-zoom-1.image.png)

（3）代码第 5 行 `app` 节点的 Symbol 信息：

![](./images/0414dcc13da04dcf96ca19f4d6f95217~tplv-k3u1fbpfcp-zoom-1.image.png)

（4）代码第 7 行 `app` 节点的 Symbol 信息：

![](./images/3e86c28068ea44fa9d0269dc1cd9b8a6~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/eb1ae27a4a454061a9b0ce7acdd56ed1~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/3bc1264b6ec14c48aa34510775018e91~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/a89d7fee087e4403904d3d2d3d21b12e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/c03b44519aec4eb9a93f5664e33c810e~tplv-k3u1fbpfcp-zoom-1.image.png)

因为 AST 是树状结构，从最末端的叶子结点着手遍历，可以覆盖到全部 `identifier` 结点，防止遗漏。自下而上分析像是一种倒向漏斗的筛选模式，在经过一轮一轮的分析筛选后，就能全面且准确地定位到目标节点。

![](./images/6d6d84f9968c4470a06cc1b3fff368f0~tplv-k3u1fbpfcp-zoom-1.image.png)
