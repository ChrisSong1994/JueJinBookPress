...
我们知道平均值的计算公式是数组的总和 ![\sum_{i=1}^n x_i](./images/9af5c85ed273360b0ae713af41b5e54a.webp ) 除以数组的长度 ![n](./images/239555667673d91ca2bb91413cb08e98.webp )，假设我们要给数组 ![x](./images/a9c0ac9747a682ebac77b7407ec622da.webp ) 的子集，前 ![n - 1](./images/239555667673d91ca2bb91413cb08e98.webp %20-%201) 个元素的数组进行求平均，就可以得到以下两条公式。
...
![m_n = \frac{{m_{n-1} \times (n-1) + x_n}}{n}](./images/22000b4afcafd86e5963a5938e1772eb.webp )%20%2B%20x_n%7D%7D%7Bn%7D)

这条公式表示了长度为 ![n](./images/239555667673d91ca2bb91413cb08e98.webp ) 的数组 ![x](./images/a9c0ac9747a682ebac77b7407ec622da.webp ) 的平均值等于数组 ![x](./images/a9c0ac9747a682ebac77b7407ec622da.webp ) 的前 ![n - 1](./images/239555667673d91ca2bb91413cb08e98.webp %20-%201) 个元素的平均值乘以 ![n-1](./images/239555667673d91ca2bb91413cb08e98.webp -1) 再加上第 ![n](./images/239555667673d91ca2bb91413cb08e98.webp ) 个元素后除以 ![n](./images/239555667673d91ca2bb91413cb08e98.webp )。其中 ![x_n](./images/a9c0ac9747a682ebac77b7407ec622da.webp _n) 就可以理解为数据流中的数据块，我们只需要维护上一个平均值和上一个数据集长度即可。以下例子假设数据集不断“吐出”数值 `1,2,3,4` 并以此类推。
