...
![](./images/517222d57c045f126348af5bee97e530.png )
...
![](./images/858d9203049e9c0a734e7ca8a45494d5.png )

调用接口需要平台提供的 `AppKey`，在你注册登录个人中心的**我的数据**中可以查看对应接口的 `AppKey`：

![](./images/c825bd84594efd41090bf4b343a22b54.png )

获取到 AppKey 后我们便可以对接口进行测试了，这里我们可以直接通过对应接口的测试按钮进行测试，当然你也可以通过 `postman` 工具进行调试：

![](./images/665f980460d021d10cb63aa2d15b9299.png )
...
![](./images/c58bf3bb93907495a964771b7c450448.png )
