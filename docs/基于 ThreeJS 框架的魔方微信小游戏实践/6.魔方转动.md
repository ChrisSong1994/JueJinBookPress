...
![](./images/41aaac19e1f63d9c64fb292903123fb8.png )

示例代码在 [Threejs_rubik](https://github.com/newbieYoung/Threejs_rubik/tree/master/lesson/demo4) 项目中；

![](./images/2179263a6d667bee9d722fb62be642b3.png )

## 实现

首先需要分析转动魔方操作：

![](./images/634ac1237e6a39b02e0562f391930b47.png )
...
![](./images/1b6524a4546ff0e9862c0db3782fbf54.png )
...
![](./images/f9659b148fd91ee1b985948e90415ac7.png )

但是当我们点击魔方区域`蓝色面的红点`时，`intersects`就会是由近到远的碰撞元素数组了；

![](./images/36180ddbafabe117a67b497eb4af66aa.png )
...
![](./images/b6478897314ef3558885a6409ff8f44e.png )
...
![](./images/85cc746a284476cc0ed2f8d81eee607a.png )
...
![](./images/e6fe02693a5553a02f42b7e5a8f0e36c.png )
...
![](./images/962d452913206339d6412c64888d03ea.png )
...
![](./images/63feb500a28b144a7d97fb4d52cb2dd2.png )
