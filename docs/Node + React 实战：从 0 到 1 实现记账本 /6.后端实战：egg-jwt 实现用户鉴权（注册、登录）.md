...
![](./images/db5e51fface2f922a286ab4b3feb2c80.webp )
...
![](./images/04e9b4db45c8edc0f0ea41bd27b49955.webp )

查看数据库是否生效：

![](./images/f34aa52a99b5ba6069d47a8712910446.webp )

可以看到我们注册的信息已经进入数据库，此时我们验证一下，再次发起相同的请求，查看服务端代码的判断是否生效。

![](./images/df1aedb967a16b2562f020ac2f60c480.webp )
...
![](./images/5df51d42716e954f13eb483b5a914bdd.webp )
...
![](./images/7af5317c738ed018d0932a1feacc2d03.webp )
...
![](./images/f2e2216cdbe8e83f310255a0165ea9ab.webp )
...
![](./images/9bcc2136d44ea4582d9e3770830f9ad1.webp )
...
![](./images/b8497b5028f97f6fdcfa7b8e4027d790.webp )
...
![](./images/3e0fe77414200c2c618914b9d830d5b0.webp )

勾去选项，发起请求，如上图所示，进入中间件，判断 `token` 不存在。我们在随便写一个 `token` 值验证无效的情况。

![](./images/3503695253db473c2414a1ddf8474d1f.webp )
