...
![diff (2).png](./images/6d98fa135ce686d24648070ce113017b.png )
...
![diff (3).png](./images/ef4d9ec97b55f8178e12c02f04b9c207.png )
...
![laoba.png](./images/f9fa7b3f81c4dd381407e1a0e4c5e1c3.png )
...
![hoist.png](./images/03c3e29d7e0e407080cbd4062a506609.png )

**选择 Option 下的 `hoistStatic`：**

![optionh.png](./images/fb9d354229c131bac17d9f140bdadf3f.png )

**静态提升后：**

![hoist2.png](./images/bce0b764a371eb61efa00ed46bf616fb.png )
...
![giao.png](./images/c12d152686d70a15547f5d880f52ac05.png )
...
![giao1.png](./images/d3407dad951281f26c74d0014dc4483a.png )
...
![ssr.jpg](./images/89587757dde7e7c6a4995dd3972c83b0.png )

#### StaticNode（静态节点）

上述 `SSR` 服务端渲染，会将静态标签直接转化为文本。在客户端渲染的时候，只要标签嵌套得足够多，编译时也会将其转化为 `HTML` 字符串，如下图所示：

![staticnode.jpg](./images/4dc1c9a88f557d932d800ce580b95156.png )
...
![](./images/ea8607e293a9ff5538f72357c83abee1.png )
...
![](./images/809fcc0c7fc02cdb7e6f8c943130aa51.png )
...
![](./images/e9ac1e9509fd95d7374ca331ea539be3.png )
...
![](./images/c7d01cb96a50adec5c7fb56a24821a8c.png )
