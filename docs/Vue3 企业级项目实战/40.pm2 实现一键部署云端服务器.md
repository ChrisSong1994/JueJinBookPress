...
![](./images/852badf0c0378ccd4e9d6f7b65a3e724.png )
...
![](./images/ee093b7783cc6cf01c9bd68e6762c1da.png )
...
![](./images/6e634e1592d4d41efafe659a4cc04568.png )

在项目根目录下执行它：

![](./images/c463e9638ec6b79e276169b488e482ed.png )

如上图所示，就表示成功了，观察服务器上的文件目录：

![](./images/93057500bb28c680f2d954c9cec79468.png )
...
![](./images/ec4ca5833c77ebb09f80d166d7cf1ba2.png )

可以看到，先是拉取最新代码，然后在通过 npm i 安装工具包，再通过 `npm run build:release` 打包，最后通过 `pm2` 部署项目。

![](./images/c103aa4fbd183ff6fbe8c7f0d325213c.png )

部署成功后，通过浏览器访问 `47.99.134.126:5018` 地址，如下所示：

![](./images/9849791a39e8551a11026e631268cefd.png )

如果有域名，配置好之后，访问地址就成了下图中的形式：

![image-20210505130558827](./images/5a31afcf644378bd1287ae4cd614ee49.png )
