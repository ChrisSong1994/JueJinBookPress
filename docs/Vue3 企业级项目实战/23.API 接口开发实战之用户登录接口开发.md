...
![登录页面](./images/01b20b6e2f9223abd5fc18468af83a26.webp )
...
![taobao-login-page](./images/5d854dd6448fc36ddc377c6fc58d55bd.webp )
...
![login-check-simple](./images/6dc8f5bca6a0a19568a526b1a965e199.webp )

当然，还有一些验证操作是必须的，比如前端在发送数据时需要验证数据格式及有效性，后端接口在访问之前也需要验证用户信息是否有效，因此完整版的登录验证流程如下：

![login-check-detail](./images/91b74e16731564059dec2928dd430f1f.webp )
...
![登录页面](./images/8f902c1020a6346f0d0a6e78580cfdf3.webp )
...
![image-20210407114338200](./images/0effd25bf754dd21f993ea40fce12726.webp )

点击 Execute 按钮，就可以发送登录请求了，结果如下图所示：

![image-20210407114454319](./images/9977a181cb555a00a56dc552ef2f7802.webp )
