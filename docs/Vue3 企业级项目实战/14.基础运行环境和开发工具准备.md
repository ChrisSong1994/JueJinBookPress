...
![](./images/2568da1145e53592ddfc8a37282f70c0.png )在 JDK 下载页面中看到不同系统的安装包，如下图 2-2 所示，选择适合所使用电脑系统的版本进行下载。

![](./images/9530ec89b9dc2eb1c385691748d6aa49.png )
...
![](./images/8bc95ff178b06e6feb6469a74fcdbcb4.png )
...
![](./images/e5688077de836a9d52b5fc0d4d44ef72.png )
...
![](./images/c6b4bbf95fb69d7753ad52e133a480d7.png )

编辑 PATH 变量，在变量的末尾添加 `;%JAVA_HOME%\bin;%JAVA_HOME%\jre\bin;`，如下图所示：

![](./images/a90e0dcf0bf52f3eacb3b0daf276d332.png )
...
![](./images/59d33a76a06423a5c906260394be50d1.png )
...
![](./images/7adfedb80eedb8317377c4d1251e2b87.png )
...
![](./images/53bd567d96f8ceda141dff9586a1399e.png )
...
![](./images/9f6a9f8fcfb5ba611312d8cf41a1e5e7.png )
...
![image-20201224204216166](./images/798a20121ace293eb6956015cc89a88d.png )
...
![image-20201224114747436](./images/2a049ee8a3c0888e1fa61214ab4d078b.png )
...
![image-20201224114651986](./images/0384350435d6e7e3a6b900c789152115.png )
...
![](./images/68b9d4e3555c2c9818dccfc10f365fbf.png )
...
![](./images/6cb773de2cddbec72cc90619e74b56ca.png )
...
![image-20201224204546787](./images/d297d46df4cbc320e5a2d10fcb23219e.png )

首次打开 IDEA 编辑器可以看到它的欢迎页面，如下图所示：

![](./images/e974d1194e95ca0154f7a32bc0b04f67.png )
...
![image-20201224211323320](./images/73538b77b8cf4cba5904c94943c177f4.png )
...
![image-20201224211505493](./images/d4e5330212df16f61b97ef72cde86437.png )
...
![image-20201224212044229](./images/27db69cb2e6f22d9fe8febfa69681558.png )
