...
![截图 2021-04-25 17.20.50](./images/e839ee28cc810d3b4846ded94b95c2e1.png )
...
![image-20210424171752928](./images/8729e0dd194ed78583ad93c7d3330897.png )
...
![image-20210424155338344](./images/be0ffeb17be42e34e6456bc101786c01.png )

由于这些接口都需要登录后才能访问，首先我们访问登录接口，拿到一个可以正常进行身份认证的 token 字符串，如下图所示：

![image-20210407170852871](./images/58a51099b16bb08f26b76d9b4ea50e0d.png )
...
![image-20210424172944530](./images/afa1c953e4dc3f7cdff5b77d0fdc06ee.png )

首页配置列表测试数据如下，如下图所示：

![image-20210424173009386](./images/a85fdb5cbfd7a48277459b6634df6d1f.png )
...
![image-20210424173242934](./images/049bae64193f271b9b07667a081de921.png )

添加成功后可以看到列表中多了一条数据。

以上是正常情况，如果 token 不正确或者请求的参数不规范也会得到对应的错误提示：

![image-20210424173318497](./images/a7c9f3829741e8d499e806f49fd6764a.png )
...
![image-20210424173447138](./images/2052a674db857cf329ffd2a25c3122c4.png )

而如果传入的 id 未查询到数据，会得到如下返回结果：

![image-20210424173518763](./images/011ce96d80377072d630a7c54c6962e0.png )
...
![image-20210424173658710](./images/5ff887b01fbe0375e3cc3fee34b5f5ef.png )
