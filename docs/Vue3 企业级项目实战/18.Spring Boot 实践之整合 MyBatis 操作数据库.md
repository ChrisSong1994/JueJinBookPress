# 18.Spring Boot 实践之整合 MyBatis 操作数据库
...
![MyBatis](./images/e64bf18c26e322e372c2268b88d6eb7b.png )
...
![image-20210107142441792](./images/f310bacda4b7dd5a2c444b0fa5bddf05.png )

点击 mybatis-spring-boot-starter 并进入 mybatis-spring-boot-starter-2.1.3.pom 文件，源码如下：

![image-20210107142736233](./images/5feb9e008cad543e3a432a5b74dda38b.png )
...
![image-20210107143055609](./images/9fd1794e0691af8aca3b58b8fef026f9.png )
...
![WX20210111-160615@2x](./images/04237d7f531f9ddc1212a79f23962699.png )
...
![image-20210107173053707](./images/73bb4c6b36e2f35cd6d2e52ac7860450.png )

此时查看数据库中的记录，可以看到已经新增成功，新的记录已经生成，数据如下图所示：

![image-20210107173605571](./images/4877baeb6f1775a27e852b6f6aca9bf5.png )
...
![image-20210107173759835](./images/a33f65d0d79a7f0e76d376aca43aa4fd.png )



此时查看数据库中的记录，id 为 5 的记录已经被删除成功，数据如下图所示：

![image-20210107173901505](./images/3b12749aa960301128523377e35a25c8.png )
...
![image-20210107174052760](./images/2980219bd47bd159977ecc85291d9afa.png )

此时查看数据库中的记录，id 为 1 的记录已经修改成功，数据如下图所示：

![image-20210107174139644](./images/de737d1c68f1091632c3ad90da8be91a.png )
...
![image-20210107174216282](./images/43644b92108e7e9cce8baf951591b212.png )
