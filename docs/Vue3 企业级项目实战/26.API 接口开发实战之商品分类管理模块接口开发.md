...
![image-20210124162822962](./images/5bb4699135e2ecec9819a7aeec39e911.png )

- 京东商城分类选择

![image-20210124162954809](./images/dd6b76d279fed878599ea26908ec68a3.png )
...
![image-20210415174825138](./images/799a8dd8a1c4cdd0dff963cf341e0bb3.png )

由于这些接口都需要登录后才能访问，首先我们访问登录接口，拿到一个可以正常进行身份认证的 token 字符串，如下图所示：

![image-20210407170852871](./images/09485203b7932dfddfe5f083d62cbfc6.png )
...
![image-20210415174700129](./images/b88434bdcff18deabef9b8fe5f44320e.png )
...
![image-20210415175834529](./images/8b1d2a7d12a7b0432e9639ddf33841bd.png )

添加成功后可以看到列表中多了一条数据。

以上是正常情况，如果 token 不正确或者请求的参数不规范也会得到对应的错误提示：

![](./images/d725423f281fda23c67302dd32836fb9.png )
...
![image-20210415180250747](./images/4ba7c0568e796c0dbab536420f115362.png )

而如果传入的 id 未查询到数据，会得到如下返回结果：

![image-20210413111404393](./images/ce22ccb298e0148c7609b6ac69dee2f3.png )
...
![image-20210415180428705](./images/86ea9e98188f9e02305f375977ea956a.png )
