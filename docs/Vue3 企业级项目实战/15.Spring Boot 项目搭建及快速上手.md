...
![image-20201230103952476](./images/d12bb11af084f6a07df7fd4a92b48f5a.png )
...
![image-20201230104215631](./images/bac48eeb2ea3c5b239be8f0d9a57c100.png )

很明显，该项目中将会采用 Spring MVC 开发框架并且使用了 Tomcat 作为默认的嵌入式容器。

最终，初始化 Spring Boot 项目的选项配置完成，如下图所示：

![image-20201230104240154](./images/9090ed749b1b6e88a565fb8a413db401.png )
...
![image-20201230111323318](./images/3a3d2a99ec9e1567794b7eafe4433d55.png )
...
![dictionary](./images/bf5cdd96cd96ef99f05c5aa6c398a6e8.png )
...
![image-20201230142739075](./images/27f998f5de4e51ce7125777d280ea335.png )

- 工具栏中的 Run / Debug 按钮：点击工具栏中的 Run / Debug 按钮也可以启动 Spring Boot 项目，如下图所示。

![idea-run](./images/87ea9595f1d687f6ae01f35995be5289.png )
...
![image-20201230143603197](./images/4451fdb126cf941d86b5d659be339bd7.png )
...
![image-20201230144501331](./images/268f216d512f8f8508b7d36af810bd1a.png )
...
![image-20210113150227072](./images/c7064788b4cb3ce80cab507d65d5b073.png )
...
![WX20210113-151438@2x](./images/2a61ea131ae57b08364a31fe34a500db.png )

2. 在 ltd.newbee.mall.controller 单击鼠标右键，在弹出的菜单栏中选择“New → Java Class”，之后新建名称为 HelloController 的 Java 类，此时的目录结构如下图所示：

![image-20210113151911617](./images/37e1a6ae78f8b488c1dd0b4d0320c822.png )
...
![image-20210113160717677](./images/81a197997cc18473f4fbdcf6ca168b71.png )
