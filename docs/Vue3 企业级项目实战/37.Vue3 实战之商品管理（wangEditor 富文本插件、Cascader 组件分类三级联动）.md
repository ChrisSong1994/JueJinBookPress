# 37.Vue3 实战之商品管理（wangEditor 富文本插件、Cascader 组件分类三级联动）
...
![](./images/66ff672c0029f707ad2015629f9a44ff.png )

其次我们点击新增商品按钮，需要跳转到「添加商品」菜单栏，自然是展示一个添加商品的表单页面，表单样式如下：

![](./images/6d27dee3005ddbb49403565cd6d3c1ac.png )
...
![](./images/05568743f049c7faf7790b6014efd383.png )
...
![](./images/93c61506c40648d60641ade2cc2affc0.png )
...
![](./images/89076bd743d2130cf5924cc7ec8c9e6d.png )
...
![](./images/d6bf03abb6d32beb3b34671c635b4f68.png )

![](./images/009d7fd252c833e6eda0eeb2da41ba12.png )
