...
![](./images/40afbc1c2b97f4aed62692b88e7e3da0.webp )

点击创建一个新的 token，复制它，回到终端运行 `heroku login -i`，账号名输入你的邮箱，密码输入 token，确认登录：

![](./images/d982849da8bdb01110094f57a7c37530.webp )
...
![](./images/80a4ecceef6425d377736bf35d5d8b7e.webp )
...
[![image380be9c6e463109c.png](./images/2af26d0153ffbe6180d15ef51452d6e1.webp )](https://www.imagehub.cc/image/GfiN6y)

点击安装，将安装到我们的应用中：

![](./images/8fd478d3f131810e36997768eb34b155.webp )

![](./images/b88fbe925283f8edb956076f3932806f.webp )

数据库的链接会被以环境变量 `process.env.DATABASE_URL ` 注入进来，来到应用配置页面，点击显示环境变量：

![imagee38ce6a381dc9b3b.png](./images/76d24d3d6803f229319851ff249e2323.webp )
...
![imagedb88d65589f9bb99.png](./images/b5d0c6e9d23302c633c4b5335c335552.webp )
...
![imagee102f1b42e36a82b.png](./images/172c86f65f72d7f979add09803afa5e2.webp )
...
![imagef0c3c4a1ded5150f.png](./images/db5900bd6235bfc7c0e00519dcf01e29.webp )

![imagea22f61b473e93e2c.png](./images/460f9aec3a4f1d7509ee87fcdc74ebae.webp ) 
...
![image752c0cd8664a87c4.png](./images/d608f4c6bb292d3c65b23b30b27b5a44.webp )
...
![](./images/f0cfa5398f9cc56fa8a6a300e2348b22.webp )

`GET /article`：

![](./images/bb05580d782fce50d3057bb3808b8320.webp )

`GET /article?id=20`：

![](./images/f9d051a61fa04dbb99020ab345da3ce2.webp )

`POST /article/update`：

![](./images/994e156b4834ad190464292069e69bab.webp )
