...
![image.png](./images/6a86720ed3bc191b6845dc246ac736c1.webp )
...
![image.png](./images/a62a4ec835f5c0ec8967815009b81640.webp )

![image.png](./images/5d09fc8e2bb45dc8542112c57bab48e1.webp )

你会发现，使用 const 声明的变量，其类型会从值推导出最精确的字面量类型。而对象类型则只会推导至符合其属性结构的接口，不会使用字面量类型：

![image.png](./images/900d12266489cbfd1bd7d66e06eef307.webp )
