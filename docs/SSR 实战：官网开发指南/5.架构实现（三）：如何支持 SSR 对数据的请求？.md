...
![image.png](./images/d21d952227c35b26430f9229ebca579e.webp )
...
![image.png](./images/77ecf8860b56338b8146d2528bc67841.webp )
可以看到展示的是默认数据，那是因为我们并没有进行初始化的请求，所以它走了默认的 state 兜底，然后我们点击刷新试试。

![image.png](./images/50c7f8b5b95464e8d1c3f0c0686a7a7d.webp )
...
![image.png](./images/b043e24b552a39076985c5cbd94c0bc9.webp )
...
![image.png](./images/6e023f58bc308a5a6564c90eede38aa1.webp )
# 小结
