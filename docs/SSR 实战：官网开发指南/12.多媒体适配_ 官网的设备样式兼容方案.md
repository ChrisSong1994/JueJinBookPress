...
![image.png](./images/f868310c998d81999f76fcc8c092ff1b.webp )

安装完成后，我们移步到样式问题，输入 16px，可以看到会有对应 rem 提示，我们将所有的 px 单位替换即可。


![image.png](./images/10e114220245e76d54e302b94bb2f5c8.webp )
...
![A Demo for 《深入浅出SSR官网开发指南》(移动端) - Google Chrome 2022-08-14 15-54-08.gif](./images/f57fc116fe47303a5ebfd4bfc4ede791.webp )
当然我们也可以通过 network 选中设备的方式查看，那个是更加真实的模拟方式，包括请求头在内的都会同步为对应设备，类似这种拖动的查看方式，是为了排查是否有边界的分辨率遗漏，可以覆盖全部的场景。


![image.png](./images/5faeff4783bd3f2cf1856c2640001024.webp )
...
![image.png](./images/6866e1d056f4c3648eda16671e954ecf.webp )
...
![image.png](./images/eca94c499d13c0b748341cb510393a6c.webp )
...
![image.png](./images/23554497f57fa5143dc1e0a177cd3abe.webp )
...
![image.png](./images/7d06f704aa9f19ac9a70ec7d932342e2.webp )
