...
![image.png](./images/bc30823a8f004bf4ece7f8e70bee4d58.webp )
...
![image.png](./images/3ce72490fd949fab48394a63305b91ea.webp )
...
![f53793d2-8fb2-4518-91b1-082808742bd7.gif](./images/7d3969165a32ec999b68fcc9a4c6f12c.webp )

接下来我们对之前的文章页也写一些简单的样式，再提供一下标题、作者、描述这些字段，代码这边就不讲解了，都是一些基础的样式代码，同学们可以下来自己看一看，效果是这样的。


![image.png](./images/d8d0398df620375dba124fa4c1e3d6e8.webp )
...
![image.png](./images/e5d478f8a7658030d3d45ca91e9816a3.webp )
...
![image.png](./images/9090e8abae4b17ff1b6ebeaa4181f4f0.webp )

我们已经有配置一些数据，其中富文本区域的配置我们需要着重关注一下，大家可以打开第一篇文章，《时政新闻眼...》，这篇文章是我到新闻上随便找的一篇，其中包含了文本、标题和图片，我们看看它的配置是咋样的。


![image.png](./images/d14fe9593f9c00d7565ef8f1a4b43cdf.webp )
...
![image.png](./images/48314f345b11ea3e32cc7cf28f91bfc3.webp )
...
![image.png](./images/dd02e034f40079892464cbebb97e41e9.webp )
...
![image.png](./images/acb314795c38610ea21c02f87ca30c62.webp )
...
![image.png](./images/406d645a4cad3c43ede0d6097caef367.webp )
...
![image.png](./images/aa250883e620bd4d6348fa1f8c34c259.webp )
...
![image.png](./images/b446aec2f3adc61e603cddb2887c3c2e.webp )
...
![16a40330-4789-475a-a3af-ce6bc8fcbb75.gif](./images/33da116b1fc6737d8250eef8cd98ce1e.webp )
...
![image.png](./images/f84ff91630d37a63638ce2fa74132256.webp )
...
![image.png](./images/1ff2fb6c1280356ddc99bc859e571def.webp )
...
![image.png](./images/41d9878a30fd9ff5e1ebd03d592864b4.webp )
...
![image.png](./images/5adea93b72971aaaf50e46abd1ca9a8a.webp )
...
![image.png](./images/4a045ebe02b2ab44311da6b63a01abd2.webp )


![image.png](./images/2bb798bc9095eec4b90129d0ebb6fc01.webp )
...
![image.png](./images/e78698a2f3cf65a95d0adc29703161a6.webp )


![image.png](./images/11fa909dc0cb9ea61fd7c78ce2538ed0.webp )
...
![image.png](./images/5511f4e86a464ae84cd22fdc2ca20489.webp )


![image.png](./images/d0f5c7ba53901a88fa53e1e63217e23d.webp )
