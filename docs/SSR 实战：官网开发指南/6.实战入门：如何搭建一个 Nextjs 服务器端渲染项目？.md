...
![image.png](./images/e4034a67885052c7bad9618cd36195de.webp )
...
![image.png](./images/6a58a89a9f82251925dce3be90a9e23a.webp )
...
![image.png](./images/c929d5d474dccdec3db123dd24d804a7.webp )
...
![image.png](./images/6f51a7f559fd60a1188870949f615102.webp )
...
![image.png](./images/d650c216ad0a78e98882edcc68a4cdd9.webp )

然后我们可以拿脚手架生成的代码试验一下，把 home 的模块化引用换成 scss，然后去掉一个类名，重新按`.`, 可以看到已经可以了：


![image.png](./images/b481517f8cfe69e23a956e093d6162e5.webp )
...
![image.png](./images/7c7260f8cd653ea63351e14aa89cbc33.webp )


![image.png](./images/620e13bfa150d8a14a61ba5cd93a6cee.webp )

我们在 home 处加一个 debugger 试验一下，已经可以进行调试了。


![image.png](./images/1325322dbb3d2025aac098203e75d528.webp )
# 小结
