...
![](./images/1d585e36a1d4e1e4a0f55a7abebc8634.webp )

顺便把源码也做一下：

![](./images/b94c187b5b3b23d9cabdb97169104d46.webp )
...
![](./images/efb9d63ca33be9933e2847426fc9611c.webp )
...
![](./images/fde548c7d144af8470da8ab4cb11decb.webp )
...
![](./images/7647f8a0ee2afa5bd20a36beb364eeea.webp )

高度有点小，在 MaterialWrapper 设置下 height：

![](./images/72b3a9c0d4cbfa6351822e3608fe4204.webp )
...
![](./images/59f882ece360c1f3e3fd0f832742a13d.webp )

每个组件都要区分编辑和预览两种状态，甚至渲染的内容都不同。

所以，我们最好是编辑和预览状态的组件分开写：

![](./images/6c5a3500558cd552eb49006eb5ae2e42.webp )

改下 ComponentConfig，添加 dev、prod 属性。

然后我们给 Page、Button、Container 组件都添加两种状态的：

![](./images/0ce1a6c286dd9386de18c6f06f4e0507.webp )
...
![](./images/c3d8e1e9aedb3884973d8d1238087fb1.webp )

![](./images/532cd5f2b9a4395589e4fcc9ce66b363.webp )
...
![](./images/dad81672799ed906a596c799eb9ba498.webp )
...
![](./images/6352c2bd6ff835cba1f2b825abc2f365.webp )
```javascript
mode: 'edit' | 'preview';
```
```javascript
...
![](./images/407273ed51887cd514779c5c0312e136.webp )
