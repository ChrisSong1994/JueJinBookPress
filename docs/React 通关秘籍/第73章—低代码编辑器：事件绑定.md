...
![](./images/19a38acb76b14142f5bdeb6224081a13.webp )

选中某个事件之后，可以添加动作：

![](./images/9d37b6cc64746fd61389c9f9bd47a06d.webp )

你可以添加自定义执行的 JS 代码。

或者执行一些内置的动作，比如跳转链接。

![](./images/1f8bb2b3d9787ffaf08137b95f7421f6.webp )

还可以调用别的组件的方法，比如修改某个组件的显示隐藏：

![](./images/e20423a92a18a6505729143710b3ade3.webp )

这节我们就实现下。

首先，不同组件可绑定的事件是不同的：

![](./images/caf658685159205f7fa11341f76d9ec1.webp )

![](./images/8164b76b9edda1881a57d7881e544bee.webp )

这明显也是需要配置的。

我们在 componentConfig 里加上这个配置：

![](./images/36f022e235b05b91b6d340bbb32a5718.webp )
...
![](./images/8235a8cbb89bc1edfdbf3bd755fbd452.webp )
...
![](./images/46698489c1f0724665e31df08044b076.webp )
...
![](./images/58de9357bf6df3dd0118459882d18824.webp )

![](./images/a796d7fd6aad12236c5eeec048c0b457.webp )
...
![](./images/e6ec435f7860c681c506cb21c1eec314.webp )

那渲染的时候根据这个绑定 click 事件就好了。

改下 Preview 组件：

![](./images/c76549ea28612ab32cbb697b29a2349a.webp )

![](./images/314b51d713da1dc513a47b479b35c4cb.webp )
...
![](./images/06a24c61112afa4119bc41cd20cb9dc2.webp )
...
![](./images/40c6e93b5913147ddb7da39f93433d12.webp )

虽然交互有点区别，但流程是一样的。

看下 amis 的 json：

![](./images/242925aba8890c87f90ab9d5b641b171.webp )
...
![](./images/842c94749751076fbc2f3ac237ec7f09.webp )
...
![](./images/3e51324615874674f38f8adf2daee8ff.webp )
...
![](./images/e7d4f5a4e3d9f6b9d2864d41f6f43f0c.webp )
...
![](./images/c9db949bccbd35dad261a3299d51a04f.webp )
