...
![](./images/bbfeba2866048fdc343c1af542ea899f.png )

vdom 是指 React Element 的对象树：

![](./images/ca15cd711c1f305204f0bafbc85dddd2.png )

之后这个 vdom 会转换为 fiber 结构：

![](./images/9bcb2b512c4a7eecf54b9b11a43b35be.png )
...
![](./images/0e2c48e87f8a0befc1200352461b6abd.png )
...
![](./images/671fcc5a32b9c6516531945027a4a6ce.png )
...
![](./images/e23a70ebb2c0a189b5a9fc490cc74a46.png )
...
![](./images/8b5d2af409c17c56475d5632a5e33d56.png )

然后把剩下的节点 schdule 就好了。当再次 schedule 到这个任务，就会继续渲染。

![](./images/e517139c413ecf6a050316f9746b7931.png )
...
![](./images/6f11510086f0066d6f25b3d708105cef.png )
...
![](./images/beb68bc4e16ead2d70306355c73eabff.png )
...
![](./images/abf1c85e261b17771389845c354c7971.png )
...
![](./images/a70f0ba0aab654c6f76a714c75b49f22.png )

这样设计的好处，自然是可以用二进制运算快速得到是哪种优先级了：

比如按位与、按位或等：

![](./images/3e06abaf61002d47ae2d366f91510710.png )

![](./images/f9105af12eb4e27366a49940a057c2f6.png )
...
![](./images/4b680cbdd46ed559000bc4ba7f950e1b.png )

是不是就很像赛道：

![](./images/7db6f3a374f137686dccd7f57dcb1e8e.png )
...
![](./images/d2fe4e8863a652686ea06e58940c9ff5.png )

怎么实现的 Lane 优先级转 Event 优先级，那就是有几个分界点了：

![](./images/50d24ac473e2801f3fe20c11de5d873f.png )
...
![](./images/45f4fc4154466459ba15918cb31e2c56.png )

![](./images/f88af6b79037148d14e57448007f9a44.png )

并发执行：

![](./images/ac5c6657d80d206871ca5fc854445202.png )

![](./images/4ec98ebb124cd943d0e4e193d71fb48e.png )
...
![](./images/9383d2f83be545edabd25ac39aae4640.png )
...
![](./images/abd6bcf646fc899c6f4b666ab7c5e26a.png )
