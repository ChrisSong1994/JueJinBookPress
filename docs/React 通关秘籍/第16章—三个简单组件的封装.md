...
![](./images/16df76e7e1053c13fa50ad4d408e87bb.webp )
...
![](./images/05ba7cd6fcb714d46c1a9eba15fdd150.webp )
...
![](./images/343ea26fdc1d6ce954bbdf95ea0232b0.webp )

![](./images/401c1b32478aad19361f9984d7f46704.webp )
...
![](./images/9d030bd160e7f52636a41ed9d873ebfa.webp )
...
![](./images/10bd63c18dc830c021260c9a6c9adcfd.webp )

可以看到，2s 后 dom 发生改变，MutationObserver 监听到了它子节点的变化，属性的变化。

![](./images/f95ce491fb7315b2187b6954566b46f1.webp )
...
![](./images/3c571ab86116f026c5c6dce17b0f71a2.webp )

这个 api 用起来也不麻烦，但可以封装成自定义 hooks 或者组件。

ahooks 里就有这个 hook：

![](./images/5cd82372ee8adb08c13a8540549b1796.webp )

而 antd 里更是把它封装成了组件：

![](./images/b9b15085774cfb5fedf5d0f5ff6b4c6d.webp )

这样用：

![](./images/e850b9a63f5214f99bfe8b8f36cc758a.webp )
...
![](./images/cf1f88c6a43989e3fbd55da099820d4c.webp )
...
![](./images/255603dcd09af7f4d6a4314429d7803d.webp )
...
![](./images/6c617b7ca2c1f0b63265efc1e620c5bd.webp )
...
![](./images/59e9d77a4802160a258aedf80cb2957b.webp )
...
![](./images/c32a6079e549f96296e387ceea9556f0.webp )

然后用 cloneElement 给元素加上 onClick 事件，执行复制，并且还会调用元素原来的 onClick 事件：

![](./images/fdb4b35b5a903b995d57ff5c998d4dd3.webp )

换成我们自己的组件：

![](./images/b872f447bc104b9d3c96b59ed1b57792.webp )
