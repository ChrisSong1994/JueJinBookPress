...
![](./images/acba492b97b261d47035f087540ba07f.png )

我们只要在选中组件的时候，在右边展示组件对应属性的表单就行了。

不同组件的属性是不同的，这部分明显是在 componentConfig 里配置。

![](./images/5536489f1fe61567b39e4839b0626953.png )
...
![](./images/bcf816817281982951c48e37d0db58b2.png )
...
![](./images/4423e9893960eceaa0531efa4f436a47.png )

其实 Setting 部分不只是设置属性，还可以设置样式、绑定事件：

![](./images/09aae981e3dfe86eb7c39b5ed9387b9c.png )

![](./images/9a3b47eb332752f3002ad494931163e3.png )
...
![](./images/89db29dde09a8072562b05e03b299de0.png )

当 curComponent 变化的时候，把 props 设置到表单用于回显数据：

![](./images/05575d2b1963f757a7394b2cefb79301.png )

当表单 value 变化的时候，同步到 store：

![](./images/679ef9c0353440f88f1f669eb8a033c1.png )

下面就是表单项目，分别渲染 id、name、desc 属性，还有组件对应的 setter：

![](./images/13714b97965f6c0de54e9e462c5f558e.png )
...
![](./images/21f9d10dbce216feeb92bfb0bd119909.png )

扩展更多的 setter 类型，支持 radio、checkbox 等表单项。

还有，现在这里贴的比较紧，我们加个 padding：

![](./images/664d14faee8280eba88e6ac5b15a1f44.png )

![](./images/978e3e4535a0d97644bb311a5b275245.png )

![](./images/7483d3c2917a1adc84ee0f92f5e8f300.png )
...
![](./images/5f5c58d96b5d4224f30fad8b56b105bd.png )

![](./images/ea3f0e178dbc5890232e7631fd5e9cfa.png )
...
![](./images/6501101db864eea93bce4b76058e399b.png )

给渲染的组件参数加一个 styles 参数：

![](./images/493659036ca9a338c114b3387a8f7c95.png )

把 styles 渲染出来：

Button 组件：

![](./images/9303d5f7866cd6321dc8f389616152e7.png )

Container 组件：

![](./images/89d0b5d5cb09baca0d24c60a1f50cfef.png )

Page 组件：

![](./images/83e92f3684165024d5d4ea2d9b75375c.png )

然后我们在 addComponent 的时候加上个 styles 试试：

![](./images/fa875cf3799f8bdf0eda21c340de04ea.png )
...
![](./images/43c13011b93137c858ed5035dc876ae3.png )

![](./images/e6ee55e50b1f7c1af9496f338eb032e8.png )
```javascript
...
![](./images/33da9a1f1e0aa4e1d52faf5809e6491c.png )
```javascript
...
![](./images/2ff5d8cd84cf8dde3b623bfd88417458.png )
...
![](./images/7d8837420b8fb2fb4a2f2e5c282e9c7e.png )
...
![](./images/df7a73ceac31dbde3de6be0d2f7447e2.png )
调用下：
...
![](./images/935634b66c4d1c385307bde84fb1769f.png )
...
![](./images/d793c7fcf0258c5730c2858dce580d7a.png )

所以在编辑器里删除 css，合并后依然保留着之前的样式。

我们支持下整个替换就好了：

![](./images/702a163e9d991714e8ab3de9f1599e8d.png )

![](./images/cf58c70016f84602cdca7dc8858f67a9.png )
```javascript
...
![](./images/4ccc307e0f0666d86ac0bd16b1ea4615.png )
...
![](./images/1d1cdf5b50c4339ff264450b12945c41.png )
...
![](./images/bff883ba78086b335660b7cb6c22ba15.png )

![](./images/3f0dbc5e5ff9cb324b6c02cb560ae51f.png )
...
![](./images/0c0ffb4c47bb35f457d96e233f75bec2.png )

这是因为 components 变了，到渲染完成，然后再 getBoundingClientRect 拿到改变后的宽高是有一段时间的。

加个延迟就好了：

![](./images/0bd902ec776ab78a5fe1ab8a8befb98d.png )
