...
![项目依赖](./images/49f1479420ae25fcc3b4efa2ad050990.webp )
...
![Multirepo](./images/4708f1d9c799d79966bc36685359b1b8.webp )

在使用`lerna`后，`Multirepo仓库`就会变成`Menorepo仓库`，其组织形式就会变成这样。

![Monorepo](./images/df5254d5691f21f0c5a3a31a249ed421.webp )
