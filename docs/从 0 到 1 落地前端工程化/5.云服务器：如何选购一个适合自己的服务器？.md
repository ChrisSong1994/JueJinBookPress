...
![混用云计算产品](./images/e12cdb35ac364551b8d1bb7effa7aff5~tplv-k3u1fbpfcp-watermark.png)
...
![云服务器](./images/bd6d385e6eef45e8918c21ad0a256990~tplv-k3u1fbpfcp-watermark.png)

进入`云服务器`界面，点击`立即购买`。

![立即购买](./images/1139d7b050de4697bf07f1b7c19e9c6e~tplv-k3u1fbpfcp-watermark.png)

进入选购界面，根据我选项选择配置，点击`免费试用`。

![免费试用-1](./images/b2f853877e2f48288b2e8b3662717887~tplv-k3u1fbpfcp-watermark.png)

![免费试用-2](./images/730bd55437d34cb5b7575e1754087d47~tplv-k3u1fbpfcp-watermark.png)
...
![新用户专享](./images/02af1516b01b4eb1874ff197e009defd~tplv-k3u1fbpfcp-watermark.png)

老用户价格相比新用户价格还是提升了很多，当然也可用亲人的身份证注册绑定新账号再以新用户的方式选购，这样可省下一大笔可观的费用。

![老用户专享](./images/65a97bd897a14fbaa0b8f5f45ed485e8~tplv-k3u1fbpfcp-watermark.png)
...
![更换操作系统](./images/a6986c9e16844616b82c236223bd9c4e~tplv-k3u1fbpfcp-watermark.png)
