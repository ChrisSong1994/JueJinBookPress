...
![www文件夹](./images/1ae6dc66bc618d5008360d10de3c40e8.webp )

准备好个人官网源码，在`client`文件夹中创建`yangzw`文件夹，把源码拖到`yangzw`中，最终的入口文件路径是`/www/client/yangzw/index.html`。

![官网目录](./images/aca328eed289ea16f8560a56d4cd8c7e.webp )
...
![添加安全组](./images/552067a43227ff2165101a34bd9d784c.webp )
