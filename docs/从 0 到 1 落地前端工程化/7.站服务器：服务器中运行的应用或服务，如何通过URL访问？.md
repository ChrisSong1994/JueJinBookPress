...
![www文件夹](./images/0d5325b0fce54b2d93cfffc4a58fa930~tplv-k3u1fbpfcp-watermark.png)

准备好个人官网源码，在`client`文件夹中创建`yangzw`文件夹，把源码拖到`yangzw`中，最终的入口文件路径是`/www/client/yangzw/index.html`。

![官网目录](./images/91de3e82272446eab47c65d81dc981d2~tplv-k3u1fbpfcp-watermark.png)
...
![添加安全组](./images/b2a2bbbf8c6d4fe29e62dd8cb1b9f133~tplv-k3u1fbpfcp-watermark.png)
