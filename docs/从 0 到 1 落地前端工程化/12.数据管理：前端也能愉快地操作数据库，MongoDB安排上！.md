...
![下载配置-MongoDB](./images/68e019da2ae6787175225751d452060a.webp )
...
![下载配置-Compass](./images/bf07da832cfbfca18d6d3a3e839ab8b8.webp )

打开`Compass`，发现需填写一条`MongoDB标准URL`才能连接数据库。

![Compass-连接](./images/4552c787b4ae997de43ba668f52c4a38.webp )
...
![Compass-连接成功](./images/77e5f9fa7b99cb8808b0935405a982aa.webp )
...
![小型接口系统](./images/a7db1e3e6340a9109449776d8428b4d2.webp )
...
![SchemaType](./images/9c85d77cbe9f59d10bf13a07559bcde5.webp )
...
![Postman创建请求](./images/bd4dd75de3b8a925f16bf279386483ae.webp )
...
![Postman配置参数](./images/a5cfcbb05e5506429c4294125a867ec7.webp )

输入完毕点击`Send`，输出以下信息表示请求成功。

![Postman请求响应](./images/dd46048e791ef3fdf9efaa45b65a819c.webp )
...
![刷新数据库](./images/adecbdf86b039c965297030ac16a9694.webp )

![新增集合](./images/11c0cd1f54e4ab0925a475b166a305ea.webp )
...
![Postman接口集合](./images/d53a78548724585ebcf03c3a62fe5929.webp )
...
![Postman全局环境](./images/ea8efd990a57455996e2d7398b131b40.webp )

输入`全局环境`的名称，设置当前环境中的变量内容。分别创建`开发环境`与`生产环境`的变量。

![Postman全局环境Dev](./images/c1b9d879aba3324eb0a17559323037ae.webp )

![Postman全局环境Prod](./images/e828781c2b473ac3fc36a264307d4a9c.webp )
