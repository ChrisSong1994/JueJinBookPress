...
![掘金课程推广](./images/0d94d9206beb411bb38db83013e92a76~tplv-k3u1fbpfcp-watermark.png)
...
![GithubToken配置](./images/b2cfa62ecf9343b4b89f3a93f1c05588~tplv-k3u1fbpfcp-watermark.png)

确定无误后点击`Generate token`，生成一个`Github Token`。

![GithubToken](./images/c03748cbfedf49529cc38b79eb8127c9~tplv-k3u1fbpfcp-watermark.png)

不要刷新网页，立即点击复制按钮把该`token`复制并保存下来，因为刷新网页或重新进入网页，该`token`会消失，只剩下`token名称`。

![GithubToken名称](./images/ffecf74635bb4bb396614ee7042f5d58~tplv-k3u1fbpfcp-watermark.png)
...
![ActionsSecret配置](./images/a4261db9b99c459aa9b09ec819ed1500~tplv-k3u1fbpfcp-watermark.png)

确定无误后点击`Add secret`，生成一个`Actions Secret`。

![ActionsSecret](./images/6a9b912fe65c47df987995dd50555202~tplv-k3u1fbpfcp-watermark.png)
...
![GithubPages](./images/9c2933a7828f42b7b4e5b946ebc88350~tplv-k3u1fbpfcp-watermark.png)
...
![CBD](./images/a4caeaa41d4b4480b63c8a40de6b7c3a~tplv-k3u1fbpfcp-watermark.png)
