# 26 函数式思想在前端状态管理中的实践（下）：盒子模式 & RxJS 篇
...
![](./images/2d3a88e2584e4cd4a402d55d10ba1e3b~tplv-k3u1fbpfcp-zoom-1.image.png)

`nestedObservable` 内部存储的 `val` 也是一系列的盒子，如下图：

![](./images/44e962408ffd49d487bd4f52590d236c~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/74fb4d98fec74a9393de155853af1fe2~tplv-k3u1fbpfcp-zoom-1.image.png)
