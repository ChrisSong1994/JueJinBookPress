...
![image.png](./images/56973219edca4f628189fae26ccee3da~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/17795f89d00145bc94a91a4217ea29e0~tplv-k3u1fbpfcp-watermark.image.png)

这个文件中的内容也很简单，通过 vscode 提供的 registerCommand 方法我们可以注册一个命令，第一个参数是命令的 key，第二个参数是命令触发后的回调函数，完成注册后我们只需要安装插件即可搜索到这个命令。

![image.png](./images/df639a4278e04424806951b774f39781~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/794106ceed6c4bcdbe12ab901cea43ac~tplv-k3u1fbpfcp-watermark.image.png)

具体怎么配置的大家可以自行去官网查阅，这里就不做介绍了。大家只需要知道，在这里配置好的参数会在插件安装后，从 extensions 指定插件目录体现。

![image.png](./images/3489f9e64b6e48d3a2da1080083ed92a~tplv-k3u1fbpfcp-watermark.image.png)

同时我们可以通过调用 vscode 提供的 API 获取到这些参数的配置值，并在我们的实际逻辑中调用。

![image.png](./images/e7bfa052fa424d24be5e58ab364e3eaf~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/17d4319368824912b8b6284a7bb12d3c~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/1d56c7f26fc54b33b1a7f54192f40608~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/0ea53cef8753453bad4b83981dca7988~tplv-k3u1fbpfcp-watermark.image.png)
...
![](./images/0a6ed5aa5a964adf87529ba5933bd0bb~tplv-k3u1fbpfcp-zoom-1.image.png)
