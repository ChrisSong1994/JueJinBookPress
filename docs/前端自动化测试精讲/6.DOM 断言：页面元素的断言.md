...
![](./images/623aee3877c35c92ab77a42a5b405795.webp )
...
![](./images/654cba529d35051339f89e882a127b54.webp )
...
![](./images/a4e4a0569c558e33d37505a109c792f1.webp )
...
![](./images/127456141a05e3864ba5d3b482516730.webp )

不过，它的实现并不是通过 select 标签来实现的，而是自己重构了一套，我们可以打开控制台选一下 select 的区域。

![](./images/4784f0ba59a3bfa1daf68b6239cf1e2d.webp )
...
![](./images/61c7e31ea630c69ebf1c64ee6c452900.webp )
...
![](./images/1c6dbabda7af404dc8cf1eee69f395a0.webp )

但是有一些不会，比如说像 select，那个是基于 div 自己实现的，像上例中的 hobby。

![](./images/454d2112b2d66f251fd8098b4d822318.webp )

对于整体表单，`toHaveFormValues` 断言会完全失效，因为我们使用了 Form 组件，所有的表单元素name 都会被接管到类名上，而不是透传到对应元素上，从源码上我们也可以看到它的选取方式。

![](./images/82cfb67bc8ba03a2777f9546ad217d0d.webp )

![](./images/a623cf4ea97b82314b33d4efa0ced6c7.webp )
...
![](./images/3f22152381d5cac44f41adb3cb98a1cf.webp )
...
![](./images/2fb7f34cf93ebff688ad83b31d8ffaec.webp )

后续这个 pull request 会随 2.24-beta 版本一同发布，大家升级至更高的 Semi 版本即可~

![](./images/f2cb85ba56f0fdd910c4ed222a1fc522.webp )