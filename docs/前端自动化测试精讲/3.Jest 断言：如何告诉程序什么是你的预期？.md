...
![](./images/f978abe072014a10b50f95a0849291dc~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/c3fae277329c45f6975caa765fac5524~tplv-k3u1fbpfcp-zoom-1.image.png)

所以针对 0.1 + 0.2 的计算其实是这样的过程，首先需要把 0.1 和 0.2 转化成对应的二进制。

![](./images/9cf227e85559421ba728236d150e511c~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/47631ca418a647b9ad044db5d58c0b3e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/e19bb9320bfc4d798202b6357b0edb7d~tplv-k3u1fbpfcp-zoom-1.image.png)

对于 Object.is 这两个不合理的判断都得到了修复。

![](./images/c9d5a0250352438e817f18e99b45931a~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/3b8835a12dea4f2d86da86df54283ab2~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/194ab4b520474c2d9c29d0cb53ff8396~tplv-k3u1fbpfcp-zoom-1.image.png)

![](./images/6cec6d70ee244136958845c7f8091d8e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/7b7c09738b4e4980af773dabb6009bdf~tplv-k3u1fbpfcp-zoom-1.image.png)

然后通过 vscode JavaScript 调试终端而非普通运行终端，运行对应的单测命令。

![](./images/c06c29c9e567412186e8c53edc333ef8~tplv-k3u1fbpfcp-zoom-1.image.png)

可以看到对应断点处就已经停顿下来了，并且可以在左侧视图层看到当前状态下的变量值，顶部也会有步进等调试的按钮，后面我们就像平时调试代码一样正常调试代码就好了。

![](./images/3ce534ab89fb4c62a7dd15f1ad60a11c~tplv-k3u1fbpfcp-zoom-1.image.png)
