...
![](./images/89f672a92bd52dff90156ee4b07a66a3.webp )

配置上我们选择 React + TS 就可，然后我们打开项目看看，可以看到，一个没有单测能力的项目创建好了, 我们可以打开项目看看。

![](./images/b3a64c37d5e3eeb374c315dfc9cdf3af.webp )
...
![](./images/91c896fcdc8210f3ed50f4628aff02e2.webp )
...
![](./images/54341a36c0fe09b76adb3ed3a9f38d11.webp )
...
![](./images/1f9cfed65f33a497d55ba67bfd336896.webp )

我们先来看一下 jest-config 的依赖配置，因为配置文件是 ts，所以需要依赖 ts-node 进行编译，如果子依赖中没直接包含的话，的确会有这样的问题。

![](./images/b37f711a7a3c297deac9fd4253e8c0ae.webp )
...
![](./images/46a23f4d29e75fc63fca8c64454e89c1.webp )
...
![](./images/69f97e0895b2d6b63de53caa559b0ff0.webp )
...
![](./images/4b12ec355749df2c13c5a7b14d2cce3c.webp )
...
![](./images/c6c8e6b8e2d2e4c9ee8a903a14f3efa1.webp )
...
![](./images/0e448a9279be54ccf49565ef38ead222.webp )
...
![](./images/e8c607047156d76e084ba18e9211bf6a.webp )
...
![](./images/266209e9aebdc897b2deaf7a8a7235d2.webp )
...
![](./images/d13bb8425bf6a11737c10f365c393c33.webp )

![](./images/a164beac5a566c18f83a092cce736ca0.webp )

我们再试试看，看看有没有别的问题。

![](./images/05b33d213a1265a9819767d9cb3fe619.webp )
...
![](./images/2faab3ad5022910946d7a738f71ae81b.webp )
...
![](./images/709d8e007b0772660e81271c40c0fb63.webp )
...
![](./images/89c9a794bf57e582669ee22c78af057d.webp )
