...
![](./images/8024a679c1c044138fee2a69b915395e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/9529158da9074c63a2bc93a4856b0181~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/75d19af8be9d4444a0ab8906760885c5~tplv-k3u1fbpfcp-zoom-1.image.png)

选择 E2E Testing，然后选择谷歌浏览器预览，最后会得到这样的一个页面：

![](./images/d32d5570ffda464e831a47de329edded~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/e226951531954aa6ab5a4fad06822ba4~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/6473057bf80f45e88b9b033d0263d0ec~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/488d781d75e44b53a64cc71427de6a4e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/959dec3c5a90405bbd79d75d9b9c64dc~tplv-k3u1fbpfcp-zoom-1.image.png)

这里它帮我们创建了一些例子，我们以 button.stories.tsx 为例看看写了点啥：

![](./images/5b9804aa147147a6ac1f02a8dfcdc9a7~tplv-k3u1fbpfcp-zoom-1.image.png)

首先是默认暴露的一些属性，这个决定了它的文档根目录，然后底下是调用这个组件以及不同场景下组件的入参，每个都会形成一个子目录，可以用于调试，我们可以看看对应 button 的效果：

![](./images/aad6620686264b59931f5339fd00014d~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/482ca6818bc8426c9caff792ee9d6718~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/38f7f8a9a0f14492a93c134bae8151da~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/0af1ab4b0e6144eda4018e916bbddc31~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/c4f91194327948dfa6d84e1478261ca5~tplv-k3u1fbpfcp-zoom-1.image.png)
