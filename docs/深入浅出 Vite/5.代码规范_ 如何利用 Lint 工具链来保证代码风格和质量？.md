...
npx eslint --init
```
![image.png](./images/c71cb725150d4e5c9d46539916047ef1~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/8a3d00d6cabd4093b7ce7121464d5bb2~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/fe73069469414debbef973c6a9f0f8ae~tplv-k3u1fbpfcp-watermark.image.png)
...
```bash
# 5.代码规范_ 如何利用 Lint 工具链来保证代码风格和质量？
...
![image.png](./images/7e0957eaa8d1444f98a80173502f2395~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/0380e4bb149540649fc8b5f7f8e71c6e~tplv-k3u1fbpfcp-watermark.image.png)
