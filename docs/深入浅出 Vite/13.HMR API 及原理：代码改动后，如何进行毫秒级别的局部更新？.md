...
![](./images/9e87c4aeb83945bb8a5c6a19a5980835~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/2b518a7964444dbe8d12c177b3ed59c6~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/5a3165aa161147fabcd3a41a5cda1a1c~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/9bd3ce3fb51d4c47b1f157075c6fc141~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/6142727d2162489c9e613341f5e4ca5d~tplv-k3u1fbpfcp-zoom-1.image.png)

我们在回调中调用了一下 `mod.render` 方法，也就是当模块变动后，每次都重新渲染一遍内容。这时你可以试着改动一下渲染的内容，然后到浏览器中注意一下`count`的情况，并没有被重新置零，而是保留了原有的状态:

![](./images/51fbe46db84f4d82ba073d8d8f0ec2fd~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/2309dff1019c40a1a1e5d072f3ed0dd3~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/3449473d985b42668d8628a726ae871a~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/c7e66edd02b3456fa45c47fd44bc2eb3~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/1628e31f424d4089ad9c891c8e739ebe~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/206543cbd39241aabea49c189740ec7e~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![](./images/6c72ca8f5cff463ba75a862f4a14f5e9~tplv-k3u1fbpfcp-zoom-1.image.png)
