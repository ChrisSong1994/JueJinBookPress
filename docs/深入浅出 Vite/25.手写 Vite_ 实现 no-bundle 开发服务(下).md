# 25.手写 Vite_ 实现 no-bundle 开发服务(下)
...
![image.png](./images/46823f9f56c6486bbf2ddc357aa5936b~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/c3dd1a0e85fe42c08f8dc5f05bb83867~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/c0b357d3958c459cbcc1c3d288cf97b1~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/b945967aca1d4fd6a8582bd85620c077~tplv-k3u1fbpfcp-watermark.image.png)

查看网络面板，也能发现客户端脚本的请求被正常响应:

![image.png](./images/1f2e2dbf2b984edfacec509e18321180~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/5f7d654bfa5846d29d3777afca63c5ec~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/8206aa36285c403085251b9d2d80baaa~tplv-k3u1fbpfcp-watermark.image.png)

现在回到编辑器中，修改文本内容，然后保存，你可以发现页面内容也跟着发生了变化，并且网络面板发出了拉取最新模块的请求，说明 HMR 已经成功生效:

![image.png](./images/556efb91f2024b76ab74ba8f62baf6b9~tplv-k3u1fbpfcp-watermark.image.png)
...
![css-hmr1.gif](./images/b85a27d44b4c471b98c7457424098d71~tplv-k3u1fbpfcp-watermark.image.png)
