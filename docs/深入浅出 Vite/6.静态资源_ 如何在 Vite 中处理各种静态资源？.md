...
![image.png](./images/da297ad3ee1de6f2a38ffac47a3f9e31.webp )

而图片路径也被解析为了正确的格式(`/`表示项目根路径):

![image.png](./images/e66f92bbd4396746d02930815598d054.webp )
...
![image.png](./images/f6b77bfa370c88466192e1042ed49e38.webp )
...
![image.png](./images/fc93c1dbfea5686013c107550eb88637.webp )
...
![image.png](./images/229a9ea6ff043a9abfe2286ea6f69351.webp )
...
![image.png](./images/5b20ff4cf4e2674ba234b0dd878ed89b.webp )
...
![image.png](./images/b8951dee8fc9cc7fa83a682b028bfdbd.webp )

当然，HTML 中的一些 JS、CSS 资源链接也一起加上了 CDN 地址前缀:

![image.png](./images/3513a6a11a40143039851aa72cc8dc75.webp )
...
![image.png](./images/5424e829916db5c43ad058d14a9de8bf.webp )


![image.png](./images/3a47fa54f48c8b93856d30f43ef7d45d.webp )
...
![image.png](./images/1849458dc0f34031e903337641051df5.webp )
...
![image.png](./images/0a43acf76f65a80d11961ea3cd04d901.webp )
...
![image.png](./images/3c2be30d6d52e8dff3922aa0b81e696a.webp )
...
```
`icons`的结果打印如下:
![image.png](./images/12deaeaeabc3314d9afbd2bcea6ec6a0.webp )
...
![image.png](./images/2ed346d72da1bbfd8d80b5817dd97387.webp )
...
![image.png](./images/57af8e95af16295f840185f1b69ed24a.webp )

雪碧图包含了所有图标的具体内容，而对于页面每个具体的图标，则通过 `use` 属性来引用雪碧图的对应内容:


![image.png](./images/fd7c82e7839bfd6c7579d8f5f8d33dbe.webp )
