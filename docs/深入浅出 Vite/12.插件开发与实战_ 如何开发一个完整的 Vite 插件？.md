...
![image.png](./images/66aca542bd1bcafed12b6517093fb8e8.webp )
...
![image.png](./images/72e9bc35e280d033fa76994a5dbc92a9.webp )

由此我们可以梳理出 Vite 插件的执行顺序:


![image.png](./images/caceb10f0a98f5683df5432825a92621.webp )
...
```ts![plugin.png](./images/a0d98c1044391817ad5853c5eaf818b2.webp )
...
![plugin.png](./images/c4bf2a88fe353085cf341e65b0e10a70.webp )
...
![image.png](./images/739d988aa0aac312a2aec97132df4e5d.webp )
...
![image.png](./images/d314aa21a59dd9d8197c30cc7536007d.webp )
...
![image.png](./images/a72d66286ab3dcfdbce966433ec2a7f3.webp )
...
![image.png](./images/53a0e99d745d0138cdddb4f81286f74e.webp )

你可以通过这个地址来查看项目中各个模块的编译结果：

![image.png](./images/dc48c0b585ddee625b8824e06bd646f9.webp )

点击特定的文件后，你可以看到这个模块经过各个插件处理后的中间结果，如下图所示:

![image.png](./images/bb2e161e3743f49b5dc8197b4d6fa972.webp )
