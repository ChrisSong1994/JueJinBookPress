...
![image.png](./images/339255d0cdba48a2832f720a895892c9~tplv-k3u1fbpfcp-watermark.image.png)

由此我们可以梳理出 Vite 插件的执行顺序:


![image.png](./images/83c255efbdec4c66971a30ff270c70a9~tplv-k3u1fbpfcp-watermark.image.png)
...
```ts![plugin.png](./images/a93a37e0e4344b97b55bd67afe51d511~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![plugin.png](./images/d06b07cd29434ec9af7f9ea3fd39cba0~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/216e84976e3c408cb845b64bf329943f~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/59c04f44a5334138ab722400c03c071c~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/ad0d1812f0ac49759d2f284f49502ea9~tplv-k3u1fbpfcp-watermark.image.png)
...
![image.png](./images/606340bc8b9b4f81be0b0ac22516f838~tplv-k3u1fbpfcp-watermark.image.png)

你可以通过这个地址来查看项目中各个模块的编译结果：

![image.png](./images/0e972fc35eac4c168872317709707e5a~tplv-k3u1fbpfcp-watermark.image.png)

点击特定的文件后，你可以看到这个模块经过各个插件处理后的中间结果，如下图所示:

![image.png](./images/d40c06d94c96412cbf9fc2dccf35d5f1~tplv-k3u1fbpfcp-watermark.image.png)
