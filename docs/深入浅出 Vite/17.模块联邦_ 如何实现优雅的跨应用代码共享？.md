...
2. 所有的应用安装新的依赖，并进行联调。
![image.png](./images/249ff99d0641300ba317863e12db3acf.webp )
...
![image.png](./images/079b976a9e99e44508c225a59d2e2fc6.webp )
...
![image.png](./images/84916f6170bb37fe56004e2540f8300d.webp )

值得强调的是，在模块联邦中，每个模块既可以是`本地模块`，导入其它的`远程模块`，又可以作为远程模块，被其他的模块导入。如下面这个例子所示:

![image.png](./images/62962c78394640f14fb2df5aab88b2f5.webp )
...
![image.png](./images/b4110eee318015ec9845e6fa706629fc.webp )
...
![image.png](./images/4c522d7d10c9a26d788762475478a043.webp )
