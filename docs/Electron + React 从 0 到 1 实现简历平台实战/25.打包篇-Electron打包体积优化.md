...
![image.png](./images/54d8cdc0873f79f7f76454e4d1a0a798.webp )

我们右键应用程序，选中“显示包内容”，点击进入到 `Contents`，可以看到一些文件夹。

![image.png](./images/887c3671889b74d7d22e8ae085cc37b5.webp )

比如这个 `Frameworks` 里面放的是 v8 引擎和 chromium 内核，我们看看它有多大。

![image.png](./images/5b211fd4eae43d115aa316ddc483fd4d.webp )

单单这个东西就占了 178M，另外的 40M 左右大小在哪呢？我们看看 `Contents/Resources` 文件夹下，有一个叫做 `app.asar` 的玩意。

![image.png](./images/d0effed68fcaeca61ad2892df0d3079c.webp )
...
![image.png](./images/1711e3f781942dd9ecb8a1b5e66200dd.webp )

## 优化方向

先来捋一捋，我们整个应用打包出来的文件夹是这样的

![image.png](./images/1e7f2da39178fde7d1cf2c391c8d3050.webp )
...
![image.png](./images/b29ed9c71133f2967a3aa3fba618cf76.webp )

再来测试一下，`dependencise` 依赖中有个叫 axios 的库

![image.png](./images/a65e85c92e347dc5d975bb250159bb92.webp )

在测试一下，如果是插件类的 `devDependencise`，是不是也会打进去呢？试试 `webpack-merge`

![image.png](./images/a0dda10cdf325ee5fa2c260c2e6a5b76.webp )
