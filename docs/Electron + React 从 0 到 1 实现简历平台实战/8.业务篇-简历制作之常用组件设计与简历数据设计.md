...
![image.png](./images/5c9942ca57adca62d58e9d61e5f765e8.webp )

以上图为例，我们可以将它适当划分，下图是划分之后的层级关系

![image.png](./images/54d31818a52cae78505a8a0aa49c7c81.webp )
...
![image.png](./images/7043801a69666030ab71f4c0abaa7993.webp )
...
![image.png](./images/519a3ae19a01bfb40cc3f3ffdd0d5dc7.webp )
...
![image.png](./images/63bc48e16472ce870bd8e58abc9fd99d.webp )

而往往我们都会自己实现一套 UI 样式，假设这里我们的样式效果为：

![image.png](./images/305a3c2bd3e01474d9dc1f6b65d32888.webp )
