...
![image.png](./images/d4ea306fdbeb6ebcf98cc860a1d35ec7.webp )

当我们点击“获奖证书”后，将其加到“已添加模块”中，此时简历模板会同时展示获奖证书对应的数据。同理，当我们删除“已添加模块”中的某个模块后，简历模版上不展示删除的模块信息。

![image.png](./images/350187adcb67952c8c5c434f0d3f7505.webp )
...
![image.png](./images/d8e730f39ecf0a256f72994f020368aa.webp )

### 从未添加到已添加实现

接下来我们需要实现，当点击“未添加模块”中的某条 Item 时，将其添加到“已添加模块”，并同时把“未添加模块”中点击的 Item 删除。如下图所示，下图是一个添加过程。

![image.png](./images/98653cb1d1fc762136f0d9c0ee1bce80.webp )
...
![image.png](./images/1723452da92956a3479003e3b446eb19.webp )

需要明确的一点是，我们在常量文件中，对于工具条数据的每一条都添加了 `require` 字段，意味着当 require 为 true 时，这是`必选项`模块，也就是无法删除。

![image.png](./images/b3e394b30e4c92439de9881bed7b4e69.webp )
...
![image.png](./images/6e002ab978746d12f755b7139c5945ee.webp )
...
![image.png](./images/3a0c4ae9c515a2fddd443e5f6afcc4d9.webp )
...
![image.png](./images/1d9ce7153d4e7dce86eb961a2d3398a9.webp )
...
![image.png](./images/ff670c49e516fd966f937649c736deb8.webp )
