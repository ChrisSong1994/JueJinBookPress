...
![image.png](./images/2f6b4b5e10ad9f88d270112c52453249.webp )

![image.png](./images/7f3a882d8b8bf3e3a6d64a531f45cc42.webp )

![image.png](./images/7b7b8193482e16994e6a9f9d3f79d9b7.webp )
...
![image.png](./images/34d1818107fe021f58042116034c0ab9.webp )
...
![image.png](./images/03099368e5c0ba1959921c5c8054cd35.webp )

我们去 `index.[hash].js` 文件中，查找一下 `base64` 关键字，只能找到 20 条记录

![image.png](./images/a0de977b3fbe5d02bf85224db0710487.webp )

- **url-loader**

很明显，dist 目录下的 `dist/images` 文件夹，一下子少了好多图片，现在只有 4 张图片

![image.png](./images/9345e13a76ba222987efda4e642e2be0.webp )

我们去 `index.[hash].js` 文件中，查找一下 `base64` 关键字，找到 28 条记录

![image.png](./images/2b3b70a2234891fb4dab6c77f10b451c.webp )
...
![image.png](./images/37c6482a5ca881309aa1cb75b2177009.webp )

通过 `terser-webpack-plugin` 之后，在第一次构建打包相对较久，但之后的构建打包，由于我们设置了 `cache` 以及 `parallel` 属性，时间变得更快，经过三次构建，时长均在 10s 左右

![image.png](./images/9d406cbd6cd6d00b95f9e2242fab79fc.webp )
...
![image.png](./images/f7638c56a36cc6e17dfc12cb09c5d117.webp )

giao ！ 反倒是时间被拉长了？这...于是我就去搜索，看看网上有没有什么方案，无意中发现有人遇到过着累问题，我丢，这坑爹了，开启多线程，CPU 上升，如果此时 CPU 满了的话，整体速度会变慢。

![image.png](./images/45d1e47c9f5cbd71384314ba53ffa0ea.webp )
...
![image.png](./images/97988943266fb0dc4759bd799382f0a8.webp )
...
![image.png](./images/47e0ddb5d966003afe5cc669a4cff25c.webp )
...
![image.png](./images/efa567099ab7b9db9e93b053f16e0677.webp )
...
![image.png](./images/a22882164bcbc0b5406b9dff49d31f45.webp )

感兴趣的可以点进去看看 `reacts.manifest.json` 到底是个啥东西

最后我们来看看通过 dll 之后的打包时长有多少

![image.png](./images/2e53a8233f68422d3e9b23cc40722fcd.webp )

![image.png](./images/c75a16de7f4c1046f94676950515dad4.webp )
