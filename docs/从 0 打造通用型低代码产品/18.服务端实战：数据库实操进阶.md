...
![image.png](./images/b163a0c52c6997c1de8043dda4af8b09.png )
...
![image.png](./images/5ddaeab1dfd1744ed8b3a36ee55cd8d7.png )
...
![image.png](./images/e2ee137c870b413f7f48eb5c9cdb70e1.png )
...
![image.png](./images/0a6ea731205ab76c8659a258ccba9536.png )

再次请求查询接口的时候，返回数据并未包含最新插入的数据，则代表缓存功能开启成功。

![image.png](./images/beb099a06675d0f2f68a8390e8e5099b.png )
