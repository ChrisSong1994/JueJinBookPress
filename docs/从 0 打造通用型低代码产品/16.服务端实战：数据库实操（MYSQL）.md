...
```
![image.png](./images/2fed63b90318d980bbc4bee8be378b4c.png )
...
![image.png](./images/b24ed34e01b26c0b4f9410c0e5d5be5e.png )

4. 其他通用的内容，照搬之前的 **low-code-test** 子工程即可，但将其他的业务模块去掉，最终获取的目录结构如下所示：

![image.png](./images/261a1ab30fe77235405596558a0118b9.png )
...
![image.png](./images/d0692c4c9f0d997c59d6a5e74f9140d1.png )
...
![image.png](./images/12f3acb63839fce4f9cbe3c40e9dac51.png )
...
![image.png](./images/3a824a70f8070c27f23e1e6d716565a8.png )
...
![image.png](./images/1e98a5aebf3d632c58e04b71df583e31.png )
...
![image.png](./images/d4181754e59d05e38d510337f30c2708.png )

4. 测试执行此方法得到如下返回结果则代表插入成功

![image.png](./images/217617c992788dd90e0ba19cca4ee3f5.png )

同时数据库应该也支持新增了对应的数据字段

![image.png](./images/b601709bace5708a498d25409011b197.png )
...
![image.png](./images/9911bc6d0339f593046e831f1be8d4ce.png )

查询单个：

![image.png](./images/9f2c01cde574c1154575f9783a67aedc.png )
...
![image.png](./images/14ff0aac5cf68b70ac4e3fdfa04b94df.png )


直接查询数据库可以看到 **id** 为 **1** 的数据已经确实被删除了。

![image.png](./images/8aa3869d4b719643b3923baf66213460.png )
...
```
![image.png](./images/8bd0638fea2e028c64fff0895dcf06a3.png )

> 注意，这里的 demo 使用的是 patch 方法，所以我并没有加 id 属性。

正常请求之后，数据库自然也会更新成功：

![image.png](./images/e95893f0a951d27f787841aad1c5c4c5.png )
...
![image.png](./images/c4f2d94c4e39d0a59715a8f383086431.png )
...
![image.png](./images/48feca0be1ac314171efac882ffee5b6.png )

新增用户：

![image.png](./images/fcaea9afa0b681a634ff0f44700b2e63.png )

查询部门：
![image.png](./images/56fc48a95c0736155c2ab6cc865b4648.png )

查询用户：

![image.png](./images/f665b081551648cfe4fe06ba5a640312.png )
