...
![](./images/cbe31309f09726b3d9e858f39b3e0c01.png )
...
![](./images/358ddd698b46f9eac5078a44ed031cc7.png )
...
![](./images/73568e4462cfc0d584d107dd138f46cf.png )

### 预览入口

首先，在编辑器中添加预览按钮，以方便操作。该按钮位于编辑器右上角的 **ToolBar** 区域，如下图所示。点击该按钮后，将会跳转至 `/preview` 页面，进入预览状态。

![](./images/b188a1e3925a6d2ebce2f9da5ac66fb3.png )
...
![](./images/d35045afde585a958635ecced79d272b.png )
...
![](./images/99fdf383503d33119e6ec959a1e7f679.png )
...
![](./images/8c4ed0ebb4a0ed13e680d1539117a331.png )

**预览界面**

![](./images/fc8505f2e9629cfcec45c13fc8a2c046.png )
