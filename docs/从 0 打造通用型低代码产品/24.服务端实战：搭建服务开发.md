...
![image.png](./images/ea5c163245c756b9b6db1da853355f35.png )
...
![image.png](./images/f1c1b1136bc18b232afc017d300dde30.png )

接下来我们按照模块来逐步介绍代码的细节。

#### Site

![image.png](./images/fa66c278f2a60f3e7a95a3a345cb7a16.png )


![image.png](./images/fb261f4f3d06721dc87638636777d00d.png )
...
![image.png](./images/93495dcd74a54a5df9dc93699eea4460.png )

因为我们有出码的打算，所以在项目中也引入了 **Nunjuck**，作为一个独立的工具模块，后期我们会额外拓展讲解。

#### Page

![image.png](./images/eb3ea8d8a049a10eb6f067809f49c4a6.png )
...
![image.png](./images/36b3a97f2a2d4e80e57d3eb99413b5f0.png )
...
![1705588624317.png](./images/f0e9664537ef4a4f40e0c4571fa86535.png )
