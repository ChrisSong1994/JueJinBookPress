...
![image.png](./images/428c9021b7715bc21ec55ae404bc446e.png )
...
![image.png](./images/3112f4abe47f816fc531cd7b8c374d44.png )

正常完成用户 **jwt** 注册之后可以看到如下所示，我们已经正常登录成功了。


![image.png](./images/db6be34a0fd8c8f7987b38b6e805e9ad.png )
...
![image.png](./images/46f54713b9ef3f3dfec8358d6485cbf0.png )
...
![image.png](./images/8d0f5f9290d01ccaf9bcaafa6e07c0ec.png )

用户系统的主要代码如下图所示区域：

![image.png](./images/b085fa2e455e42974d463e37f01a9568.png )
...
![image.png](./images/9d840a89170ae68134e472abc6015679.png )

#### 资源管理

![image.png](./images/57a9baa48a2d281364eded6a8a56779c.png )

资源管理的服务端代码如下所示：

![image.png](./images/65806715b77fad05e6aaf8567792b285.png )
...
![image.png](./images/2cde3566e3b2ad1f118708d377900caa.png )

权限的服务端代码集中在下图所示：

![image.png](./images/6628217e51286a5a7c2b5bde6063b886.png )
...
![image.png](./images/14117961fd1ce88b297e30030f30d86f.png )

这一块是最为复杂的一点，因为角色需要同时关联用户以及权限，所以整体的设计比较复杂，为了将系统的拓展性做的比较通用，我们采用的是 **role-privilege** 以及 **role-user** 关联表的设计。

角色管理的服务端代码如下：

![image.png](./images/3a028e6b19ddae17c0d65a588ee8ef3c.png )
...
![image.png](./images/cb776d5531812a0e1292b344aaa77823.png )
@Entity()
...
![image.png](./images/722519ba98c6b420b81905432c4904ec.png )

所以在用户授权权限的时候，其实是新增 **role-privilege** 表数据：

![image.png](./images/26eff4ef252897f22e6bb939b453677b.png )

再完成角色授权之后可以进行用户的角色给予：

![image.png](./images/ef5dcd7709f1d0e782da8928bf0af033.png )
