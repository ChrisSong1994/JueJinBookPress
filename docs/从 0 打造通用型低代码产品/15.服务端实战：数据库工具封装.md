...
![image.png](./images/ee6d763e963dc1e86304055a9b1a321d.png )
...
![image.png](./images/fd2c685dac93cc96ac99133183e3954a.png )

点击测试能正常得到如下返回值的话，则代表数据插入成功，功能正常：

![image.png](./images/21abdd1aa321b1c6b1fd001c220ea548.png )

查询数据库所得如下所示：
![image.png](./images/2961a11bf25b6a6848c046f805a5e0dd.png )
