...
![](./images/961824ea2881e35006df1198975c4d1a.png )
...
![](./images/c6a77a6c08d9cf02271e75e5176b30fe.png )
...
![](./images/95bfce1990533823682cdb530caf8ac2.png )
...
![](./images/7614cd2db2d6a5ac34a55e8786a0e48b.png )
...
![](./images/be21c314bb6df3b3aa61cd61974461c6.png )

### 状态绑定

当属性面板渲染结束后，这个时候切换表单内的属性是没有任何效果的，因为编辑器的状态与表单的状态还没有进行关联的流程，也就是下图红框中的步骤。

![](./images/75e32c64e21d0b3949fcc376abf99cfb.png )
