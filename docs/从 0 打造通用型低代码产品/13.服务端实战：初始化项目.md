...
![image.png](./images/a5000641537f76e6dbf10b108a4a5ea1.png )

如果你本地没有对应的镜像，则会开始拉取对应的镜像。

如果想后台启动的话，则使用 `docker-compose up -d` 脚本，启动完毕之后如下图所示：

![image.png](./images/984e5657acd0f8fde19d3894a816ef2f.png )

如果出现上图的问题，代表此镜像与 **M1** 芯片不兼容，最简单的解决办法就是切换 **mongodb** 的镜像为 **mongo:5.0.0-focal** 即可。

![image.png](./images/b479d21b974c68d73f23cbceaf000019.png )
...
![image.png](./images/8c134bc80bb948cf20fafefa28d42fba.png )
...
![image.png](./images/df65c3ac65b48443ac082d8f396a85c8.png )
...
![image.png](./images/206bcd9ee4fd69b7fcbe2cbeb759126b.png )
...
![image.png](./images/80832f80a26fd890f857bd09d1a4a210.png )

项目目录结构如下所示：

![image.png](./images/ea6d9939017fed3bbcf28c02786df35d.png )
...
![image.png](./images/997a681b3421ffee61dae9273cdf6184.png )
...
![image.png](./images/960c77f6860c54705a377383ab6ff6e1.png )

新的目录结构如下所示，`devops` 与 `low-code-test` 两个工程都被收拢到了 `apps` 目录下：

![image.png](./images/efcdc5f518865aee445f0da353ae2ae3.png )
...
![image.png](./images/525dc7cbabc0d121806896d91edf292f.png )
...
![1684657269109.jpg](./images/cde9acbe0d46dff2faee2705fe84b1cb.png )
...
![image.png](./images/fec6aeb4f3bcb83749e3c8d8533cbf03.png )
...
![image.png](./images/df2e9247b08ce8babf4ab40b7b5a229a.png )
