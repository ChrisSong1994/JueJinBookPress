...
![](./images/56fd1068c9c74a099f8f935a6757dab6.webp )

diff 算法是通过同层的树节点进行比较而非对树进行逐层搜索遍历的方式，所以时间复杂度只有 O(n)，是一种相当高效的算法，如下图。

![](./images/6fe366b4395c39b65a048323c4a1e530.webp )。
...
![](./images/3667a909da03747b94f971853460e918.webp )
...
![](./images/a774934a59600a9e149dc0b89e06c59a.webp )
...
![](./images/cf9a79d628560ed1edac56e41b1fb62c.webp )
...
![](./images/29623c1293db3cb79f039228e3febce6.webp )
...
![](./images/251e26da21316dadb50f1b90a66053ef.webp )
...
![](./images/d0c7f320bb3d69e33be4234dc9f60a97.webp )
...
![](./images/d4917e7bf64dda114bbae42ec8177a6b.webp )
...
![](./images/71d5d971b4a49032c5321b557a322061.webp )
...
![](./images/31948949021e53b93607861edf4351ce.webp )

同理，如果满足 `newStartIdx > newEndIdx` 条件，说明新节点比对完了，老节点还有多，将这些无用的老节点通过 `removeVnodes` 批量删除即可。

![](./images/8e5fbfaed5dd17516d83d1ac5d070ad1.webp )
