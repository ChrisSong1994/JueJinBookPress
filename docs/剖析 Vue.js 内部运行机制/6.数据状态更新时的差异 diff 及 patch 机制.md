...
![](./images/1609be691ed64525~tplv-t2oaga2asx-image.image.png)

diff 算法是通过同层的树节点进行比较而非对树进行逐层搜索遍历的方式，所以时间复杂度只有 O(n)，是一种相当高效的算法，如下图。

![](./images/1609be700a80c98a~tplv-t2oaga2asx-image.image.png)。
...
![](./images/160b707df4902029~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b70ecf5967f0a~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b71f5a48631f4~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b7228b9ecb23a~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b723af0fd706a~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b72ae720954cd~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b73aa8f758342~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b73f50ed43932~tplv-t2oaga2asx-image.image.png)
...
![](./images/160b7457cae26687~tplv-t2oaga2asx-image.image.png)

同理，如果满足 `newStartIdx > newEndIdx` 条件，说明新节点比对完了，老节点还有多，将这些无用的老节点通过 `removeVnodes` 批量删除即可。

![](./images/160b744a2c07257d~tplv-t2oaga2asx-image.image.png)
