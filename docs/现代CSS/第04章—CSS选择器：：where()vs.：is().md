...
![img](./images/289de5c3dd72b9f5a10a01150137e309.webp )
...
![img](./images/5cef0e468aa96fa505e23fadc2667c88.webp )
...
![img](./images/7bd97a1ab5c41b16b69f674ef7e36393.webp )
...
![img](./images/90c7c72a321494b6fb063b8dfa109259.webp )
...
![img](./images/b15277eb4e3989c9cf2def3b4c9c96ee.webp )

很明显，`#bar` 选择器获胜，它是一个 ID 选择器。如果将 `p:is(.foo, #bar)` 和 `p.foo` 两个选择器来对比：

![img](./images/0facfd1342b6d034ac10b6b95af458b2.webp )
...
![img](./images/31d8dbd8e0a960706162c2c093da577e.webp )
...
![img](./images/2d8cdd46fd0e645fb836b831beb2cf45.webp )
...
![img](./images/505fbc7a7614d9d9e1ce890d748a2202.webp )
...
![img](./images/ba8303817cd742d5da018e94d08fe4a3.webp )
...
![img](./images/b78d9892b1e5dcb616d5e40aed9faa1a.webp )
...
![img](./images/d49a71c43c9a0184fdc2c033ad9d83e1.webp )

就这个示例而言，第二条规则和第三条规则的选择器权重是相等的，但第三条规则位于第二条规则之后，因此第三条规则的获胜，所以运用到 `img` 的边框颜色是 `orange`，而不是 `green`：

![img](./images/2e4de47d16e2ea6f553d7f57d3d13cf9.webp )
...
![img](./images/e52954073cb55c0cd534bf04d9021072.webp )
...
![img](./images/32d3e997eae06f17c59c33b81a7503a1.webp )
...
![img](./images/fa4d80c16a3f4b8ab01b9af580b6b626.webp )

> Demo 地址：<https://codepen.io/airen/full/ZEqybYE>

正如你所看到的，现在按钮的背景颜色始终是绿色。这是因为 `:where()` 选择器使相应选择器权重变为 `0` 。

![img](./images/0082935acc87d741c763444074f9941d.webp )
...
![img](./images/757b88399fb09dfe6b47aaf01388a18b.webp )
