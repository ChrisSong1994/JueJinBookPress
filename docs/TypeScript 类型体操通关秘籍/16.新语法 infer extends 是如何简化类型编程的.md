...
![](./images/746d8240e9e9ba1ecaaf9370527f059f.webp )
...
![](./images/54e1788534400ecf5fcf5d891b9ff850.webp )
...
![](./images/dea7768fd6765d553c45d7bfb1df5517.webp )
...
![](./images/c86115aa999b5cb3f0a0024272f04546.webp )

从 string 数组中提取的元素，默认会推导为 unknown 类型，这就导致了不能直接把它当 string 用：


![](./images/ad32e17209d818e3549fa8d55fba8ee8.webp )

那怎么办呢？

之前的处理方式是这样的：

![](./images/2447e9c5616fe367f2f2a7601ef2acbd.webp )

加一层判断，这样 Last 就推导为 string 类型了。

或者也可以和 string 取交叉类型：

![](./images/d368bbfaef6b8578ecd6058d3d18fed1.webp )
...
![](./images/02c781ee294cda85009151ee89830b87.webp )
...
![](./images/aede855755058e47604329ed7b63842e.webp )

而 4.8 就是这样了：

![](./images/0eb39648bce8823d4483ff32d1c7f50a.webp )
...
![](./images/e3a3688b188f998b4b3b98db3a3357b3.webp )
...
![](./images/3e46572b857c3833ce5045d01bde4af4.webp )

这就是 infer extends 的第二个作用。

处理 string 转 number 之外，也可以转 boolean、null 等类型：

![](./images/ad7aeedd9ac536cedffc4dfe1febb28a.webp )

![](./images/f3d41a77ddeb799ec66533160f06a565.webp )
