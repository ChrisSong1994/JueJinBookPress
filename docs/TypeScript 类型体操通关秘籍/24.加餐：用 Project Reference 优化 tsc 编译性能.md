...
![](./images/c9692ed27abb319d0041533622d7b94c.webp )

它们是用同一个 tsconfig.json 来配置编译方式的：

![](./images/a4414c7ed59dbab1963bc3b4dfd29a97.webp )

执行 tsc 就会编译所有 include 的文件到 dist 目录下：

![](./images/93e6c94c5799e5d75777a556cbdbc35c.webp )
...
![](./images/1ecc9c5360552a04c9549760a2aac190.webp )
...
![](./images/5691786f96fedaeb57f9987bd4b0af74.webp )
...
![](./images/2ef8b21bd61529c90c361f7683c16b6c.webp )

之后为了优化编译性能，换成 tsc 的 project reference 的方式了：

![](./images/6da813d042d7d49e4282c7ea11b69b07.webp )

![](./images/93e41d6948fcb7bf2ded674b895a9a4c.webp )
