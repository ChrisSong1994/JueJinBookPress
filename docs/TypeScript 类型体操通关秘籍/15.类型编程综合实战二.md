...
![](./images/bbff4e87a74861cab87a6e88b8eb0c02.webp )
...
```
当传入 number 参数时：
![](./images/01f82fcf6bad3f9d22ba162ce65dc765.webp )

传入 string 参数时：
![](./images/ba3f349a1a9e1d7cbcd3973e725f78e0.webp )

函数可以用 interface 的方式声明，同样，也可以用 interface 的方式声明函数重载：

![](./images/9ef5981469de0da2929372848f1d77e6.webp )

函数类型可以取交叉类型，也就是多种类型都可以，其实也是函数重载的意思：

![](./images/aae85ab56200de3eff35af3075672946.webp )
...
![](./images/63354a21e734f69cb1c0fbfe4f2c2ef1.webp )

第二种重载方式：

![](./images/f3968121d75430cee7ed3bcfc2230ebb.webp )

第三种重载方式：

![](./images/eafdf696461fef9e6cadfd5110e701e6.webp )
...
![](./images/dbe6c79b2e804328fee8c88f092ada81.webp )

然后再通过 ReturnType 取返回值的类型，就取到了联合类型的最后一个类型：

![](./images/11f4614aef3ad01959c07dc562af8b08.webp )
...
![](./images/8a8115567961c44ba1606024da3af729.webp )
...
![](./images/0b6a9acd46631b694ff6d2ce5a22790d.webp )
...
![](./images/6aed76b6017cb145821f0714dfe1d5fc.webp )
...
![](./images/878c3a379467a193d30247ca2acf5f15.webp )
...
![](./images/450e4c6de3ac83b5d63f780a3e545b54.webp )
...
![](./images/0d42fb03db609891a0ac4219caa21c92.webp )
...
![](./images/9e60775edca3d5ad93f351aa2b0a3bd6.webp )
...
![](./images/e1002f1712bc7a59997814a4f4b318c9.webp )
