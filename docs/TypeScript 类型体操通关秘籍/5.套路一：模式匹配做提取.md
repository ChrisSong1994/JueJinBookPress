...
![](./images/f9d2a178ef6cf1151e7082b2b8b1d676.webp )
...
![](./images/ba88eead3608337e771dd1a2abaa5e6e.webp )
...
![](./images/7df7679fca836c3df8e9b2d3175bcde2.webp )

当类型参数 Arr 为 [] 时：

![](./images/65691595720a41c490f0cd9d7c1621ce.webp )
...
![](./images/537bbf9356187b0621a3ddbc38001221.webp )
...
![](./images/0bbc99e824ac34f9f3b12afa275c4ca9.webp )

当类型参数 Arr 为 [] 时：

![](./images/b43ccf51064e9e806a1509f00e140adf.webp )
...
![](./images/50152556d46089c446a7097ad720d7de.webp )
...
![](./images/538564a8da6200a1e0bb057b01bcb3b0.webp )

不匹配时：

![](./images/2957377f2462aad4b50199cb89780795.webp )
...
![](./images/fc2165fdc3581b6f49ebe0cb6be19d1f.webp )

不匹配时：

![](./images/0147d8a16539df61d22112bd89ab7a90.webp )
...
![](./images/23041626800679a3f046f4d83b3b0db3.webp )
...
![](./images/57fbb03c231fa3412c261f71236ece70.webp )
...
![](./images/5442681323d2220bcfb304fc55d98de7.webp )
...
![](./images/57da10f149e2dea0f8f42b0cdd6362a8.webp )
...
![](./images/2145ff2686285ec14cc7385afa073b80.webp )
...
![](./images/f9b6a3b7046c129b0bc56c26df3a10a5.webp )
...
![](./images/c73803c9e14c91c25931ab85e22dc71b.webp )

如果没有报错，说明没开启 strictBindCallApply 的编译选项，这个是控制是否按照原函数的类型来检查 bind、call、apply

![](./images/7db2a40e8cb42a817708d492799e9878.webp )
...
![](./images/03d279222772abf10a3dd509154c901a.webp )
...
![](./images/80f71573ac6fdcaba1da0ebfd6a66742.webp )
...
![](./images/984377de14f8e2f1ac6e461a7de3287a.webp )
...
![](./images/578d4e954c5a7b28d20b19ac87010e76.webp )
...
![](./images/743106c15f2e5691effd6eff6f419499.webp )

在 ts3.0 里面如果没有对应的索引，Obj[Key] 返回的是 {} 而不是 never，所以这样做下兼容处理。

如果有 ref 这个索引的话，就通过 infer 提取 Value 的类型返回，否则返回 never。

![](./images/2450470e114801bf6fddbc289cb7ae61.webp )

当 ref 为 undefined 时：

![](./images/f613c8300c5050acbe3f25604fff8f09.webp )
