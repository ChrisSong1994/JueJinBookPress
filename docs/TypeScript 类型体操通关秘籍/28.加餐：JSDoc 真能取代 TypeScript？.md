...
![](./images/861d6c9f93151a44bb60c328704132e2.png )
...
![](./images/34e6bafed71e960061d888e4020fa077.png )

在代码的注释上加上类型的标识，然后通过 jsdoc 命令行工具，就可以直接生成文档。

比如这样的文档：

![](./images/a9ed55d46169e6234c4a57506376b35c.png )
...
![](./images/4c8984e68dfdceb02f74b1e7c9a6443c.png )
...
![](./images/0acb353fa9144ea8f43dc041542d17f2.png )

这里注释里的 @type 就是 JSDoc 声明类型的语法。

在 vite 文档里，你可以看到对 JSDoc 的支持：

![](./images/6a8ba2e42aff35997f81757426ff184e.png )
...
![](./images/3ba1dcec517ff71a64e822eaaba4246a.png )
...
![](./images/e892ae9b0d823bc83d7e43388c9fecd8.png )

生成的 tscconfig.json 太多注释了，我们删一下：

![](./images/e7254881e1a14d3c3372bffdaaed3091.png )
...
![](./images/d8b4994c8864aeaf0c5c1ef5729d3d35.png )

在 tsconfig.json 里 include 一下：

![](./images/329996bd79579ca999f52b6a70012dc1.png )
...
![](./images/323910105dd6ee43242a6b77be1e991e.png )
...
![](./images/4f13afafa04dcefb03bd47bf79cb593b.png )

需要在 tsconfig 里开启：

![](./images/e609de671bed5e00f3defb97891f2828.png )

allowJS 是允许编译 JS，checkJS 是在编译 JS 的时候也做类型检查。

开启后你就会发现，js 文件里也会做类型检查了：

![](./images/be60647cdd3ca295efeae405140c7977.png )

hover 上去的时候，会提示类型信息：

![](./images/32256b29bbf3d11e6c5300b369fc9fc0.png )

注意，这可不是用 ts 语法声明的类型，而是用 JSDoc 写的。

然后我们开启 dts：

![](./images/3c984d8a3de061e068ee6bd8463688c1.png )
...
![](./images/cf2d8b9e9d5ea541ebead108c9c60781.png )

而这时候产物的 JS 代码和源码差别不大：

![](./images/b3f734730ee7999502b9c54d48085bc6.png )
...
![](./images/804174b26450a2f2f7834aabd1a1b347.png )

这里可以是各种类型，比如函数类型：

![](./images/944640a9dddcb5b2bdc6f9da3517e0da.png )

如果类型被多处用到，可以用 @typedef 抽出来，单独命名：

![](./images/9ce2ce426fbdbf9e744492e2fb302de2.png )

你还可以把这个类型放到 dts 文件里，在这里 import 进来用：

比如我把它放到 guang.d.ts 里：

![](./images/f22a69e53f392ca6c124d6878b371cd8.png )

然后这样引入用：

![](./images/7471048dfdc0dedbd326097b82031989.png )
...
![](./images/5c7609d24a3cbddea7fc09ad5884c368.png )
...
![](./images/1f1c88ad03f24994d4e8edff6e832ad2.png )

![](./images/bf6cce25dd2f71a7ef27ea5d4772db48.png )

通过 @template 声明类型参数，然后下面就可以用了。

泛型都可以用，那基于泛型的类型编程，也就是类型体操当然也可以玩：

![](./images/8ea30ee865a484438916acb77f15542b.png )
...
![](./images/2d329632e3d6c5c1494bd89a16035ed3.png )
...
![](./images/72cc9e090f59843c54173859330b138a.png )
      
![](./images/9758e7ca9c991370f445eccbf8c9f545.png )
    
![](./images/2850a86e4eda5f7fb779fee0934d1db6.png )
...
![](./images/3f6577b51b03162a6ccb7f170619f70b.png )

直接看官方回复：

![](./images/2b2509ffae463adac8963c1517059b45.png )

![](./images/be783b32b0d76e40b459222171df5f21.png )

![](./images/f698a88bf083267c96adc336a17930a4.png )
...
![](./images/6f6c372aa74f232edd66c589ed050038.png )
...
![](./images/7f7bafaf085638ac67f9b91aa15df84c.png )


然后复杂类型在 dts 里定义，然后这里引入：

![](./images/426e39dbd9da07055dae75deed368334.png )

![](./images/7bcc1e200d808f09256373451d7bfb80.png )
