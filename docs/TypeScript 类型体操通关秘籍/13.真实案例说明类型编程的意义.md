...
![](./images/8444b9f14235bd7884efdde85c648120.png )

如果要给这个函数加上类型，大家会怎么加呢？

大部分人会这么加：

![](./images/59ed63e64b18c21e1041b26f0e2ffcc5.png )
...
![](./images/59f4276440c2e7038b84f0a6465ef92e.png )
...
![](./images/307587d7f7e9bcb6478c17d730003bc4.png )
...
![](./images/85f5a218e98004528ba70092ae636589.png )
...
![](./images/11ef9517f94c32ba1750f437e909c73f.png )
...
![](./images/e413361867156bd423a94bd0ab69fb1a.png )

所以要把不满足条件时返回的类型改为 Record<string, any>：

![](./images/ee663c324f2e0b5a9d6a163980ed8917.png )
...
![](./images/2d5aff5300c5f5325fa635f1657e9933.png )

vs

![](./images/527b4ce4ab0f5626b0bfde9e3885addb.png )
...
![](./images/bbbd842cb26a36486322c63e00aa3d8c.png )

![](./images/4d51fd37c6ed86e33027daf610f1bada.png )
...
![](./images/1faf8b77f45eca070dff52edb13a86b1.png )
...
![](./images/ff7a1f056c2227b308f425cd8733aac7.png )

加上 as const 后：

![](./images/113346fc4229d44119de62b1700c2839.png )

没有 as const 时：

![](./images/6b7a329fc4712db866a9c27d592d574a.png )

加上 as const 后：

![](./images/b5a6316c81ab3c1c8d19d93411a13166.png )

这里类型参数 T 是通过 js 函数的参数传入的，然后取 typeof，也会遇到 as const 的这个问题，约束为 unknown[] | [] 就是 as const 的意思。

![](./images/9e2efdcb1d06686506dfe1c7f6e495e0.png )

![](./images/9c643f420f16fbb668896b7908b3c3bf.png )
...
![](./images/0d4d6e9ffb9645ceefa60b580c216e44.png )
