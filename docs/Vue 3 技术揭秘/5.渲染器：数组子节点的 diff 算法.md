...
![image.png](./images/37839d2ac4b39a7ca91f17f1b8877ac2.webp )

第一步执行时，会完成对 `a` 和 `b` 头部这 2 个节点进行 `patch`。当 `i = 2` 时，由于此时的 `c` 和 `e` 节点的 `key` 不一样，所以退出了头部比对流程，进入尾部比对：


![image.png](./images/49dcbbb9e2d88d9c69002b4e78a9db9a.webp )
...
![image.png](./images/0255fe4982af84a1e66d553d32ac0240.webp )

第一步执行时，会完成对 `a` 和 `b` 头部这 2 个节点进行 `patch`。当 `i = 2` 时，由于此时的 `e` 和 `c` 节点的 `key` 不一样，所以退出了头部比对流程，进入尾部比对：


![image.png](./images/f0aa770258aba6807f5a067071322068.webp )
...
![image.png](./images/7ba3c3956b37bc3f0134340ae92eabb9.webp )
...
![image.png](./images/a5477c82b92f1275ec9feeccaead675c.webp )
...
![image.png](./images/59c1931dc6a8ccf41349e376f87fa58f.webp )
...
![image.png](./images/277686d5160ba14fc9b978428e8acf5f.webp )
