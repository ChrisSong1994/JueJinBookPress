...
![image.png](./images/6f30eeefa5f0b132250e30122c6788f0.png)
...
![image.png](./images/645730487c5ed9e8aaf65ad3669956c6.png)

如果想要查看 Chrome 浏览器的进程运行情况，可以通过右上角的**设置 / 更多工具 / 任务管理器**打开：

![](./images/0233086d2f0a108f4275d5f30f47be2e.png)

打开以后可以在任务管理器的列表中查看进程情况：

![](./images/2fd0b13df4c8fea7cd50e8d77040744d.png)

## 浏览器沙箱隔离

由于 Web 应用运行在 Renderer 进程中，浏览器为了提升安全性，需要通过常驻的 Browser 主进程对 Renderer 进程进行沙箱隔离设计，从而实现 Web 应用进行隔离和管控，如下所示：

![image.png](./images/7d9f2c0a9051400411e96b6e0d1a42a1.png)
...
![image.png](./images/aa11165d220f7cef3a11789d15e1aaa5.png)
...
![image.png](./images/d76515ffb780e123c7df638738b27480.png)
...
![image.png](./images/4c77bbfba660310ecc53ffcc6055a683.png)
...
![image.png](./images/46a6d7023b42ca04d43bdcfe122b2154.png)
...
![image.png](./images/57b808d10ec5fe204e69db81e17eaad7.png)
...
![image.png](./images/31d0a36211580b9627eaadded7220d93.png)
