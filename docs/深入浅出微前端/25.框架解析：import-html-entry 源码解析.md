...
![image.png](./images/f5c0891e59c0d86a471c89a3cd3ae9d2.png)

上图中的**微应用 Fetch 加载逻辑**会使用 `import-html-entry` 替换实现，如下所示：

![yuque_diagram (53).jpg](./images/6ad8a0cc23312ac4730f1efe36c27bc7.png)
...
![录屏2024-06-01 10.49.55.gif](./images/13ab426d3a1b3e9e4d80e5af67db477c.png)
...
![image.png](./images/8a1b6398057c50ae56b83f75266d6d9e.png)
...
![image.png](./images/2067871042c570fd3fdc2b86807eab5f.png)
...
![yuque_diagram (55).jpg](./images/8f2ab5d01f6cad8b283c5bb1431676f5.png)
...
![image.png](./images/bf7a31380963858260c0cf2a0a52841a.png)
...
![yuque_diagram (59).jpg](./images/061a5db0e61978ea5e601a34e182f3a9.png)

> 温馨提示：上图中的绿色区域实现提取外联 `styles`。

其中通过正则匹配 `<script>` 标签（包含内联和外联脚本）的执行流程如下所示：

![yuque_diagram (60).jpg](./images/8b8ec50d64113b65a8778a9c1cbc374f.png)
...
![yuque_diagram (61).jpg](./images/6679432d6f0dae536b0da63c83e3ea2c.png)
