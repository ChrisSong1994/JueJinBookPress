...
![image.png](./images/1dd344114f75d64693aca8c5d4dc63ce.png)
...
![image.png](./images/b649395648d69dccc4a64e0081e53852.png)
...
![yuque_diagram (12).jpg](./images/949ecd43bf76a9dee049c22125d78af4.png)
...
![yuque_diagram (33).jpg](./images/9d245ea887f79258a6503031faf4db3c.png)
...
![yuque_diagram (45).jpg](./images/10e24b92aacadc53c0aea61b80200ae6.png)
...
![GithubActionsCI.gif](./images/58b2ea1b03830b653240fc8f31125b09.png)
...
![image.png](./images/335027e90e09e1bdf2492c87efe121ac.png)
...
![image.png](./images/86b77616de9c23ca0cbe0cd342dc66f5.png)
...
![image.png](./images/15761c41676286760b2983428053aa63.png)

在规则中我们会进行 Pull Request 操作，因此在 CI 流程中我们可以增加 Pull Requeset 触发事件，当开启 Pull Requeset 时自动触发 CI 流程的执行，如下所示：

![yuque_diagram (46).jpg](./images/6c3ffb6130a6e64fe664956d191e6b82.png)
...
![image.png](./images/04a934561614d49842a1fad7d6794391.png)
...
![image.png](./images/afce87941f5465760a417b5a5e48daa4.png)

如果希望 CI 失败可以禁用 Merge Pull Request 操作，那么可以对保护分支的规则进行如下配置：

![image.png](./images/1f0d2cfe846aa5e561c0bf33f6d8a33a.png)

> 温馨提示：通过在搜索框中输入 CI 的 Job 名称来搜索对应的 Github Actions 工作流程。

此时如果 CI 失败则无法进行 Merge Pull Request 操作：

![image.png](./images/2d7454675fefefc29d4d11764d3acc84.png)
...
![yuque_diagram (44).jpg](./images/3e3f94c30c95c2158950f1074436aa4a.png)
...
![image.png](./images/64cbd411dd4673c37650ddccbc14626f.png)


- 第二步：前往 [ADD REPOS](https://coveralls.io/repos/new) 开启项目仓库的 Coveralls

![image.png](./images/70563986aaf21e7912fbcdef7417a908.png)
...
![image.png](./images/d8de946b4e4cc47be067f4ef9eeaa85f.png)
...
![image.png](./images/96e7a9a9c58d870cc5c7af2da46bf98a.png)
...
![image.png](./images/310fa7cb3de5f1a7b8439052981fd8d4.png)

由于本课程需要执行 CD 流程，因此可以创建一个 **Automation** 类型的 Classic Token：

![image.png](./images/064beb3291a0ecd50f62a7b2f806650f.png)

创建完成后需要及时复制并保存 Token 信息，因为刷新之后 Token 信息会被隐藏：

![image.png](./images/8bc6a9dc92018d4c14dadcce382e272b.png)
...
![image.png](./images/6e0b59c3300409449791453747c2cc6d.png)
...
![image.png](./images/af3ae2e6346d2874d2bd93b72e9698ec.png)
...
![image.png](./images/c86b85584301e8fa8b42f6a7bb3cc638.png)
...
![image.png](./images/789dcfca18b4a5c79d7ea9429beb314d.png)
...
![image.png](./images/03730f56d86bc1c7f956dc3520e32c5d.png)

发布成功后，我们可以通过邮件来查看版本发布的信息：

![image.png](./images/068a5b821cb4fadc2d46643a599ce4d7.png)
