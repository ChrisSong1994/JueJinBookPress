# 2.又一次 Hello World：TypeScript 开发环境搭建
...
![](./images/ad9de4c50d9dcdc0b1f084fca766809d.png )

在打开的设置中输入 typescript，筛选出所有 TypeScript 有关的配置，点击左侧的"TypeScript"，这里才是官方内置的配置。

![](./images/d30553fa85d21244ab7562530a51e039.png )

补全搜索词，使用“typescript inlay hints”：

![](./images/1e5fd330d09a05d60aed4adc71d262a2.png )
...
![](./images/8c197f878d7a8f1f4a293931457cfb77.png )
...
![](./images/c6383a40d43e2c56fc0e057dcad54478.png )
...
![](./images/29a04f3ad3d474d40704497913950646.png )
...
![](./images/0ded8930e3ef5ffe42bc52caeba6c945.png )
...
![](./images/76ac0d60576714b7a11d5189bbd74df3.png )

编译行为会随着你的代码变更自动执行，无需手动操作，但是如果你希望执行编译后的 JS 代码，就需要通过 Command(Ctrl) + Enter 的方式了：

![](./images/f703bdac2fd90b59df7442db21d92e05.png )
