...
![](./images/ca95afa9e11bb1da0e9c2b6f89f42205.png )

![](./images/b75188ec89cf6711aebebd239654e7b8.png )

浏览器直接访问文件路径的 URL：

http://localhost:9000/aaa/ground.png

![](./images/6740b3de7191c3a1764c3ef334fb1343.png )
...
```
![](./images/d9d766f98fc3513aead207757f78d50c.png )
...
![](./images/6fc0e5bac01654f0369c19fb1b29680c.png )

![](./images/248733d6f336e6fab666aa3d8d07b5b1.png )
...
![](./images/2e5480de8586c1be7fee8bd28def9310.png )
...
![](./images/d56faf73c3ae9909dd653ba8e6fc5031.png )

点击上传的时候遍历文件，对每个文件路径调用服务端的 presignedUrl 接口进行 url 签名：

![](./images/d726367299623f83f0aaab89f4f770a0.png )

之后用返回的 url 就可以直传服务端了：

![](./images/d4be8fb573889b551a963fd1c46bcb7f.png )
...
![](./images/74a1b41bdb3076e2cb6b7e2eacb7bb6e.png )
...
![](./images/a226b063970ecf9a9ac47c4025091c43.png )

![](./images/53ef04e9af9e9615500cd30778dbab22.png )

上传成功！

看下 url 签名之后的样子：

![](./images/3f3de9020c912579c516391e598e67f9.png )
