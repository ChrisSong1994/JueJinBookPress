...
```
![](./images/d5963d2e93c8f927978d43961db84a4d.webp )
...
![](./images/eb087f71dfe98648de820e1440cd0422.webp )
...
![](./images/20ca4ace1153c1e3a353eb7ba5cba8df.webp )

![](./images/202b7b43b2a9f549209faf0af9eb475b.webp )
...
![](./images/11ae6bf31de8e0ce8d0f3442be69b3b8.webp )

在 mysql workbench 里可以看到创建好的 user 表：

![](./images/6dbf2c9fa44213bb9e1ac6416f521cb0.webp )
...
```
![](./images/073c551406bb67d65ea2bc48a45af764.webp )
```
nest g service prisma --no-spec
```

![](./images/6223d59c428b658efd3e810ec0b722ee.webp )
...
![](./images/e7a67b5f310c385a73902b407dc7c350.webp )
...
```
![](./images/186afa977a54d34c87da8d143823ab05.webp )

在 UserService 里注入 PrismaService 来做 crud：

![](./images/59addffffe47be17f7e7acca00e68609.webp )
...
![](./images/ce6a03c519e64a7088e81d1922303eb1.webp )
...
![](./images/c97fa0140804fe1a1c6fd7d085407895.webp )
...
![](./images/d5a2c188de9f8b8813a707441777538f.webp )
```javascript
{
    "username": "guang",
    "nickName": "神说要有光",
...
![](./images/c8d5cdb51d1c4a46aabfa9f3056a4afd.webp )

数据库中没有 captcha 的字段。

我们要在调用 service 之前删掉它：

![](./images/dfcb3b348e0f80c35188599c25bbc598.webp )

再试一下：

![](./images/75b45c1fd76d668064955fdf2807b1ad.webp )

服务端打印了 insert 的 sql 语句：

![](./images/4af914e5a0858316188b2ec857fde56b.webp )

数据库里也可以看到这条记录：

![](./images/2b30171c19fcb3b75aa0b5d7acd8113c.webp )
...
![](./images/5353e5a69ea327fffc3b52845e9e35b2.webp )
...
```
![](./images/298343ceeee1ff688fa701946933fe1e.webp )
...
![](./images/872acb916fe18ba79605cad2de8b9f5f.webp )

因为还没实现发送邮箱验证码的逻辑，这里我们手动在 redis 添加一个 key：

![](./images/aac42e4039a8f71704f03500a53fc5d5.webp )

![](./images/80a29ad889274a2103c93afff57cc0f8.webp )
...
![](./images/d52e325ff7589d768ccc542646d45efe.webp )
带上正确的验证码，注册成功：

![](./images/2333e52ac1a0d79db6e9249d89965e64.webp )
这时可以在数据库里看到这条记录：

![](./images/120969d4f84c48f1825066a9aa3675c8.webp )
