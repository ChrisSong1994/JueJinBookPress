...
![](./images/205a88db82cb8f90e1938281a19c86e6.png )

![](./images/2a71190e6a74f84c38df30b126e8e377.png )

![](./images/a178fc12d97294e266a11fcd243e6f40.png )

![](./images/de5194dcabbbe57e60b03b0d0bd51505.png )
...
```
![](./images/08fea4d85ffb52b87354fd5b46b93ddf.png )
...
![](./images/f8637bae16b1965544511276a2f838b4.png )
...
![](./images/836d935913063d222f833ea3a4eb6836.png )
...
![](./images/46c4401aaf6124c5e010a84d0a1904f4.png )

![](./images/0c4522b3eaff94530aa0be40eec926fe.png )

![](./images/69ca865dc50ff745083cfc725318f077.png )

![](./images/a878945fa4509b52e7f9b187672c32f2.png )
都没啥问题。
...
![](./images/81bfa82ea91bd6af1899d780633fa61f.png )
...
![](./images/9909d72a82736275c9d15d64ca1a1a5f.png )

然后看一下接口文档 http://localhost:3005/api-doc

![](./images/f0af24a0eb54d22fd90e86cd8f08ae59.png )

![](./images/ff47bdbcf25d99b09ad38b4a37fc795c.png )

传入用户名、密码、返回用户信息和 token。

在 postman 里测试下登录接口：

![](./images/30ba65eb7ed823e1b4f2de2da4913694.png )
...
![](./images/c24d44e867d50d583580a793779979d5.png )

![](./images/0b9335758a5b208f65c0de02ac4bf2dc.png )
...
![](./images/96c37eeec874170fa49fcabe871d5eb2.png )

当密码错误时：

![](./images/82edf5d1b8319688a2149754fa5153b8.png )

登录成功时：

![](./images/a86055539ad94757caf17cfd4e9baf44.gif )

![](./images/f79b5767bc0960bad7ac034b3f779a4c.png )
...
![](./images/04d649501c8a8331ffccf7d0a7e74c8b.png )
...
![](./images/71285fde869fbd3a8a4dc82ea8e19af6.png )

没啥问题。

不知道同学们有没有发现，其实这个页面应该是三级路由：

![](./images/f8245d1445a2939c36dec80b02e3d60b.png )
...
![](./images/af9fcc75c8ecaa147ffe440bb386529f.png )
...
![](./images/d4dc0ebb939e260da9629e3633228611.png )

然后来写 UserManage 组件：

![](./images/5a0f39e8d8fd93690699137d826c2d61.png )
...
![](./images/ae47839421fbf4c50b0e60daf685a7fe.png )
...
![](./images/8a924a7c376f5f998bb566fabfad9741.png )

然后我们调用下搜索接口。

看下接口文档：

![](./images/2ad62a07666e780a56fae8a02356b3db.png )

![](./images/8daff0b7db7bf851d3b432df47e7f8de.png )

在 postman 里调用下：

![](./images/3689f4950608fccbdea6ce3b2cba2ed7.png )

这个接口是需要登录的。

我们先登录一下：

![](./images/f02d50de002b7d7fda7b5f5dd9cf2ad1.png )

带上 access_token 再访问：
![](./images/20ca3e26a44e9c8fd386655f4abf9fab.png )

![](./images/493cfc4787060b4f9025776f4c949b9f.png )
...
![](./images/7b08eaace5ed3cd3911288af15c24bcb.png )

测试下：

![](./images/5456c9d28e275a08ad69b416b97858d0.png )
...
![](./images/b08470510869931756fe2a4843d247a4.png )
...
![](./images/0853518545d519cf31c4ea8e0b9685c7.png )

看下接口文档：

![](./images/49fa4ab94944e08a7ece2d570683716c.png )

很简单，就是个 get 接口。

我们在表格里加一列：

![](./images/b2e66bb0e5177b175d32f5564ba0a328.png )
...
![](./images/c2953e1b91a8754c7ad446afed4dc98d.png )
...
![](./images/ce1da7212d262e7c4414bea7023f9fc1.png )

需要添加一列：

![](./images/3abafe97820f5724438236d76a8e87de.png )
...
![](./images/b14d868dd4af617bad9792b37b17de0d.png )
...
![](./images/86160729df9715228d8c2579ad31382e.png )

freeezeUser 也是：

![](./images/a29770a6b1419f47e2614933d05a5faf.png )
...
![](./images/322e761f6b5add9e27945b2db0bf237b.png )

把它添加到 useEffect 的依赖里，这样就能触发重新搜索：

![](./images/7f22fe843141dc1fd8b9f9ce37e047d8.png )
...
![](./images/5f8cdafcab884ca72e1f3fcee4955ad8.png )

然后在搜索的时候拿到最新的表单值：

![](./images/385822b6e22595a3987cde7ab6e41e73.png )
