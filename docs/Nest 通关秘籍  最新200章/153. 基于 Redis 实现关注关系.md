...
![](./images/7d22b6b6ddb18b6e52cd05311c1a7609.png )

![](./images/62ca5f6811ac0f292cef7629da2a5c9e.png )

![](./images/cc2b43130621d0fb955b93924aa1cdc4.png )

![](./images/5749612ef3a233b74ac8fd3260ee9d9b.png )
...
![](./images/e783c1e5a6e0f1d05f0c859cf2a08d42.png )
...
![](./images/2fd96634c26660b446e1bb57139d6556.png )

然后返回关注者或者关注的人的时候，用 SISMEMBER 判断下用户是否在 follow-each-other:1 这个集合中，是的话就可以标记出互相关注。

思路理清了，我们来写下代码。

![](./images/80476f33d0c127cb7a9ee4febdc74f28.png )
...
![](./images/34f75f73b73185cec37fb51ec3b6ea08.png )
...
```
![](./images/b9098c3d70cfa83a48cdc7028d2e4d2d.png )
...
![](./images/7d792d97d7af27e6112993dd259ca330.png )
...
![](./images/01223950d50986df568eafe09655ef22.png )

在 mysql workbench 里可以看到 user 表和 user_followers_user 中间表

![](./images/25c6859705980d188ac9a580c6d4ede5.png )

![](./images/0075569dba8204ecc57db640e0b62b15.png )

我们在 UserService 添加一个初始化数据的方法：

![](./images/5cd19923bb1f8e9d054b54b553843c27.png )
```javascript
@InjectEntityManager()
...
![](./images/db415acd2c723b7f4e6eca0c2bc2f058.png )

打印了 6 条 sql 语句：

![](./images/48135e35fe5c961db5b62d4ffeacd2a3.png )

在 mysql workbench 里看下：

![](./images/2491c81448351a4532b4f0a296fa596f.png )

![](./images/f0f00ae730e2aceb3448b81cf01f2446.png )
...
![](./images/05af2381295e5498b70c83a7bfa3a7ae.png )

传入 userIds，查询对应的 User 信息返回。

![](./images/b3d2650e3e95e9ade1acb6f1c5cce885.png )

根据 id 查询用户的信息，关联查出 followers 和 following。

如果 follwers 或者 following 为空，那就没有互相关注，可以直接返回。

![](./images/6d7925b24dda71e911a5fcda72e716a7.png )
...
![](./images/cd4fabfd61f2c6e497cd4990f64398af.png )
...
![](./images/9fc2efe55b5063f9046daccd159c5406.png )

结果是正确的。

在 RedisInsight 里可以看到这三个 set：

![](./images/4ef489e12f85091657449132065049c8.png )

逻辑比较复杂，我们调试下。

点击 debug 面板的 create a launch.json file

![](./images/c3ef63ba00a2420d0353ce214f90603b.png )
...
![](./images/0ada52569bda2298f8fd0a1310a8c60d.png )

点击 debug 启动：

![](./images/d68f136510af81876570624eb601a3aa.png )

浏览器访问下：

![](./images/2cdf2e00556ad46049487c0cbd9127a2.png )

可以看到，它走到了 else 部分。

在 RedisInsight 里把这三个集合删掉：

![](./images/675d20e0723a7208eae78d9b2b585e4f.png )

再次访问：

![](./images/da5c1100922421182e7353483fe7605b.png )
...
![](./images/97c3bf429d848b870f8d94c9b3df2989.png )
...
![](./images/d60ee64d482a2f16bb9f100ddc0c852f.png )

可以看到，数据库和 redis 都更新了：

![](./images/23e8d4624e6b43366c5ccc87128b645e.png )

![](./images/b03ad5ccdd7b834bb3e97d8b952daf9f.png )

![](./images/cb6522177d9b2507366686e947fa9c6f.png )

再次查询下：

![](./images/9b51143375e1765ccdc32d650360e8dd.png )
