...
![](./images/f9b6f2aab11c2c0caf74bc1b1ad4d844.png )

填一下启动参数：

![](./images/cf9cc8ff75cda1059837b80b6643ecde.png )

指定环境变量 MODE 为 standalone，也就是单机启动。

启动后可以看到打印的一个网页地址：

![](./images/27f5f85af40de7aadc1a769be5d35c5d.png )

把 ip 替换成 localhost 就可以访问了：

![](./images/8511030fe19715a15053e26572ca5bb3.png )
...
npm init -y
```
![](./images/835cd874b42e65681cec0d9056730235.png )
...
![](./images/560720f93599f22ce4254ed2dbe1c692.png )
...
![](./images/e6604af895dbcf763a921ad97ab7dd3c.png )

然后我们去 nacos 的控制台页面看一下：

![](./images/ecceb101bb00b6818c9a542b1bad0cc0.png )
...
node ./index2.js
```
![](./images/9161d1a4b78e337c7cf8e733501214a6.png )

现在 aaaService 就没有实例了：

![](./images/9298832ea0f7438536626c15b37aa6aa.png )
...
![](./images/b8502ae6e39662bc2d8c496e5831e204.png )
...
![](./images/016f7d9c24e382af5691dc26dd5f503c.png )

之后再跑 index2.js 去掉一个实例。

![](./images/b25b9a081012862493587fee186245a2.png )

这时候在 index4.js 就监听到了这个变化：

![](./images/33170c92f67a914b18a03613dca42247.png )

![](./images/dbc10950fb48846f3ab9ad76db95a97e.png )

当实例改变的时候，就会调用回调函数，传入现在可用的实例。

在控制台页面也可以看到，确实只有一个实例了：

![](./images/21a58b47467b81ef517a901029c03d90.png )
...
![](./images/2f4ea270e7d3fe33b58bab874b6b6ba7.png )

跑完之后可以在 nacos 控制台页面看到新增的这个配置：

![](./images/d58918972e1818cef9ef1ff4e5827a48.png )

![](./images/404bcbd80cdafa49efc02ab0618f2528.png )

然后试下查询：

![](./images/941206b2980cd31defb5da6b96e8fbca.png )

再试下删除：

![](./images/f699d7d7751e26840d5dfc3dc078383f.png )

![](./images/832f3ca5ff9db8594cb8e7ed1266b10f.png )

最后试下监听变化：

![](./images/b16c7a633a43068be2f4799fe7c8fdb4.png )
