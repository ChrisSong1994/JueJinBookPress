...
![](./images/33c5dfb2c21762ba4b9fa7361491667a.webp )

对应的路由我们前面写过了：

![](./images/34f90ece91a280afa68362a60407d082.webp )
...
![](./images/22fe1d5ea5ba84c2a04a305e75f0efca.webp )

根据这个指定表格列的定义，并且添加分页的处理。

其中涉及到的 User 和 Room 的类型从其他页面导入：

![](./images/25e6d357c418f0cc7b9dd28d6b719661.webp )

![](./images/4140089b06d575270a44e2724acd17e2.webp )

![](./images/653d6a340d2452b65e51a4caac4455fb.webp )
...
![](./images/c6505d1147e7a13ed5c6f74e503f75da.webp )
...
![](./images/245962a0fdd55db1004d02ed3f267cc9.webp )
...
![](./images/4e65677e56da2b3dc0fe25598296e079.webp )

数据库里就这 4 条记录：

![](./images/4cd5ac204a1d32cd5b4ab6e495439a55.webp )

然后带上参数搜索下：

![](./images/841137b85f0d66468d29c7b0ad9f4f1a.webp )

![](./images/1755ceb0b19284bf25707774fa6e42d7.webp )

![](./images/a89d24d905c538b46c14cb7ad36b86e4.webp )

开始时间在 2023-9-29 的 10 点到 11 点的预定有 3 条：

![](./images/05db3ce806e86847bcf8d7922fce446b.webp )

11 点到 12 点的有 1 条：

![](./images/90f67d23a8359ae6ade0691c0a4e4c68.webp )

这样，列表功能就完成了。

可以再加上个按照状态过滤，这个是 antd 的功能：

![](./images/1828e8565461f8623f6b5139f6071ac9.webp )
...
![](./images/e4ce243e4e6f8f37c157e303c77a4fe7.webp )

![](./images/cdfc0cb41e8f348a6f0412f782ac83d3.webp )

然后加上右边的按钮：

![](./images/441d457106489f1b4387396581909f57.webp )
...
![](./images/b99d083d84eac1d7082c609d64215855.webp )

![](./images/8a7462d590db82c64ce9b3a3244ea042.gif )
