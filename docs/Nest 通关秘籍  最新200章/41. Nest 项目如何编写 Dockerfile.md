...
![](./images/b86845fce26e79c2ba594299a0b85ed3.webp )
...
![](./images/e60d50b77792da6bf4878f213458d27f.webp )
...
![](./images/1407c12d1770f26d3e8cc0b7e28b9d47.webp )

然后就可以在 docker desktop 里看到你构建出来的镜像了：

![](./images/5187f08570dbb79183d6600d3c5a6649.webp )

如果你 build 的时候报这个错误：

![](./images/7a7ed00af46d8c9c5a87b9c30bd5cc17.webp )
...
![](./images/4cfc9c5cfc86c4c82cb969d7c3ef0ab3.webp )

点击 run 把它跑起来：

![](./images/078ea434d956721d91601794a8209d22.webp )

容器跑成功了：

![](./images/6ed85e0e9f39a48254cdad7237e7102a.webp )

浏览器访问下也没啥问题：

![](./images/a9ca81a0018ec4d86156322277a60e8a.webp )
...
![](./images/d1c48fb028746533b61925e714d087a5.webp )
...
```
![](./images/01bcfc61f2ae45848a38fba74a3619fa.webp )

把之前的容器停掉，把这个跑起来：

![](./images/def76de7dc35c710000b118efd707d11.webp )

这次用 3003 端口来跑：

![](./images/ba615888231802534c505f831a7c5df5.webp )

![](./images/b7afbfc52b2dc7d9937343cb8756b9d3.webp )

浏览器访问下：
![](./images/92766e4f84bf671aa517f26a927744cf.webp )

nest 服务跑成功了。

这时候 app 下就是有 dist 的文件、生产阶段的 node\_modules、package.json 这些文件：

![](./images/dede415e0c8dc52e8b2f0a82dc7a7733.webp )

对比下镜像体积，明显看出有减小，少的就是 src、test、构建阶段的 node\_modules 这些文件：

![](./images/50256e7426934f4db4ca12012afc47b4.webp )
...
![](./images/e86bfea0d25cdfde3aae4d13540b4e6c.webp )

可以看到现在镜像体积只有 277M 了：

![](./images/77b91af1fdce83de530a06e3a62cc0fc.webp )
