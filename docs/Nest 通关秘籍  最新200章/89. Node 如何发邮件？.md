...
![](./images/f9fb9c33d7998e1647f802738dc25952.webp )

![](./images/74a500cfba8763d0b7c7f0f0836d149b.webp )
...
![](./images/855407f3500dc310eebcdf41d26a59ab.webp )
...
![](./images/1902410b98caea2f44404f46ba272fbf.webp )

开启后可以在设置里看到：

![](./images/a557954f80db4c9f5aadb20308b29507.webp )

然后在帮助中心页面搜索授权码：

![](./images/6d0cf2c3b4cdb781afaadd8b77991b46.webp )

按照指引生成一个授权码：

![](./images/2efcf32af7902a2a469f0095fa528bc6.webp )

这个是 qq 邮箱特有的一个第三方登录密码：

![](./images/a59e403f9384ccef9123ad7771077f86.webp )
...
![](./images/8f6db6b58f2746747bc91bf2dd06878c.webp )

可以看到邮件发送成功了。

我们在邮箱里看看：

![](./images/4e302b2e35c961c75d7fe78579354a6e.webp )

确实收到了这个邮件：

![](./images/6a4f9dcc0e9d419adeaa948359e472b8.webp )

这样我们就用 node 发送了第一个邮件！

而且邮件是支持 html + css 的，比如把我之前写的一个 [3 只小鸟的 button 的 html](https://juejin.cn/post/7167355169934409758) 拿过来：

![](./images/f95206c3e3d4aceee9bc60d95a02d23f.webp )

放到一个文件里，然后发邮件的时候读取这个文件：

![](./images/e53b17202acb51b292108be48fcd42e0.webp )

然后再跑下：

![](./images/e4c155b5edfd760285dcc8c39b3234d3.webp )

收到的邮件也渲染出了这个 html，并且 css 动画也是正常的：

![](./images/cef447c9376169e758d9c02b86217207.webp )
...
![](./images/978225e8a39d63df13b080e726fdd2e7.webp )
...
![](./images/256c1ffe963de595c7d99ed6cf91a7a9.webp )

可以看到打印了搜索出的符合条件的邮件的 id，然后我们来处理下这些 id：

![](./images/263dc77765ff365935fdb59b3aa0de75.webp )
...
![](./images/fbffb4108f679c7674e6252f1b436613.webp )
...
![](./images/d8f99a1b4d91201d6a1af258a7cbadfd.webp )

日期也确实都是 7 月 10 日的。

我邮箱里有这样一个邮件：

![](./images/09154fa7401978d2822dab7ddedb195a.webp )

可以看到，附件也下载到了 files 目录下：

![](./images/344da9fb3b6392cd6cf852b5235aa00b.webp )

我们把 html 的内容保存到本地文件里：

![](./images/d64cff166a65255148d9039d312f68d1.webp )
...
![](./images/72b3eb20ff32675aa0ce6e9d8710d6ef.webp )

在邮箱里可以看到也是这些邮件：

![](./images/38bbc127e9f8e63409bd1ad22361e119.webp )
...
![](./images/e92017bb0f450aa2a15269ecb2fdc45a.webp )

![](./images/4f1a7c16ae939c6c1832755e1a8ef029.webp )
