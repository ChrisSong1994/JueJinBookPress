...
![image.png](./images/5a9f5a664335c5959980ce98b7a74c9f.webp )
...
![image.png](./images/833b4600bb40599e1e1f24d64fbcc4b9.webp )
...
![image.png](./images/7a40de683a3b1efbb93007c87ed67eb5.webp )


![image.png](./images/8194556ae6dcc37fa3e5b2d182fde7a6.webp )
...
![image.png](./images/7b472943cdca51f164aa3f879d87ea10.webp )

现在只返回了 id，我们返回下详细信息。


![image.png](./images/50aa1bcc491946da372931c94bde0b0d.webp )
...
![image.png](./images/11d6ee599a3f048c91e0c46ce289eb4a.webp )

这样就返回了排行榜的详细信息。

加下前缀：
![image.png](./images/2c4e970464b7831ad3de7f4179023e68.webp )

![image.png](./images/a3cca11eff05c9b5dcdced935ec54674.webp )

加一下 AuthGuard 做下登录鉴权：

![image.png](./images/a4ebe3247d6a5e99ee2c188085f9d3b8.webp )
```javascript
{
  provide: APP_GUARD,
  useClass: AuthGuard
...
![image.png](./images/6d7a5a2b3e50104a7dc3565b69148397.webp )
...
![image.png](./images/5c1e5d476a1287055f47d0ad78ccaaa3.webp )


![image.png](./images/6a3365226f9b25c3f7715da30c100538.webp )


![image.png](./images/f2f902cbafcbfd90bceea5774d5bed24.webp )
...
![image.png](./images/12db4e546e5b80db06058fe9992d895e.webp )
