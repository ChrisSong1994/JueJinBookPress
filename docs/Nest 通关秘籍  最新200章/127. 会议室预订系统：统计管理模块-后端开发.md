...
![](./images/a7bd9121dcbf6dba74f93f7e10d438b8.png )
...
![](./images/266328c5c2b0e286e241c3aaf6ce7231.png )


![](./images/48a0df7ae8282b747d1aa829417bd51c.png )
...
```
![](./images/c2ec5b8d32bc44ec3eeb962180c24c5f.png )
...
group by b.roomId;
```
![](./images/f90faf92f88df3ba68ebdff414214fe9.png )

把关联的表换成 meeting_room 就好了。

当然，现在的数据不是很多，我们添加一些数据：

![](./images/6c43799f039442ca4380fc480e87f1ad.png )

直接通过 mysql workbench 的 copy row 和 paste row 快速复制一些数据就好了。

复制出来的数据要改下 id，以及其他一些信息。

![](./images/b67abb4b565093ee3f4d6c5b40b92164.png )

我添加了 4 条数据，并且指定了不同的 userId 和 roomId，点击 apply 应用修改。

然后再跑下那两个统计 sql

![](./images/5e9e2f92a6171d9c3e40989ec90b3fde.png )

![](./images/e91a17a71d3082c863aba98640028709.png )
...
![](./images/120f4780263a9c45df5d950050c7cb29.png )
...
![](./images/5e6549485a53e5db8f1f47a3d82e8b04.png )
...
![](./images/5f564254def44d010f33c1bf06ab1bf2.png )
...
![](./images/0a0ff56ea31a37ae829fc9f2708ea536.png )
...
```
![](./images/44db062222e62e570e3efdd49f16c25d.png )
...
![](./images/3d3a73ef63af2b8accb327a90b7413a7.png )
...
![](./images/672b08ede010c7cf2d3a9f121c65d37f.png )
