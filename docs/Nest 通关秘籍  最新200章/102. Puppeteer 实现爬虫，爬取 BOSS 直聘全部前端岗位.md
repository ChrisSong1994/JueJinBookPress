...
![](./images/19b4c7a7da37171086aaab58948a8677.png )
...
npm init -y
```
![](./images/95e4c2ca1443bf482a3d1304f7d83bc4.png )
...
![](./images/59d763e0c37a47d6fe5f0e3aa9210eb6.png )
...
![](./images/bbe0365648e72dc7d4fbe6c00e8bfdd3.png )
...
![](./images/ce2cadb77d4fe4c622091115f6d94400.png )
...
![](./images/30fa2866be2c27c60778dc445ccb6b69.png )
...
![](./images/bbe7f52e78ef276fac6356e65a7f80d4.png )
...
console.log(allJobs);
```
![](./images/bbc70e6aa912873ddb2bc7623be2ac6e.png )

具体的信息都是从 dom 去拿的：

![](./images/277cafde6d2f75ed7364a280b5964703.png )

跑一下试试：

![](./images/5d47744d66999db3f746f8ca715bd64f.gif )

![](./images/0ee6358713f62e289577c91f6b78a4c5.png )
...
```
![](./images/49ddc00c43941ad75b469389357b15f0.png )
...
![](./images/e4b34a203c0fd597fa959f6a01d9a2f9.png )

指定名字、字符集为 utf8mb4，然后点击右下角的 apply。

创建成功之后在左侧就可以看到这个 database 了：

![](./images/df0a88fd258db7f531bac8b68d0a1870.png )
...
![](./images/6131b53e6eff6f8572b7eb2bf5fca3b6.png )
...
![](./images/70c945a8d41dec545ff84ec84248c813.png )
...
![](./images/e689d7be5472ea4512234cfde7a05166.png )

![](./images/2fc449022f0d150c5e0fbc28cc054352.png )

然后我们加个启动爬虫的接口：

![](./images/e4188a5e56ed862ac48007bf042305cd.png )
...
![](./images/5e27bcb45cf84dc96c9e1a5105e6e967.png )

![](./images/affcf886115a81886265e1febc13165d.png )

爬虫跑的没啥问题。

不过这个过程中 boss 可能会检测到你访问频率过高，会让你做下是不是真人的验证：

![](./images/0b6e98f967f56706018c033f193082a8.png )

这个就是验证码点点就好了。

然后我们把数据存到数据库里：

![](./images/1bac6660694ae6cb1334f03da6ab2abf.png )
...
![](./images/ec0457899705cda4c7b377c4b839b5c1.png )

![](./images/7023a07af9603bfad28f2e073e3357f4.gif )

去数据库里看下：

![](./images/39fda5dcd6117102e2982b3a47dffe79.png )

![](./images/174daf0b5a4d730403c030af0ed2282a.png )
...
```
![](./images/9d2490ad58ac92aa9b8f15eefc99a084.png )

这样，爬虫就做完了。

如果想在前端实时看到爬取到的数据，可以通过 SSE 来实时返回：

![](./images/d8d89c8f845eebdf4c12b2c01b0b8ebf.png )

这样用：

![](./images/cdbdce5b62a8470f198a5fdf9f7b02ae.png )
