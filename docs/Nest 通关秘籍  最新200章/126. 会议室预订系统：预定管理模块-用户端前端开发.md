...
![](./images/20d27de5d6422fc0a6c85ed6bc82464d.webp )

这个页面就是一个列表：

![](./images/7046c4d6a5d8e7e9991709492ae88745.webp )
...
![](./images/61ee37af8827044d94785e7a125574b0.webp )

和后台管理的页面差不多，只不过这里没有 user 的搜索。

我们登录的时候把它放到了 localStorage 里，所以这里从 localStorage 取就行：

![](./images/a89f67105161432857a9349551b10364.webp )

![](./images/9679bc3670f12d74562615d665471e6a.webp )
...
![](./images/9a522defa10dccaeaac5b7ce4412b3ee.webp )
```javascript
...
![](./images/248fd8a15296865923725f7dce64ebd8.webp )

![](./images/426866fe120130707416914faa03086e.webp )

然后加上下面的表格：

![](./images/ac29b6095f00625b91b1a91cd5135649.webp )

![](./images/0ed73a5958422064844abbe49cae206c.webp )
...
![](./images/0f5ba5cfa651e550d31000733735edb4.webp )
...
![](./images/22be3291800ddc926423992e0feed8cb.webp )

![](./images/112d317c41b8da9aa4c16c32faba0fec.webp )
...
![](./images/5174d709ea2dc23aa201cdc3ce00c2c3.gif )

没啥问题。

如果没有合适的数据，就手动去数据库里改一下：

![](./images/34ead49226a95c941551744c4598e0d5.webp )

接下来，还有一个添加预定的功能：

![](./images/b9151133b10c0f7267ea635371825df5.webp )
...
![](./images/2f296ce40461d792a13e0e3af577cb00.webp )

添加 isCreateModalOpen 的 state 来标识弹窗是否打开，并且记录点击的是哪个会议室：

![](./images/cbc09a92baa26ca89c5ed4f364ed47f2.webp )
...
![](./images/13cd19a7adb3fc86649aa3163013bae1.webp )
...
![](./images/f01691e7a073bd37fa8d214d3be2eba1.webp )
...
![](./images/c4d9ba4d74d4f62d9fb7f683df712390.gif )


然后在 interface.ts 添加用到的接口：

![](./images/2ad67f8132ad7ebc730c6700a490e057.webp )
...
![](./images/8e37a142e0ce1a68ec78d40f5a6bbccf.gif )

![](./images/2451cfae04d78260124f00f85e759e34.webp )
