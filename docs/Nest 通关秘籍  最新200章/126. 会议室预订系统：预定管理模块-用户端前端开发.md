...
![](./images/20d27de5d6422fc0a6c85ed6bc82464d.png )

这个页面就是一个列表：

![](./images/7046c4d6a5d8e7e9991709492ae88745.png )
...
![](./images/61ee37af8827044d94785e7a125574b0.png )

和后台管理的页面差不多，只不过这里没有 user 的搜索。

我们登录的时候把它放到了 localStorage 里，所以这里从 localStorage 取就行：

![](./images/a89f67105161432857a9349551b10364.png )

![](./images/9679bc3670f12d74562615d665471e6a.png )
...
![](./images/9a522defa10dccaeaac5b7ce4412b3ee.png )
```javascript
...
![](./images/248fd8a15296865923725f7dce64ebd8.png )

![](./images/426866fe120130707416914faa03086e.png )

然后加上下面的表格：

![](./images/ac29b6095f00625b91b1a91cd5135649.png )

![](./images/0ed73a5958422064844abbe49cae206c.png )
...
![](./images/0f5ba5cfa651e550d31000733735edb4.png )
...
![](./images/22be3291800ddc926423992e0feed8cb.png )

![](./images/112d317c41b8da9aa4c16c32faba0fec.png )
...
![](./images/34ead49226a95c941551744c4598e0d5.png )

接下来，还有一个添加预定的功能：

![](./images/b9151133b10c0f7267ea635371825df5.png )
...
![](./images/2f296ce40461d792a13e0e3af577cb00.png )

添加 isCreateModalOpen 的 state 来标识弹窗是否打开，并且记录点击的是哪个会议室：

![](./images/cbc09a92baa26ca89c5ed4f364ed47f2.png )
...
![](./images/13cd19a7adb3fc86649aa3163013bae1.png )
...
![](./images/f01691e7a073bd37fa8d214d3be2eba1.png )
...
![](./images/2ad67f8132ad7ebc730c6700a490e057.png )
...
![](./images/2451cfae04d78260124f00f85e759e34.png )
