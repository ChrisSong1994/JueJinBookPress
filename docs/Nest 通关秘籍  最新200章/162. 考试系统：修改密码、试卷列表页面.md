...
![](./images/4e0e75b6ca125c9f3bad67dc2fc68e73.webp )
...
![2024-08-26 11.05.14.gif](./images/4a308778105bc1cd2f90ffe834ef9742.gif )

填入邮箱，点击发送验证码。

提示发送成功。

![image.png](./images/6b5ff41a6cc3b581daf6f9020d97d137.webp )
...
![2024-08-26 11.06.48.gif](./images/8ef49d215b18171174b8fdad3fc032a1.gif )
提示修改成功，然后会跳到登录页面。

在登录页面用新密码登录，提示登录成功。

![2024-08-26 11.08.11.gif](./images/389dd12c5f578b000d664c2f8e9ec1de.gif )

这样，修改密码功能的前后端就都完成了。

然后来写试卷列表页面。

![image.png](./images/35be5efcf96562af158a7e6e19927fa3.webp )
...
![image.png](./images/5ea7610e0bb7b66480a4281a21f4544e.webp )
...
![image.png](./images/9545f595628c6909d3d550974e45ab41.webp )
...
![image.png](./images/17903f533bf16ff232906ba5add99ab8.webp )

然后在 ExamList 页面调用下：


![image.png](./images/aa456de017c7d3ce5396e4a81e84717f.webp )
...
![image.png](./images/6fc0e0c37693ef9d3cbe1c5c05b47033.webp )
