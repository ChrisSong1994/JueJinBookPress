...
![](./images/66f751568242422a106272bf7cba910a.png )
...
![](./images/eb6ac84d6e47b834b66e69f79be01e47.png )
...
![](./images/ffa725224fd31e8e4537e64c37f8c7fb.png )

刷新就可以看到这个刚创建的存储过程：

![](./images/a1ce9301b81389aab68eb811f04bac4d.png )

点击第二个图标就可以传参数调用：

![](./images/68f78198ad8a24ca779b06fce1760680.png )
...
![](./images/76cca4d38404e57395c48bdaf585078b.png )
...
![](./images/0340cf4b996066ba716d6ae1be9d0281.png )

之后之后再创建 function：

![](./images/cff85a53451f29cc1f3dcaa0b53f172a.png )

创建成功之后就可以在 sql 里用它了：

![](./images/39bf7067b8f17ca47d78241572274567.png )
...
![](./images/b5f2337b1d4945fe7bc7c6d70671a958.png )
...
![](./images/77f1546542c25e81c5be08654ede13fe.png )

你也可以可视化的调用这个 function：

![](./images/fe61ca21fb069bc80a8892abdd6bdbdc.png )
...
```
![](./images/1a89a47ed4c45844c7306c7c2509c0ba.png )

我们自己来算算对不对：

![](./images/9f04aba8e23a41d4d8ba4586054c6f76.png )

id 为 3 的订单的总额是对的：

![](./images/8f95042d61579a44b20f0f4216512d50.png )
