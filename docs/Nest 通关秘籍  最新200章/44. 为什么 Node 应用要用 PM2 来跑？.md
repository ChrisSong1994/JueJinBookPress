...
![](./images/1c66c45dcfdb2df72caff4ec68a39604.png )
...
![](./images/ca17451013ebc9547420b32e65db61b9.png )
...
![i](./images/c2a50b4929c175292258b83346942b12.png )
...
![](./images/81fb693a2e3cc7262d02bcfdf5a22f05.png )

比如 main-out.log 里保存了 main 进程的正常日志，而 main-error.log 里保存了它的报错日志：

![](./images/79027487fe54a43373adf177bd842413.png )

我们再跑一个进程试试：

![](./images/2ee8d1bb1c79e1589a147ae12c623c76.png )

现在有两个进程了，pm2 logs 可以看到这两个进程的日志：

![](./images/ae3bf8132518fdb0d85e4b4fd970bc55.png )
...
![](./images/6019187db1d52c53e5d3686ef7a6b5c3.png )
...
![](./images/ffc8901579783e9225a8c6dcca23b215.png )

我们指定 1k 内存就重启：

    pm2 start xxx --max-memory-restart 1K

![](./images/95936c68abd186e59cab225ead2b9734.png )

然后在 nest 代码里用超过 1k 的内存：

![](./images/bbb1adf54de8903675907e3c39922e85.png )

先把之前的日志清空，使用 pm2 flush 或者 pm2 flush 进程名|id

![](./images/c160fefb0145589ab8f156d3aa2d703e.png )

确实清空了：

![](./images/cf61350b2a741b973cf28fd7f18a9c68.png )

访问下这个 controller：

![](./images/96bbf9856181ef5bed52d05f98187627.png )

查看 main 进程的前 100 行日志：

    pm2 logs main --lines 100 

![](./images/43585c9bbe049915611ba01d1273dd4f.png )
...
![](./images/c930dda18b63a08350790cfd772e3638.png )
...
![](./images/6ad8a0540fb3c6d415cbf84db5c24719.png )
...
![](./images/3c7e639726fa588d382965c657ecfde5.png )
...
![](./images/ea3431f4d9485bdd337d6f0ebb9ba5af.png )
...
![](./images/f08da1abb10861c294c466d23a04327c.png )

apps 部分就是配置应用的，scripts 就是应用的启动路径：

![](./images/59b3e3c3e7ed6c6c03bf678648b45b1c.png )

它可以指定的配置非常多，基本就是命令行有啥选项，这里就有啥属性：

![](./images/01b36467825e92ede38a3d3324b76672.png )
...
![](./images/4e584b67d06652229e57e3fbceaedd11.png )

然后在本地执行 pm2 link xxx xxx，把本地的 pm2 和那个网站关联起来：

![](./images/28196b866f5b4929548174966fb1cafa.png )

再执行 pm2 plus 就会打开 bucket 对应的网页：

![](./images/72a05d9803eff35e93476344f9ce8941.png )

可以在线监控你的应用：

![](./images/36974911333d312ae2e31b7861891bb8.png )

下面这些 plus 的功能都是收费的：

![](./images/ba8736f441597d53f2cd890eee9aebf7.png )
...
![](./images/af77597ae61952320177254089c19418.png )
...
![](./images/507c29c9b684b014789407d5957fa4c3.png )
...
![](./images/764a64b865555ed5e4e4c94dbbbc3cb1.png )

把它跑起来：

![](./images/0fbb79400a5857de71f118c010e6ebbe.png )

![](./images/1e102f182befd78f7837206c47ce6d1b.png )


![](./images/492c2dbd18f08c4412e760cad7614624.png )

这个就是 pm2 打印的日志。

你可以在 terminal 使用 pm2 的命令：

![](./images/e87c87dcdbcfc95ccf363744a8b35b4e.png )
