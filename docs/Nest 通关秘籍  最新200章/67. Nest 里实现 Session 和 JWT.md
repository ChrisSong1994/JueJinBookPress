...
![](./images/99c9bfea553186997b6b858cf333efe1.png )

然后用 postman 测试下：

![](./images/d8b246a905e93d996d62e460b3692984.png )
...
![](./images/892c09da5e57fa83f994918e7ffab5e2.png )
...
![](./images/d675d5fccdd84cfa9fae8f8a0a2b9f1b.png )
...
![](./images/a8ee1e65efa92265ea534bdd23e2b37d.png )
...
![](./images/7a72e3b99577168503ed5209a83125da.png )

放到请求的 header 里：

![](./images/f8875063b5f67359c19db862cbb81d49.png )

这时候响应为 2，并且返回一个新的 token：

![](./images/23246fd2f5916a43a0fe27f320be4b01.png )

把它复制下来放到 header 里再次请求：

![](./images/dc77855d0da4c32df45f8caa64d71faf.png )
...
![](./images/ee98e436965ae0e179070604e3220eb9.png )

这时候 jwtService.verify 方法就会抛异常，然后我们返回了 401 错误。

![](./images/ac20fbef794765ce279c93b85123313b.png )
