...
![](./images/f84f54e113e9080aa81d15ba3cf5bef9.png )
...
![](./images/e1075eb6b0a10cc60db0691ff4b1a6c9.png )
...
```
![](./images/fafd650fd51c68fa4297e4767abcec29.png )
...
![](./images/463f00c88e7894d2f8ad77257fb49889.png )

浏览器访问下：

![](./images/a80df4a3cd8a215597144a960f133bdd.png )

看到 hello world 代表 nest 服务跑起来了。

然后改下 AppService：

![](./images/300039264401080abcf975adc644fecb.png )

修改下端口：

![](./images/94e7f883a0beef9fdd3897079fc14029.png )

然后再 npm run start：

![](./images/602c6253ff3c8a6272de3767add35e89.png )

浏览器访问下：

![](./images/f6ba822f40741c41afda5a1a3c946efe.png )
...
![](./images/66b97813f62567712c2c06f7f10cd065.png )

设置容器名为 gray1，端口映射宿主机的 82 到容器内的 80

![](./images/e4ee6e26bad54c9f703404c5fa2df7c6.png )

现在访问 http://localhost:82 就可以看到 nginx 页面了：

![](./images/7316f5de272da0c0388e270948ce98dc.png )
...
```
![](./images/b976c258d340bbcfe257bc0c98db494c.png )
...
![](./images/58ce2fff5e6f2a83e5c5b25f72d7f2ce.png )
...
![](./images/02bc1605b52ff1dce3df1d3cc1d4bc3a.png )

点开看看：

![](./images/0981fd898122504064fab51eeb1963dd.png )

这就是本地的那个文件。

我们在本地改一下试试：

![](./images/2269b7fde9841abacf9b211649a54b52.png )

容器内也同样修改了。

![](./images/159ac316672403485771faf32d1c58da.png )
...
![](./images/27b354c9061b9908013b96d99141cd47.png )

nest 服务访问成功了。

现在我们不是直接访问 nest 服务了，而是经历了一层 nginx 反向代理或者说网关层。

![](./images/43e250876f5bfd8504991b6d664df846.png )

自然，我们可以在这一层实现流量控制的功能。

前面我们讲负载均衡的时候，是这么配的：

![](./images/fd440cf6c948b43f819908c22029ef12.png )
...
![](./images/15c79bd054b7446462c797ec49bdb4bd.png )

这样就实现了流量的划分，也就是灰度的功能。

然后我们重新跑下容器：

![](./images/032bdace6fa21134db1e8bb54be70fd0.png )

这时候，你访问 http://localhost:83/api/ 走到的就是默认的版本。

![](./images/e5022e3a6079f26c2163e8ad633e8856.png )

然后带上 version=2.0 的 cookie，走到的就是另一个版本的代码：

![](./images/59021209601b7f3b9a21790c4d889462.png )
...
![](./images/c8b978c92ca40b5d4fd5757e19fb97d2.png )
