...
![](./images/48a98cc05c44b30aebed1a7247a98bfd.png )

![](./images/7d89a43b56d712775cf5c8c4b52bf9ba.png )
...
```
![](./images/bd7995ccbfe16075e6ceef1536d2686c.png )
...
![](./images/41e1e9cd2811bc71263e5f9cb4bd5898.png )
...
![](./images/177489cfd5ecc158093429221ca53181.png )

在 mysql workbench 里点击刷新就可以看到这个表：

![](./images/a2915dcf0fb6b80ecb5a0887686f2a36.png )

点击第二个图标，查看表定义：

![](./images/bcf6a131de1f0590d7acd1272017fb14.png )
...
![](./images/10e85bd331c4648089afa3a96cff5bec.png )

![](./images/6589bbdb1d8fb2fe165b6b9e52d0eeac.png )
...
![](./images/e796b19e820b3731252d40c095404d19.png )
...
```
![](./images/5f7c8792722ec12222f83c9cbb1f19e7.png )
...
```
![](./images/78f226b33c9556fa53cee57b84bf146f.png )

打印了 3 条 insert 语句，之后又把它 select 出来返回：

![](./images/76f48965620032d6f1a3cf088cbcfbfa.png )

数据库里也可以看到插入的三条数据：

![](./images/e0c557dae836aa1063cd04670beea753.png )
...
![](./images/ed34ff4a2094cdde29d8113ee716ddc0.png )
...
![](./images/718ea5b41001223db91a76ae83995b82.png )

重新跑一下：
```
get(MeetingRoomService).initData()
```
![](./images/98003c1c9ceed9529e901f4a9697eba8.png )
...
![](./images/02ff13450137a3edfe254a5d9fc664c8.png )
...
![](./images/3b9453af5fcab293eba58bdbd050c45e.png )

这个错误的格式是我们在 exception filter 里自定义的。

![](./images/16478b3337c954925feacc7d9d60d614.png )

![](./images/cb151a4280cd8a9ab95a40d898471bfb.png )
...
![](./images/be9f2486fcb785db7abb32630e188356.png )
...
![](./images/0b9cf8aa726d83cdb4cf1780c8f3244f.png )

服务端打印了 select 和 update 的 sql：

![](./images/3a59f0dbee6b396af1de125386187a53.png )

数据库中也更新了：

![](./images/04b5d0049928dd48da808911ecb15bef.png )
...
![](./images/0930553501981e4e8b18460d5b4dbafd.png )
...
![](./images/8d5cfd4d368c425a9edc49cc16dfdd80.png )

![](./images/86efc1542b58933a0a7e7d05a769e539.png )
...
![](./images/49bc0a249fbd52a1028adbfdb9c7a3fd.png )
...
![](./images/ce094155ae970b965717cf5078c1212f.png )

![](./images/0f6bfc65680238c44e18bf17a97fadbe.png )

![](./images/59891884373f33f064c29231441c39ce.png )
