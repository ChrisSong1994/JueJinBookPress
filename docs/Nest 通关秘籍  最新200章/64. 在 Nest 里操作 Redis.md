...
![](./images/11f159b3e29af43f9e6d2fab82d32fb9.png )

最流行的就是 redis 和 ioredis 这两个。

我们创建个项目来试一下：

![](./images/624a89fc1a2bc831aab6044422ac3bc9.png )
...
![](./images/e361b6b310de8294992ebd17ea9d1831.png )

然后 node 执行下：

![](./images/ad0619d49acbfbe0e138efede931a4a1.png )

用 RedisInsight 看下：

![](./images/4a91b6d5bd1f1274f74c8bfd76cbdf15.png )
...
![](./images/b45ba637d5afae34520dc9b9818d08e0.png )

所有的 redis 命令都有对应的方法：

![](./images/7053fa452d1dbdd3c1ffc9b669768ba9.png )
...
![](./images/824e0e5043e3b296f873f35eff27a31c.png )

其他命令也是这样执行：

![](./images/b96d7d0cf6a0dd09155e33e72ce85b54.png )
...
![](./images/a3bb89ba0d89de4c82da1fd194b24cac.png )
...
![](./images/a196891c8e931f54882a923425b8f8f7.png )
...
![](./images/15b3dcaa0bc2ecee8f9271b07834e1c8.png )
...
![](./images/dff73be5058e2bf640d8824e9fcaffd1.png )
