...
npm init -y
```
![](./images/e1fd1436860e05a7a98688e17d9bff26.png )
...
![](./images/7e4a4d97349c1f843f4a7ec8305a302d.png )
...
![](./images/a11eb2870f9b3ab5b4ae0e22e84e434d.png )

在 MongoDB Compass 里看下：

![](./images/d97a6b2c4a19801b95ad17a3fbc7b512.png )

两条数据都插入了。

而且在 mongoose 里查询的语法和上节我们学的 mongodb 的 api 一模一样：

![](./images/4305c9a3b524679938482cd317adc373.png )
...
console.log(persons);
```
![](./images/061011161fe161b2103a9d2ba9af21bd.png )
...
![](./images/882c0cc33a80cf87dbc88a8a7505fbca.png )
...
```
![](./images/0fc043ae519393809e23ecc9cfa71442.png )
...
![](./images/b2fd44b0cb03e186385f4abac14af59d.png )
...
```
![](./images/70365360c74bf3dab0cf103b1a761f08.png )
...
![](./images/c679b8922e5bbeec440ffee03e4260bf.png )

然后 dog.module.ts 里注入 Schema 对应的 Model

![](./images/2045337bf7d2c516092e483f1a1f480e.png )
...
![](./images/71e9140352a849eb745811ddac9e72e5.png )
...
![](./images/8615acc1205860607cb414d66129d17f.png )
...
![](./images/56e302555e6b0c0f5d2ec426c25b812a.png )
...
![](./images/acc66bcdbfe3117ed1a879826289aab8.png )

![](./images/6e918de447546d9bfea94549d6166b1b.png )

查询下全部：

![](./images/5c881e96639a2241b576f18d06252d55.png )

单个：

![](./images/1fd4c73b14ee578f4d499640c2893cb1.png )

然后修改下：

![](./images/3e2c1e6c51d0fc99c71e1afa7805cf86.png )

再查询下：
![](./images/ae31f6d7237df2a0d838d97237481460.png )

之后删除：

![](./images/c248bc1b616f5f07180f545b32296c00.png )

在 Mongodb Compass 里点击刷新，也可以看到数据确实被删掉了：

![](./images/7c27e66252805eeeb37980b9e0ed81b0.png )
