...
![](./images/a64f57f6654661b724767157fce9f439.png )
...
![](./images/2d9a21fc0567fe7f1a265156c2182567.png )
...
![](./images/bbd1e85ced8351e8386ecbf49207923e.png )

之后分别提供了 express 和 fastify 的实现：

![](./images/26481fa7b0126a6a7f842df2c287551b.png )

![](./images/8bab69b9b7f043c973e817edf62f5ac5.png )
...
![](./images/267642f86ae38a5d6dfc2525c7a36bc3.png )

这俩适配器分别在 @nestjs/platform-express 和 @nestjs/platform-fastify 的包里：

![](./images/5d87054b683e695b1909bae9c6e74f2a.png )

默认用的是 platform-express 的包：

![](./images/9cc4881727c5dfeed5f295ff90c83c7d.png )
...
![](./images/a0d0abe1c3860c06043cb83d259d3c77.png )
...
![](./images/e55cadd2540f0c99e49ae538ac9b1751.png )
...
![](./images/3681666edb26124736bab60c48a6f68b.png )

改成这样：

![](./images/5e37682c38f4682433b402bfdc6f6eea.png )

这个 FastifyAdapter 前面讲过，传入这个 adapter 之后，就切换到了 fastify 平台。

这里你还可以再传一个类型参数：

![](./images/8b9ad94941e65c0b7b11dba9d8dec9c8.png )

这样返回的 app 就会提示 fastify 平台特有的方法了：

![](./images/07a8060d309d04bb79ccc71c2b7c653b.png )

这也是为什么之前我们要传入 NestExpressApplication 才有 useStaticAssets 方法：

![](./images/aca779ac1d57f1189f63337490e895fc.png )
...
![](./images/27fa844bef40901e4c30ca71250bcfaf.png )

![](./images/a4417da7b31abfc8f71d2e26a9918101.png )
...
![](./images/dfd7e42371fd06929115e5421c7572f6.png )

传个 passthrough 参数，代表不会在方法里自己发送响应内容。

这样返回值就生效了：

![](./images/d7f997d8ee38089018f1ee16432a11d3.png )
