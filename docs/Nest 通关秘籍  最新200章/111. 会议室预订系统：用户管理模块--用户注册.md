...
```
![](./images/b3429318e7aca7d0d9c522b674512b54.webp )
...
![](./images/4bbba5a62c1e4b65f255918a921bd531.webp )

刷新可以看到这个 database

![](./images/791f1cab7464614020bdcafb1032d85c.webp )

用户模块涉及到这些表：

![](./images/c8ef1a4fba8d64179c5f7741e6307c47.webp )

我们创建下它们的 entity：

先在 nest-cli.json 里添加 generateOptions，设置 spec 为 false

![](./images/bb721c50cc75012ea814d1adebc817b5.webp )
...
![](./images/8506045ab2a67b233872682f7af8d174.webp )
...
![](./images/ff25eea2d5d6aa92b5b5a45612983c99.webp )
...
![](./images/58027b602835cc65c4147b4d970a8a38.webp )

我们去数据库看下：

users 表没啥问题：

![](./images/9b9f7398f90e386e9945c58e1cf589fa.webp )
...
![](./images/610a764f9076ce597c1d3e4d1592641c.webp )

permissions 表：

![](./images/1ccaeb295eb200b65ec5210ce3ce08e7.webp )

还有两个中间表：

![](./images/dc43e3772d38d482235726375618dfa2.webp )

![](./images/607e224d828ec99b64e238e30650dad6.webp )

![](./images/96fc590d954cc710ac943410ec465b33.webp )

![](./images/ac5a3954eab84b11ce03e4973fa00583.webp )
...
![](./images/cbc5614a2f49f620cf0b87683d747d26.webp )
...
![](./images/382a693ffbed5c6944edf63461f60372.webp )
```javascript
{
    "username": "guang",
    "nickName": "神说要有光",
...
![](./images/31cc69be1fd9430592a6ec5192b3166c.webp )
...
![](./images/211aea91ae8ddcc0c6f7e0ba63b5fd57.webp )
...
![](./images/49eab104073aae12acc78ab21b0cbd51.webp )

![](./images/adbfb5fa2affd6f6a2f8abd186b89dd4.webp )
...
![](./images/65eca545c46869a808a55ccf413e1b94.webp )

注册的逻辑是这样的：

![](./images/ca3bd5f802c9de4033a8c45b88b94f89.webp )
...
![](./images/646244a7cf4861ea1f7cf7e30661a2f3.webp )
...
![](./images/743e328bf3d13bdc32fed2d6db04b6ae.webp )
...
![](./images/b1423306cfdf14620d80c5de9f4b73a5.webp )
...
![](./images/4c6023c4a4f91e7f6041d6de1a8c21b2.webp )

因为还没实现发送邮箱验证码的逻辑，这里我们手动在 redis 添加一个 key：

![](./images/49103c953dc434c62e146dd093ebd02c.webp )

![](./images/7ddc48184c6fde24e9128e47ca2a8d12.webp )

测试下：

带上错误的验证码，返回验证码不正确；

![](./images/7cbf5323470844857028ccb9223aca6e.webp )

带上正确的验证码，返回注册成功：

![](./images/8c2fa26a42f6564adb7c28935c7303f7.webp )

这时可以在数据库里看到这条记录：

![](./images/56dec807011ff82651efa2c2f37598e9.webp )
...
```
![](./images/3ec207011e933bdee56aa1c59f09b08a.webp )
...
![](./images/04be26441e4e860f33c7c174439663b0.webp )

邮件发送成功：

![](./images/e2ec33a3148a92b35636d489032ffcf6.webp )

redis 里也保存了邮箱地址对应的验证码：

![](./images/860a7c6933cfefca85a3a8963a7af424.webp )
