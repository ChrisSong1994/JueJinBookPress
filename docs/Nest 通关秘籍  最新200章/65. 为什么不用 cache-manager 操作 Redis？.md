...
![](./images/35d6750b215659d0204209ca42c403b7.png )
...
```
![](./images/0994952f5368709b53afb8bb6cb7aa97.png )
...
![](./images/83b45a0966c0705d97239c61e35d3a54.png )

![](./images/608f46823e3e92c66b7ddb32b64b0859.png )
...
![](./images/01eff9745a6da547425f989450f5dad4.png )

之后在 AppController 加几个路由：

![](./images/346f3ac2471cf2fb4efbb9fc8cac3e9e.png )
...
![](./images/56b78cd907f14ff692305a077b25890a.png )

然后 set 设置为 111：

![](./images/526da739bf31151698695b8624b790de.png )

再次 get 就有数据了：

![](./images/0defb3a1320f7d89a019f4813bfe9ac9.png )

之后 del 删掉：

![](./images/a1ba325971b8cd3c120d826ee1fc268b.png )

再次 get 就为空了：

![](./images/d4b7fe264e84e450b03a191e2b838a22.png )

这个缓存的用法很简单。

此外，你还可以把它加到 handler 上，自动对结果缓存。

![](./images/75d4f6008e5c4b14bb2dff74bb351f94.png )
...
![](./images/7b9ecdde90ecc8b77bde9ef4d608cbc6.png )

![](./images/818b576d0e66492cbdc5dc015d04b856.png )

改变参数再刷新几次：

![](./images/379c82c4e516ce77e4abd2d10a7e59d2.png )

![](./images/c81f413c35e30dad655e2636ed0622d4.png )
...
![](./images/2e239bc62bbfd12ffb67104f13ba9873.png )
...
![](./images/39f32d1b090b5d68f6a7d33f0b9c1ff4.png )

![](./images/d0e86f60e4018d32c63978d127987278.png )

![](./images/62bb2a09c69d117687633204b38c21cc.png )

这时候在 redis 里就可以看到缓存的数据：

![](./images/7dafb337c423f2416f6c1b197fd0cf7d.png )

注意，连接的时候我们指定 database为 2，所以在 RedisInsight 里要切到 db2 才可以看到这些数据。

缓存的过期时间也是可以配置的：

![](./images/e5f1a46e1d859aafc33d202291c7976d.png )

![](./images/d4623496436de74142e1ea2bbcd4ca32.png )

![](./images/c7ce77e5a9655345fde07273229bab55.png )
...
![](./images/a2804690d2db1a2fd6402d8c04bd39ee.png )

![](./images/4a4e47862a83eb5ae2f7e7ac2b90499a.png )

![](./images/ec8743ac0ed37ee5a1d1de631044fef4.png )

而用 CacheManager 的话，只支持 get、set：

![](./images/a0b10ebc054d44a0daf6ab79f9f76f37.png )
...
![](./images/d6a7891979c49e18cbecb70d9283c127.png )
...
![](./images/45f83c578a37cbad11535d05ad0e994f.png )
...
```
![](./images/72ed86518d90f8118fc1e495a5d82293.png )
...
![](./images/05f292f1f53c27a17395a8eaa9016b18.png )

跑一下：

![](./images/0e1e63e2ec5d17811587e9ed3dd81f61.png )

![](./images/14b9beee22fe5dfba6993a486451968b.png )

![](./images/5af41c4dc18179bdcd0eae0dcbd4dff8.png )
