...
![](./images/45334cd51643832a08815e1df686c3f5.webp )
...
![](./images/0f342d41437f1ab2b33450a5d8866b9f.webp )
...
![](./images/4664d6c97dfb07513e2b5864488a5271.webp )
...
![](./images/e6d325c8f67f005e4b86a4ef8500325d.webp )
...
![](./images/ad17d6a0e57472336a1023f8fcd4978f.webp )

那么问题来了，如果所有日志都写在一个文件里，那这个文件最终会不会特别大？

不用担心，winston 支持按照大小自动分割文件：

![](./images/05c699f0635704fbfa4665260cc09611.webp )

我们指定 maxsize 为 1024 字节，也就是 1kb。

然后再跑几次：

![](./images/66618f5dac7763bb05895f2b3e56b0cf.webp )

大概跑了 10 次左右，出现了第二个文件：

![](./images/c7e9191869a0cb8de81d40043b252972.webp )

而这时第一个日志文件刚好是 1kb：

![](./images/0f14674d73f7434368abb3612e55a316.webp )
...
![](./images/cce3443aecc7454747d0ba64d9204a81.webp )
...
![](./images/478ccc5ce6cace8546794f8ef14c04e8.webp )
...
```
![](./images/1d1bfe4d9e17be2a41c672d49acc0284.webp )

添加一个路由：

![](./images/ee9c5f21cf17404cdd6d25352fba3d2e.webp )
```javascript
@Post('log')
log(@Body() body) {
    console.log(body);
...
npm run start:dev
```
![](./images/8ef58a8adfbd4852199cab8216430d5b.webp )
...
node ./index.js
```
![](./images/f7488faf82a34b35133e551699649bcb.webp )

![](./images/3857b9ca7d98d755541ce671356dad78.webp )
...
![](./images/bce478897400a3e522e39c597a161e9b.webp )

再就是日志级别，winston 有 6 种级别的日志：

![](./images/5bcc789e8b95fc836383cb9c9f9e6e1b.webp )

从上往下，重要程度依次降低。

比如当你指定 level 是 info 时，那 info、warn、error 的日志会输出，而 http、debug 这些不会。

![](./images/725ff61288b45433dde6822bee6fcfbe.webp )

![](./images/6a0ddb2b5b7fc508b360c5f3592bbe07.webp )
...
![](./images/cce545855e7ae044893de3fa70263a6f.webp )

json：
![](./images/0054bab5babe03526b384c55b8a8dd78.webp )

prettyPrint（比 json 的格式多了一些空格）：

![](./images/9d0a7f380ca130267fe1c027aa156857.webp )

用 combine 组合 timestamp 和 json：

![](./images/d4263da2fc351819969e98313026a16f.webp )

或者再组合个 label：

![](./images/75ef2ed970c432047b5f9de797348d49.webp )

加上个标签，再搜索相关日志就方便多了。

彩色：

![](./images/ada77858ffc0930bd82f0cfea6dbc79c.webp )
...
![](./images/fa5c3ff27e2fae6f47c66d3d2b6038d6.webp )

![](./images/fbe099108db8d59feaa03e9f4e758cf4.webp )
...
![](./images/6c178e2dd8ae57bb3e05ee0852791602.webp )

![](./images/a265a38c5ea83925f6cde6481c478f5f.webp )
...
![](./images/e52db688c9fed88c28231a96dda34d6a.webp )
...
![](./images/d96f39363e7f8bbfe4370b3c04615abe.webp )
