...
![](./images/82d0ea49e9b636b956523858144f3ea5.webp )
...
```
![](./images/0899a5fc202059e1f7ba11b0c1d6e78b.webp )
...
```
![](./images/71fe3890dcfdb6a50ba7ccae11c57b10.webp )
...
![](./images/4bdad28c88de85f7b0ecb1b8a4eb2ed4.webp )
...
![](./images/4ea7dddb8ce5e1edab5d9db4e8d36a51.webp )
...
![](./images/4e0b0f9c3c43c27511670af943f79a55.webp )

现在 getSession 返回的是 Record<string, any> 也就是对象类型，但并不知道有啥具体的属性。

![](./images/5d4e49692d176b6d6b4cc0d8c9e633ee.webp )
...
![](./images/fb52c4508ee9b4830adb54363b38472f.webp )

传入类型参数之后，返回的就是该类型了：

![](./images/bc52a6b0a34b9d492c19f479f9315fe6.webp )
...
![](./images/652f521b1ae59ce9337447e0735dac34.webp )

我们自己实现的 session 就生效了：

![](./images/149358aad5797db46edcfbc4e505f529.webp )

在 Redis Insight 里可以看到 session 的值

![](./images/d761bbef2ef0ec8678721a1820377322.webp )

而且这个 session 是支持分布式的。


![](./images/c6c454562fce4be62437e63503166854.webp )
