...
![](./images/abdc741c1b7060fc2e34119d36b11345.png )

这节就来实现下进入聊天的入口。

也就是这两个：

![](./images/4f7685c031aa26d4d384c8a2fbc03353.png )

点击聊天按钮的时候，要创建聊天室，或者查找已有的聊天室，然后带着 id 跳到聊天页面：

![](./images/455519e0381a4336621c6dfc95fba9e8.png )

聊天页面选中 id 对应的聊天室。

给聊天按钮加一个点击事件，点击的时候传入对应用户的 id：

![](./images/3be24de6eb6e3d9abaaf84adf81d6198.png )
```javascript
<a href="#" onClick={() => {
    goToChat(record.id)
}}>聊天</a>
...
![](./images/686c82d3f2b16264233edc88a9e66d4a.png )

现在没这个接口，我们加一下：

![](./images/ea7f1c71be355bd2f235c2fdf457de19.png )
...
![](./images/592d0a415909908a65f5e4465673418f.png )

现在只有这两个用户在一个聊天室。

结果是对的：

![](./images/a6c4aa755c0126db31566d06e3e565be.png )
...
![](./images/5c245aca6e37e71d4054c8bd1f0aa24b.png )

在组件里调用下：

![](./images/0eaa8470b1b77312921455ca45bd9d27.png )
```javascript
...
![](./images/d16a1a15d42e892fd972867718af726d.png )
...
![](./images/509c33f8a797db05848d41e36bdad657.png )
...
![](./images/52e3b4504ca9d4de6ccf712f520cf34c.png )
