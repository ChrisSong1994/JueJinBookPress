...
![](./images/25c90949bc300c378d7031bf6a8871a7.webp )

分享出去很不方便。

这时候就可以通过短链服务把它缩短：

![](./images/c16fba00b57eb78fe6fab9626f216a98.webp )
...
![](./images/45b84474741ca29b4922b1d8760d634d.webp )
...
![](./images/e25b92d82957d425a464ab194f58a725.webp )
...
![](./images/d28f9cba6f798310bdb791814e3922c0.webp )

还可以做一些分析：

![](./images/103e17d84759f1d4fa125d86870fde45.webp )
...
![](./images/efcdb0e5a7fda3faebfec842fc7b3d36.webp )
...
![](./images/48b3bdef10c5d4ed00f1a5ffd85706a1.webp )
...
![](./images/0d5a3b4e36edb569d19a8daee03a3483.webp )
...
![](./images/7f11773984f590b2af26bf0b601b8348.webp )

随机生成 0-61 的数字，然后转成字符。

62 的 6 次方，范围有 580 亿，足够用了：

![](./images/2b3df5e36c8d076f11df295e7def43b3.webp )
...
![](./images/e6ff102fcb8e10e8774dbf94ff0ed3c6.webp )
...
![](./images/58080ff102b4d93ec0f1795e567f224d.webp )

先进入项目，把它跑起来：

    npm run start:dev

![](./images/04d2fb95a434cad8d20b997fa2fcfee0.webp )

浏览器看到 hello world，代表 nest 服务跑成功了：

![](./images/5eef68deeb6d80ce58907e03d7a8ad90.webp )
...
![](./images/b82879ccde4fc223b4a6c13c09fd82d1.webp )

指定名字、字符集为 utf8mb4，然后点击右下角的 apply。

创建成功之后在左侧就可以看到这个 database 了：

![](./images/926d62ab0291bf74b31a364a9f3eab9f.webp )
...
![](./images/750ff5ee63595ef5c8aa7faafcbeca80.webp )
...
![](./images/2420fa6cadc58997caec9773f7905277.webp )

保存之后，TypeORM会自动建表:

![](./images/d51b30a27e0f8d539efea30b47ef11f0.webp )

![](./images/8471d61b8459ee03fdd9ba49799bef9f.webp )
...
![](./images/8056bb5a7f29cd76b652b6ad0aea6a13.webp )

![](./images/92d6f58eb431ad3a552c14207ccb7c3c.webp )
...
![](./images/f492c29191b6cedb498daeb26fd07ebb.webp )

然后在 service 方法上声明，每 5s 执行一次：

![](./images/6decf1eea0698f92e06181a100b73d0c.webp )
...
![](./images/0301fc85e6c17fbc19b8e94c568d9530.webp )

数据库中也可以看到插入的未使用的压缩码：

![](./images/9b98a62a6bbae96e7cde7852fa5b3358.webp )

当然，一个个这么插入可太费劲了。

我们一般是在凌晨 4 点左右批量插入一堆，比如一次性插入 10000 个。

![](./images/471b82be6396f3b61c261982423e8764.webp )
...
![](./images/c23b53f2a390de73198885ab911cfd24.webp )

同样会自动建表：

![](./images/930295a7850a96a1b07c318e71e21fce.webp )

![](./images/06e38b5f40d56409c6e2c01817e08191.webp )
...
![](./images/1f1e4b46c776aee3917a5cfcf3869205.webp )
...
![](./images/6fe7fc24299b81f74a5a79b11c4eb7f3.webp )
...
![](./images/16a6bd65a33917172ae77266abff5e57.webp )

可以看到，打印了 4 条 sql：

![](./images/a9490031c9788be546856fcab23d7bb5.webp )
...
![](./images/7fea819d2d99daf21029fd71738f944d.webp )

![](./images/828aaf8d111063c7e782953ef2e0f093.webp )
...
![](./images/0727d128ac332c3195f86cdef35a5c2d.webp )
...
![image.png](./images/b387ff185524fd3934580c0a19984be3.webp )
...
![image.png](./images/b8ec528147e294b9dd86378b9e16c1f6.webp )
...
![](./images/774d338417fd7c9049c338366f84dcea.webp )

![](./images/0394a0cdc6c3ed15314ba0a51cc322ab.webp )
