...
![](./images/2133d2d825b405bcf27b6454f18c5c10.webp )
...
![](./images/bd3ff34e3865be5f0930ec75678e9c9c.webp )

生成了 .env 和 schema 文件：

![](./images/51f59c562f1c00645b3219822cdf5fbe.webp )

然后改下 .env 文件的数据库连接信息：

![](./images/82d4f6e76f4f0a45dbaa22abaf8f55ca.webp )
...
![](./images/c4681d6fee7096094b9909ee247d8ede.webp )
...
![](./images/30e57195fef5a7167481bcd083d60ee7.webp )
...
![](./images/9c62c6902b3f0872195cfb91c46dfcb2.webp )

生成了 client 代码，还有 sql 文件。

![](./images/9fac284c4d85ec99e20713c51168506e.webp )

数据库中也多了这 2 个表：

![](./images/7249585595b4608efc953bd88c21062a.webp )

![](./images/ea8f073ea8253d9af9537a1628dc9cda.webp )
...
![](./images/142fd42e882dd867ae79830bbecd6a2a.webp )
...
![](./images/dc0e029616ad0afb3f51730178cc345f.webp )

在 mysql workbench 里看下结果：

![](./images/3e498f0da28f0d977d3fe043cf0bc5b6.webp )

![](./images/ef3c103503544461647aee35c8c60e06.webp )

确实，数据都被正确插入了。

当然，你也可以用这种写法：

![](./images/110401d4e8671947f7ef84f272011f09.webp )
...
![](./images/97a8ff87ee5dd87a988a901b5121c798.webp )

效果一样：

![](./images/d17daf2b754531e6b90262793fe0c937.webp )

![](./images/9501d9c66e7231a5dbcf2494ab19a92d.webp )
...
![](./images/8469cc1e4afdb81e440a67320b0bc54f.webp )
...
![](./images/317c002455e58622d3eff33665fb553c.webp )

在 mysql workbench 里可以看到，id 为 1 的 department 更新了：

![](./images/8a1cb1d655966d449fede0ca89545659.webp )

关联插入了一条 employee 的记录：

![](./images/629fc528a8bc7c64502b1111bbde7c16.webp )

![](./images/4a1d81740ee0de226988180468f78631.webp )

更新 department 的时候，除了可以插入 empolyee 的数据，也可以和别的 empolyee 建立关联。

比如 id 为 4 的 empolyee：

![](./images/b5df0819b418044e7ce24c1fc8fd5229.webp )
...
![](./images/63881b4f6d35d149f1c6b917d3552a22.webp )

跑一下：

![](./images/3a31b85d420a0fca5ee91fe9a51ca030.webp )

刷新可以看到，id 为 4 的 employee 关联的 department 就变了：

![](./images/85459c60b20a35f43b0c4247acf288ec.webp )
...
![](./images/026b4faca8bab22d93562485df53b9fc.webp )

![](./images/83ff0deb2d579e97878354e36a4ce3d0.webp )

第二次跑，就是 update 了：

![](./images/fbf5f7534eb01ffed53cbeb0f19c6d47.webp )

也就是说，update 的时候可以通过 create、connect、connectOrCreate 来插入新的关联 model 的记录或者关联已有的记录。

当然，create 的时候也可以这样：

![](./images/88ea1c106e2ba78ad2ae343bdaef6256.webp )
...
![](./images/50d5dfa8d7f08c15c12bf111cc2e0247.webp )

![](./images/a3f355bddc07b769d6e350d028e5d66f.webp )
...
![](./images/ee31cb7583816189b953e9f4696399a0.webp )
