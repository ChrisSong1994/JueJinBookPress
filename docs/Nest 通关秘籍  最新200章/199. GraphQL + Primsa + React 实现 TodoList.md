...
查询：
![](./images/9c147c040895b712149fe57f5a8823ca.png )

新增：
![](./images/d044548544ba7813ee0f61ae07b6372f.png )

![](./images/5c0da6afdd3676ae8cb920d564a5a3a2.png )
...
```
![](./images/2ddfeee0855d21b37ad64f24d05c3f3e.png )
...
![](./images/2e6e86093be78c4f049d047b28dd386a.png )

指定名字、字符集为 utf8mb4，然后点击右下角的 apply。

创建成功之后在左侧就可以看到这个 database 了：

![](./images/7628927c0d51f7a3acd498e586022ded.png )
...
![](./images/9853b168fa9d95b206fbeb1cfa4063bc.png )
...
![](./images/0f5c89d41b97d7ce2985f3facd244e9d.png )
...
```
![](./images/455e8205b8345d7d6143c893a716ed15.png )
...
![](./images/f3178bf6ca23e2d6e715aa475cd62007.png )

这时候数据库就就有这个表了：

![](./images/dd9354d7307ecb550d00677f948fc94c.png )
...
```
![](./images/d5cfdeee6717504891f8ae6c6d69ced9.png )
...
![](./images/9eafdba727c75f0e989ad2fc9530daf4.png )
...
![](./images/21745214874aa772c192dd8ba8926c71.png )
...
![](./images/e3e39d0a63a40f7986b2ba5bc594be99.png )

首先是 list，现在没有数据：

![](./images/39424a76cbbd332e041541ae07f7baa5.png )

然后添加一个：

![](./images/51fe735103c2bd39bcb910954fabc46a.png )

服务端打印了 insert into 的 sql：

![](./images/91060cda9a378e107d63611bbea3fa2b.png )

数据库也有了这条记录：

![](./images/aba41fc9ce72b68ccc350183f9df3ead.png )

再加一个：

![](./images/7535529c46db5a318487cddee865af31.png )

然后查一下：

![](./images/24d58200945c0baf28d58a2e8da96217.png )

接下来试下修改、删除：

![](./images/a9c54648bdcae97e421a1836152b8156.png )

![](./images/7bb42ba30c8046811472728164c9fea3.png )

再查一下：

![](./images/b4ce289aaef1566afd589186721e745f.png )
...
![](./images/929e5fdfc65ab6efb643e56d78a2b0d4.png )
...
```
![](./images/2970e62fb180bbfdbf34f9c4e6f391b6.png )
...
![](./images/0121bb9d3b69fd7a111e2eed8ad14731.png )
...
![](./images/021d715ec6545ae922a2bebc3d7d1a86.png )
...
![](./images/5757199eb2fa7113aa20ed12bf139de4.png )

查询：

![](./images/155014a75ef6326eab15b7d921f95a90.png )

修改：

![](./images/1ddaabc97a658700a6a6c95a77771a37.png )

单个查询：

![](./images/5ed877e4fd63cfd101754287283fd115.png )

删除：

![](./images/bbc9486f0c5c5e94daeb7b02f5bfafb6.png )

查询：

![](./images/acb94bc9a76b514a56326725e4a1c93c.png )
...
![](./images/c5808622721d8865aca1cda1d39fa899.png )
...
![](./images/242249f5e362461f70254cb97521e105.png )

这里涉及到的跨域，现在后端服务里开启下跨域支持：

![](./images/f9ffa5d49be5ac72f2cebd2b347a866d.png )

可以看到，返回了查询结果：

![](./images/78b9cb2a1a8e61222d20e8c0e19dc28e.png )

然后加一下新增：

![](./images/29bb6a4f21bfd32a2720ef1f2a46808a.png )
...
![](./images/bcef7bd6dcade53a280d59e2692fe44a.png )
