...
![](./images/3cbfdb66c49e2718d68b5cd3882fb7ba.png )
...
![](./images/0fae45c9526333f83a2adb0a649d32a5.png )
...
![](./images/e4e9af3ee9827c0b8e8710d806d9284a.png )
...
![](./images/6d29d12f6f62c70a33bf5c9f46cada0b.png )

浏览器访问下：

![](./images/ef74610bbd8e0e15ae39bb4a725773d4.png )

![](./images/f959c67600a953606c7417872e5764d0.png )

可以看到，文案根据语言环境做了国际化。

![](./images/b0c4faeb4bc4fee331f791bf512eddd7.png )
...
![](./images/c2ea66f7ec9fb608825e73ebf2337b70.png )

![](./images/617cab47ee141d6138ce1dd207ff92d7.png )

![](./images/708098ffac6b183ebde54d7712fcf727.png )

再访问就变成了中文的：

![](./images/786d1b759345c93057ded97d208d02c5.png )

有的同学可能问了，现在是用 I18nService 做的翻译，那不在 IoC 容器里的类，怎么翻译呢？

比如 dto：

![](./images/51c1075e46e1251d97522f646b5dbcf0.png )
...
![](./images/eb5974961f3dfedef9790ecfe2614e9e.png )
...
![](./images/b07b54334e63a44dc4d6148ea27b8e63.png )
...
![](./images/89d9715972c29cad66a80c52347b5da3.png )

访问下：

![](./images/7325de04084c293f5e80ddf3c359f0c4.png )

可以看到，key 被替换成了具体的文案。

把 cookie 里的 lang 改为 en：

![](./images/02ef36a9dbeebbf5e6f16137fbdad1a0.png )

![](./images/43ab03b8692d0e817356e6f3c507c153.png )
...
![](./images/01c426c740cd0372711b2e87d3cfd9c1.png )

![](./images/a3ad792e33d6ee293ae91641295937e0.png )

![](./images/37d42fe74842cb75ce2a1a66f2728366.png )
...
![](./images/a416bc4594a4b3a829b78b442db00638.png )

然后用的时候传入参数：

![](./images/e25cb6d37290aa8b87fda3a9bc1fc716.png )
...
![](./images/ebe001b99dddf34179a907e9b17843b6.png )

I18nService 的 api 同样支持这个：

加一下占位符：

![](./images/916e4c1418aac0f7f37645022543dfb4.png )
...
```
![](./images/f7f3f51b2ea2c469ebe9b1a3222ab264.png )
