...
![](./images/2cb33909f68754b88a856b97db6cf196.png )
...
![](./images/2b64ac3292fbef7441ea1cd80d6e89ba.png )
...
![](./images/8fa766ab3fb4348387d6242563d9e4bb.png )

浏览器访问下：

![](./images/cda6328fffbb6a8f6749f8ef81bbb888.png )
...
![](./images/655f6c28949213de77af166a66a807d4.png )
...
![](./images/bc41f38fc2f4f788124db5d66c5bb089.png )

对应的就是这部分信息：

![](./images/2197c6487d5c8943309f9086c7d4513d.png )
...
![](./images/7161a0d8bc8e3881cd3829db9193162e.png )
...
![](./images/2d915fd28da6e57901f78bfa60a52f12.png )

对应的是这部分信息：

![](./images/1eb2969e10370d91ba6c038fb95851fd.png )

然后是磁盘信息：

这里用到 [node-disk-info](https://www.npmjs.com/package/node-disk-info) 这个包：

![](./images/62e5a3693dd528468d42898815bab2ab.png )
...
![](./images/2a35769644dc7e39c4c7bc44410cfa10.png )

分别是路径、文件系统、总大小、已用大小、可用大小、已用百分比：

![](./images/1d03b82f8cb996281e30bd2fd4a9acd8.png )
...
![](./images/85af0db555115892248d949637bcc001.png )
...
![](./images/3abf90e5e4a434ddf7e7bd5adba25578.png )

和我系统设置里的 ip 一样：

![](./images/9eeafde2ab0809455079da9082b7e116.png )

对应这部分信息：

![](./images/9cb62adcbe3ef3d6ee6eee4c2275622e.png )

这样，服务器的状态数据就都拿到了。

可以实现这样的服务监控页面：

![](./images/c1b83d2030f979a7900375fc1fa50f49.png )
