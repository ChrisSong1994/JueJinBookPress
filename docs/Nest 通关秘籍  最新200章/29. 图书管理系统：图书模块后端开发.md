...
```
![](./images/a4238f07c8b23166a7c73e367939f88b.png )
...
![](./images/393aaa078050a6c8276ad0008f439e7e.png )
...
![](./images/bc0d7e782a269d5a383ddcba93fe0094.png )

![](./images/5795898bef507e0e5b3af9e5c87aa0f4.png )

![](./images/849791970f7090254d8c67f19bd4ae40.png )

在 books.json 文件里保存了这三本书的数据：

![](./images/c590a03a3a877628fe4f1f17bec8cf95.png )

然后试下查询单本书的信息：

![](./images/63fa237cfe85339c7dd01a8e275270ce.png )

再试下修改：

![](./images/4a6787315196e3d654c3b97aeeb72dee.png )

![](./images/2e9ac49f0d259a43f4d369abdf602f4b.png )

修改成功。

再测试下删除：

![](./images/bec065e952ce553157422d6f8019a636.png )

![](./images/77f663b782abfc2c84a4e2889da0ff10.png )
...
![](./images/0cbb44a3bd8976b0513a44b99ceb7390.png )
...
![](./images/a4116a7427b475b978bd17b9a9d69412.png )
```javascript
@Post('upload')
...
![](./images/5b234a99a83a262f976bb83b6ba22bf5.png )
...
![](./images/58a141b2f95c2155647e89ef4d78e572.png )

![](./images/9b4c0189e10e9365277885f92655a072.png )

当你传的不是图片的时候，会返回 400 响应：

![](./images/f01545fef18e57b68670b9b3eea4f52d.png )

此外，还要把 uploads 目录设置为静态文件目录：

![](./images/7938baffdfdcc87bae4b2acd6b1e7b10.png )
...
![](./images/cb5142d303b30ef92c3d1ce83dcd025c.png )

这样，上传接口就完成了。

然后上传完文件，把返回的文件路径作为 cover 字段的值传上去就可以了：

![](./images/18d01010439461aec82ac0d13403f382.png )

![](./images/7f047a2758017eb4b6e12cfc0b458dc8.png )
