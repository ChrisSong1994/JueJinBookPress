...
![](./images/ffe38cec439ef7cfd8c65fc50e2a5acd.png )
...
![](./images/d8bc936b38ccb96be14e2d6bb2e04128.png )

浏览器访问下：

![](./images/fe6d843a78ca61a20033e05fc5ce77a9.png )
...
![](./images/8c83c1143a12461b05777dd0c78954e8.png )

--no-spec 是不生成单测代码。

可以看到，src 下多了 user 模块的代码，并自动在 AppModule 里引入了：

![](./images/e61bdb6bd306226493abe30869b599e4.png )
...
![](./images/1e648bf00750d1f9db74b49c0f971d60.png )

![](./images/dfc1a8e746cb36f1ce87c52b59ed717b.png )
...
![](./images/7c8cfeca29c9a66778e1ffa50b52d2ff.png )
...
![](./images/32b01466106b25472199983be661ca08.png )

![](./images/6b2dea3afa9951ee0f17c425cdd363c0.png )

校验生效了。

现在接收到的参数是普通对象：

![](./images/915e101e4a4df227ba2324eecc432582.png )

在 ValidationPipe 指定 transform: true 之后，就会转为 dto 的实例了：

![](./images/3ff0d90b227a47c8474534c2763ddc08.png )
...
nest g service db
```
![](./images/7549316a8850b3dcdea255e236ec864c.png )

这里没指定 --no-spec 也没生成单测文件是因为我在 nest-cli.json 里配了：

![](./images/74c3dfebd4b0365dc309abeb3285e9e1.png )

我们希望 DbModule 用的时候可以传入 json 文件的存储路径：

![](./images/bf2043e60c1115f734772235fcc592d1.png )
...
![](./images/f4a0d06c4a6ed48f4bebf2a64770b6ac.png )
...
![](./images/e539d70fa3f004cbc07f8c2b7b4049fc.png )

![](./images/0e133d5887c9e0c13fbfbc5a3767b21f.png )

注册成功，创建了 users.json 文件，并写入了数据。

再注册一个：

![](./images/942e06ebfc85180ec5bacb016acd630b.png )

![](./images/e53e4e11c8d237cd655b091ad7a9e34a.png )

也没问题。

再次注册同样的 username 会返回 400

![](./images/ec1b4db0b5ed34a22f2b69fb01ab5ff0.png )

注册完成了，然后再实现下登录：

![](./images/3a097601cde73d00bd09fd6b7f4fcd70.png )
...
![](./images/dd687492a5f451105d81ac83a1b23390.png )
...
当不满足校验规则时：
![](./images/66b7e246ecb7d220a603384e1a755252.png )

当用户不存在时：

![](./images/b808295647f32c038f0134bc92e41559.png )

当密码不正确时：

![](./images/00fd67f25c80312774dd60de18d9a147.png )

登录成功时：

![](./images/304bbc05c3a7cdff735a0488c9cadceb.png )
