...
![](./images/e19b284152c812478ef845c4623c0506.webp )
...
![](./images/41fc12247b70804310d6ff2335b2938a.webp )
...
![](./images/3b931d44b7bb5d50529f14cd08ee954c.webp )
...
![](./images/d5455bdf053271ac847cd90d07aaf2c9.webp )

浏览器访问下：

![](./images/674a64947640f47a160333dbc9c89ba9.webp )

![](./images/4f6fd097b6be06bb9e5f3c666cf54c61.webp )
...
![](./images/c548d0341e98581896000d82290cfee6.webp )
...
![](./images/003703ab29ad0575955cc84845333f80.webp )
...
![](./images/a765902ad3ffea26e1bdd3708a372ca2.webp )

因为我们本地访问用 localhost 是拿不到真实 ip 的。

你可以查一下本地 ip，用 ip 访问：

![](./images/580cb2c6554edc3830f9b30603cb6bb0.webp )

![](./images/c6e6e12d591eeda02613a791e004e177.webp )

这里的 ::ffff 是 ipv6 地址的意思：

![](./images/8ceedb2c9dd5ac71526b4c92168a0139.webp )

这样部署到线上之后就能拿到真实地址了。

那如果想拿到 ip 地址对应的城市呢？

![](./images/d635c301ef1747420965c1a761659dcb.webp )
...
![](./images/50bd14b1e08801b50fb4a6686e14acc3.webp )
...
![](./images/093bf5a06a95fc3e6ef2a8b02b34f419.webp )

然后在 interceptor 里注入 HttpService 来发请求：

![](./images/d7182eff7a2564995ea37dee8c36759b.webp )
...
![](./images/f5c566e4382f8de27688d78bab5d77c7.webp )

如果想用原生 axios 对象，可以直接调用 this.httpService.axiosRef.xxx，这样返回的就是 promise。

可以看到，返回的数据是没问题的，但是字符集不对：

![](./images/a4da93c58126a0cd16d9d3539c1ad996.webp )

![](./images/54630b0437cfca514653683644511d9c.webp )

接口返回的字符集是 gbk，而我们用的是 utf-8，所以需要转换一下。

用 iconv-lite 这个包：

![](./images/fe5e53b05a2e3c222f35bc5653adbabf.webp )
...
![](./images/ffb671e12f9f7d93c644b97fd1f2e04e.webp )
...
![](./images/71c94f77d5291010e572713e0c3a2a0b.webp )

当然，这个不建议放到请求日志里，不然每次请求都调用一次接口太浪费性能了。

登录日志里可以加这个。

![](./images/27429520942744a1203288be2a962134.webp )
