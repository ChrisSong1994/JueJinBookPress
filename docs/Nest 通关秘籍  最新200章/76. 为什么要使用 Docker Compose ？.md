...
![](./images/47b864466c7c234797b7ae591813db58.png )
...
![](./images/2ce7f6a689e75997aff36c8580a701c8.png )
...
![](./images/e18a01155aa474a34079e2319d0e4b74.png )
...
![](./images/34846ced3a5c93f2b985e871cab007c0.png )

可以看到，执行了 create table 的 sql。

![](./images/8488b126fb11190b744b62cf90a71c8c.png )
...
![](./images/4ebddc2febde9ffc61a92ad9fb580308.png )
...
![](./images/58769c9ce23b4c97368b23d6180e973c.png )
...
![](./images/d91931e15b72f469fbfe332a2cf93895.png )

![](./images/0261fe8a411046796984e5eb266da855.png )
...
打印了 redis 里的 key：
![](./images/7757755819cbc19e1ce0aa59ed571682.png )

在 RedisInsight 里看到的也是这些：

![](./images/19ae1873c2337c4b50c5ee3858ec0571.png )
...
docker build -t eee .
```
![](./images/44287c7e4887257a8af5bfc6b43aa481.png )

（我这里稍微有点久，用了 200 多秒）

在 docker desktop 里可以看到这个镜像：

![](./images/7398c1e15a8a71b446c006235ba05113.png )

那假设在服务器上，要怎么部署这个 nest 应用呢？

我们先把 mysql、redis 的容器停掉。

![](./images/c7e7815b0c3eb5731abe74c55730c0b0.png )

![](./images/edb6286f8c2124761e0a00153db53c49.png )
...
![](./images/c58718eb7b779611a4e485d9c77123c0.png )
...
![](./images/60e7f7f9b9f8139f4971a94394dc13d7.png )
...
![](./images/065267e24637b6b0967fa08dc319f482.png )
...
```
![](./images/591299cce62a9bac856e17435f5b6eee.png )
```
docker logs redis-container
```

![](./images/cc5d27bce24da50fa6e4330d506c3268.png )

```
docker logs nest-container
```

![](./images/54a9266f7cebd75447aa4a79db8abf4b.png )
...
![](./images/156af606bad0153c90c63609fa31bbba.png )

然后把 AppModule 里的 redis 和 mysql 连接信息改一下：

![](./images/8a456a396389ccfeca8c5554eb026a5f.png )
...
![](./images/ee62af9eb676934c8c47746fb376726c.png )
...
```
![](./images/b4d0ac434e76588c651e51469473ee05.png )

然后在数据库里把 aaa这个表删掉：

![](./images/f6cde24d8cb8f05aa96c2c13440c327c.png )
...
![](./images/1e570e34cde0c641cb98843d88504a69.png )
...
![](./images/61bd354209b1b78d8b66d574d6422585.png )
...
![image.png](./images/1333c2e0d8b844ba678dc9fc7abc9c1d.png )

浏览器访问下 http://localhost:3000

![image.png](./images/71176b481a032e05784dadea2ea80b1e.png )

再次 docker logs 看看：

![image.png](./images/09d354f9372899fd616f9cce971d4787.png )
...
![](./images/90fab79ae20a653e71d52526dbf211b0.png )
...
![](./images/f4c86f86de5adf2eee5b04d7ef4349f7.png )
...
![](./images/b3a9ad30a93aeabb1fc0e763e1486365.png )

浏览器访问下 http://localhost:3000


![](./images/578083b6d66fb3454b182c03e8ff1ae2.png )

可以看到 redis 也连接成功了：

![](./images/6527fc9365644022219490304d58e434.png )
...
![](./images/c792ef258766c2be46a7e41010d324ba.png )
