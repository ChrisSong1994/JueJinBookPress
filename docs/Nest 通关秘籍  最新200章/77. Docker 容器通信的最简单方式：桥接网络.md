...
![](./images/c6b36bff321f4873f75e974e653b7dea.png )
...
![](./images/402c4dd3490e5769672481887dcf0fbd.png )
...
![](./images/9649fed49de0552c18beb0382070881a.png )
...
![image.png](./images/9eb59931f23bf2650ef5502c46400efe.png )
...
![](./images/e3be46611f57f40525570895f405ea36.png )

然后 nest 的部分我们要改下代码：

修改 AppModule 的代码，改成用容器名来访问：

![](./images/5e8f8af164b79e0e0fb74e8ea61ca387.png )
...
docker build -t mmm .
```
![](./images/92bcf411155d9ea7e61b9db23c658a76.png )
...
![](./images/266cd20cddb9e114b72ab3feeb7d34d0.png )
...
![](./images/57786e730237860ae4dcd34c9b16be20.png )

浏览器访问 http://localhost:3000

![](./images/81693499a32b6bf3d07b519faff29599.png )
...
![](./images/951b1045d06710ee6d6768f851a69f0b.png )
...
![](./images/9895def8be254963a2b56a8bb12c5cfa.png )

现在可以通过容器名直接互相访问了：

![](./images/e75a65bcde38a21b6876d6bcd1ebe625.png )

原理前面讲过，就是 Namespace。

本来是 3 个独立的 Network Namespace：

![](./images/92d8bbf711ac8be0717a1c4bda15aa64.png )

桥接之后就这样了：

![](./images/a45c071537332af27d9562ba12cef6fd.png )
...
![](./images/964176a5d3ddf810c6ad18a2e6b2794d.png )
...
![](./images/d2d32ac832c026752c7e939fcc80b866.png )
...
![](./images/52f725605db6efe4c87d7d9fb541f023.png )
...
![](./images/363b05921c89193ab54d05b9dec10b7f.png )

可以看到，会先 build dockerfile 产生镜像，然后把 3 个镜像跑起来。

![](./images/4efa8d3b2d6f97dc89f7e70197ff00ef.png )
...
![](./images/e1f6d979340e6abe8ee1c2255f6e3107.png )

也拿到了 redis 的 key，说明 redis 服务跑成功了：

![](./images/f223dc192d450f6a25bf9713d610a39a.png )
...
docker-compose down --rmi all
```
![](./images/5d9cc6b41a9149e513d983288bb05c9a.png )

把 networks 部分注释掉，重新跑：

![](./images/9cbb6836f2693e28764c4743be53bf3d.png )

你会发现它创建了一个默认的 network：

![](./images/fd150356e2aee5a9684952c595e370ee.png )

mysql 和 redis 的访问都是正常的：

![](./images/87a1688089590bf0d83c5f00c81a76d9.png )
