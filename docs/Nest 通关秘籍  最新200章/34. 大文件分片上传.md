...
![](./images/ef677fa897f6e78151a5476f2a4496f7.png )

服务端再按照 multipart/form-data 的格式提取数据，就能拿到其中的文件。

![](./images/a2546535c72936a87e7985b1dacb3e3d.png )
...
![](./images/6ac7ac8c318cacecef712e331caac351.png )

那如何拆分和合并呢？

浏览器里 Blob 有 slice 方法，可以截取某个范围的数据，而 File 就是一种 Blob：

![](./images/d6e238f92e2f985839532c02376116a7.png )

![](./images/c04a2c214bcd3b896b8e6c60f6e58eb3.png )

所以可以在 input 里选择了 file 之后，通过 slice 对 File 分片。

那合并呢？

![](./images/db544a4e780fd2b066d4ea871269dc05.png )
...
```
![](./images/076f0e297f1f085336fd98c4f3d4cf1f.png )

在 AppController 添加一个路由：

![](./images/6c2fd415f6051b6575cb6ccbca829f29.png )
...
![](./images/9802b1542eff769a44875b0e54a5b58f.png )
...
![](./images/690c9a529ee39b4c05acc38edc30ce16.png )

浏览器访问下：

![](./images/81940d26ca65d7172e46268663c04525.png )
...
![](./images/c5a4dc4cbeacc91333b00f19c129bcb8.png )
...
![](./images/ee7385a6d989156b118b74858356d878.png )
...
![](./images/1151a2b831241e82f9e033c50edcea27.png )
...
![](./images/03ca0a1199a48fbc117027f4ce50d924.png )
...
![](./images/ea930566dcca4506ae578c412132ff34.png )
...
![](./images/bd5b837f81b496f1a583964ec637bfb5.png )

这样就不会冲突了：

![](./images/867d0e3f2a12985e49ca56a63f0d287a.png )
...
![](./images/1f2167a61fd7137cc6d1a60995d507b7.png )

可以看到，合并成功了：

![](./images/1a145b3543826717d5ee7c1857c733e0.png )

再测试一个：

![](./images/0a174c1a65ed25ab24389c553ac1a0d7.png )

![](./images/5e0a53457341c690365f03ff8c0c4546.png )

也没啥问题。

然后我们在合并完成之后把 chunks 目录删掉。

![](./images/ec0b3c9a0bc8d7ddd384e0372113a2d5.png )
...
![](./images/07a7137b11320d3de31f8dea3f297f7c.png )
...
![](./images/edbf49f47afb1bb793218c113c1cbb32.gif )
...
![](./images/60f01e5d3af4c263a7bd302b5e56937c.png )
