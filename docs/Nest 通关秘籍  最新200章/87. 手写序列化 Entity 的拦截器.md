...
![](./images/1f7f44d4340e08fbf3e1541a87864ac1.png )
...
![](./images/b4d49456b9c074e2435125bf23e7edd7.png )
...
![](./images/c7f6da89f382f7341d03ee723a39be89.png )
...
![](./images/2db4e24513ef4f3f08d14947a94431b3.png )
...
![](./images/e0ac9b309c3066726ae312007bbb8d26.png )

加一个调试配置：

![](./images/dac4f3717ecf7a96f1cde9a48e13ace9.png )

![](./images/90a96438ce71230c6cf38244ed369a15.png )
...
![](./images/d4d3b3c5e921faed6fa1778b4f0c24fd.png )

现在是 undefined：
![](./images/8886f06c80adbb163a77585a1306acf5.png )

加一下 @SerializeOptions 装饰器，用我们刚才写的那个。然后点击 restart：

![](./images/76c6b3caf65316ee9bac9fb2fba72a4c.png )

这时候就拿到 options 了：

![](./images/2493bf65049fdd6f0c4fbeb74e14dcfd.png )
...
![](./images/45fe5016545c78690d248cdeeba8f5c9.png )

transformToNewPlain 就是用 class-transformer 包的 instanceToPlain 根据对象的 class 上的装饰器来创建新对象：

![](./images/49cd8489df975614eaf89a934a18a77b.png )
...
![](./images/98a70ee4471ca03d1262bc78d6ea68bc.png )

转换完之后就是新的对象了：

![](./images/ee0e3aa1a998d75c1ce2e26e5afead89.png )


![](./images/e00a1b913274ea4e15dda35a9dcd9721.png )
