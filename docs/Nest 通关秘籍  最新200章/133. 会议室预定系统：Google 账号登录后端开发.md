...
![](./images/27fea37176a771022d7b2a2a853baedb.png )

![](./images/d2e084a68fe17e4455528310b5dab9b9.png )
...
![](./images/593d1590974bc8a415431175d9dd44c6.png )
...
![](./images/6f36ecf3637bdec961a55dd843b94bd0.png )

因为缺少了 username 的信息，你填上之后就可以注册了。

并且它还自动给你登录了：

![](./images/e764d9423b85bd915200cd05b512066b.png )
...
nest g module auth
```
![](./images/5476a34c05789879bb2263cf50e6c325.png )
...
![](./images/4f0e58c4e0d661032fed415e6a3272e2.png )
...
![](./images/4180540179baea8f5cb88206f00f11ca.png )

当密码错误：

![](./images/d88e4e124c221cdd19a8f082a558f944.png )
...
![](./images/c5385f9be7b39dd5c9377b0f1f9c515f.png )
...
![](./images/04f6ef2a1b165a62001bb184490e8cc2.png )

![](./images/f1fa25059b121279851d753b6f2cfa63.png )
...
![](./images/b7e2506ac95fd89d71dd5892bfe06a7c.png )

之后在 UserController 添加两个路由：

![](./images/3711a650e168358cc6c5586d2235eada.png )
...
![](./images/3b7ae375d9a92f5bf94f031069336adb.png )

那我们只要在拿到用户信息的时候自动注册下就好了。

在 user.entity.ts 添加 loginType 字段：

![](./images/116e096927a439ae71397c63502f3180.png )
...
![](./images/c498778b7811fcb7daf064ec42cb049a.png )
...
```
![](./images/9f824c95b0a95373399228c529778b1f.png )

生成的迁移类没问题：

![](./images/4a3faa4309ce9a44d28b429254244529.png )
...
![](./images/30ef7f3be8457811f78fe910bb9c38d3.png )

在数据库看一下：

![](./images/e8d09a7fe27ed9f572d968cfea8c51ba.png )

![](./images/282d97ddd931bec3cc37fb1babfa0db7.png )

loginType 列添加成功了。

![](./images/e15eb66edc8c2c34587bdfc0e357f914.png )
...
![](./images/2e15159ecbed96c98ef31f4503d29cb0.png )
...
![](./images/486bdc07d38f47875f6b9a02e373e2e2.png )
...
![](./images/1bca681e79b1d33c08ef6306679dfda2.png )

数据库里 user 表也插入了该用户的记录：

![](./images/14fd2ac73c9774b4e307143d961f62c6.png )

nickName、headPic、username、loginType 都是对的。

后续 refreshToken 的流程不受影响，因为它只是取出 jwt 里的 userId 来查询用户信息并重新生成 token 返回：

![](./images/9945e32c5dd4baf137f2146a3e34ff99.png )
...
![](./images/cd0e2689252873786342ea58b96caa7e.png )
...
![](./images/2fc1b4d44b4205c259b050977f498568.png )
...
![](./images/d523a8a0a209f2e18e6043f1c20a083d.png )
...
![](./images/1570ee574d0cc7add8b358fcdbc6deb5.png )

在 callback/google 里注入 Response，设置 cookie：

![](./images/5fd3a014c79da88ea48063807bb7ff2e.png )

然后重定向：

![](./images/4ffe31852de095c809719c26b02d891f.png )
...
![](./images/b57d150afc4ea7c8adbcdf8949709ab5.png )

![](./images/363cffb465e0c0471d3bb0b91f761738.png )

此外，我们还要处理下普通的登录，用户名密码登录的时候要过滤下 loginType：

![](./images/e5ba15444319ab19ec4cf8f0d1ad93fe.png )
