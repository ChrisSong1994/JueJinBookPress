...
![](./images/617987fee40351ccf8f5995c9b94f3e5.png )
...
![](./images/6bcba912ceb4323a8b0730f54b341ad5.png )

输入用户名、密码，点击登录：

![](./images/428864cad57c81a93a6b8d4c6325c29f.png )
...
![](./images/73ca34ef13737e0d81efd5e4a7abb43d.png )

在 postman 里测试下登录接口：

![](./images/81897b08bcbe28e2e91e00cc2a905aaf.png )
...
![](./images/425a9e556b480d7ae6eac290c5380a51.png )

提示跨域错误：

![](./images/74862483d8521ff81805a80be3933d76.png )

我们在服务端开启下跨域支持：

![](./images/8fa6c00b9de24a8863a1070940ad0775.png )
...
![](./images/7c20aa9a183000ba2e020f41a4726b99.png )

提示登录成功，并且返回了用户信息和 token。

再输入错误的用户名、密码试试：

![](./images/d3f3e2e098bb934f1bf4ad0db2d0ec8a.png )

![](./images/b2f4af794a148733dc2fb6cfc732853c.png )
...
![](./images/f72e0b9bed9d264678483aa74a11e2fb.png )

![](./images/4cffef960b5ed7746f5eaa7eeba0c245.png )
...
![](./images/28eea864173e6e1360383c192d8e2cca.png )

填入信息，点击注册，控制台会打印表单值：

![](./images/9bd5bd1d90929bf7ce6171343032a066.png )

然后来调用下注册接口和发送验证码的接口。

在 swagger 文档看下这俩接口：

![](./images/f44e6494c8308c8b814407a1cb9c9e40.png )

![](./images/e7dc95ff12fd1c93fb9b5d774e941860.png )

同样，我们先在 postman 里调用下：

调用发送验证码接口：

![](./images/e6559f96fddb916c3aaf1ddcc7a9b55b.png )
...
![](./images/c5a56b53183b3cafbc66d0f360a68949.png )
...
![](./images/d2c23ff70abb0efd276ccaae22d198c7.png )
...
![](./images/418b858b10cc832dd31b170ddbb82dba.png )

去邮箱里看一下验证码：

![](./images/aff3dfcf3242efa40518e3b2f6be4b99.png )

填入验证码，点击注册：

![](./images/20bcc06fee5da3df8f845e385604d675.png )
...
![](./images/c8cd6a3af1418660e31abcd1eff8463b.png )

![](./images/a69cf749dd1ec711158f4cc092054cb3.png )

测试下：

![](./images/3cd11448368e3da45a7b8892bd6e28cd.png )
