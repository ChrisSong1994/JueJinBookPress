...
![image.png](./images/5fb24a5ccd632883058d850c2c36059a.png )
...
![image.png](./images/6940378f2a474f5066e2d1369f95b090.png )

![image.png](./images/96b9f411a79b757bcbaeefcbbd495843.png )
...
![image.png](./images/d9a175321cb9842b53e9388eddd2a8e1.png )

然后我们写下结果页面，显示下分数：

![image.png](./images/5daf4dfd45e8c85da693cd06d86f46d1.png )
...
![image.png](./images/f9b339b78da2d73816116de4c00c50a2.png )
...
![image.png](./images/27495d8daa30835d252eda754b8c2e5d.png )

根据 id 查询答卷，设置 score。

并且根据 examId 查询下试卷：

![](./images/d08873781e31106ce1495f469cc08b30.png )

渲染 json 的逻辑和编辑器一样，只不过 value 直接指定为正确答案：


![image.png](./images/d80fdb55c1f2a1fc0799d9a8e8aae202.png )
