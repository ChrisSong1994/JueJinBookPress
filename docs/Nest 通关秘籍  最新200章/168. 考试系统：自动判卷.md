...
![image.png](./images/5fb24a5ccd632883058d850c2c36059a.webp )
...
![image.png](./images/6940378f2a474f5066e2d1369f95b090.webp )

![image.png](./images/96b9f411a79b757bcbaeefcbbd495843.webp )
...
![2024-08-27 17.34.37.gif](./images/9033964089e73688ee9e582205747630.gif )

每种类型问题添加一个：

![2024-08-27 17.36.09.gif](./images/d8914d9acc0cdedfdd3e27cfe326600f.gif )

点击保存后，去答卷：

![2024-08-27 17.42.38.gif](./images/6c5db2aec068a35c1871ee489225fc1d.gif )

可以看到，计算出的分数是对的：

![image.png](./images/d9a175321cb9842b53e9388eddd2a8e1.webp )

然后我们写下结果页面，显示下分数：

![image.png](./images/5daf4dfd45e8c85da693cd06d86f46d1.webp )
...
![image.png](./images/f9b339b78da2d73816116de4c00c50a2.webp )
...
![image.png](./images/27495d8daa30835d252eda754b8c2e5d.webp )

根据 id 查询答卷，设置 score。

并且根据 examId 查询下试卷：

![](./images/d08873781e31106ce1495f469cc08b30.webp )

渲染 json 的逻辑和编辑器一样，只不过 value 直接指定为正确答案：


![image.png](./images/d80fdb55c1f2a1fc0799d9a8e8aae202.webp )
...
![2024-08-27 18.07.53.gif](./images/96f7472957681eea83a844c3ee0dfbb1.gif )
