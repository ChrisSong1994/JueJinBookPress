...
![](./images/9489f2a1be3d15966ce602c2b8af3aa2.webp )

那就用现在的数据库，如何保证面对大量并发请求的时候，服务不崩呢？

答案就是消息队列，比如常用的 RabbitMQ：

![](./images/8f187da21acb022b8bf5301bd5b51e1c.webp )
...
![](./images/472d23e1266332c8e5b94577a9581989.webp )
...
![](./images/889ffc1f5d791756d329a50ef65e5ab2.webp )
...
![](./images/594280b4eb26c06181eba3ba709d83cc.webp )

这个版本是有 web 管理界面的。

点击 run：

![](./images/8ffa24e35950059b7d74d3c2d14d8c5a.webp )
...
![](./images/0bee07774006c65ae9889b4531caf6cd.webp )

就可以在浏览器访问 http://localhost:15672 了：

![](./images/6d61d58877a59805f352cf028986e993.webp )

这就是它的 web 管理界面。

输入 guest、guest 进入管理页面：

![](./images/84d18654853db02639298bfed7c1b57c.webp )
...
npm init -y
```
![](./images/8fd074fd39b7a870538bb1eda348949c.webp )
...
![](./images/39708cbf2b5e70e03abd06c6b1e5e700.webp )

![](./images/ab45599fc637f297ac15466a0cc3cf32.webp )

之后就可以在管理界面看到这个队列了：

![](./images/f6ba10993811964c799ec28e4ce3c22e.webp )
...
![](./images/3ac958f75f2beb3773ddcd3ccda6fee1.webp )
...
![](./images/832e87026f3fad50c8a7cc60345508a9.webp )
...
node ./src/producer.js
```
![](./images/bd9e84057edc818797d60da26101febd.webp )

消息消费端：
```
node ./src/consumer.js
```
![](./images/c1f91884a5afbf0964b5b67013431982.webp )
...
![](./images/1c0dcb37654d9cf4dc51b6930214eb62.webp )
...
![](./images/0148c810b681df153085d017ece99112.webp )

这就是通过 direct 交换机发送消息的过程。

在管理页面上也可以看到这个交换机的信息：

![](./images/2d77f79b21bfe7d3e30419b6835e13bc.webp )
...
![](./images/c9cd90d6e93a2c6c9a6876f822ab5b95.webp )

可以看到，两个消费者分别收到了不同 routing key 对应的消息。

当然，在管理界面这里也是可以发消息的：

![](./images/6069a0853de374dcdef01897deae2410.webp )

消费者端同样可以收到：

![](./images/2d9ba56a362635b47ebea2881d450128.webp )
...
![](./images/ab5d9d0e7a8c671ad8422dc533925598.webp )
...
![](./images/f122ccabc1e8a1cd29c64ba002667a2a.webp )
