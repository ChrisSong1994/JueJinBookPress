...
![](./images/438cc3b764c2be6af97d5922aa9a98bd.webp )
...
![](./images/35c7469c36fb54f8e576a6d8626b3a0d.webp )
...
```
![](./images/d90e54d92cbbf62ffec794df66af0b21.webp )
...
npm run start:dev
```
![](./images/9a9aa97683c165d26dac780fd6637814.gif )
...
nest g resource aaa
```
![](./images/4dfc1bf3f387d5d923498a12d2eb0754.webp )

把 AaaService 导出：

![](./images/57840ae2dd9425dca7b2de57551af321.webp )
...
![](./images/820f71b1f6d3cc73021328dd17439ea5.webp )

上节我们定时把 redis 数据刷入数据库就是这样做的。

我们设置的每 5s 执行一次，其实是一个 cron 表达式：

![](./images/78b288329c795d8e6647d2a46e5a3f2a.webp )

cron 表达式有这 7 个字段：

![](./images/1a76ac5c2e42dc9ee5409632eb8c9dd2.webp )
...
![](./images/cb162b72d02f41bc15f35180992313bf.webp )
...
![](./images/91b3f82b33b2b1d9a5ebefcbeeacf13c.webp )

这个 @Cron 装饰器还有第二个参数，可以指定定时任务的名字，还有时区：

![](./images/e496e56b075f5b1ba02bb4adabcdb194.webp )

时区的名字可以在[这里](https://momentjs.com/timezone/)查：

![](./images/04a016316c8eb8ecfc4339bf95b5b571.gif )

除了 @Cron 之外，你还可以用 @Interval 指定任务的执行间隔，参数是毫秒值：

![](./images/06d17c293257fd26ed389631cbd7d64c.webp )
...
```
![](./images/346a337d79f0e1622803aaea577880ec.gif )
...
```
![](./images/3d114178f6c9ade47a840051acaf7c1a.webp )
...
![](./images/fefc1ac2e6ee4d83b6e7dd9ceadaf35a.webp )
...
![](./images/352d1d179f60993882de8874d2233342.webp )

这样看不方便，我们加一下调试配置：

![](./images/ff1ddfb217c460fe6806afb4b1d535ad.webp )

![](./images/49651352f8a7c4805ca8fbdbc0a7d4c6.webp )
```json
{
    "type": "node",
    "request": "launch",
...
![](./images/eec3659b5aba0a7e609f9da6ce75fe68.webp )

把之前的服务停掉，点击 debug 启动：

![](./images/5ac2b984eeaeb498092abfa4ecc8f2ab.webp )

代码会在断点处断住：

![](./images/a4b4a9b4bab09c23b3ec7b87a84fb4b9.webp )
...
![](./images/2d2473ce93c5943155502058bde95694.webp )

再根据名字拿到具体的 interval 定时任务：

![](./images/f0363f34cb52dda1f1d1a2ae82c41b44.webp )
...
![](./images/1c3482cce5643b6d6c4dfb63e60c53b5.webp )
```javascript
this.schedulerRegistry.getTimeouts();

this.schedulerRegistry.getTimeout('task3')
```
![](./images/dbfade24f61382a4cc8d6cd7f49e58fa.webp )
...
![](./images/44b9cddc2a30702a1e9feb6d2f75e399.webp )
...
![](./images/cb04b0c3f4565e836472620c49ffe767.webp )

当然，还可以动态添加定时任务：

![](./images/908255ef881b92476d65b0ba767a586d.webp )
...
![](./images/1ca8eb5c1d6ce323dce82a575376ad0f.webp )
