...
![](./images/bedd6e9943cda6b4193c5ee4269622a7.png )
...
![](./images/d54c2ebe489ef2ae8ce296f9f1f3824d.png )
...
![](./images/122e43f2e761feb391532514774e962f.png )

postman 里访问下：

![](./images/d7d122d42153c461c557f651c83d66cd.png )
...
![](./images/71fbb21617ed25cc1d42803cbcedb44a.png )
...
![](./images/5f27cc7f1e1c3ca28229a9c515936e2c.png )

![](./images/fe33fa2a93d340965ac5353e796ffab7.png )
...
![](./images/88defc33e939220a8f1e4c23ead757a0.png )
...
![](./images/2c6f3d4c4cabdbb1035662b71ee1fb3e.png )

现在带不带版本号，不管版本号是几都可以访问这些接口：

![](./images/478f5c6de732f9378dff5014a45f3afc.png )

![](./images/2ef199da096b501aeed744ba1627fc21.png )

![](./images/44a5dbe9928ba2aaeedc82a902f1813b.png )

但是现在因为从上到下匹配，版本 2 的接口不起作用了：

![](./images/b33cfd709e5f0e5b21669a71fbfdd551.png )

这时候或者可以把它移到上面去：

![](./images/8079a29b4cd02f5419ebb7c40aee3758.png )

![](./images/fda2533b9fdaf82ee50b8e7cfd7df1bc.png )
...
![](./images/057ec3bedb56e0269b14521c6a848095.png )
...
![](./images/fa62ab8e4d2cb4c9a09491efc3aefc7c.png )

其他版本走 AaaController：

![](./images/89bbfd0580f32d3e972b2891aaea4577.png )

一般我们就是这样做的，有一个 Controller 标记为 VERSION_NEUTRAL，其他版本的接口放在单独 Controller 里。

注意，controller 之间同样要注意顺序，前面的 controller 先生效：

![](./images/effd5a3f6ac64a5973dffb2ad345a0c7.png )

试一下：

![](./images/0931b8c366dfc9ae8c159690844ab7ca.png )

![](./images/c4c94dac6c56b9acde7dca2daf803554.png )

除了用自定义 header 携带版本号，还有别的方式：

![](./images/d21abeaa5b89bed62dcc871d212cfa6c.png )
...
![](./images/424122364b28d750b9d68fc82ecacfb8.png )

![](./images/63a9a0bc8afda698bd40e626781af562.png )
...
![](./images/c19868fe6fe2aadba17a785cb5fb7355.png )


但是这种方式不支持 VERSION_NEUTRAL，你要指定明确的版本号才可以：

![](./images/d7e34613311e811b80d33da26cdc7223.png )

![](./images/29c33a364c1daad474f1327ab4b569ab.png )

![](./images/b1667b437f236a34d5941d58b3ed07c4.png )

![](./images/e06424677372c0db87d210f10eabb067.png )
...
![](./images/7f5c9de316c338030f68732c2b7457e4.png )

![](./images/2d41523ecbe1fead8e693b9cd984646f.png )

![](./images/db169e50d62c9a68a391907022e4eddc.png )
