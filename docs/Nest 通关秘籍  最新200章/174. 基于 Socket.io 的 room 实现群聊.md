...
![](./images/dbc4c1354e900da6987dbab64b3b6ff3.webp )
...
![](./images/4f6c7a80cc48c8b163b76bea0714bf44.webp )
...
```
![](./images/b5a71ecdb4ca38929d38d79ac5d697ba.webp )

注意，选择生成 WebSockets 类型的代码。

这样，基于 websocket 的 crud 代码就生成了：

![](./images/eb25cee0e983c4a700edead8e706e9ab.webp )
...
![](./images/7b266c1584770b4305a6555b23673977.webp )
...
![](./images/234d9d619b03f64a503e31d38f72fdd0.webp )

浏览器访问下：

![](./images/e5bfc8820b8e474473fbec0d2cbdbd63.webp )

![](./images/1dd9a35efd02a09c589726e92da320a6.webp )
...
![](./images/1ac343e0b600c8fa94459e1bf78a1a68.webp )

这两种是等价写法：

![](./images/fa308da3987480625d9fe22b956bea55.webp )
...
![](./images/dfc3ef2778e2b3025c0762fcf0cc4f85.webp )

再打开一个页面，进入 bbb 房间，这时候之前的 aaa 房间并没有收到消息：

![](./images/3c0d3dd13dba6d77a83505efc8bfd739.gif )
...
![](./images/fbf9cc366dbcb9569737bdeab62c354a.webp )
```javascript
import { MessageBody,SubscribeMessage, WebSocketGateway, WebSocketServer } from '@nestjs/websockets';
import { Server, Socket } from 'socket.io';
...
![](./images/8eb5df479ee9c9fa3972a86008559b29.webp )
