...
![](./images/0a6b87e67724c96c49e6856363b960f7.png )

但是只在接口返回 401 的时候做处理不够，我们应该在路由级别也做下判断，也就是路由守卫。

分析下 frontend_user 的现有路由，需要登录的这几个页面都会渲染 Index 组件：

![](./images/9ad37cc6fa7ec88ce5412bdbc2c351ba.png )

所以我们在 Index 组件里做下判断就好了：

![](./images/2faf5b90ee3a58d2a6209e9e5ca6ab55.png )
...
![](./images/467d7e916001c0f45bfff5f7773c3b93.png )
...
![](./images/e5f07af462837f3c0bf4c52863e48fa1.gif )
...
![](./images/17f014eb7a09c35d1a6104d458f4f015.png )
...
![](./images/7c737737d6843a0944e95f2742590615.png )

![](./images/b6fb91164084956e47f1f325f5dbb868.png )

去掉 main.tsx 里的 index.css 和 StrictMode：

![](./images/d9dbb21762c71eecd4f57a9aa44e59ee.png )
...
![](./images/c6695f3af070ed68ef7bca506dc730fd.png )
...
![](./images/bc2211ed33427e4e3dfe2bbdde754ceb.png )
...
![](./images/de267088268f5be02f9a927250b4efca.png )

memo 里会对比 props 和上次有没有变化，没变就不会重新渲染。

那如果我加一个函数作为参数呢？

![](./images/668a53b8adbd74988e484964da85169b.png )
...
![](./images/6931e74c9905f419863563c1cd4cc78f.png )

所以说，memo 和 useCallback、useMemo 是配合使用的，我们之前单独用 useCallback 没什么意义。

代码里的 useCallback 可以去掉。

![](./images/4edf3131bb0c568145e36da6907b7ae2.png )
