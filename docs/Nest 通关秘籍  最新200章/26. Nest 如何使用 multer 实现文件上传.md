...
```
![](./images/b19c2573cede6f173b419938e1e0f965.png )
...
![](./images/4eb9db4d0c754970f69fb1de03ec8af4.png )

然后来写前端代码。

之前我们用过这种方式：

![](./images/e74bcc587ce596d3661510b526cfb6f1.png )

就是让 nest 服务支持静态文件的访问。

现在我们换种方式，让 nest 服务支持跨域，再单独跑个 http-server 来提供静态服务：

![](./images/6c716bd5af2c81bf2296f151c2d8b512.png )

![](./images/9c459d0a80a25ad923f06092244ec729.png )
...
![](./images/68bfd2ec841a316b46c4b4bedd149193.png )

服务端就打印了 file 对象，并且文件也保存到了 uploads 目录：

![](./images/f71d6051f7075f4d69c84ff7e500b8cd.png )
...
![](./images/069c2ef0e09507edd6d2a863081a885e.png )
...
![](./images/3f59fe6f6dc5d9e7247b52b589c142cb.png )

后端收到了上传的 aaa、bbb 的文件：

![](./images/da37b23c9ecc3a644be63933d0a7687c.png )
...
![](./images/c5649f705127bbe4ee6df4f3215d8f95.png )
...
![](./images/f22c1c214ba4c72995d8299385149cae.png )

![](./images/df347932533dca3d446164ed5c6490b2.png )
...
![](./images/b1eee3b14116f19547768eb250255202.png )

在 FileInterceptor 里也是一样：

![](./images/5eae0573fa228b9592c418b6d371cacc.png )

在 multer 里我们是通过 array 方法来处理多个 file 的字段：

![](./images/7a7a62c950aad54d31f3a986e85649ef.png )

在 FilesInterceptor 里也一样：

![](./images/1c199458a95389e17800ea4805f9671a.png )

另外两个装饰器也是同理：

![](./images/117cef7bf4eefbd1f7f15f59c235087a.png )

![](./images/9f1fd0b6ebd3164dd01a50992f284447.png )

而 UploadedFile、UploadedFiles 这些装饰器，只是从 request 中取出处理完的 file、files 等属性作为参数传入 handler：

![](./images/2d798aa7948972b9ae724eefd276d218.png )

了解了这些装饰器的原理之后，回头再来看这些文件上传用的装饰器，是不是就很清晰了呢：

![](./images/e8911c066e66df6bb81e7e22eaec57a3.png )
...
![](./images/ae04c7515fb2aa2b74d004e942d95827.png )

然后访问下：

![](./images/54a59bd02c759603fe38a597bc33042d.png )
...
![](./images/8bb5373cc912eef9f8d8ec49335a2891.png )

可以看到，返回的也是 400 响应，并且 message 说明了具体的错误信息。

而且这个错误信息可以自己修改：

![](./images/ef19c3784da336b653d1c44b02ad4a67.png )

![](./images/c524a9022b338f746cd18711c5c08329.png )
...
![](./images/67570c353944ce5770540aacda578c7a.png )

在浏览器上传个文件：

![](./images/e6e00bad6f00135b53d4e62a95efe2ae.png )
