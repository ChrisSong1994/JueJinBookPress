...
![](./images/68d7b919cb380c7736a6158a55af9581.png )

那总金额就是 200，需要改 order 表的 total\_amount 为 200。

![](./images/f69976c0fddef73664a85eed1b39a5d9.png )
...
![](./images/6c722dafd778d91c73c626f65bf8ace7.png )

![](./images/fce2ceaf9a304426f3764694a3a0ad3d.png )
...
![](./images/1305dd2e6c0222871aa11f4a2b9ce8f4.png )

你会发现它们的数据恢复了：

![](./images/3813d93cce5dfeb04b61ff19ac8c3cf5.png )

![](./images/26886bfab6e2fe9a7dd1d87e16bbcb06.png )
...
![](./images/9240e4cad71bbd8c1b53b5632d7b6eef.png )
...
![](./images/6ae553a9f59070154af4f94eac42f40c.png )

![](./images/2c22916a40a31f53cc941f400a2470fe.png )
...
![](./images/203705f5039f1c9dc86df390d17367fc.png )

![](./images/09de58d5b84829ce1a2d343bf388e6eb.png )

这时候 order\_items 表修改成功了，但是 orders 表修改没成功。

这确实是这个点的状态：

![image.png](./images/4f6bdb60fad1c8496e162c0a5c7f6df7.png )
...
![](./images/313eadde1aa554789a53dac491afc5ff.png )

![](./images/a016c722ff576d9bfe649e60b553c6cc.png )
...
```
![](./images/1ba951be2dac1543f6bde65fb6e64d39.png )
