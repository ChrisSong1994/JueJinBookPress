...
![](./images/7c07f394c037b47bdb6328570061c073.webp )

access_token 用来做登录鉴权：

![](./images/47816d0bd0df07e9b63f33d80d6267fc.webp )

而 refresh_token 用来刷新，拿到新 token：

![](./images/9bfc15decd1996fc98ed6bbd6aa92e8b.webp )
...
![](./images/7b11580ace351d37b2d3b71456d2e7ab.webp )
...
```
![](./images/15d578b1d0843037b858c760215f484e.webp )
...
![](./images/11604cc4e22b880e5870bb5b619f87a1.webp )

![](./images/cd99878a814c4db16abd3366ca27b63c.webp )
...
![](./images/a430c041452d78dc63539ea06882e35a.webp )
...
![](./images/75ffe75a7a7add2d61b4f6c58a59906d.webp )

在 mysql workbench 里可以看到 user 表：

![](./images/f2ca3ebdd17ad17aa05e96003d341784.webp )
...
![](./images/8dd0d3f549b3abb6cfaab31f6ede8cc4.webp )

![](./images/c59f0d722660d3b17a6caf803bb5ec7d.webp )
...
![](./images/d829c6bf4d060121a5fe787462c496d0.webp )
...
![](./images/402968e097f712c4c0896c72a54134ff.webp )
...
![](./images/80acbd28d0517728b33932236bfb83eb.webp )

我们测试一下：

![](./images/cfc31f052a5b59323be531b7abefb3b4.webp )

![](./images/047e17527e00e478bb05d51c030b5f31.webp )

鉴权逻辑生效了。

然后我们登录下：

![](./images/8faf9ecd4d151f5009bff0b7adac94fc.webp )

把 access_token 复制下来，加到 header 里再访问：

![](./images/7843371b1770fbf7c46d80dd3044845b.webp )
...
![](./images/f1bc4a4a4fdfc26cf00c05e6cc4a825a.webp )

refresh_token 失效或者错误时，会返回 401 的响应码，提示需要重新登录：

![](./images/49df33573b6f34bd47aa1e6f15dbec1a.webp )
...
![](./images/c26b2038a20b1b798265b57ab7ceb660.webp )
...
![](./images/2f47b51945f2b6acc73e41a55d18acd0.webp )
...
![](./images/8d37cbb595a27e804ed5f514e5d62f0f.webp )

可以看到 /aaa 访问成功，返回了数据，/bbb 返回了 401

![](./images/f5234e4b54564a8a3d7db7238a2a84c8.webp )

这里请求两次是因为 index.tsx 里面有个 React.StrictMode，把它去掉就好了：

![](./images/56b29bfd40222e849eba80a6c249e6ec.webp )

![](./images/5a4b2ab0af1af548d84549fb03eadd34.webp )

我们先登录一下，拿到 access_token，然后在请求的时候带上：

![](./images/9e1056f59dfb871ce8af7f16cfb2b26a.webp )
...
![](./images/96fba70491a27b4824973277c657f34b.webp )

![](./images/90bb8527e66024a393973ceb6248b41c.webp )

![](./images/dfa1a3da446630894fd85233f7b48305.webp )

如果很多接口都要添加这个 header，可以把它放在 interceptors 里做：

![](./images/00b15619e44c6ddebb7670bab10bb147.webp )
...
![](./images/0f073653a0ea48da553a0f8828ef7709.webp )
...
![](./images/f514a1b0fb5df479c1064f71aefbc412.webp )
```javascript
...
![](./images/58bb953863aec849a4d7aec65be23470.webp )

刷新下页面：

![](./images/3355bb6ca5c64ab408229ff4ce095304.webp )
...
![](./images/0935bff14af3b6b17fc5c2a02f9cd0bd.webp )
...
![](./images/30cddf019189c558b2e9de6dea6c5e2e.webp )

确实刷新了多次，并发的 3 次，还有后面又访问了一次：

![](./images/a5300033d975bd5d37f692bf86ba7d46.webp )

其实这样不处理也行，多刷几次也不影响功能。

但做的完美点还是要处理下：

![](./images/ad4905b7a0e4b1d16db4e08b1fb16d21.webp )

![](./images/afaccb3bb622a2ea077ed10a3223f1be.webp )
...
![](./images/917a44eede6c9cafbec63a869ece5ad9.webp )

现在就只刷新一次 token 了：

![](./images/81119a6fe56636db7af2a14b7a613260.webp )

最后，为什么说双 token 会更安全呢？

![](./images/e4d09b8a699199492bdec6a366ba72ae.webp )
