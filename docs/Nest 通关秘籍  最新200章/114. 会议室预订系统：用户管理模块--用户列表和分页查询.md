...
![](./images/ad8136df019d1a16cf8f8bde551a5b78.webp )
...
![](./images/f4566815c29ba656ce7012810745bee3.webp )
...
![](./images/28082c2db40cb5c2030211e78aec1782.webp )

然后把 LoginGuard 里的异常改成 UnLoginException

![](./images/11af3e65faf2ae1b720b2ffadb823039.webp )

测试下：

![](./images/8428f574862461212cb90780cd153124.webp )

现在当你不带 token 访问 /aaa 的时候，返回的就是自己定义的格式了。

搜索下之前代码里抛的异常：

![](./images/418f89005653105b19275c52a92a555f.webp )
...
![](./images/4e83efdbf3974b3552e96ee8697e7a96.webp )

这样，所有的代码都不用修改，返回的响应就已经变了：

![](./images/1af508253e96664b836339a4867a6616.webp )

![](./images/fa18259daeeecc32b11c4344481e441b.webp )
...
![](./images/ce124d693c13e6cb00598e30a83049a3.webp )
...
![](./images/3718efbca3c2ebbf415d2d2ed5fa8a37.webp )
...
![](./images/1a7dcf537548d3721afe5ee61131b253.webp )
...
![](./images/58d823afa82e5f797bba21916555b900.webp )
...
![](./images/995de8aef0c9bb6df530abc1a3ae0cad.webp )

当我传 nickName 包含“里”的时候，服务端查询到数据只有一条。

![](./images/36a8a11a71cd08be298bdc600af16c0b.webp )
