...
![](./images/34de9b48e6484d3bcd82aae1e56e190e.png )

这两天国庆节，大家出去玩可能会借用共享充电宝。它也是基于你的位置来搜索附近充电宝：

![](./images/390aa87c341b52c895f3185818ead822.png )
...
![](./images/ff1339623d6c5eb4bf1d491341087dab.png )
...
![](./images/11ed8f7ebb5f309a247452d019eb1652.png )
...
![](./images/f85e5aec8ff84573b73acd7d5cde0dbe.png )
...
![](./images/42bd02c489ea5fd24c77d09f3b02204c.png )
...
![](./images/fda12c5841cf74749af5b051c7e30d7e.png )
...
![](./images/75fac6ddc28140255b622dd0ea0f627a.png )

因为两个点相距 166km，所以搜索 100km 以内的点，只能搜到一个。而 200km 的内的点，能搜到两个。

这样，我们就可以实现搜索附近 1km 的充电宝的功能。

![](./images/1b381426bbf7989a8562244748dfe739.png )
...
![](./images/d7dd6f75aef1870acde4f40c1f9f1354.png )

指定 marker 的经纬度和图片就行。

这是添加 Circle 的代码：

![](./images/4455d8e967c6a70f2028756949b3424b.png )
...
```
![](./images/9f08f3cd654db88cbf0d8e1d090a7a9a.png )
...
![](./images/c369a8dd9e87c6e489ec05f6d03bda34.png )

浏览器访问 http://localhost:3000 可以看到 hello world，就代表 nest 服务跑起来了：

![](./images/e52288152cda458b18af2434497d80c5.png )
...
![](./images/8ed861881caea52088dc610136e47657.png )
...
![](./images/3b7a4014332687e453d605fdb6568a56.png )

/addPos?name=guang&longitude=15&latitude=35

![](./images/ca854b51a797ba397a1f9e5ba4b339f4.png )

/addPos?name=dong&longitude=15&latitude=85

![](./images/5ce80b5a4bbf62ae9c4186ac3f29551d.png )

然后去 RedisInsight 里看下：

![](./images/8b5a4447d3d7e97acda59c6a71fdec8a.png )

点击刷新，可以看到确实有了 positions 的数据。

然后我们再添加个查询位置列表的接口：

![](./images/2f9a5f447e89f86bcc74b1ddaca596e9.png )
...
![](./images/3814d7bb1da6b43aea2806b29d1730d2.png )

没啥问题。

在 AppController 添加两个路由：

![](./images/1c46bc9edd068b71fef961665123a086.png )
...
![](./images/104381f5069630e35cbee19ac265affb.png )

![](./images/3e465aeac7ee0cc81157aad13e5b1315.png )

最后，还要提供一个搜索附近的点的接口：

在 RedisService 添加 geoSearch 方法，传入 key，经纬度、搜索半径，返回附近的点：

![](./images/1a15e521a74c7e95dc1c9a1176701e92.png )
...
![](./images/eea9c568ad02986f4966e9f7f250b066.png )
...
![](./images/23f35f41abc88b7547465ab8729b6019.png )
...
![](./images/d5c99b963a38cd8336307cfa55066a97.png )
...
![](./images/d1be2d76260c832fe1cb6db0fb161a69.png )

不过现在的经纬度我们是随便给的。

可以用高德地图的坐标拾取工具来取几个位置：

![](./images/b0e7553cc73db61c5054b24219c30b47.png )

天安门： 116.397444,39.909183

![](./images/300d9e15725742e681cdf93dba3c2ae4.png )

文化宫科技馆：116.3993,39.908578

![](./images/909303f8aad5e83adb82799e886e95fd.png )

售票处：116.397283,39.90943

![](./images/828d8a238d9938297e4b9616a59c6dc7.png )

故宫彩扩部：116.398002,39.909175

![](./images/7c515cdc64d6d1b56415db01102b5d0d.png )
...
![](./images/cc17a38d35538a000405c2322ef0b5e5.png )
...
![](./images/9f6f9a4a28b3eb5a126c957b8e693d4c.png )
...
![](./images/e65e68efac61f2fb1d2f3e2eaae7f6b0.png )

/nearbySearch?longitude=116.397444&latitude=39.909183&radius=0.05

![](./images/73d554b58e8f73dde39cd43e9f9252f6.png )
...
![](./images/c15df5306af7c501cc1d6b6e788cd785.png )
...
![](./images/b7c59b94b94e1a414af69299b854dd3a.png )

接下来引入 axios，来调用服务端接口：

![](./images/7d7417b420ec6c2697e084ee49d373cf.png )
```html
<!doctype html>
<html>
<head>
...
![](./images/dd650dea1897091c8cdc48130f9f79c4.png )

然后把 radius 改成 0.05，是这样的：

![](./images/dd0cacab402e664bda038ce7df0e2537.png )
