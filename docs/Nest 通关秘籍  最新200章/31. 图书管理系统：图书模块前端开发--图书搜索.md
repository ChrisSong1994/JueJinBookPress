...
![](./images/e951c3d02b91ccb51257d03a5edb1956.png )

![](./images/a12ac1918e200841646a57a8055711b9.png )
...
![](./images/5b1588ee159535b1b5a6e2c9d67b05be.png )

![](./images/ce9afec27929f02f77832589f3a5c337.png )
...
![](./images/667b79cd3bb5a977d5c233ccaf926767.png )
```javascript
...
![](./images/c31d1bd9f4fb3e179fcc87b8746950d8.png )

![](./images/67270ce0f586e133b12f2f70a054107a.png )
...
![](./images/1b9d3a939f572513b384d7d09aa690e3.png )

可以看到，图书列表加载并渲染了出来。

然后来实现下搜索，之前的 list 接口没支持搜索，我们改造下：

![](./images/29b4139f09d89dec345c0a635779bdac.png )
...
![](./images/0dbb22c97f0e2696e37075e687c1a211.png )
...
![](./images/1200e3f9db2d34f61baebf7004aaf767.png )

传 name=西 时：
![](./images/dbe99bd0f31f6fa913c3d2fdbcfd1cd5.png )

传 name=水 时：
![](./images/f68d2a0b4cc7f50bef2aa86cebbd666c.png )

然后我们在前端代码里调用下：

![](./images/f7ca9b55ce2e37fd17711f922cfacddb.png )
...
```
![](./images/774b13c7df46462a73e23fbf29dbb638.png )
