...
![](./images/8b13df4564e836fada66b1c96498c5ea.png )
...
![](./images/64c93e67aa0ef2d4190688b3d5721f3d.png )

之后进入[控制台](https://console.qweather.com/#/console)，点击创建项目：

![](./images/117a5900b8b178ef0da00814478cedd0.png )

这里大家选择免费订阅（我别的项目用了，就没免费名额了），指定 key 的名字：

![](./images/b54e436e2c33c70a04b8eee74778cce8.png )
...
![](./images/32b19d91da6be4e0cf63e7d75c2a639a.png )
...
![](./images/a11b110be3e1feadc7968d9cdf285283.png )
...
![](./images/9bb3de6c3e2fc9e2737c05e4f5b94072.png )
...
![](./images/d238b3ab90c0bebf855edae32dd1b0a1.png )
...
![](./images/1c7f1385c3793be4c0dd5c2892bf2ffe.png )
...
```
![](./images/5ea7a163ec7fb2ab60c8f2ee9186d317.png )
...
![](./images/19a328d2e539db466628520d416cc731.png )
...
![](./images/4df2cafc19d4c7a2f062fccd040c42c2.png )

访问下试试：

![](./images/752f8bab99f325a28a78f18cca7a7da0.png )
...
![](./images/06abad084634432d6ea389ef41c21c9d.png )

这样就好了：

![](./images/f7d0c3c7cd65af93a2cc9e30b3c234be.png )
...
![](./images/77a1866e6587d17272a41a98c31698c5.png )

这里可以填入各种请求配置，比如 baseURL 等，其实就是 new 了一个 Axios 实例：

![](./images/bf9fe890e9d8051b07d3b4fdf614b5bd.png )

然后在用到的地方注入 httpService：

![](./images/7ed2acb157d27e33a291654dff249180.png )
...
![](./images/1d1cecab384830d201129b7678c4a7d1.png )

测试下：

![](./images/0003bbce2aace549740ad85420d364ef.png )
...
![](./images/38904c57b4593316f3100780a379f3bc.png )

![](./images/1b22458ff1ca01089af976924eef4374.png )
