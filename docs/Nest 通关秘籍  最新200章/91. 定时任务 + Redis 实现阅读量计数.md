...
![](./images/0af49b5100ce4d219ed493d2916cf8ee.webp )
...
![](./images/694d7739dbc6365f0c5971a2f6e9267a.webp )
...
![](./images/890ce6b8c86291de9bef8bbd40ccb8f2.webp )

刷新可以看到这个 database

![](./images/3bb3af1b00bc4f251d8d0b623873e367.webp )
...
![](./images/b896357b4343d6c784749a078808bcaa.webp )
...
![](./images/26a831a5fbb9cab61303d51eed9beece.webp )

可以看到 typeorm 自动创建了这两个表：

![](./images/d536d1a915fd11d1d4fb812093c90433.webp )

然后插入一些数据：

在 AppController 创建 init-data 的路由，然后注入 EntityManager：

![](./images/e26fb6bccc7e81f7761c1b50bdae9668.webp )
...
![](./images/3ea3d8b52d1c9435e3d2d2c2715f458a.webp )


可以看到 4 条 insert 语句：

![](./images/b087e8eea6530ba29fda04a55f2d9aa4.webp )

在 mysql workbench 里也可以看到两个表都插入了数据：

![](./images/1d3ee01f08642bfd0ab9a55f7433c75e.webp )

![](./images/12c3cce2893d97173fda5b6fa1e24f79.webp )
...
![](./images/b0023b02aa8369f2a1dd53ec4efea7e8.webp )
...
![](./images/857cfe160460ec2e37a696d5a13957bc.webp )

![](./images/261e4ae875ab9ce826b5f42f6cc5ecc5.webp )
...
![](./images/64d17df8a9a937e795bb5540e8e88135.webp )

当密码错误时：

![](./images/30aa69d9da7d85d7f772a0b91325daf1.webp )

登录成功时：

![](./images/7e38f9bde7769cd69ea5562755ba78f8.webp )
...
![](./images/95e80a4babe277574680f287b0723355.webp )
...
![](./images/3a81d81252aa8c282e9ac680e6fe9545.webp )

再次查询出来的就是新的阅读量：

![](./images/5415083047d963d43b790cb00d1c0878.webp )
...
![](./images/2d36bb21b18975eccd71530a24fa2203.webp )

服务端打印了 3 条 sql：

![](./images/332154aefc09df76b795f9379750e550.webp )

redis 里也有了这个 hash 的结构：

![](./images/dc6dc5e48aa74b2e58d300a3747418c6.webp )
...
![](./images/af75c30d95a784a323c83c6de2a5534d.webp )
...
![](./images/a78b45bcd227c7c69c78b19aeef4befb.webp )

重新跑一下：

![](./images/76ace1f96511eef4ad4427a0755c2535.webp )

现在就只有一条 select、一条 update 了。

![](./images/6bc1c747b59728cafeea71e49f092885.webp )
...
![](./images/47be414ac19bdaa4d04b860a9cfbf82c.webp )

因为这时候查的是 redis。

redis 里数据更新了：

![](./images/4b10865e8f5ac8545ce6ff0d0f7f438b.webp )

但是数据库里的 viewCount 还是 8

![](./images/904925ba13231dc126a321dec4f55567.webp )
...
![](./images/9c29e628e9472dbed5131409e2927d35.webp )
...
nest g service task
```
![](./images/6f0dbba9a4ea0097fb57cf6d579b6d7b.webp )
...
![](./images/9aadc31ab4a7ff3379be15b96708d2c2.webp )
...
![](./images/3b70c76f8084ef1d4b9fcb600e3003dc.webp )
...
![](./images/ba429bc9ee404791dde6c6147d764387.webp )
...
![](./images/c802afffce83bc8f4a283877965def63.webp )

现在只有一个 key，我们再访问下另一篇文章


![](./images/49fc13127cb07e2baa7758a336163ed8.webp )

现在就有 2 个 key 了：

![](./images/1bd8599dee50fc244b213a4f785d17e4.webp )
...
![](./images/a8dc06b96bf93edf392032b774f8895d.webp )

但是数据库里没变：

![](./images/37e69e7bb967f3badbf71c11b264eb3f.webp )

过了一会，控制台打印了 2 条 update 语句：

![](./images/6c2c950f0cc0668060ffd3b6fb4738ec.webp )

数据库里的数据就更新了：

![](./images/90a96bc67ed2e5ac3017540ab5172268.webp )

接下来只要把定时任务的执行时间改为 4 点就好了：

![](./images/7d126145e7a6cd2845211547454a3f86.webp )
...
![](./images/82662a39aed836297eb254e8f5e50c54.webp )
...
![](./images/e8cb5c16210574812a3261e0652af716.webp )

只不过现在没登录，用的是 ip，而本地访问的时候获取的 ip 就是 ::1 这样的，线上就能拿到具体的 ip 了。

然后我们登录下再访问：

![](./images/f7e58b38007f658184819ec8b3a130aa.webp )

![](./images/f58e20ae8ba5e577d761abdaa97c5310.webp )

这时用的就是用户 id 了：

![](./images/9c8d9acdd4d0b1d4820139a0c1402515.webp )
