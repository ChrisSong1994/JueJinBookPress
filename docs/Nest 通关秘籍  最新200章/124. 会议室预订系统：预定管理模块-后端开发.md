...
![](./images/3e9aaf1d2b910f67c621d1a450762cc7.png )

![](./images/72833645c64320dc37c41e0e25d820ab.png )
...
```
![](./images/92fe476c80a6142adceab11345ef96b4.png )
...
![](./images/9f1bef40f1cc13bb4d982b7ddf78782c.png )

我们在 entities 引入：

![](./images/e75e7f3e1ca512bc857d176bb810fc1f.png )

typeorm 会自动建表和创建外键：

![](./images/82f0bb5bde66a4d738d5a1538d5accdb.png )

在 mysql workbench 里可以看到这个表：

![](./images/e953cc04d9ccf10c2c20b4a00f41e4ac.png )

这两个外键都是 restrict 的约束：

![](./images/590e987d1b38510d257f03822aa22843.png )

restrict 是只有从表没有相关记录，才可以删除主表记录。

但我们会议室是支持删除的，怎么办呢？

![](./images/ca46ecdf6aa739231f3002b14d1965ff.png )
...
![](./images/480ab8781641f3120a954272b1af87a8.png )

在数据库的 booking 表可以看到插入了 4 条记录：

![](./images/bb2044f385c206486baf3e53cc874188.png )
...
![](./images/96a659e67caf5a998e09f9252449b2c5.png )

我们来写一下：

![](./images/108508af8048a4e775afe0587820272d.png )
...
![](./images/529db0b5f85bc8d19274bd501d1395be.png )

先看下有啥数据：

![](./images/1d76a0507504665779751ef9ff8c5c3c.png )

![](./images/c4270241ad68387ac5cf6a0cc8dbe75e.png )

![](./images/662ae472c833806a2aa70a882fbdc8ad.png )
...
```
![](./images/b1d6f91f59005091d51405934bf32654.png )
...
![](./images/103b324a5b3d975b217d60264febcff3.png )

打印了一堆 sql，下面有查询的结果：

![](./images/655b988f90ec4471f41955a29c0ebf73.png )

查询出来的是 id 为 1 和 3 的记录。

因为条件是 user.name 包含 guang：

![](./images/42f21619178b7e54ed2570bac554e7c5.png )

room.name 包含天王：

![](./images/2a62a60dff636269c1b1c758861ef3d0.png )

所以查出这两条是对的：

![](./images/6e5dac88cda0882a4deb2827df019747.png )
...
![](./images/07d6e981ad61865581d7340461163e0d.png )

可以在这里指定 select 的字段：

![](./images/d31331ca010a3aebfc7a7287bae0faec.png )

但这样有点麻烦。

我们直接查出来之后把它删掉就好了：

![](./images/7330d3a378ee739f8a87c9d29977a252.png )
...
![](./images/e2025dfb7dd382fb986fef4d79d4214d.png )
...
![](./images/2bbb8aa692c1632a477214a9094e5aa6.png )
...
![](./images/3eb64253e18a5ecbb3468b584e21dfc4.png )
...
![](./images/2b09827bcf2056694a18458e4d72fef2.png )

带在 Aothrization 的 header 上访问 add 接口：

![](./images/d98b772e5a2712275e2a492eee974b4c.png )

![](./images/acb59f6e30e20616ba080318ec0b5437.png )
```json
{
    "meetingRoomId": 3,
...
![](./images/9b56cec3d1f9fe0c03d5e6fecf95d090.png )
...
![](./images/589bdba7860a333547df64522bea271a.png )
...
![](./images/069c67a1e2b95433254057e58d487633.png )
...
![](./images/e2d1e26e6a57b907acfb06d987d25929.png )
...
![](./images/bafa87b92d218abb4a3645d0c05232e9.png )

状态有这 4 种：

![](./images/9c49c4a51dfd2042f8c5b2e1a071a7e4.png )
...
```
![](./images/93aab5dbc7de364494abd1f3c943ed1c.png )

```
http://localhost:3005/booking/reject/2
```
![](./images/ad27af762e3f3b58732e9ef867d14d08.png )

```
http://localhost:3005/booking/reject/3
```

![](./images/f6f46d94420946f957fec19696897916.png )

在 mysql workbench 里可以看到状态成功被修改了：

![](./images/653757689c060bad839f59531f933b0f.png )
...
![](./images/63135b85b2304f692ba66e45d6e126d7.png )

第一次催办，管理员会收到邮件：

![](./images/b792d40f0ae6ba5fb581c482124bfc22.png )

第二次催办，会提示半小时只能催办一次：

![](./images/f586ceabd95079aac81325f4e344f6c0.png )

在 RedisInsight 里可以看到这两个 key：

![](./images/e6aaa0f25263e7bedcc1744464d3fb08.png )
