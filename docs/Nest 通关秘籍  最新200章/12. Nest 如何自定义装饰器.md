...
![](./images/777b762f273cebbbc2a6327113980888.png )

这个装饰器就是自定义的装饰器。

之前我们是这样用的 @SetMetadata

![](./images/0d123bc2521da322b7613e3e994e4965.png )
...
![](./images/15aa753af642e50c564872df2b05d486.png )
...
![](./images/f567d99f3d2e824f99857b0a47ba2841.png )
...
![](./images/80c04fb7eae15214ad79671f5a97ab41.png )

装饰器就可以简化成这样：

![](./images/ea8760676a61185bbcf5129a0124f099.png )
...
![](./images/682df33f63d1948c2f5decaec9649891.png )
...
![](./images/fff28031cb9edb23557696bb8826caab.png )

大家猜这个 c 参数的值是啥？

![](./images/5cfc61011f669bb9387bdca36be5af8d.png )

没错，就是 ccc，也就是说参数装饰器的返回值就是参数的值。

回过头来看看这个装饰器：

![](./images/99b1b8d44af2c6ab8d234d4f77f39bd9.png )
...
![](./images/6f3cb19ff79d6652de4128433df74b9f.png )
...
![](./images/9dbd08535dd67996edb017b53bd07ff2.png )

![](./images/b4ca1174f15943f6e8835643e649a22f.png )
...
![](./images/e5b1236b918a32c7221404e01d999013.png )

![](./images/ccaa8f6e813594b49a7017ce3f194a73.png )

![](./images/18952b55badebb2724bde5a48c1ede28.png )
...
![](./images/e1e147afdfff326f0aab34bc173174d4.png )

![](./images/003c1666eabaefd8d3541ae75c877bbf.png )

可以看到自定义装饰器生效了：

![](./images/d7466a90a386ac92dfdaab384babef3c.png )

也可以通过 applyDecorators 组合多个装饰器：

![](./images/7cde08d63682085f4c9587b7485269d7.png )

![](./images/91cc1d675e6bb11b3759908a050a3aff.png )

在 guard 里加一条打印：

![](./images/25bcc8c0b7b135674745ed5d348d358e.png )

浏览器访问下：

![](./images/5a70672a95b11342b353a4f6c620ca69.png )

可以看到 metadata 也设置成功了：

![](./images/1dff74e882b34dd0e014844311836125.png )
