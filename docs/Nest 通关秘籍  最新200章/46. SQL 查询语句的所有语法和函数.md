...
![](./images/6b9ffdad56d8484280f51c57ac276d5c.png )

上节我们跑 mysql 镜像的时候，把数据保存在了一个目录下，这次把那个目录挂载到新容器的 /var/lib/mysql

![](./images/58892b2a817c821a2953a13e57185f15.png )

指定容器名、端口映射，点击 run。

这次不用再指定 MYSQL\_ROOT\_PASSWORD 的环境变量了，因为这个配置同样保存在挂载目录下。

![](./images/679a19cdf746b1a464909d42bb20b050.png )
...
![](./images/eb64fec44572894aa7e5a7b63bc162e6.png )
...
![](./images/5c87a48114e655ef38518b0db7b46383.png )

![](./images/7ad8d655a9d3adafa07994e86b8eba7e.png )
...
![](./images/98073da12f437c1c3e3619bbb8a5f659.png )

然后执行建表 sql：

![](./images/fe319256c1a87b1ca8992450466ca0ea.png )
...
![](./images/aae3201c7e612fd3eba1efb72e1ca864.png )
...
![](./images/7dcc97cfba1cdef7035448660e7b11c2.png )

插入了这样 18 条数据：

![](./images/69081b46badfeb773e01e4397b7cef65.png )
...
![](./images/3dfcfb5c4c63278a5c49f28732b6a211.png )
...
![](./images/7eb3e28b3d4770bd6266e5f6eb8c91e5.png )
...
![](./images/66e276d18adf1c17217d03fc10d49f31.png )
...
![](./images/a1141e7eb6af83b9563e4bfc369e0814.png )
...
![](./images/7837c226d1429c7d5bf14f263880547a.png )
...
![](./images/3f0a14189fe66be58d6426fa3eea85ad.png )
...
![](./images/0e063daee744b1888190476b9d550788.png )
...
![](./images/e52a9deeccf9662ed6f556cdd125d4ab.png )
...
![](./images/1162608c9af59f5dc2bdcb6042f5d5b2.png )
...
![](./images/0345056b1b92f72fe209e3e7ad3c3de2.png )
...
![](./images/e7d8703e626566f9879b5469f510e086.png )
...
![](./images/57515d555bc763d3e8a4079da9c0747a.png )
...
![](./images/ea3b24ec47f1c9979da636f1c837f1ca.png )
...
![](./images/a44e00e05e6687a7e4dd6803bc41d5fc.png )
...
![](./images/1f315fb86c565b640c917bb5eeda8299.png )

过滤之后是这样：

![](./images/cfcc3a26a47d85de6c9d5fc305d23b97.png )
...
![](./images/be793b379665d9f2e4c9e0b26077e9d3.png )

这时候可以用 distinct 去重：

![](./images/85a9e570644d87c75b166a45ea455a4b.png )
...
![](./images/e1f3116d698bee1ac228eac721f298df.png )
...
![](./images/873f0e968603fddaee4e916b1731167e.png )
...
![](./images/2a4ca5ad1183f949b3e38a62f347a1b3.png )
...
```
![](./images/779628bb86226981a3575749b3d60182.png )
...
![](./images/e004983a2488c6fe7ed5919ea900dde1.png )

```sql
SELECT name, score, CASE WHEN score >=90 THEN '优秀' WHEN score >=60 THEN '良好'ELSE '差' END AS '档次' FROM student;
```

![](./images/eeccce6a144f1fa3e4d08acd6925cd6b.png )
...
![](./images/a31c5385a1ae1fd3cea3e00a4cc5b1cb.png )
...
![](./images/bee3d9aa62c0a1b128f0c032598b1a72.png )
...
![](./images/1186d3904645e4017585b99630ce81db.png )
...
![](./images/fd67c01ce8a197c82aa82a53a97ab7a6.png )
...
![](./images/339e2812828da1ba50946274631572bb.png )
...
![](./images/bd73a8cb4554644be1cf34ceebe5525e.png )

```sql
select greatest(1, cast('123' as signed),3);
```

![](./images/8e4ded4d5de035aa6aa99613da37018a.png )
...
![](./images/6dd8ba69e12ea66f96717b0d2d2a41d9.png )

```sql
SELECT STR_TO_DATE('2023-06-01', '%Y-%m-%d');
```

![](./images/d843ed8e8058298092af61c09705f6f0.png )

至此，我们就把 sql 查询的语法和函数都过了一遍。

此外，你可能注意到，写 sql 的时候，我们有的时候用单双引号，有的时候用反引号，有的时候不加引号：

![](./images/fa2a2929d3c6026d1925e59aa8350ade.png )

![](./images/ca9c372366d8fb983db70d40a13674f2.png )
