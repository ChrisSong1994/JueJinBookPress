...
![](./images/7a805ca1213efcafa34df3b637d01bca.png )

有现成的库 [emoji-mart](https://www.npmjs.com/package/emoji-mart)：

![](./images/5dee4dffbfd2293df6442e6b5ebd5b0c.png )
...
![](./images/1b6c9a44084b6d021096fbc834de6937.png )

![](./images/a944e1916538e9898113cf905cfc729b.png )
...
![](./images/f160ca8833b1e50959b5080594fcee18.png )
...
![](./images/78f62643671b2a764fdf0dbdb0ae4036.png )

![](./images/77a05263961396fd928044cf1e99abb9.png )
...
![](./images/ce68d687503425051550c8c96fa075b5.png )

首先在 sendMessage 方法加一个 type 参数，可以指定 image、text、file，默认是 text。

然后上传完图片之后，调用 sendMessage 方法，type 为 image：

![](./images/a03d6bb91ad24742e23e0681c930711d.png )

另外，消息展示的时候也要根据类型做下处理：

![](./images/45b3c154ae1edcb13959feed266882ef.png )
...
![](./images/4091ada27143c09a7e369c14cb7dc6fd.png )

type 为 file 的时候，预览部分直接展示 value：

![](./images/359b30272aa0a42d9ea0879e3253b556.png )
...
![](./images/3500a25b0cff60e4f68efdcee4088210.png )
...
![](./images/cb84e87cd3af15472723e8aea7b324c6.png )

加一个 uploadType 的参数，点击图片、文件按钮会设置不同的 type。

然后发送消息的时候，根据 type 来发：

![](./images/cda50ef53e494a6cd43ec78241ac57b6.png )

然后改下展示的内容：

![](./images/37226e0b3df98acb6bdd842f6f2dbf4b.png )
...
![](./images/4ec4dede779e9c0892ff2d8869dea904.png )

![](./images/01d00aa17fa47030ff736889f12df80e.png )
...
![](./images/d63a549d4c6bedbb62e2b7b5d037fb40.png )
