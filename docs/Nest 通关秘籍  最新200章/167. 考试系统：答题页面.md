...
![image.png](./images/8b36e94ab2fc7f24ffeb1f46cba6eef4.webp )

![image.png](./images/eba8eafbc53cfd04132f30e089c797de.webp )
...
![2024-08-27 10.03.31.gif](./images/9e7e97600deb2ec7134985a1ed0bdea6.gif )

跳转成功，id 也是对的。

我们编辑下，点击保存：

![2024-08-27 15.12.05.gif](./images/56431661570cb44f413e27d0f12abd15.gif )

加个返回按钮：

![image.png](./images/d6416bf490178e622669f412847464bc.webp )
...
![2024-08-27 15.15.13.gif](./images/e51fea796b2344e9701e1dc1dbfe1b41.gif )
...
![image.png](./images/72ff4663ab274f5ec468162973609413.webp )
...
![2024-08-27 15.20.05.gif](./images/f5e5011a311b1a4a8efbd1f5356cfe29.gif )
...
![image.png](./images/f522d91ce67a80056e9fbfe64f712c1f.webp )
...
![2024-08-27 15.33.21.gif](./images/cd62ef53f500a3ef7844d8c04fd6e58d.gif )
...
![image.png](./images/f4f26b11483a227e3122680e225a58f0.webp )
...
![image.png](./images/102647da3756040d20640c254ae34f62.webp )
点击提交的时候，打印下：

![image.png](./images/40dceb48840d5914caa8ef6174fe096a.webp )
...
![2024-08-27 16.01.23.gif](./images/8abf0ac360f8e76e49cc6e0b80a769b3.gif )

接下来只要调用下新建答卷的接口就好了。

![image.png](./images/31cc60354de5f90c2bc2fd9bd1cc8246.webp )
...
```
测试下：
![2024-08-27 16.14.41.gif](./images/2c89b9e452080be0eda5514fad9c0a25.gif )

提交成功，跳转的链接也是对的。

看下返回的响应：

![image.png](./images/fa12b9102815e0fbd44190869a068252.webp )
