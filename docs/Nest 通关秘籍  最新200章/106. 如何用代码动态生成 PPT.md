...
![](./images/3b2f7ff8c2bfc2419317ff46f1b2f4d6.png )

![](./images/62d67d0aaf487e9e851c5a1c47e7c197.png )
...
```
![](./images/1f136a8f688ca9517552de27d53f86ce.png )
安装 puppeteer：
...
npm run start:dev
```
![](./images/2f88763ce15635b8c045dcb73350d1f1.png )

试一下：

![](./images/3871c600dfd3ae1c1fd04be7115de4b7.png )

然后继续点进详情页，拿到学校的描述：

![](./images/62d67d0aaf487e9e851c5a1c47e7c197.png )

![](./images/2b9b9ff24c7fc7774807de4555f866f8.png )
...
![](./images/a5bfd7f446017fb6f6af21ed55505fea.png )
...
![](./images/e2d58359c49253fc593b6b880f438f9c.gif )
...
![](./images/757810e07b1605e6e60e09e6385e7afd.png )

![](./images/d1f704511f9dca21d818b328ce8f1cb9.png )
...
![image.png](./images/97ea64d21c6af4d1e28e1cca0b68df5c.png )

打开看一下：


![image.png](./images/38a85ed583ffca058dfd79e4788adfdb.png )
...
![](./images/8eb734632f9a108b0353386d79d588d1.png )

换成这里的：

![](./images/1094b5b6531202eeec7e6bd20dacf1ad.png )
...
```
![](./images/e21e4e3da784fc447cd636384e20b28c.png )

跑一下：

![](./images/ed42c435561d9dc7f2bee285bf592ca4.png )

跑完之后可以看到，动态生成了 400 多张 ppt：

![](./images/1f069bd7be81c3d3f86890e4698c8ab7.gif )
