...
![](./images/ffb13cf8ba14e749e7c057ab12bd669d.png )
...
![](./images/d920d9189e21d33b8246b100a3051377.png )

登录，拿到 token。

然后带上 token 访问 /user/info

![](./images/df747ec6733573d6c0ed420240931555.png )
...
![](./images/d5b4ec936fd4a9c1a51caa4c821b7aa0.png )

![](./images/a7fb5fc458b504ca568bccaace059fef.png )
...
![](./images/8b80015d9ac50b1680a6742cfe403d6f.png )

在 redis 里手动添加 update_password_captcha_邮箱 的 key，值为 111111

![](./images/d9019ebd4c52edc1536bcb0495ddeb06.png )

半小时过期。

注意，我们现在连的是 db2

![](./images/c1bd3fb39b44204c7e7965c11ee992ed.png )

然后再试下：

![](./images/80105c95daa6892c8292a4b76d77e9f7.png )

修改成功。

我们为了开发方便没对密码做加密，可以直观看出来密码修改成功了：

![](./images/ecb738bb93bd251fb88dfc18c7391b8d.png )
...
![](./images/9cf210e6add52091df4b38a42e2e80e0.png )

![](./images/e2057debf16c778705aa1593b2ab4b73.png )
...
![](./images/0ff3998ce07a2bb70a0efce08025a6b9.png )

![](./images/454b9004962e74d89b659156927b5da8.png )

登录账号拿到 token：

![](./images/19607396436425c6f93084ad6b5d563e.png )

带上 token 访问 /user/update 接口：

![](./images/640de104e30fd6b5e2743f3fa251679d.png )

更改成功。

查询下：

![](./images/5ac8a1db6b804ef7f67b6ac07b725546.png )
