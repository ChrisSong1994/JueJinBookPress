...
![](./images/041a9256b4e28bdd9254b6aa1e329a76.png )

掘金的文章榜：

![](./images/2f249b11b2fd6528b25674f42be4175a.png )

作者榜：

![](./images/3d034ea0185d2c89161a090545c5e686.png )

微信的步数排行榜：

![](./images/0a0317bf79818a9f706a96dafdc813da.png )
...
![](./images/7c2ec2252d2aebbc0f43da2db980ae4c.png )
...
![](./images/743eb51f1f063de272e77774155679b7.png )

三个成员，分数分别是 1、2、3

![](./images/bece46396361759d0997adaf815819eb.png )

用命令看的话就是 ZRANGE：

![](./images/d2dbbb0b1374809e182f24fac6ebe64d.png )
...
![](./images/f7ee37777b73f66a5e1915d4be503c84.png )
...
ZRANGE rangeset 0 -1
```
![](./images/f5a5fb077f75b8189f5139cf024d69c5.png )

删除个成员试试：

![](./images/f29f6f31efdccf95edee800d0ed48cda.png )
...
![](./images/ee4b597d276957c95a36d6eb2f7b336a.png )
...
![](./images/8cbb8a0182aafcdfe33ac4704888bc40.png )
...
![](./images/38c353a8bb740ba21bd8cd883ce57da2.png )

用 ZRANK 查看成员在集合内的排名：

![](./images/cde4c3843518fa04967b431a07c2e381.png )
...
![](./images/8f2ba8a1dc6e64ab4ae44a44b0e33a2f.png )
```
ZINCRBY set1 3 mem2
```
看下新排名：

![](./images/5b20099dd7d5945057276a0ceb70c28c.png )
...
![](./images/1d86867394b14ee54e180efba31e9bee.png )
...
ZUNION 2 set1 set2
```
![](./images/7fbdb3d09ec279dbfedd774cc9216acf.png )

还可以加上分数一起：
```
ZUNION 2 set1 set2 WITHSCORES
```
![](./images/00eb6bf4a396fae338393729ca990665.png )

或者把合并后放到另一个集合：

![](./images/aae0ade1f392f5276965e2b42007a764.png )

```
ZUNIONSTORE set3 2 set1 set2
```
![](./images/b4f8da354f936bf31c39a050f34fcba7.png )
...
![](./images/eb83b350115567d820fb80f1f2c7e9a8.png )
...
```
![](./images/524c6c072f6a14660f1f9324de70f885.png )
...
![](./images/94df7e74de8fac29517bbd7279ca3164.png )
...
![](./images/c9dddd41f89940a252df3a75f3ba846d.png )
...
```
![](./images/e760bac3ca23681ec81e8cae3e108e3d.png )

```
localhost:3000/ranking/join?name=dong
```

![](./images/042199f97d8c6094f743a85419d9cb18.png )
```
localhost:3000/ranking/join?name=xiaohong
```

![](./images/89afec8d50d01498f67c7060733d8d78.png )
...
```
![](./images/ccbfbe6305f52bcd1a27fffbcf273cbc.png )

在 RedisInsight 里看下：

![](./images/e9b529c9821d78def295e087185c1f00.png )

![](./images/245fa060e2344c0ae63b95c356cf8f71.png )
...
```
![](./images/5b8c81f8f234acec178cfe18bcd23b54.png )

```
localhost:3000/ranking/learn?name=guang&time=2
```
![](./images/ca6761a398e39758ddb2a860b0be1d23.png )

```
localhost:3000/ranking/learn?name=xiaohong&time=5
```
![](./images/a02e9f35bbee8092a91cb759a7b009a4.png )

```
localhost:3000/ranking/monthRanking
```

![](./images/8425304ff12482d25b5a40567de43c9d.png )

我们改下本地时间（mac 和 windows 改本地时间的方式不一样）：

![](./images/c27aba44e01db581d8a6c3e648ca1ad5.png )
...
![](./images/5727ee3d928182e21fa8f4208ec37e2c.png )
...
```
![](./images/b1e5e11a5cd15645eef419679d0b75c8.png )

```
localhost:3000/ranking/learn?name=guang&time=3
```

![](./images/8d7dae27de2a8a7c85c23faf04ef2f44.png )
```
...
![](./images/5e3e2c94b16562624b0fbb69dcf1049c.png )

还有年榜：

![](./images/179dbd00a87d32ebf0764f3bb7f15b80.png )

可以看到，年榜是合并了所有月榜的结果。

在 RedisInsight 里看下：

![](./images/bcf83b8b9636b7896ad0774fe76ff09a.png )
...
![](./images/e1257c4402107f53c04199df0e128042.png )
