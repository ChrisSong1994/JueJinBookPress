...
![](./images/0cb35563e094d2ddbf0d4effaeb021c8.webp )

这里 node 能直接解析 esm 需要在 package.json 里设置 type 为 module：

![](./images/bc735ea986d76de17ecd9473100ef953.webp )
...
![](./images/031b22a34d97d2261af73ba2e3249e5b.webp )
...
![](./images/2953e790d96ae54c3b4c365d952a8d90.webp )

然后浏览器访问 <http://localhost:3000>

![](./images/b15888a6bb22462a05e1a3861a7feb9b.webp )

就会看到打印的耗时数据：

![](./images/4cf39a9f8a22122bd9a41a26f2c8ae73.webp )

或者全局启用这个 interceptor：

![](./images/ad5e8e7959912aa05c865fed5fe7257e.webp )

路由级别和全局级别的 interceptor 还是有区别的，路由级别的可以注入依赖，而全局的不行：

![](./images/4b02a15496f05550da5eff8b49cbe3f6.webp )

![](./images/661c0c1bf62be1e261ec6cb0576b3505.webp )
...
![](./images/6766eecb1a0be04931ee910bbdd86be0.webp )

跑下试试：

![](./images/23398b6263eccdb9ae468bbddad5533c.webp )
...
![](./images/cef2cc07293f4c58a001e340b228515e.webp )

浏览器访问这个接口，会打印日志：

![](./images/1c0e1f245e1464155f3c37111f044fc9.webp )

![](./images/0d71837284f782ed367a95dcc0e7042e.webp )
...
![](./images/690295930ebc51ebdc800c622a685a6c.webp )

浏览器访问下，可以看到返回 500 的错误：

![](./images/77455e7496658c890d4ed3a3a1977480.webp )

打印了两次错误：

![](./images/f5a4142d24843661f516cb62aab546aa.webp )
...
![](./images/ac9ebdc60d9faef6270d57b7a9417284.webp )

![](./images/87b398b25f5732065c3218beda91acf1.webp )
...
![](./images/00fd0f25cf37e630357711d42c39f034.webp )

浏览器访问，3s 后返回 408 响应：

![](./images/2b21261810ff3ebf4a951fca823bb94a.webp )

就是在这里处理的：

![](./images/b8c37f93d85f17d679553ce23ec52003.webp )

不信可以抛一个其他的 exception 试一下：

![](./images/47733bc5920c08464566b8aaec15d041.webp )

![](./images/a892ddb056a832b0fc8e1dd237d3c379.webp )

最后，再来看下全局的 interceptor：

![](./images/f517616919627367b77266198cd0e191.webp )
...
![](./images/8a7cfe771eaa23cc9666b0720334058c.webp )

在这个 interceptor 里我们注入了 appService：

![](./images/e3d875bbec3bb01df9236fd186ed5080.webp )

添加一个路由：

![](./images/81120610024483ee17e27fc122e6f0af.webp )

访问下：

![](./images/ecc869fcdf52b56305f07ca442b551b1.webp )

可以看到全局 interceptor 生效了，而且这个 hello world 就是注入的 appService 返回的：

![](./images/c60022d52732afa9c68be2ab9131ba80.webp )
