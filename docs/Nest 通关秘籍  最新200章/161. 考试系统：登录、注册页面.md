...
![](./images/a2a8a7a5c56063bb22e49b29b5c02801.png )
进入项目目录，把开发服务跑起来：
...
![](./images/ab2a98ed778664eebacf9cf83d5d07a6.png )

浏览器访问 http://localhost:5173 可以看到这个界面：

![](./images/ecef596a735554315310a07cb95e4b6e.png )
...
![](./images/f50e7b8202d024b7c947a50879c40ed4.png )

![](./images/a0a77072f30e1be07f894ed9e9e2229b.png )

![](./images/439bcfef75d79bbccc88d12df36853f3.png )

![](./images/337cdf300930740aa2edc476c447f068.png )
...
![](./images/04d5d837375548045e24dc0e4c728c5d.png )
...
![](./images/d5de437997f3eea98b4ddab229d17d39.png )

输入用户名、密码，点击登录：

![](./images/e458bfd7a092aa207236a5c237f1370b.png )
...
![](./images/b0f207aa72834a6347d0d1d771f36500.png )
...
![image.png](./images/ee7830ef4b1aea31c0a7923ba72be97c.png )

登录下：

![](./images/f4899dbc81e6e5a33721f8b1b8cff824.gif )
...
![](./images/756508831a5d36dc9fd096aefdef9142.gif )
...
![](./images/8e45e8a333164a30bbe52e6abe9ac4ca.png )

填入信息，点击注册，控制台会打印表单值：

![image.png](./images/b22d4a5d5c18c475e24150349b118cc8.png )
...
![](./images/3ac484ffa4faf1ae41371415a2f5a514.png )
...
![](./images/238c3401e54db9eac613d6e260d97133.gif )

![image.png](./images/3755047db336f99ca5a2e7a22be5c40b.png )
...
![2024-08-26 10.22.17.gif](./images/bd1a7f429b97cee3b28104be33f4724a.gif )

去邮箱里看一下验证码：


![image.png](./images/9b2013da11c5d973a250f6fc495b3695.png )

填入验证码，点击注册：

![2024-08-26 10.23.14.gif](./images/a29c31138653d8cf44892f38c824d7c1.gif )
注册成功，数据库里也看到了这条记录：


![image.png](./images/33f4bff0a828fe205cf2c5b69ac59688.png )

这样，注册的前后端流程就走完了。

然后调用 useNavigate 的 navigate 方法，注册成功后导航到登录页：

![image.png](./images/58fe20bde201912f8367df8d46cba8be.png )
```javascript
const onFinish = async (values: RegisterUser) => {
    if(values.password !== values.confirmPassword) {
        return message.error('两次密码不一致');
...
![2024-08-26 10.23.14.gif](./images/a2391e6795d24744830828b129808729.gif )

同理，login 成功也要加上跳转逻辑：

![](./images/1c0f0a22ca4116981b044b5fde2fccce.png )
