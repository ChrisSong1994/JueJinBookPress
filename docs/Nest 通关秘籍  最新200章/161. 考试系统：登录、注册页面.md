...
![](./images/a2a8a7a5c56063bb22e49b29b5c02801.webp )
进入项目目录，把开发服务跑起来：
...
![](./images/d5de437997f3eea98b4ddab229d17d39.webp )

输入用户名、密码，点击登录：

![](./images/e458bfd7a092aa207236a5c237f1370b.webp )
...
![](./images/b0f207aa72834a6347d0d1d771f36500.webp )
...
![image.png](./images/ee7830ef4b1aea31c0a7923ba72be97c.webp )
...
![image.png](./images/b22d4a5d5c18c475e24150349b118cc8.webp )
...
![](./images/3ac484ffa4faf1ae41371415a2f5a514.webp )
...
![image.png](./images/3755047db336f99ca5a2e7a22be5c40b.webp )
...
![image.png](./images/9b2013da11c5d973a250f6fc495b3695.webp )
...
![image.png](./images/33f4bff0a828fe205cf2c5b69ac59688.webp )

这样，注册的前后端流程就走完了。

然后调用 useNavigate 的 navigate 方法，注册成功后导航到登录页：

![image.png](./images/58fe20bde201912f8367df8d46cba8be.webp )
```javascript
const onFinish = async (values: RegisterUser) => {
    if(values.password !== values.confirmPassword) {
        return message.error('两次密码不一致');
