...
![](./images/b2731d8caba84a70ee538bf486f4482f.png )

所以，我们在它平级添加个路由：

![](./images/7ada4b3b91818277cc6d8c6d7b7fb039.png )
...
![](./images/466e2657e8e6566e2748b590fba3e600.png )

![](./images/bc6c093eaec6c2d97ee86be16cde97c8.png )

没啥问题。

但是现在点击菜单是没反应的，我们给它加上 click 事件。

![](./images/c267ccdc6c1dde6fa3df60634dc45951.png )
...
![](./images/09c9d3f8451264c7c4d0af0d4d671822.png )

测试下：

![](./images/21229e2331a8628c00dab2e97ba05164.gif )

点击菜单可以切换路由了。

但现在有个问题，页面一刷新，选中的菜单项就变了：

![](./images/2b1cec31eeff8e9421d001dc47fb4d5f.gif )

我们需要根据当前路由来决定选中哪个：

![](./images/d399a71eb9a1de549175a13d3eb60ed7.png )
...
![](./images/0fbde22d900595683e4d2c2014f89119.gif )

改下 Index 组件，添加两个链接：

![](./images/fd0243bf107421d021bd8f85217a0e23.png )
...
![](./images/47f0e0190bb953b01ad9c6d2677793ff.gif )
...
渲染出来是这样的：
![](./images/04de3336cb953728baef2dd4fbf38ce0.png )

上传功能也是可用的：

![](./images/9ab18f897c85559331667400c288f180.gif )
...
![](./images/2daa37531e38b2b63c1752d3571ebed6.png )
...
![](./images/b01b8054e8b91ba26d9b40824758b9a3.png )
...
![](./images/538f7c6e3a4a6e55ff9f60387467a063.png )

改完点击 apply。

然后需要重新登录一遍，因为现在后端会直接从 jwt 里取邮箱地址，重新登录才会更新。

![](./images/75abf1f77353c395ee567097d7d3b380.png )

邮箱收到了验证码：

![](./images/03b637c7f8c13913ff9c7348db2c5ef0.png )
...
![](./images/e691115195b5846d776190c69eb12f3b.png )

修改成功后，刷新页面，可以看到依然是修改后的数据，就代表修改成功了：

![](./images/2926129011ceede3ec3558971ce5b327.gif )
...
![](./images/cdb846c8de66ec823b9273aefca1281e.png )
...
![](./images/86e487e1b4dee7db831153a542beb533.png )
```javascript
useEffect(() => {
    async function query() {
        const res = await getUserInfo();
...
![](./images/2b758e69dab323386e2121359ad518b1.png )

这样邮箱地址就会回显，并且只读：

![](./images/c79d9b7cad7472253b2270566d62d50e.png )
...
![](./images/ae90effc67c8718f46e78ce141b5dfcf.gif )

邮箱收到了对应的验证码：

![](./images/a90efb254ae7898c5344d86d8ae2759b.png )
然后加上修改密码接口：
...
![](./images/d1a9fcdd6a3d248aa7b5ff48a4466b01.png )

我们可以去登录页面，用老密码试试：

![](./images/2d34245617573ef7da849ad8afc5b6c9.png )

再用新密码试试：

![](./images/b9d560d48ef75bb9e1cac85cb7e844df.png )
