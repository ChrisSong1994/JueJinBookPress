...
![](./images/1713554f71ca21534795e37fe0032a63.png )

其中，RPC 是 Remote Procedure Call，远程过程调用。

比如 java 微服务有个方法 aaa，node 微服务想调用它，就可以通过 gRPC 来实现。

![](./images/d060204f99dfd53933e0f213f69945b0.png )
...
![](./images/12b20787cca5c3cc91ec5209f43b38be.png )
...
```
![](./images/114965e81b958601921394e631afbc90.png )

这样，就有了两个 nest 的 application：

![](./images/b221b446769312da445c7517c6dabcc6.png )

改下 grpc-server 的启动端口号为 3001:

![](./images/d78c3c86fdc85ea547a7ea925f7f3ec4.png )
...
![](./images/738c0cb3646e252d7656171e74477232.png )

![](./images/1b2a524dd38f703f6871818a729abb0c.png )

浏览器访问下：

![](./images/b778eac76fd783ea86ce98c2c48990eb.png )

![](./images/1515b0bbea81b52362f56403311d7099.png )
...
![](./images/39f982dcc2733d2fd511ab03f4d89f0c.png )
...
![](./images/42673ed232d14bc3a36c7665dc6e85d6.png )

安装之后就有语法高亮了：

![](./images/738a0f8f95c7c4df93cd6041027407cd.png )
...
![](./images/be3af1927e2e477393bad1fd6278b889.png )
...
![](./images/fa700935fd3284087e3e9cf27b6a6613.png )
...
npm run start:dev grpc-server
```
![](./images/cd6368e9bea11cff6afc46fe2f466eb0.png )

这时 dist 下就有 grpc-server 的代码了： 

![](./images/65bd7095270c4e03ccc9e387a85029f8.png )

然后我们在 grpc-client 里连上它：

在 AppModule 里添加连接 grpc-server 的微服务的配置：

![](./images/075a41b028ae782b776ab47210929058.png )
...
![](./images/435846374d9071b40d92f9e832130d3c.png )

然后在 AppController 里实现调用远程方法的逻辑：

![](./images/c97da5e301c33929d6251c75853ba327.png )
...
![](./images/585e6ca4340a5b1043403d96f663f368.png )

![](./images/1b11542bdb60905709983c1f2407572d.png )

可以看到，远程方法调用成功了。

这就是基于 grpc 的远程方法调用，用 java、python、go、c++ 等实现的微服务也是这样来通信。

![](./images/301ad089ce335ad36a425a6a513cfd58.png )
...
![](./images/bc5733b4a5d031952f78ed6e834e86d9.png )

然后也是定义这样的 proto 文件：

![](./images/e7cf48dfe7454589e0c606ad4709b19b.png )

之后定义对应的 servie：

![](./images/70a6668f6d4f6a47dd22906c6f6f9a19.png )
