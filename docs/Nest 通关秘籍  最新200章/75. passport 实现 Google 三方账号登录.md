...
```
![](./images/04f7de4c3c2f72546e682d4173edaed4.png )
...
![](./images/c213d05fa03c8de0824bf03bad0e0c17.png )

点击左上角的按钮切换到你刚刚创建的 project：

![](./images/5aca2d3e0d303679644ee483cdaf819a.png )

进入 api & service 页面：

![](./images/6a01eeb7506f728b662ec42b5225399f.png )

点击 OAuth consent screen，然后勾选 external，点击 create：

![](./images/fa59c1bc7ba55fd5797120c69d1ef939.png )

输入三个必填信息：

![](./images/c0c2e46c19d077733af613f725d00f07.png )

![](./images/698ee4b2d154d86884a4040a075c85ff.png )

点击 save and continue。

然后点击 Credentials 创建凭证：

![](./images/9690b3db323f88f752bce61da2b426af.png )

输入应用类型、name、填入授权的域名、回调的 url，点击 create：

![](./images/f6c6cc6d74a92c3d2b1ad1a31422315a.png )

这样 client id 和 client secret 就生成好了：

![](./images/3137b9fe52a8f83e2895613f1edbbfba.png )
...
![](./images/3d518ffe8d3fa4621b063dd24b1b8853.png )
...
![](./images/0fc0bd6f7bfa9f725dc21075cf1cd89c.png )
...
![](./images/d4f234d390808b439da5e2d645df8074.png )
测试下：
![](./images/7f93a06ebc9202453438d8227a43bd89.gif )

可以看到，google 的用户信息拿到了：

![](./images/23415ab863dcbdfdf44ed67868b56213.png )
...
![](./images/76bd3813694d32494fec0ffd33602587.png )
...
![](./images/d128498bdedec1e7e658082702611808.png )

![](./images/4abcacc9a8d2a429f1d9eb61f30badbb.png )
...
![](./images/2a1e6306da108ac0878ca3fb56393469.png )
...
![](./images/f63d1688a6b3c44d360dd914261ba693.png )

自动创建了对应的表。

在 mysql workbench 里也可以看到：

![](./images/a8d3ca9a48c39bbc97e67d17868b2922.png )
...
![](./images/1683e83e95ddf564658953d938b618ba.png )

![](./images/2c191b0ad6cb75c0eceed237750b9e28.png )
