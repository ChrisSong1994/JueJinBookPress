...
![](./images/d6e2de72c9f36da825d105ae0448dbe8.webp )
...
![](./images/cd8434f13053d5bbc37362f4a0a2b03c.webp )

浏览器访问下：

![](./images/24e7068dd339f91dc06698e27d4c8668.webp )

这时候在 devtools 可以看到 aaa 请求的 body 是多个 boundary 分隔的格式：

![](./images/d2878cbec3bc84a8212d00b4dd376cb8.webp )

而分隔符是在 Content-Type 指定的：

![](./images/8cba7e87da811630681072fddc12d923.webp )

这就是 form-data 的传输格式。

然后去服务端看看：

![](./images/0bc0fd3abbfa91fd2ff7f91ac3b57061.webp )

req.file 可以拿到文件字段，其余非文件字段在 req.body。

并且服务端多了 uploads 目录，下面就保存着我们上传的文件：

![](./images/d0bb6a1a7e3b81baa8039c610d188511.webp )

单文件上传我们会了，那多文件上传呢？

再添加一个路由处理多文件的上传：

![](./images/006e46d8d7e46253154c27891c3ac8a8.webp )
...
![](./images/6b1ffea96758df1b742839c99ea476cd.webp )

node 服务的 req.files 接收到了多个文件：

![](./images/f273a64c44445259c26fefbf7694b664.webp )

并且 uploads 目录下也多了俩文件：

![](./images/6ec0d5cd828e415cdc40d1bb552dc08f.webp )
...
![](./images/4288073a375024dbfd5244c3a947be2c.webp )
...
![](./images/6bb176aff1be13d861f1afb979810b90.webp )

可以看到服务端打印了报错：

![](./images/52d154c01d8ff9aa86c94e7e5d4dbb6a.webp )
...
![](./images/19f3f4bc1dfd861191f00c4ed7886153.webp )

![](./images/3a4cd59eba69decf4c7f6b2cc756b5b0.webp )
...
![](./images/58142f63c6a935336534afd706055dbd.webp )

服务端收到了 aaa 和 bbb 的文件：

![](./images/1cf483f665671cbcadabd997ef79cebf.webp )
...
![](./images/93036ad8d6896731f077f392096656db.webp )
...
![](./images/2ee2870436a425a6d525c467b8149a20.webp )
...
![](./images/e7f6c2d4a95d18b79571c37cae6e606c.webp )

我们用时间戳 Date.now() 加上Math.random() 乘以 10 的 9 次方，然后取整，之后加上原来的文件名。

测试下：

![](./images/e2d5103b73c38f2524c1bc6bd8442db8.webp )

然后浏览器再次上传：

![](./images/eaa2471e6f8579156a57960f2d1e695f.webp )

就可以看到目录和文件名都修改了：
![](./images/e36dd367362c20dfca7def6e929721c9.webp )
