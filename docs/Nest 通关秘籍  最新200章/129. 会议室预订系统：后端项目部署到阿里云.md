...
![](./images/41ee69461bd58d63e5cb76d1b14f0232.png )
...
![](./images/987549973e83751354161ffd6658a45c.png )

把 localhost 改为 redis-container 和 mysql-container。

还要改一个地方：

![](./images/46c1f3a5bd9f95b8522fc1346a19b542.png )
...
![](./images/f1d697ebaa7a2314654d6f0ed8043480.png )
...
![](./images/406c1cb4a1f40303b9e95d2e6fb1e37e.png )

然后分别跑 mysql-container 和 redis-container 容器：

![](./images/99d24f1a6d6cff5d331bf82e9e306205.png )

最后可以看到 nest-app 也跑起来了：

![](./images/5bd6ddd4341a06c6be95d1687f96d864.png )

访问下接口：

![](./images/5212b44a8b33ad0af4253b449e3d1022.png )

![](./images/116e7625caf26d3bd69fe788607654b6.png )
...
```
![](./images/09499823b2810ddb854d7b219f7bd3f1.png )

接下来把本地代码 push 到 gitlab 或者 github：

![](./images/275cbdf08c110b1bd84d0dbef8153dca.png )

然后在服务器上把它拉下来跑下 docker compose up 就行了。

我们买个服务器：

![](./images/d8c5dd7383ee8d3264c0ff731d7cfff5.png )

![](./images/981e24281d184aa74aec512a15d4c60c.png )

![](./images/814034b2e3282462732fba4dc339374a.png )
...
![](./images/bc1e8afa4a42a3c5f6f6510569620d48.png )

点击远程连接：

![](./images/cc7aed865908cabca61f6701fc9662c6.png )

点立即登录。

我们用 ssh 密钥的方式登录，这里需要一个密钥文件：

![](./images/3e809fba272fbac72e3e25e090e7f8b7.png )

在这里创建：

![](./images/a282dbdc6655701dac240806518265b3.png )

创建完会自动下载密钥文件：

![](./images/e58af1cb064f1a7c9348afacbd514b04.png )

然后点击绑定密钥对，也就是用这个密钥来登录的服务器：

![](./images/578f10dbe8554ba1c44b28f262b5b3ea.png )

这一步会重启服务器。

然后再次远程连接，就可以用这个密钥文件来登录了:

![](./images/316c7ca0e63d166ada8d8f1896bbe096.gif )
...
yum install git -y
```
![](./images/cc0a3498c7974125259f78a105470194.png )

![](./images/2d944d66c237110ce3a2da03da55b2c6.png )
...
![](./images/7e23447d186584989315c66af04c4137.png )

进入项目目录，跑下 docker compose 就行：

![](./images/63157b3ce41046b9ceece003e973e92e.png )
...
![](./images/8e8af7d1effb5ef977eb8a65dabb058b.png )

![](./images/d5f98189ae6723cc7cc0326d6bfe6d2b.png )

![](./images/2ee8fa766abf8334d8493979782d8038.png )

docker 安装好了，设置下开机启动，也是复制文档的命令就行：

![](./images/11dc61650debb21e3a9c73d85373083e.png )

![](./images/c9e992af9ffeac272dcaadc6dbcd3a10.png )

然后安装 docker compose，同样是直接复制：

![](./images/fa88d9c5d4cab0282da3a8640ee91dcf.png )

![](./images/5a73fdc1d1f7c4dd022718ef5178a892.png )
...
docker-compose up
```
![](./images/d10c2202fe2151f98dc48e95ce66c820.png )

会先 pull mysql 和 redis 的镜像，然后 build nest 的镜像。

之后就把服务跑起来了：

![](./images/7f07e03477ecf6d4b3bdeced41bc9412.png )

过程中可以看到，会自动创建一系列的 table：

![](./images/517deb9c16e49e3c61e1f65463e8b50e.png )

因为我们现在还没关掉 synchronize。

因为我们服务跑在 3005 端口，需要在安全组添加一下这个端口：

![](./images/18e2171fa337ee32e4a65f5f06a5a3df.png )

![](./images/ca9640d9dbd2705c21b97e08326813c2.png )

然后就可以用公网 ip 访问了：

![](./images/6450c85b4a0cb085a4bc707a451c6d3d.png )

![](./images/9b92a7e66e61d255e118918c145f37f7.png )

![](./images/e61364cc278adeba08bbfe6667685b1d.png )
