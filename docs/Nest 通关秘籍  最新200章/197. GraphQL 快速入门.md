...
![](./images/499f9a15f0c27f1d21edf5adfca2f00e.webp )
...
![](./images/7402ab761aa48c1593c1a882f02b4b0a.webp )
...
npm init -y
```
![](./images/4be0df7fdd232062b52a514cd805f970.webp )
...
![](./images/9262d86e85bc7a5585888704aa4f216a.webp )
...
![](./images/d0c5778f760ba4b8dabd1e029f9f4d57.webp )

有同学可能问了，node 可以直接解析 esm 模块么？

可以的。只需要在 package.json 中声明 type 为 module：

![](./images/fde893712a41ed04ce490356a7afeacc.webp )

那所有的 .js 就都会作为 esm 模块解析：

![](./images/7065f93cf7f78220177c2eede7c250f4.webp )

跑起来之后，浏览器访问一下：

就可以看到这样的 sandbox，这里可以执行 graphql 的查询：

![](./images/d902c934c90726b67cb7cea30aa048d5.webp )
...
![](./images/4fc8bd4008750bfeff46983d069b1baf.webp )

![](./images/c6fe08b2858f06b6e071637ac1b20bf0.webp )

这里 “光光” 那个学生是异步取的数据，resolver 会执行对应的异步函数，拿到最终数据：

![](./images/e2775d6febd803eefb608d6617732ed1.webp )

取老师的信息就可以这样：

![](./images/bc5ea3523dcdecf7d5194b94cebd5a5f.webp )
...
![](./images/ff274d1b52f350e8eb8810a4447ab862.webp )
...
![](./images/e2bec5ef73d33420f9623b846dce04fb.webp )
...
![](./images/db020163c589e6702058043363a59ced.webp )
...
![](./images/fad30ab9d37e4b11a92cabf68b46e211.webp )
...
![](./images/96a47234895f902f074e8f22561ebcd5.webp )
...
![](./images/b90692169816bbbb452f278a97327728.webp )
```grqphql
type Res {
    success: Boolean
    id: String
...
![](./images/98ab6cc2ad51f13f8bbd2af774623f93.webp )
