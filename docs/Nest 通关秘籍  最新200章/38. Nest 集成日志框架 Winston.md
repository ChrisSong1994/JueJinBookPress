...
![](./images/62b2429cb228d7eeb037fac24f5aee62.webp )
...
![](./images/ee909af1bed403d5d98950ed43589e00.webp )
...
![](./images/eb7535729d4dd8f562c52e2dda9073e1.webp )

现在的 logger 就换成我们自己的了。

然后在 AppController 里添加 logger：

![](./images/b55bd88139d386721d513c5867b7068f.webp )

浏览器访问下：

![](./images/7738e8a60b83bb7da3384c3050f2af45.webp )

![](./images/35c41d24403c1ad56352531c2da53bd1.webp )
...
![](./images/8fe644e67b34f3e4a2413f930fd66930.webp )
...
![](./images/3b073a4c814194e39837056693e482e6.webp )

是不是和 nest 原本的日志很像了？

然后我们再加一个 File 的 transport。

![](./images/a418a60f3e2b8621da272c8994c290c4.webp )
...
![](./images/b35f7fe57aa551db97d60f7f1aa99cc2.webp )

file 的日志是这样的：

![](./images/f436c1b6757f36a0e1d6736729e76940.webp )

这样，我们就完成了 nest 和 winston 的集成。

我们还可以进一步把它封装成一个动态模块。

![](./images/d420e59d5ea3c6bc16c068ba8b8ffe5e.webp )
...
![](./images/14a53cf6f2e93ae495882198910dfda1.webp )
...
![](./images/8d71ab8b2541f2f37c4afe11db3cfc04.webp )
...
![](./images/327eef4f2e9623f6dd33b31989a217db.webp )
...
![](./images/696420f52387b06db3d1e81f8b9eae3c.webp )

只不过现在就没必要每次都 new 了：

![](./images/6f77c78fedf29e712689f8e2b5eaf17c.webp )
...
![](./images/2385700100ee98ea7e5e4d78140732b9.webp )
