...
![](./images/baf1f727d161853829f5fa0127b50b1a.webp )
...
```
![](./images/6d2066260eb8e0c9519910a3a96452bf.webp )

会生成 migration 的 sql 文件，并且会更新 client 代码。

看下生成的 sql：

![](./images/e5bf6535e18d1be1097a777402469e8e.webp )

还有生成的表：

![](./images/7380c32c73f2e3351cde9ac34899072d.webp )

![](./images/36c5cb7acc978c06f5153e9651315ce9.webp )
...
```
![](./images/c7a8ab924500f5d32d2583adf8f88334.webp )
...
![](./images/7933e4e331d3610853c8219846555cbc.webp )

聊天室创建完成后，单聊把 user 和 friend 加入聊天室，群聊只把 user 加入聊天室。

测试下：

![](./images/f8ee7bdf5698f01fe36b4019a9da3dba.webp )

sql 没啥问题：

![](./images/544f7291926c76507bc526f9357da5b9.webp )

看下数据库：

![](./images/2552eb1bed4a5a944fa9762d2d1e57b6.webp )

![](./images/04afa7b15193309f61f1803adad2a8cc.webp )

可以看到，聊天室创建成功，并且有两个人。

再创建个群聊：

![](./images/9cf18c8665a47e4079be2576f084f029.webp )

看下数据库：

![](./images/c720472fb67bc6cd00c185eb13ded3ac.webp )

![](./images/b72c4965993131887b1b35313bb9b2c2.webp )
...
![](./images/f648dd3b0570fd262e7ea1844299688c.webp )
...
![](./images/4f2819f8f5e296172af60ad02113d7e4.webp )

![](./images/b73539ac342d2450bcf4880872850cf9.webp )

没啥问题。

然后 chatrooms 接口应该返回群聊的用户数，我们实现一下：

![](./images/4f9f285a1ffd29e2ab02d1062ca575e2.webp )
...
![](./images/0beb317a1309c32f5030b69383472173.webp )
...
```
![](./images/eeab45ad6604f6a24c664dc3a6ab244f.webp )
...
![](./images/680106be99c93f0fbf85a7aa41b549b4.webp )

![](./images/c2eaf15472b48a4ce8c466cc391dfb9e.webp )
...
![](./images/6cecc8adbb0829c0c5133012b8f254ab.webp )
