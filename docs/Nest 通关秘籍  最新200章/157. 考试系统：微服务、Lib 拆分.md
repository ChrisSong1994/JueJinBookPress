...
![](./images/4f88ca674bcee9e821c5a7979f064f77.png )
...
![](./images/7cea16e85925b1f7af8eae4c2d74338e.png )

```
nest g app exam
```

![](./images/3f70df562a7b6d2ac39d9a65c556445e.png )

```
nest g app answer
```

![](./images/775ebae1594c6ee614a6249f8cdbf7c3.png )

```
nest g app analyse
```

![](./images/8f54aac41678cdf077b93d1ac11af15e.png )

看下现在的目录：

![](./images/501a7fc1ea38dcbbb5a1cd8ede7f4e64.png )

还有 nest-cli.json

![](./images/2e5e44c04b6029956270fe10063b2e4e.png )

我们改下 user、exam、answer、analyse 的服务的启动端口，分别改为 3001、3002、3003、3004

![](./images/d7a3a6b10da199cf049a4e6f14e85e41.png )

![](./images/c2a565b58ce82366baa508f72a9712b7.png )

![](./images/5acd4b534d9f2bbab27dbc7e0367ab25.png )

![](./images/7a1ee15431c9dbb4812298fad7847e17.png )
...
![](./images/370ac4488463cb1265fecc3ea54bef67.png )

![](./images/34aa4091d2b6fc3400307e97f8f3d832.png )

![](./images/3a0b979aebdad867f94c727fd8547c89.png )

![](./images/6e9d61ae3e0093f23d1f810421adcad4.png )
...
![](./images/ed88a6391d7883322bbdfc10267613e2.png )
...
![](./images/deded893bc740b15928bcfa573dbc342.png )
...
![](./images/6023554b170868f6f63594b123fe92b4.png )
```javascript
...
![](./images/18b78ca659e0f9f2a066be99b7cd8532.png )
...
nest g lib redis
```
![](./images/cb045bf418b0818a9b97ce8aba8be8f9.png )

会让你指定一个前缀，这里用默认的 @app。

然后可以看到在 libs 目录下多了这个公共模块：

![](./images/7c19e39f7b53aa9e8ede5da2a3610a10.png )

并且在 tsconfig.json 里生成了别名配置：

![](./images/c509974b75331c953cc88c16c9f71cbe.png )
...
![](./images/c271e65679952410e73aaa333888f0f3.png )

![](./images/30e85e0157fc3779f0951e61f94d5b81.png )
...
![](./images/6eeb5d156a116590f5f4fd6dbb46a4b2.png )
...
![](./images/d3fb3250ae7ad28552c1b9ef3a10203f.png )

可以看到，lib 里的 RedisService 正确引入并生效了。

在 exam 微服务里也引入下：

![](./images/3010f0d709a3f15ed2213ae78f4bf7c6.png )

![](./images/b64fb64e477322088efcf0231d0b1f13.png )
...
![](./images/b826cacf8b639ffe06a23d69efe77170.png )
