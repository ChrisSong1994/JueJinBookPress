...
![](./images/c14f0ba26f6f6c1dd97a516581504e78.png )

应用启动的时候，我们指定了端口：

![](./images/7b1fdd248f05f1ed32227a5a9272032f.png )
...
![](./images/e2a08eaf1b21d889006366d2412a1cb5.png )
进入这个目录，安装 dotenv：
...
node index.js
```
![](./images/6b1465e6afdb2fab3f6c58a4fc3081e7.png )
...
![](./images/ebcbe019e8fc8748f8422b57a442b6dd.png )

如果你手动置顶了环境变量，那以手动指定的优先：

![](./images/c6bf1d901d33cbb4fe899c54f28af0ee.png )
...
![](./images/b59aeaa85b62b84566de09e292eac2c0.png )
...
![](./images/1f4c1ad1a5402fcf6b50adbf093f8399.png )
...
![](./images/b6bcff53923349de3737fcd23c8aa252.png )
...
![](./images/699cbdce128c8843da23c0263d18e40a.png )
...
![](./images/5fd5d59f974a92e355d9b632e7bdb866.png )
...
![](./images/1432e4e4238d2d03f6ddc5b035f77fed.png )

在 Controller 里取出来：

![](./images/1ee70ab934b56daaadf603d135cbba75.png )

浏览器访问下：

![](./images/d17032c3b8e412143728f51974a3c6d7.png )
...
![](./images/dfb3726dcf1e3b04f3deda9117c3f01e.png )

同样，前面覆盖后面的。

改下 Controller：

![](./images/84e6d522174cac20e9ff3a8bc535e779.png )

浏览器访问下：

![](./images/f5f641d31feaaf5e567fa84be013b220.png )
...
![](./images/2799195fcae88cd829264cd2fada9c57.png )

在 BbbModule 里注入下：

![](./images/24471620c6bf51abec372b81338ba784.png )

跑起来你会发现报错了：

![](./images/b28c1ec2cd26796b55752b6d06923c21.png )

这个模块找不到 ConfigModule。

这时候把 ConfigModule.forRoot 注册为全局模块就好了：

![](./images/0e1d7bb950e1f598e42f9f0946fdcb11.png )

这样就可以在 BbbModule 读取到配置了：

![](./images/ddddc7d672df240c76e98a22cebc949d.png )
...
![](./images/c0eb00615e260916ca010acf747c03de.png )
...
![](./images/9287d6b1716d0f0c4c3735d794fd8c0e.png )
...
![](./images/d981f3b125291352663b9a8985560fb0.png )

之后动态返回模块定义：

![](./images/8dffb9e4e50ad9b27af8d9457822fc3f.png )
