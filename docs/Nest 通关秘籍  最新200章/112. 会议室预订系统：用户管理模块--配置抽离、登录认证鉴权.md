...
![](./images/16e09e978404b8ccdf59dcec42b29f44.png )
...
![](./images/2a3904023a36a8b26fcfe2777bcaddaa.png )
...
![](./images/5caa861303361cef00e34bf69cf6f856.png )
...
![](./images/8d2957b16ccd681dd413ddb4b5a4555e.png )
...
![](./images/524f3dff7dd4ff9737c36c9279b84d53.png )
...
![](./images/9993385e953b78b48a4f289871863b87.png )

然后我们把 .env 移动到根目录，再删掉 dist，重新跑 npm run build。

![](./images/cc7d61e8bed3d727f571ef3c07da22a4.png )

并没有自动复制 .env 过去。

如果你就是想把 .env 放在根目录，那可以手动加一下复制逻辑：

![](./images/26275776bacbb7caf92a08648f45afdf.png )

这样再跑 npm run build，就会把 .env 复制过去了：

![](./images/feee48c3c8a4e711dc18621479d41647.png )
...
![](./images/b1a419ce9bbd458d20906c82ad65556d.png )

```javascript
const configService = app.get(ConfigService);
await app.listen(configService.get('nest_server_port'));
```
![](./images/cfa19f60d0c889ede3a38672168a4acf.png )
...
```
![](./images/8d33777169ea04a978e73c7a58281806.png )
```javascript
{
...
![](./images/f754343ced19121bf5c61f9dd731073e.png )
...
![](./images/5e09129408ee20f81dd8943610880e6a.png )

![](./images/2b2e10637281f98c9db6e75412324a6e.png )

![](./images/736c2c4e614a7bb9cafcdc5a8c4c98ea.png )

![](./images/99f2b437872d6efb76b2daeed322ab60.png )

![](./images/e5029d90a0befc21137ac1281a92c2d4.png )
...
![](./images/d2dcc698094b037d9bddad62cd969f5e.png )

![](./images/8af3ae5bc224b0212ffb69161a8f019e.png )
...
![](./images/56f90ad9892d5ed07fe40c0dbf10ea84.png )

服务端打印了包裹在事务里的 insert 语句：

![](./images/60cbbfcc417cde3c7a73548e70a87b3d.png )

在 mysql workbench 里看下：

users 表：

![](./images/7fe5cde90c046c40f9af092421c8b531.png )

roles 表：
![](./images/cff7d52a069264756d60badb18b5d3d8.png )

permissions 表：
![](./images/9a5aab0851a19eda0f16e57ee51746e1.png )

user_roles 表：
![](./images/b82e79eb9c45c038888ea7f6e8b35e8f.png )

role_permissions 表：
![](./images/872be6d9d88f3856c5375390c822010d.png )
...
![](./images/c7f903dc979a2e4153d39f73e59a647e.png )

你可以修改生成的 sql 文件位置：

![](./images/54d89b9a2a8f552ae51ee973643a4db2.png )

然后我们来实现登录：

后台管理的登录和用户端的登录是分开的：

![](./images/4b48a02b281f03e2d346b5b5828e2425.png )

![](./images/edf70dc6655856ed5478722afc50d566.png )
...
![](./images/e84b10aa04b773d6cae827811b849984.png )

![](./images/072785d5ae7f77c08abbefe193872095.png )

![](./images/1008d831cdd7cba8f53d5d52c610f099.png )
...
![](./images/a4313b9bbc37b82d85b223c807b7cb82.png )
...
![](./images/0735b65830fab0f527f707264df4809b.png )

/user/admin/login

![](./images/a8efe06ac2d79bfaae7a633d7c044fba.png )
...
![](./images/adb08a762f6feb1a94cc07e6779feb72.png )
```javascript
...
![](./images/cb937bc10f8e71d5d9c659f96fd3fed3.png )
...
![](./images/f5471ac49cc4931cb067370f82bdebd8.png )

GET /user/refresh

![](./images/2e83fa9dfabb6bca121df3061200d74e.png )

POST /user/admin/login

![](./images/5f7f9d83202e33440e72d88ddea6389e.png )

GET /user/admin/refresh

![](./images/f49554226bb0b872af7475c3c407ba30.png )
...
![](./images/fdc230dd73faf06fd6dc50e23cb87f36.png )
...
![](./images/9ef557a5b6f59fbd9a526f82e1b20c29.png )
...
![](./images/84815f23c421a32eae4f768358145ded.png )
...
![](./images/efce1b830b0a1b85b923d130e45ec78d.png )
...
![](./images/f43150568c521740f2603d3248f42151.png )
...
![](./images/cca0161f2d802d120a1b9e3030affc61.png )

带上 accessToken，是可以访问 aaa 接口的，因为 zhangsan 有这个权限

![](./images/20434cf4770d80993bbcf5a272a50327.png )

![](./images/4fb746d3a846acaa9aee530c08845866.png )

访问 /user/login 登录 lisi 账号，拿到 accessToken

![](./images/e0a18f9b69ed66af57298c5be936eea8.png )

带上 accessToken，就不能访问 aaa 接口的，因为 lisi 没有这个权限

![](./images/9276095bb4cb31e79a507793e78e0199.png )

这样，接口鉴权就完成了。

最后我们把这两个 @SetMetadata 封装成自定义装饰器

![](./images/e83f065b92e30dffe4dc6f02cdf2a48b.png )
...
![](./images/ae3ddf9c83447111bac9ecd61c6daf89.png )
...
![](./images/894437613a8b94a96e3ec1caf54bf030.png )

拿到 zhangsan 的 accessToken 来访问下 aaa 接口：

![](./images/aa7ae7631b518242c2cf0f4637902846.png )

可以看到，服务端从 request 取出了 user 的值传入了 handler：

![](./images/cc54939cea6521742e0d65fa12ce8bd6.png )
