...
![](./images/6d5ad58eab7ff0393b10b689af9dadc8.png )
...
![](./images/93748f94a0a12e2291abe4fa1d354d75.png )
...
![](./images/231b651e5b387da80b734750934734bf.gif )

填入邮箱，点击发送验证码。

提示发送成功。

![](./images/46c78b9fd4eb647b866873ad4cf422f1.png )

邮箱里也收到了这个验证码。

然后填入新密码，点击修改密码按钮：

![](./images/e5f01c655d557931bb8feafe24fc01e0.gif )

提示修改成功，然后会跳到登录页面。

在登录页面用新密码登录，提示登录成功。

![](./images/5e024c956b68ba900a16f3ec2bee8782.gif )
...
![](./images/a60139d7263845a0c127dfa7e298b3f3.png )

![](./images/86ce8bcd476583c4151401f3c5cc2dc9.png )
...
![](./images/9756182d238240b36abbb0b18eda3b3a.png )
```javascript
{
    path: "/",
    element: <Index></Index>,
...
![](./images/af9da43e8f05b5f7ff2dcdc02af56e68.png )

![](./images/0a238b6d974eaabb7188114ad1f976a4.png )
![](./images/20f5d2533ec756d88d5d5cf1ef39b111.png )
...
![](./images/1476a3d90de7368cdd60f61a9b58f0ea.png )
...
![](./images/a3e408bd23550e7dc3c4f31f93e6a6cf.png )
...
![](./images/c6c963cca152ba3feff673f62a99ae75.png )
...
![](./images/77d463e2d42cbbb64a43c575029a5f8a.gif )

提示没登录，然后跳转到了登录页。

给用户图标添加跳到 /update_info 的链接：

![](./images/8e86c305d808d5f0f4cb6eae3ba89193.png )

我们登录下：

![](./images/ce8248d7eeef4c7f16cce7b1c2fe3d30.gif )

再访问就不会 /update_info 跳转了：

![](./images/561ce77a9a27a74d167592324a0d4d45.png )

然后可以看到控制台打印了当前登录用户的信息：

![](./images/08d7f4fb4ff4c0a081f168e0ecafa378.png )
...
![](./images/49220cdcb556c61f68335e13e1b80c37.png )
...
![](./images/1beeafad7a7065d9140b50ccb7ddd55f.gif )

![](./images/6eba81215dbcfe4d029b85845b605f95.png )
...
![](./images/a09a6124e7fb5d2d162c39b578d1296b.png )
