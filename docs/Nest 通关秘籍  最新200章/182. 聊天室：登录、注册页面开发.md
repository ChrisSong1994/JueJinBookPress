...
```
![](./images/14d029db113da7c718dc47d6115d8511.png )
...
![](./images/87f1d3c4e9ade1f5a46165f73cac98f6.png )

输入用户名、密码，点击登录：

![](./images/32168b046b42022bd663902d0f405f9e.png )
...
![](./images/338a9ca9d9ea606a775e6e9a8caaed3f.png )
...
![](./images/a90f26ebf37382a95f2db2d5160cdaf0.png )
...
![](./images/79cc7bee6e511e9b6987421d8326b062.png )
...
![](./images/3eaa0e711f13798945717fe4ea761400.png )
...
![](./images/529629198d6bc1f4e8853fbcc416965d.png )
...
![](./images/afd816ef7cabb3260f78396124468f42.png )
...
![](./images/ee40c5e6bcdc4302b7c56ca4219a687b.png )
```javascript
const onFinish = async (values: RegisterUser) => {
    if(values.password !== values.confirmPassword) {
        return message.error('两次密码不一致');
