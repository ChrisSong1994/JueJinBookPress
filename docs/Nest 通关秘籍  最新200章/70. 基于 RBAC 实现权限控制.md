...
![](./images/fe71ef473dfdcfd381e6c38028335b3f.png )

直接给用户分配权限。

而 RBAC 是这样的：

![](./images/a0d9f53d4888f77c67a75acae296a1a3.png )
...
```
![](./images/54b52be4ebdcdfa001742058059ebd50.png )

可以看到创建出的 database：

![](./images/a73a3b47c3654e4928c737a6b5238db8.png )
...
![](./images/9e614fcafc23ec01e5838eb505c8bccf.png )
...
![](./images/831a8a0c44c2d0a7a52029a7935f1f2f.png )
...
![](./images/f25e8d728b1656b86c8156ed32229f42.png )
...
npm run start:dev
```
![](./images/9b70bd93c0ca8ffecd459eafb48d4e43.png )
...
![](./images/4eb16a14d78a702494d5bde078cf5ecf.png )

![](./images/35923de7e3662355cdb64a103ccb0c74.png )

![](./images/543fec66589d9da86049b1178419cbb3.png )

![](./images/6b6232265c3d51c7233c90759c761f7b.png )

![](./images/13847e1e9b3f1e6cdbef9d3ae743534a.png )

还有外键：

![](./images/dab5805201514b787983aa13cbc91a5b.png )

![](./images/21d64af11a221bce5aada54c433f4a9e.png )
...
![](./images/8e13ef52714357e9b25beea7d8649177.png )
...
![](./images/78c05a325206f63a0540c499ac144cfe.png )

服务端控制台打印了一堆 sql：

![](./images/f0ebbb80a05b0bc2987040ef35299b97.png )
...
![](./images/034f6bcac9b01053ffc08ab1945ac66c.png )

role 表：

![](./images/d466081c6ba271f2be95c333c157ea4c.png )

user 表：

![](./images/dcaab02fb138eb6f7f4285327871d9b7.png )

role_permission_relation 中间表：

![](./images/0239cdd064aca7c182592bb392eb2424.png )

user_role_relation 中间表：

![](./images/2fec6fb5d8431968900abb9b45404a56.png )
...
![](./images/51bf22d76297b64edb224aa0daa52401.png )

然后在 postman 里测试下：

ValidationPipe 不通过的时候，会返回错误信息：

![](./images/6d03d9f79684e0bd3f4a8274bf929987.png )

ValidationPipe 通过之后，就会执行 handler 里的方法：

![](./images/d6975c65c0889fa062f7fa20e88e95a5.png )

![](./images/74a7a2d5ad54789ec318ef231f4239d5.png )
...
![](./images/ed5e7ddc2dc8568382c4c3ff77bfe57f.png )

![](./images/555515e2166b86b31de2ec76ace0fbbb.png )
...
![](./images/87d86079dc1dd9814eb4bcbca0aff495.png )

设置为全局模块，这样不用每个模块都引入。

然后在 UserController 里注入 JwtModule 里的 JwtService：

![](./images/e410d0d84b7c1db413581fbbe95a749d.png )
...
![](./images/8c8e9543e1fc8b335d91e28609088488.png )
...
nest g resource bbb 
```
![](./images/7d11124c11c006a16d5b08410f896f85.png )

![](./images/63bdeb6d935e319d93b0ec1c48831ca3.png )

现在这些接口可以直接访问：

![](./images/b56f2819274930479332a71bb32cac20.png )

![](./images/e9f301302a6abc4210c37ad7d02bd3c3.png )
...
![](./images/ad30dee690959d0d7f119d5bd2bf72aa.png )

但这时候会报错 user 不在 Request 的类型上。

扩展下就好了：

![](./images/4df6f2feda6a403a62d2fdb67adb46e4.png )
...
![](./images/483bd211eccb5f86fde31d74740c3195.png )

这样太麻烦了，这次我们全局加：

![](./images/d6fa3b143a6803af0ebb2f181c5077c0.png )
...
![](./images/c957cb1f4721c1afeb72d86dc962c50b.png )

再访问下 aaa、bbb 接口：

![](./images/7eace854315fa3640fa6940d1a209352.png )

![](./images/69401084ff56cd045ba2f410328730e7.png )

但这时候你访问 /user/login 接口也被拦截了：

![](./images/5665f43ed82bcc4ea22c38d9949f4812.png )
...
![](./images/0d02887a8d1039180ea1d9c760720c24.png )

![](./images/c1b8a7ef30f75b19153fea86a487c3e5.png )

我们支持在 controller 上添加声明，不需要每个 handler 都添加，这样方便很多。

然后需要改造下 LoginGuard，取出目标 handler 的 metadata 来判断是否需要登录：

![](./images/7835b66e8ae15d88e8ea94bd1a3463e3.png )
...
![](./images/c6263fc507fb8fa2a9ee1800af433fa7.png )

因为没有 require-login 的 metadata：

![](./images/a40fcc3c274732fc483387dbbeeef07d.png )

而 aaa、bbb 是需要登录的：

![](./images/50b68c765422d4565e48e7e518e13637.png )

![](./images/c8ef45075ad0ce45e5916f9e6774aec1.png )

因为它们包含 require-login 的metadata：

![](./images/e4f2113834eb6778c52959bf3a0f69ba.png )

然后我们登录下，带上 token 访问试试：

![](./images/65fb506d9e49ab01236fdd3152634320.png )

![](./images/4fff9577a8377d24bb6fc92af345360b.png )
...
![](./images/fd29dc38723d56f0a8d5ed96ef259b62.png )

PermissionGuard 里需要用到 UserService，所以在 UserModule 里导出下 UserService：

![](./images/0b0ee09289e6461bb72df3cd31c2c056.png )
...
![](./images/23f2f896fe4fe61e08c443c6dffd8270.png )

可以看到打印了这个用户拥有的角色的所有 permission 信息：

![](./images/7a75a3d25243d5875e80629eefba5663.png )

再增加个自定义 decorator：

![](./images/4bbfd8069c5ee46272de4102277f9abb.png )
...
![](./images/c438ecf2e11614e7c580e0a1d866b829.png )

在 PermissionGuard 里取出来判断：


![](./images/6cd2bba6c681be54474e03332c2a9641.png )
...
![](./images/3f3ac8e8975d92fc8f0b38c341691efe.png )

带上 token 访问：

![](./images/076e1cc58eb5ea7c0614056a529c36de.png )
...
![](./images/fd880c2791e89ae539ba6223961f8813.png )
...
![](./images/d04ccbd8241b0de193fa157e2cb7ba06.png )

我们再登录下张三账号：

![](./images/8c129c26aea3a36c1335c16e9576d6c4.png )

用这个 token 去访问下 bbb 接口，就能正常访问了：

![](./images/3298d19afb6bf6efb60b1034f7dd404d.png )

他是有这个权限的：

![](./images/9aeb7fcbdd3ef8134680ea8f0188cd4c.png )
