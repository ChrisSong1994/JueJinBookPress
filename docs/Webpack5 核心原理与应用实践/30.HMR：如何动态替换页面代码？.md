...
![image.png](./images/22453568cbf7e2d2fa84792ead0b2a85.webp )
...
![image.png](./images/b9915a1c200a1ee1c22333b2c32cbc84.webp )
...
![image.png](./images/0bfc819e009025861b3084c3c0cce120.webp )

**再次，加载更新**：客户端通过 WebSocket 接收到 `hash` 消息后，首先发出 `manifest` 请求获取本轮热更新涉及的 chunk，如：


![image.png](./images/fa046d1718c2f7c914321ceb644f3b70.webp )
...
![image.png](./images/71b7802cb7a49c7927842da680171ff2.webp )
...
![image.png](./images/d1ae41325e0190c04782d84a29340c10.webp )
