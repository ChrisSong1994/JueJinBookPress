# 24.Init、Make、Seal：真正读懂 Webpack 核心流程
...
![image.png](./images/10d6e799ea49e8486448ab04bef73d30.webp )
...
![image.png](./images/5742aef848f48312f8c19ef293463ee9.webp )

为了方便理解，我把上述过程划分为三个阶段：


![image.png](./images/d933171678672d420f73db1724e57592.webp )
...
![image.png](./images/6b2ccdfd26c99211407de5026f719c4d.webp )
...
![image.png](./images/f000692a1a99a4e14043d8e909c8f103.webp )
...
![image.png](./images/a531bafdb927c26c7ea4b6cc82f1e112.webp )
...
![image.png](./images/31482514b582cf994c3f10f56c4e9c9f.webp )
...
![image.png](./images/2b40fae73757519ad17db674afbdf86c.webp )

之后，调用 Acorn 将 `index.js` 代码解析为 AST，并遍历 AST 找到 `index.js` 文件的依赖：


![image.png](./images/2770c216280c79041795153b40db8d3d.webp )
...
![image.png](./images/e466180010d94a3f8355883523d4a774.webp )

接着，又触发 `module[a/b]` 的 `handleModuleCreation` 方法，从 `a.js` 模块中又解析到 `c.js/d.js` 两个新依赖，于是再继续调用 `module[a]` 的 `handleParseResult`，递归上述流程：


![image.png](./images/486f2116c0ce3cf11d4bbecfe809c531.webp )

最终得到 `a/b/c/d` 四个 Module 与对应的 Dependency 对象：


![image.png](./images/0663fec482ba6eee1900accb6e4b7592.webp )
...
![image.png](./images/9c96cd494a8a6b3385096df0d1d2324b.webp )
...
![image.png](./images/f9509ca0b81ffca210d7f80ca9588c08.webp )
...
![image.png](./images/0001ab09fad3299e3c55d4cc39304933.webp )

a 依赖于 c/e；b 依赖于 c/d；a/b 同时依赖于 c。最终生成的 Chunk 结构为：

![image.png](./images/459cf2f27f1551d205186cab511eea61.webp )
...
![image.png](./images/43076b9e67566097f704a181d3e98c7d.webp )
