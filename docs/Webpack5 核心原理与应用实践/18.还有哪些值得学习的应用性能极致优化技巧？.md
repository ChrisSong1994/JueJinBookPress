...
![image.png](./images/3a59b23d521567b5195e04bda4a1b288.webp )
...
![image.png](./images/e117428aecb5f73a2e3cff736e8b3234.webp )
...
![image.png](./images/d7d59f21a2d1279321b0cab6ce4ff6a0.webp )

构建后将生成入口 `index.js` 与异步模块 `async-a.js` 两个 Chunk 对应的产物：


![image.png](./images/4587df84a4ad44060624d884c1566d76.webp )
...
![image.png](./images/c20f9ee38a0fd3cf47fe9c3a73c6d271.webp )

父级 Chunk\(`index`\)也受到了影响，生成新的 Hash 值，这是因为在 `index` 中需要记录异步 Chunk 的真实路径：

![image.png](./images/ad6e5973f85b3a79d56beffb32a4f5f1.webp )
...
![image.png](./images/fe58e29b52a6b5e22c36c94686f349cd.webp )
...
![image.png](./images/89b1fb39ba028bb1906dfca858b2181f.webp )
...
![6e31845d-7b51-422d-8822-83126c613d7b.gif](./images/ec44a84598fd4e743e61fb819b76a634.webp )
...
![image.png](./images/a83791f072039cfcfb52ae404094b57b.webp )
