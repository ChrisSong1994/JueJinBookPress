...
![image.png](./images/cedc52ea97bfd8a78cd931ca3a506220.webp )
...
![image.png](./images/527308559c95b3c551dbba7159b4556e.webp )

左边为 `main` 产物，包含所有模块、运行时代码，与普通 Bundle 无异；右边为 `foo` 产物，代码结构非常清爽。作为对比，若不指定 `dependOn` 属性，则构建结果：


![image.png](./images/12c646be90399c75b794ced235a5fc5c.webp )
...
![image.png](./images/1e198080baf2d0c79e367ebcb8c9ab45.webp )
...
![image.png](./images/8ecc8d3655005af0929c00698607f386.webp )
