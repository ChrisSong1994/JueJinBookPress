...
![image.png](./images/640432f2f73d781ea8cd1f6dcf807e83.webp )
...
![image.png](./images/4827ce696c8153392b1c4cb22f8a9167.webp )

- 使用 `this.emitError` 接口，同样不会打断编译流程，效果：


![image.png](./images/8d49fb447c2b06107e585eea95364938.webp )
...
![image.png](./images/1cbed5751950803cde8aa1a9b8adca68.webp )
...
![image.png](./images/8d914aebdd49a7099ce5cfa189a3a233.webp )
...
![image.png](./images/66db7a95d213a1be5f09ac83393ea406.webp )

`pitch` 阶段按配置顺序从左到右逐个执行 `loader.pitch` 函数\(如果有的话\)，开发者可以在 `pitch` 返回任意值中断后续的链路的执行：


![image.png](./images/ff84044a1bbd6625de2d31d361881b73.webp )
...
![image.png](./images/cec4e56ab6dc6f2f6ab4a49045cb81a4.webp )
