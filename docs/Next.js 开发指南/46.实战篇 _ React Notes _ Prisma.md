...
![image.png](./images/a867f6e4746f5e77fb7c58c39bf61b52.png)
...
![image.png](./images/ec4656091bca18afea5c887d54a6caf4.png)
...
![image.png](./images/d449c6e49c186a797f50ebdea5db9ade.png)

![image.png](./images/3a1df48eb00af28926f09971e80dd4d5.png)
...
![image.png](./images/d1226f3b054d6cd17db0d7e2e4b73c03.png)
...
![image.png](./images/44c4685dba96aebfe288b7da61dc6e54.png)
...
![image.png](./images/eb178646917ab015317bad29623fd2b5.png)
...
![image.png](./images/ee79372b8bb6616cba551bd0b1a758ab.png)
...
![image.png](./images/ebca5babe2977f5a112386f4eb5f2027.png)
...
![image.png](./images/6323f82665e36a805b711f7c3ff120cb.png)
Prisma 目前支持的语言和数据库有：

![image.png](./images/c39011d4dcba000afc2c602f3195b703.png)
...
![image.png](./images/2d6f72bf3edac81dd2dad85545989c66.png)
...
![1.png](./images/f646ead666c7002ceb4ef57091ed878d.png)

执行 `npx prisma db pull`，如果出现以下提示即表示连接成功：

![image.png](./images/b87d32e7ac4ff2f953724111ec7859eb.png)

注：虽然是报错信息，显示数据库为空，但说明至少连接上了数据库。如果数据库不存在，就是另外一个报错了：

![image.png](./images/6ab7beb290f2979c05604cd25d2f1185.png)
...
![image.png](./images/9bdb83aedb5d82ab7e65ba724d77176e.png)

再次查看数据库，User 表、Note 表和其中的字段都已建立：

![image.png](./images/7d93361652d625a31b5ad5cde2338c22.png)

这个 Prisma schema 同步数据库的过程，就被称之为 **migration**。每次迁移，都会生成一个迁移文件，存放在 `prisma/migrations`下。

现在我们直接修改数据库，比如在 Note 表添加一个 `content` 字段：

![image.png](./images/9c81b853508a7d9d9f18f477168cbab4.png)
...
![image.png](./images/5acb0042aaf60a9cd51670dfc0326266.png)

### 4. 语法高亮与自动格式化

多说一句：schema.prisma 因为是 Prisma 自定义的文件格式，所以文件默认无语法高亮，使用 VSCode 的同学可以下载 Prisma 这个插件以支持该文件语法高亮：

![image.png](./images/18402ba9688758bd28c635cf224fb47d.png)

安装该插件后，还可以打开 `settings.json`，添加 prisma 文件的自动格式化：

![截屏2024-01-18 下午8.08.04.png](./images/62ee0c0f95ab6eae7d614dc95e2cc88c.png)
...
![image.png](./images/4f6de3ac6326a7ff110dff2bb57f7e97.png)
...
![image.png](./images/109ce11ad6679ea0b39dcd34101a0b56.png)
...
![image.png](./images/cdd8b0bbc1481f4fb0cf8227122c69c3.png)
...
![image.png](./images/c3f5f76f2ac52357d8e5ed06f12cb9c4.png)
