...
![image.png](./images/4c1d7d42bbbc71169732f5c46562a2d6.png)
...
![截屏2023-12-16 下午7.58.57.png](./images/9f2ec59dc279fd82ac928ec09cdfb961.png)
...
![image.png](./images/00e9a81d4325d10929e3866799d09861.png)
...
![image.png](./images/85cdb5769b68b6eeb282d0e9b96a392f.png)

至于怎么实现的，想必你也想到了，两个请求虽然地址一样，但请求头不一样。这是返回 RSC Payload 的请求头：

![截屏2023-12-16 下午8.45.08.png](./images/f9190335f9fbc40a559d6d915d6ab03e.png)

这是返回 HTML 的请求头：

![image.png](./images/16eea4477a5ef8ea86d647c92d7f79ec.png)
