...
![image.png](./images/b7c4c67d7caecb94c6efd1c03158a20b.webp )
...
![image.png](./images/c76f30785e724aa3dd5c6bd238f4f5db.webp )

点击 Create，部署完成后自动跳转到：

![image.png](./images/b85dd82e5f7801480d70677db13a5cdb.webp )

点击左侧的预览图片，查看部署效果：

![image.png](./images/8a15f1800d1eddc6f20e1a18a17b8619.webp )
...
![image.png](./images/33be54fe6a87666a25a42634a2c0d660.webp )
...
![image.png](./images/ad4c54f39467f70a2533d88dcc6c472f.webp )

修改后，可以发现主页展示的内容和 HTML 元数据都发生了变化：

![image.png](./images/6db8cedb61f695f2ffd5b089adc0bac6.webp )

#### 4.2. 修改 logo

![截屏2024-04-30 17.24.03.png](./images/d09a4a0e0039d05130648f6ad1ea551e.webp )
...
![image.png](./images/4e27def5be67c53a6422f3ab3b0bdb3c.webp )

#### 4.3. 修改导航栏信息

右侧导航栏的信息在 `/data/headerNavLinks.ts`，根据自己的需求修改即可。

![image.png](./images/2cf23fffe7e88f67c222d47e31ded902.webp )

#### 4.4. 修改主页样式

这里的内容看着有些奇怪：
![截屏2024-04-30 17.37.42.png](./images/54a973a71fd7e3faa089e30e94b77919.webp )
对应的代码地址为 `app/Main.tsx`，根据自己的需求修改即可。我直接注释掉了，修改后的效果如下：

![image.png](./images/98ca174f051ccdbf15c837e1e605cf39.webp )
...
![image.png](./images/40ffdf0ef10e62d3f86b1ac69181632e.webp )
...
![image.png](./images/6cba98f48a427d2de74812bab587c520.webp )

#### 4.7. 修改项目信息

打开 <http://localhost:3000/projects>，可以查看到预设的项目信息：

![image.png](./images/072967fa11339772314dbb93dc78afa4.webp )
