...
![image.png](./images/0560689a465f18968a452a8f3ddbf19f.png)
...
![image.png](./images/d83f0864839eec5f7db0a251ecad6b8d.png)
...
![image.png](./images/72b1739d9b6a2ea04e87728d9a7f3e80.png)

2.  显示上下文文档：

![image.png](./images/7df31505d8340ba87a58a0d0ee3fa4df.png)

3.  显示可用选项：

![image.png](./images/1ea9c49a7f948f235b6acb78e077c01d.png)

4.  确保 `use client`被正确使用：

![image.png](./images/59839f4bcf801b76424d60b7b6c922e0.png)

5.  确保客户端 hooks（如 useState）只在客户端组件中使用：

![image.png](./images/78a23d5f10265846d3afba71593f67b5.png)
