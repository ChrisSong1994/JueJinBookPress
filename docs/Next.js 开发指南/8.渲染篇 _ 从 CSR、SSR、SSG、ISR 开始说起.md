...
![image.png](./images/9ae0bb87ee2b253b1256b4186d4f690a.png)

JavaScript 获得数据后，最终更新为：

![image.png](./images/da4afb921a03c54280cc3e95be59a2e5.png)
...
![image.png](./images/85392a460038ea1afe883ecf1cac8ba8.png)

服务端会在每次请求的时候编译 HTML 文件返回给客户端。查看 HTML，这些数据可以直接看到：

![image.png](./images/01af2396d129be933617c26932d7517a.png)
