...
![image.png](./images/4212cb7308278e4fe5c65a4c454cb8eb.png)
...
![image.png](./images/7ebe6e6785f5e8b8f7443e7d71472096.png)
...
![image.png](./images/d685214dae5ea564f38fc01e92d81136.png)
...
![image.png](./images/2b3674239ea75bfa98b39d7bead6174c.png)

因为我们将文件放在了 `public`下，所以直接访问 `http://localhost:3000/uploads/24-01-03/occaecati-4s2adp.md`即可查看文件内容：

![image.png](./images/cccd5c87db93c173fb37854be27404c3.png)
