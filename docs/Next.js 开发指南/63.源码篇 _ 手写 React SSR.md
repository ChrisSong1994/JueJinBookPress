...
![image.png](./images/4cc3ad944ff0501314dc7d0ef6b8f809.webp )

项目根目录会生成 `index.js`，浏览器打开 `index.html`，效果如下：

![csr.gif](./images/e86d45cde8d1b893847a3fe93872f2da.gif )
...
![image.png](./images/2e0631f82c687f701d1c7f36305d4734.webp )
...
![image.png](./images/f92ca8dd1ff0185f687cc1480fa2bf01.webp )
...
![image.png](./images/8847a0d06e2def5a6c879b55b848cc9a.webp )

此时打开 `localhost:3000`，你会发现页面成功渲染：

![ssr.gif](./images/52286f8d5a2338ddb8e1c097335505e8.gif )
...
![image.png](./images/152942515305d8bbb3e5a91fecaab860.webp )
...
\`![ssr-1.gif](./images/8d2d58023e151ae27823ac64badfb24f.gif )
...
\`![ssr-1.gif](./images/0881ee0db0b11ad7e8de3d6e3c3c43f5.gif )
