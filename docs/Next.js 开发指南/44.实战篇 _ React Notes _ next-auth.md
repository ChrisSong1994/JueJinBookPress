# 44.实战篇 _ React Notes _ next-auth
...
![image.png](./images/24f8cfa2bdd0629fcb2a8e9f46c0327a.webp )
...
![ReactNotes-Auth5.gif](./images/635758b6798229436046236b533b5b67.gif )
...
![image.png](./images/970ee1dad8d1fe49c22e8e23be56c8b0.webp )
...
![image.png](./images/7981b4c9713d31cb742f22b3f38fd255.webp )
...
![ReactNotes-Auth5.gif](./images/6c9461592b582292e8554379bb18e8f1.gif )

如果登陆的时候报如下错误：

![image.png](./images/a9c735476325c29d985979084556a4a5.webp )
...
![image.png](./images/1a500841fcae23a041cd3102f3300dbc.webp )

当用户点击 `SignIn` 按钮的时候，跳转到 `locahost:3000/api/auth/signin`：

![image.png](./images/ed47a45ce2f1e4f181cc3bdf8963e93b.webp )

这个页面根据你提供的 providers 选项而生成，在这里我们只配置了 GitHub 登陆，所以显得有点简陋。但如果配置齐全的话，效果可以如下（当然具体样式也支持自定义，详细请参考文档）：

![image.png](./images/b955d13b72d137be425ed0e42da33301.webp )

这里我们以 GitHub 的 OAuth 为例，当我们点击 `Sign in with Github`，查看对应的元素：

![截屏2024-01-04 下午8.49.35.png](./images/8d136267b18165bb3f426e31623ccdfc.webp )
...
![image.png](./images/c72ac57483fac6beba0397a2efec745f.webp )
...
![image.png](./images/0707979d44c049ca45540043b8f71ae0.webp )
...
![image.png](./images/a3e9fb0e4a6157b4bfdfa8b16eb5e574.webp )
...
![image.png](./images/b18288e5f56db967599c3da0c6cb541e.webp )
...
![image.png](./images/9b9beb0251a501c24e1c963e0460d390.webp )
...
![image.png](./images/fb85b8ce934853e3b1c249e662e0374d.webp )
...
![ReactNotes-Auth6.gif](./images/c167a90812053e4373653e30d46d8fbe.gif )
...
![ReactNotes-Auth7.gif](./images/df5ac81ed73bbbac9b786f4b102c6ea4.gif )
...
![ReactNotes-Auth8.gif](./images/132771c5950aed460b70b89de712f61c.gif )
