...
![ReactNotes-搜索.gif](./images/91c032b070b1a9deb59851ddf7f71c94.gif )
...
![image.png](./images/40eae207cb6a1ac0f254b6416eb4e944.webp )
...
![ReactNotes-搜索1.gif](./images/4857d04e4ab598e57dda351fb685779e.gif )

#### 尝试 3

搜索功能看似可以正常运行了，但是有个问题，让我们查看下此时的源代码：

![截屏2023-12-21 下午5.55.33.png](./images/580802be6015222e80343fcffabf73b9.webp )
...
![ReactNotes-搜索2.gif](./images/9c05aa1e0ebc16a5de3c1da2acfb46ce.gif )

客户端也不会打包 `dayjs`：

![image.png](./images/121b817dff79909576aecd37495338ae.webp )
...
![ReactNotes-搜索2.gif](./images/bd09eca59375546c597fa02a43946c54.gif )

客户端也不会打包 `dayjs`：

![image.png](./images/707133b8fb2891a2196e202ace4d4792.webp )
