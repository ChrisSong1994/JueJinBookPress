...
![image.png](./images/e925ced180689ac3d455624ab6d30da1.webp )
...
![image.png](./images/04afd961525d8a247560d0ae33428954.webp )

Segment 放到 Route 这个场景时：

**Router Segment**，我翻译为“路由段”，路由中的每个文件夹都代表一个路由段。每个路由段都映射一个对应的 URL Segment：

![image.png](./images/2c991b494395ae0b63fb8f93f14dbac8.webp )
