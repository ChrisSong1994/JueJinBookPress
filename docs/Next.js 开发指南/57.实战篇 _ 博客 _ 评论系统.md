...
![image.png](./images/5346696f195e422cbebd3fa2520c0eea.webp )

3.  创建应用后，进入应用，点击左下角的设置 - 应用凭证，获取 `AppID`、`AppKey`、`MasterKey` 等信息：

![截屏2024-05-19 18.05.07.png](./images/6661a193a0cfb0e81a89579363ca2f21.webp )
...
![image.png](./images/5905da3a7ee4df312d03dc1c68a313cb.webp )

部署成功后，进入应用的设置页面，设置环境变量：

![截屏2024-05-19 18.14.30.png](./images/5c043d7a815580ec8e8cf69137e3fe7b.webp )

配置三个环境变量 `LEAN_ID`, `LEAN_KEY` 和 `LEAN_MASTER_KEY` 。它们的值分别对应上一步在 `LeanCloud` 中获得的 `AppID`, `AppKey`, `MasterKey`。

然后重新部署（这步是为了让环境变量生效）：

![截屏2024-05-19 18.19.25.png](./images/2d60c8ddc9521c3a8f79093304c8cb6f.webp )
...
![截屏2024-05-19 18.29.02.png](./images/c5072c3c2e786836923076901b0733ae.webp )

配置成功后，访问 <https://waline.yayujs.com/> 就可以查看评论前台界面：

![image.png](./images/6ea6777ed9275abe28ceec3a2746d5bf.webp )

访问 <https://waline.yayujs.com/ui> 就会进入评论管理后台：

![image.png](./images/c16292dd274f800b9d6c088cb3ae0f4d.webp )
...
![image.png](./images/5d1dcfcd608628279b06204137caed28.webp )
...
![image.png](./images/4f3227c97cd34c7c680b4745010445f1.webp )
