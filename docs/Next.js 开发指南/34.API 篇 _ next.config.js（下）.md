...
![image.png](./images/43db8d30c5adc64c9134b6610c4493a6.webp )

让我们在开发环境中测试一下这个配置，原本请求的地址是：

![image.png](./images/2e5e0b0720b95f6372a7310267f0f177.webp )

配置后会变成：

![image.png](./images/192cbb7c290ddfe4175001b761a73736.webp )
...
![image.png](./images/e009cc9b67b5a5364e15bd1bf0ff1fed.webp )

你应该访问 `/docs`：

![image.png](./images/cf091bf8ee577d408637b2dca6771e54.webp )
...
![image.png](./images/a2aaaaf3f444c2bc2b4c893e598d1616.webp )
...
![image.png](./images/34c529f2386d173ac51b9c8d1942fd27.webp )
