...
```bash
# 49.实战篇 _ React Notes _ Docker 部署
npm i && npm run dev
```
...
![image.png](./images/c9938ffa7f71fe75d2f9f61b84fc7cd5.webp )
...
![image.png](./images/64558a3e0a71d4a6c4c0947e1e93f8e5.webp )

如果你没有设置过，宝塔里也支持容器快捷的设置反向代理、绑定到具体的域名上：

![image.png](./images/1c65626f5197a38672a806b69913a9c9.webp )
...
![image.png](./images/024296726b7e21e2721a03bb4f8a7af9.webp )
...
![image.png](./images/266107519ac4fb78fe64023e90df1930.webp )
...
![image.png](./images/464e0378b39d9477e3731472bb366607.webp )
...
![image.png](./images/eb3574a545493f46dc1e5c5989a43857.webp )

那么问题来了，如果我切换了 host，我如何知道浏览器打开的地址访问的是线上还是本地呢？

方法有很多种，一种简单的方式是查看页面请求头，如果是本地：

![截屏2024-02-20 16.39.06.png](./images/1af4f51aebcf94fa5e7810ba2c84bfba.webp )

如果是线上：

![截屏2024-02-20 16.40.20.png](./images/2fbfaf1f206a4e99771f1632c942ca2f.webp )
...
![image.png](./images/60c4ef380197fa9fa7f6abbf6890d0f4.webp )
...
![image.png](./images/480c9fbe77e55667829a856e6d272eea.webp )

查看镜像大小：

![image.png](./images/a1d6557657e1bd7550bba7e9094e84ec.webp )
